...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_navs">Accordion and navs</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Components</span> - Navs</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="components_navs">Components</a></li>
				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<h6 class="content-group text-semibold">Accordion with controls <small class="display-block">Using panel controls, except <code>collapse</code></small></h6>

							<div class="panel-group accordion-sortable content-group-lg" id="accordion-controls">
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion-controls" href="#accordion-controls-group1">Accordion Item #1</a>
										</h6>
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
											<a class="collapsed" data-toggle="collapse" data-parent="#accordion-controls" href="#accordion-controls-group2">Accordion Item #2</a>
										</h6>
									...
									<div id="accordion-controls-group2" class="panel-collapse collapse">
										<div class="panel-body">
											Тon cupidatat skateboard dolor brunch. Тesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda.
										</div>
									</div>
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
											<a class="collapsed" data-toggle="collapse" data-parent="#accordion-controls" href="#accordion-controls-group3">Accordion Item #3</a>
										</h6>
							...
							<h6 class="content-group text-semibold">Left control icon <small class="display-block">Using <code>left</code> aligned control icon</small></h6>

							<div class="panel-group panel-group-control content-group-lg" id="accordion-control">
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion-control" href="#accordion-control-group1">Accordion Item #1</a>
										</h6>
									</div>
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
											<a class="collapsed" data-toggle="collapse" data-parent="#accordion-control" href="#accordion-control-group2">Accordion Item #2</a>
										</h6>
									</div>
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
											<a class="collapsed" data-toggle="collapse" data-parent="#accordion-control" href="#accordion-control-group3">Accordion Item #3</a>
										</h6>
									</div>
							...
							<h6 class="content-group text-semibold">Right control icon <small class="display-block">Using <code>right</code> aligned control icon</small></h6>
							...
							<h6 class="content-group text-semibold">Panels styling <small class="display-block">Using different panel styles</small></h6>
						...
						<div class="col-md-6">
							...
							<!-- Basic collapsible -->
							<h6 class="content-group text-semibold no-margin-top">Basic collapsible <small class="display-block">Basic collapsible functionality</small></h6>
							...
							<h6 class="content-group text-semibold">Collapsible with controls <small class="display-block">Using all panel controls, except <code>collapse</code></small></h6>

							<div class="panel-group collapsible-sortable content-group-lg">
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
											<a data-toggle="collapse" href="#collapsible-controls-group1">Collapsible Item #1</a>
										</h6>
									...
									<div id="collapsible-controls-group1" class="panel-collapse collapse in">
										<div class="panel-body">
											Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch.
										</div>
									</div>
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
											<a class="collapsed" data-toggle="collapse" href="#collapsible-controls-group2">Collapsible Item #2</a>
										</h6>
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
											<a class="collapsed" data-toggle="collapse" href="#collapsible-controls-group3">Collapsible Item #3</a>
										</h6>
							...
							<div class="panel-group panel-group-control panel-group-control-right content-group-lg">
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
											<a data-toggle="collapse" href="#collapsible-control-right-group1">Collapsible Item #1</a>
										</h6>
									</div>
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
											<a class="collapsed" data-toggle="collapse" href="#collapsible-control-right-group2">Collapsible Item #2</a>
										</h6>
									</div>
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h6 class="panel-title">
											<a class="collapsed" data-toggle="collapse" href="#collapsible-control-right-group3">Collapsible Item #3</a>
										</h6>
									</div>
							...
							<div class="panel-group">
								<div class="panel">
									<div class="panel-heading bg-info">
										<h6 class="panel-title">
											<a data-toggle="collapse" href="#collapsible-styled-group1">Collapsible Item #1</a>
										</h6>
									</div>
								...
								<div class="panel">
									<div class="panel-heading bg-slate">
										<h6 class="panel-title">
											<a class="collapsed" data-toggle="collapse" href="#collapsible-styled-group2">Collapsible Item #2</a>
										</h6>
									</div>
								...
								<div class="panel">
									<div class="panel-heading bg-purple">
										<h6 class="panel-title">
											<a class="collapsed" data-toggle="collapse" href="#collapsible-styled-group3">Collapsible Item #3</a>
										</h6>
									</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">List group component</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							...
							<p class="content-group-sm">List group is a flexible and powerful component for displaying not only simple lists of elements, but complex ones with custom content. The most basic list group is simply an unordered list with list items, and the proper classes. To use linked list group items, add anchor tags instead of list items (that also means a parent <code>&lt;div></code> instead of an <code>&lt;ul></code>).</p>

							<div class="row">
								<div class="col-md-6">
									<div class="content-group">
										<p>Basic list group</p>
										<ul class="list-group">
								...
								<div class="col-md-6">
									<div class="content-group">
										...
										<div class="list-group">
											...
											<a href="#" class="list-group-item active">And hello exotic staunch</a>
											<a href="#" class="list-group-item">That and well ecstatically</a>
											<a href="#" class="list-group-item disabled">Amid ruefully hello sped</a>
											<div class="list-group-divider"></div>
											<a href="#" class="list-group-item">Burst circa less contritely</a>
										</div>
									</div>
								</div>
							</div>
							...
							<!-- Contextual classes -->
							<h6 class="text-semibold">Contextual classes</h6>
							<p class="content-group-sm">Example of list items <code>contextual</code> classes. Depending on the context, you can highlight a specific list group item using available contextual classes: <code>danger</code>, <code>success</code>, <code>warning</code> and <code>info</code>. To use, add <code>.list-group-item-*</code> class to the base <code>.list-group-item</code> class. Also you can add <code>.active</code> class to highlight active list item. Custom colors are also supported.</p>

							<div class="row">
								<div class="col-md-6">
									<div class="content-group">
										<p>List item colors</p>
										<ul class="list-group">
								...
								<div class="col-md-6">
									<div class="content-group">
										<p>Linked list item colors</p>
										<div class="list-group">
											<div class="list-group-header">Success context</div>
											<a href="#" class="list-group-item list-group-item-success">Sheared coasted so concurrent</a>

											<div class="list-group-header">Info context</div>
											<a href="#" class="list-group-item list-group-item-info">Relentless ouch essentially</a>

											<div class="list-group-header">Warning context</div>
											<a href="#" class="list-group-item list-group-item-warning">Negatively far essential much</a>

											<div class="list-group-header">Danger context</div>
											<a href="#" class="list-group-item list-group-item-danger">Into darn intrepid belated</a>
										</div>
									</div>
								</div>
							</div>
							...
							<!-- List group elements -->
							<h6 class="text-semibold">List group elements</h6>
							<p class="content-group-sm">Examples of group list <code>elements</code>. You can add badges, labels and icons to any list group item. Depending on a placement of the component, it will appear <code>before</code>, <code>after</code> or will be positioned on the <code>right</code> of the list item. To use right positioned element, simply add <code>.pull-right</code> helper class to it. Dropdown menus are also supported.</p>

							<div class="row">
								<div class="col-md-6">
									<div class="content-group">
										<p>Icons in list group</p>
										<ul class="list-group">
											<li class="list-group-header"><i class="icon-menu7"></i> Group header</li>

											<li class="list-group-item">
												<i class="icon-comment-discussion"></i> And hello exotic staunch
											</li>

											<li class="list-group-item active">
												<i class="icon-mention"></i> That and well ecstatically
											</li>

											<li class="list-group-divider"></li>

											<li class="list-group-item">
												Sheared coasted so concurrent <i class="icon-gear pull-right"></i>
											</li>

											<li class="list-group-item disabled">
												Into darn intrepid belated <i class="icon-graph pull-right"></i>
											</li>
										</ul>
									</div>
									...
									<div class="content-group">
										...
										<ul class="list-group">
											<li class="list-group-item">
												<span class="badge badge-danger">93</span> And hello exotic staunch
											</li>

											<li class="list-group-item active">
												<span class="badge badge-primary">73</span> That and well ecstatically
											</li>

											<li class="list-group-divider"></li>

											<li class="list-group-item">
												Sheared coasted so concurrent <span class="label bg-pink-400">New</span>
											</li>

											<li class="list-group-item disabled">
												Into darn intrepid belated <span class="label bg-teal-400">Resolved</span>
											</li>
										</ul>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="content-group">
										<p>Icons in linked list group</p>
										<div class="list-group">
											<div class="list-group-header"><i class="icon-menu7"></i> Group header</div>
									...
									<div class="content-group">
										<p>Badges in linked list group</p>
										<div class="list-group">
											<a href="#" class="list-group-item">
												<span class="badge badge-danger">93</span> And hello exotic staunch
											</a>
							...
							<h6 class="text-semibold">Custom content</h6>
							<p class="content-group-sm">Simple example of a <code>custom</code> content in the list group component. You can add nearly any HTML markup, add images, custom elements and colors to the list group item. Example below demonstrates a simple content with <code>title</code> and <code>text</code>. For proper styling, heading must contain <code>.list-group-item-heading</code> class and content must have <code>.list-group-item-text</code> class.</p>
