...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/job_list.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="job_detailed">Job detailed</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Job Search</span> - Detailed</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="job_detailed">Job search</a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-body">
									<div class="media stack-media-on-mobile text-left content-group-lg">
										...
										<div class="media-body">
											<h5 class="media-heading text-semibold">Interaction UX/UI Industrial Designer</h5>
										...
										<div class="media-right media-middle text-nowrap">
											<a href="#" class="btn bg-blue"><i class="icon-envelop2 position-left"></i> Apply for this job</a>
										</div>
									</div>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Desired Skills and Experience:</h6>
										<ul class="list">
											<li>
												<strong class="display-block">Strategic Thinking.</strong>
											...
											<li>
												<strong class="display-block">Experimentation.</strong>
												Experience optimizing designs based on A/B testing is a plus.
											</li>
											<li>
												<strong class="display-block">Communication.</strong>
											...
											<li>
												<strong class="display-block">Marketing.</strong>
												You are familiar with and have previously worked on a marketing team.
											</li>
											<li>
												<strong class="display-block">Asset Management.</strong>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">What we offer:</h6>
										<ul class="list">
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Interested?</h6>
