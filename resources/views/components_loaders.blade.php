...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="{{url('assets/js/plugins/loaders/progressbar.min.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/pages/components_loaders.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_loaders">Loaders and bars</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Components</span> - Loaders</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="components_loaders">Components</a></li>
				...
				<div class="content">
					...
					<!-- Content loaders title -->
					<h6 class="content-group text-semibold">
						Content loaders
						<small class="display-block">Animated <code>content</code> icon loaders</small>
					</h6>
					<!-- /content loaders title -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Content loading spinner 1</h6>
								<p class="content-group-sm text-muted">Using <code>icon-spinner spinner</code> classes</p>

								<button type="button" class="btn btn-default" id="spinner-light"><i class="icon-spinner spinner position-left"></i> Light overlay</button>
								<button type="button" class="btn bg-teal-400" id="spinner-dark"><i class="icon-spinner spinner position-left"></i> Dark overlay</button>
							</div>

							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Content loading spinner 2</h6>
								<p class="content-group-sm text-muted">Using <code>icon-spinner2 spinner</code> classes</p>

								<button type="button" class="btn btn-default" id="spinner-light-2"><i class="icon-spinner2 spinner position-left"></i> Light overlay</button>
								<button type="button" class="btn bg-teal-400" id="spinner-dark-2"><i class="icon-spinner2 spinner position-left"></i> Dark overlay</button>
							</div>

							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Content loading spinner 3</h6>
								<p class="content-group-sm text-muted">Using <code>icon-spinner3 spinner</code> classes</p>

								<button type="button" class="btn btn-default" id="spinner-light-3"><i class="icon-spinner3 spinner position-left"></i> Light overlay</button>
								<button type="button" class="btn bg-teal-400" id="spinner-dark-3"><i class="icon-spinner3 spinner position-left"></i> Dark overlay</button>
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Content loading spinner 4</h6>
								<p class="content-group-sm text-muted">Using <code>icon-spinner4 spinner</code> classes</p>

								<button type="button" class="btn btn-default" id="spinner-light-4"><i class="icon-spinner4 spinner position-left"></i> Light overlay</button>
								<button type="button" class="btn bg-teal-400" id="spinner-dark-4"><i class="icon-spinner4 spinner position-left"></i> Dark overlay</button>
							</div>

							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Content loading spinner 5</h6>
								<p class="content-group-sm text-muted">Using <code>icon-spinner6 spinner</code> classes</p>

								<button type="button" class="btn btn-default" id="spinner-light-5"><i class="icon-spinner6 spinner position-left"></i> Light overlay</button>
								<button type="button" class="btn bg-teal-400" id="spinner-dark-5"><i class="icon-spinner6 spinner position-left"></i> Dark overlay</button>
							</div>

							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Content loading spinner 6</h6>
								<p class="content-group-sm text-muted">Using <code>icon-spinner9 spinner</code> classes</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Content loading spinner 7</h6>
								<p class="content-group-sm text-muted">Using <code>icon-spinner10 spinner</code> classes</p>

								<button type="button" class="btn btn-default" id="spinner-light-7"><i class="icon-spinner10 spinner position-left"></i> Light overlay</button>
								<button type="button" class="btn bg-teal-400" id="spinner-dark-7"><i class="icon-spinner10 spinner position-left"></i> Dark overlay</button>
							</div>

							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Content loading spinner 8</h6>
								<p class="content-group-sm text-muted">Using <code>icon-spinner11 spinner</code> classes</p>

								<button type="button" class="btn btn-default" id="spinner-light-8"><i class="icon-spinner11 spinner position-left"></i> Light overlay</button>
								<button type="button" class="btn bg-teal-400" id="spinner-dark-8"><i class="icon-spinner11 spinner position-left"></i> Dark overlay</button>
							</div>

							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Content loading spinner 9</h6>
								<p class="content-group-sm text-muted">Using <code>icon-sync spinner</code> classes</p>

								<button type="button" class="btn btn-default" id="spinner-light-9"><i class="icon-sync spinner position-left"></i> Light overlay</button>
								<button type="button" class="btn bg-teal-400" id="spinner-dark-9"><i class="icon-sync spinner position-left"></i> Dark overlay</button>
							</div>
						</div>
					</div>
					<!-- /content loading spinners -->
					...
					<h6 class="content-group text-semibold">
						Page loaders
						<small class="display-block">With light and dark overlays</small>
					</h6>
					<!-- /page loaders title -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Mini bar theme</h6>
								<p class="content-group-sm text-muted">By loading <code>theme_bar_xs.css</code> file</p>

								<div class="pace-demo">
									<div class="theme_bar_xs"><div class="pace_progress" data-progress-text="60%" data-progress="60" style="width: 60%;"></div></div>
								</div>
							</div>

							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Mini bar with text</h6>
								<p class="content-group-sm text-muted">Uncomment piece of CSS code to show text</p>

								<div class="pace-demo" style="padding-bottom: 30px;">
									<div class="theme_bar_xs"><div class="pace_progress" data-progress-text="60%" data-progress="60" style="width: 60%;">60%</div></div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Small bar theme</h6>
								<p class="content-group-sm text-muted">By loading <code>theme_bar_sm.css</code> file</p>

								<div class="pace-demo">
									<div class="theme_bar_sm"><div class="pace_progress" data-progress-text="60%" data-progress="60" style="width: 60%;"></div></div>
								</div>
							</div>

							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Small bar with text</h6>
								<p class="content-group-sm text-muted">Uncomment piece of CSS code to show text</p>

								<div class="pace-demo" style="padding-bottom: 30px;">
									<div class="theme_bar_sm"><div class="pace_progress" data-progress-text="60%" data-progress="60" style="width: 60%;">60%</div></div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Default bar theme</h6>
								<p class="content-group-sm text-muted">By loading <code>theme_bar.css</code> file</p>
							...
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Default bar with text</h6>
								<p class="content-group-sm text-muted">Uncomment piece of CSS code to show text</p>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Mini Xbox theme</h6>
								<p class="content-group-sm text-muted">By loading <code>theme_xbox_xs.css</code> file</p>
								...
								<div class="pace-demo" style="padding-top: 10px; padding-bottom: 30px;">
									<div class="theme_xbox_xs theme_xbox_with_text"><div class="pace_progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div> <span>60%</span></div>
								</div>
							</div>

							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Perspective theme</h6>
								<p class="content-group-sm text-muted">By loading <code>theme_perspective.css</code> file</p>

								<div class="pace-demo">
									<div class="theme_perspective"><div class="pace-progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div></div>
								</div>

								<div class="pace-demo" style="padding-top: 12px; padding-bottom: 28px;">
									<div class="theme_perspective theme_perspective_with_text"><div class="pace-progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div><span>60%</span></div>
								</div>
							</div>

							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Corners theme</h6>
								<p class="content-group-sm text-muted">By loading <code>theme_corners.css</code> file</p>

								<div class="pace-demo">
									<div class="theme_corners"><div class="pace_progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div></div>
								</div>

								<div class="pace-demo" style="padding-top: 12px; padding-bottom: 28px;">
									<div class="theme_corners theme_corners_with_text"><div class="pace_progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div><span>60%</span></div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Small Xbox theme</h6>
								<p class="content-group-sm text-muted">By loading <code>theme_xbox_sm.css</code> file</p>
								...
								<div class="pace-demo" style="padding-top: 10px; padding-bottom: 30px;">
									<div class="theme_xbox_sm theme_xbox_with_text"><div class="pace_progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div> <span>60%</span></div>
								</div>
							</div>

							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Squares theme</h6>
								<p class="content-group-sm text-muted">By loading <code>theme_squares.css</code> file</p>
								...
								<div class="pace-demo" style="padding-top: 10px; padding-bottom: 30px;">
									<div class="theme_squares theme_squares_with_text"><div class="pace-progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div><span>60%</span></div>
								</div>
							</div>

							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Radar theme</h6>
								<p class="content-group-sm text-muted">By loading <code>theme_radar.css</code> file</p>

								<div class="pace-demo">
									<div class="theme_radar"><div class="pace_progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div></div>
								</div>

								<div class="pace-demo" style="padding-top: 12px; padding-bottom: 28px;">
									<div class="theme_radar theme_radar_with_text"><div class="pace_progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div><span>60%</span></div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Default Xbox theme</h6>
								<p class="content-group-sm text-muted">By loading <code>theme_xbox.css</code> file</p>
								...
								<div class="pace-demo" style="padding-top: 10px; padding-bottom: 30px;">
									<div class="theme_xbox theme_xbox_with_text"><div class="pace_progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div> <span>60%</span></div>
								</div>
							</div>

							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Tail theme</h6>
								<p class="content-group-sm text-muted">By loading <code>theme_tail.css</code> file</p>

								<div class="pace-demo">
									<div class="theme_tail"><div class="pace_progress" data-progress-text="60%" data-progress="60" style="width: 60%;"></div><div class="pace_activity"></div></div>
								</div>

								<div class="pace-demo" style="padding-top: 10px; padding-bottom: 30px;">
									<div class="theme_tail theme_tail_with_text"><div class="pace_progress" data-progress-text="60%" data-progress="60" style="width: 60%;"></div><div class="pace_activity"></div><span>60%</span></div>
								</div>
							</div>

							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Circle tail theme</h6>
								<p class="content-group-sm text-muted">By loading <code>theme_tail_circle.css</code> file</p>

								<div class="pace-demo">
									<div class="theme_tail_circle"><div class="pace_progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div></div>
								</div>

								<div class="pace-demo" style="padding-top: 10px; padding-bottom: 30px;">
									<div class="theme_tail_circle theme_tail_with_text"><div class="pace_progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div><span>60%</span></div>
								</div>
							</div>
						</div>
					</div>
					...
					<h6 class="content-group text-semibold">
						Progress bars
						<small class="display-block">Basic progress bar options</small>
					</h6>
					<!-- /progress bars title -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Default progress bar</h6>
									<p class="content-group-sm text-muted">Example of a basic progress bar</p>
								</div>
							...
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Progress bar with label</h6>
									<p class="content-group-sm text-muted">Remove <code>.sr-only</code> class to show label</p>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Striped progress bar</h6>
									<p class="content-group-sm text-muted">Using <code>.progress-striped</code> class</p>
								</div>
							...
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Rounded progress bar</h6>
									<p class="content-group-sm text-muted">Using <code>.progress-rounded</code> class</p>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Animated progress bar</h6>
									<p class="content-group-sm text-muted">Using <code>.progress-striped.active</code> classes</p>
								</div>
							...
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Stacked progress bars</h6>
									<p class="content-group-sm text-muted">Multiple bars in the <code>.progress</code> block</p>
								</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Progress bar sizes</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<p class="content-group">By default, Bootstrap supports only 1 progress bar size. Limitless template extends default sizing up to 5 additional height sizing: large, small, mini, extra mini and micro. To use, just add <code>.progress-lg (*-sm, *-xs, *-xxs, *-micro)</code> class to the container with base <code>.progress</code> class. Micro progress bar is the thinest bar with fixed 1px height.</p>
					...
					<!-- Contextual alternatives title -->
					<h6 class="content-group text-semibold">
						Contextual alternatives
						<small class="display-block">Predefined progress bar colors</small>
					</h6>
					<!-- /contextual alternatives title -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Basic progress bars</h6>
									<p class="content-group-sm text-muted">Progress bars contextual alternatives</p>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Striped progress bars</h6>
									<p class="content-group-sm text-muted">Progress bars contextual alternatives</p>
								</div>
								...
								<div class="progress content-group-sm">
									<div class="progress-bar progress-bar-warning progress-bar-striped" style="width: 75%">
										<span class="sr-only">75% Complete (warning)</span>
									</div>
								</div>

								<div class="progress">
									<div class="progress-bar progress-bar-info progress-bar-striped" style="width: 95%">
										<span class="sr-only">95% Complete (info)</span>
									</div>
								</div>
							</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Animated progress bars</h6>
									<p class="content-group-sm text-muted">Progress bars contextual alternatives</p>
								</div>
								...
								<div class="progress content-group-sm">
									<div class="progress-bar progress-bar-warning progress-bar-striped active" style="width: 75%">
										<span class="sr-only">75% Complete (warning)</span>
									</div>
								</div>
					...
					<!-- Horizontal progress bars title -->
					<h6 class="content-group text-semibold">
						Horizontal bars
						<small class="display-block">Advanced <code>horizontal</code> bars</small>
					</h6>
					<!-- /horizontal progress bars title -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Left progress bar</h6>
								<p class="content-group-sm text-muted">Left animated progress bar</p>

								<div class="progress content-group-sm" id="h-default-basic">
									<div class="progress-bar progress-bar-primary" data-transitiongoal-backup="75" data-transitiongoal="75">
										<span class="sr-only">0%</span>
									</div>
								</div>

								<button type="button" class="btn btn-primary btn-sm" id="h-default-basic-start">Start</button>
								<button type="button" class="btn btn-danger btn-sm" id="h-default-basic-reset">Reset</button>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Right progress bar</h6>
								<p class="content-group-sm text-muted">Right animated progress bar</p>

								<div class="progress right content-group-sm" id="h-right-basic">
									<div class="progress-bar progress-bar-primary" data-transitiongoal-backup="75" data-transitiongoal="75">
										<span class="sr-only">0%</span>
									</div>
								</div>

								<button type="button" class="btn btn-primary btn-sm" id="h-right-basic-start">Start</button>
								<button type="button" class="btn btn-danger btn-sm" id="h-right-basic-reset">Reset</button>
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Filled percentages</h6>
								<p class="content-group-sm text-muted">Percentages display in the bar</p>

								<div class="progress content-group-sm" id="h-fill-basic">
									<div class="progress-bar progress-bar-primary" data-transitiongoal-backup="75" data-transitiongoal="75" style="width: 0%">
										<span class="sr-only">0%</span>
									</div>
								</div>

								<button type="button" class="btn btn-primary btn-sm" id="h-fill-basic-start">Start</button>
								<button type="button" class="btn btn-danger btn-sm" id="h-fill-basic-reset">Reset</button>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Filled custom text</h6>
								<p class="content-group-sm text-muted">Text displays in progress bar</p>

								<div class="progress content-group-sm" id="h-fill-nonpercentage-basic">
									<div class="progress-bar progress-bar-primary" data-transitiongoal-backup="75" data-transitiongoal="75" style="width: 0%">
										<span class="sr-only">0%</span>
									</div>
								</div>

								<button type="button" class="btn btn-primary btn-sm" id="h-fill-nonpercentage-basic-start">Start</button>
								<button type="button" class="btn btn-danger btn-sm" id="h-fill-nonpercentage-basic-reset">Reset</button>
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Centered percentages</h6>
								<p class="content-group-sm text-muted">Percentages display in the center</p>

								<div class="progress content-group-sm" id="h-center-basic">
									<div class="progress-bar progress-bar-primary" data-transitiongoal-backup="75" data-transitiongoal="75" style="width: 0%">
										<span class="sr-only">0%</span>
									</div>
								</div>

								<button type="button" class="btn btn-primary btn-sm" id="h-center-basic-start">Start</button>
								<button type="button" class="btn btn-danger btn-sm" id="h-center-basic-reset">Reset</button>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Centered custom text</h6>
								<p class="content-group-sm text-muted">Text displays in the bar center</p>
								...
								<button type="button" class="btn btn-primary btn-sm" id="h-center-nonpercentage-basic-start">Start</button>
								<button type="button" class="btn btn-danger btn-sm" id="h-center-nonpercentage-basic-reset">Reset</button>
							</div>
						</div>
					</div>
					<!-- /horizontal progress bars -->
					...
					<!-- Vertical progress bars title -->
					<h6 class="content-group text-semibold">
						Vertical bars
						<small class="display-block">Advanced <code>vertical</code> bars</small>
					</h6>
					<!-- /vertical progress bars title -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Top progress bars</h6>
								<p class="content-group-sm text-muted">Top animated progress bars</p>

								<div class="content-group-sm" id="v-default-basic" style="height: 200px">
									<div class="progress vertical">
										<div class="progress-bar progress-bar-primary" data-transitiongoal-backup="30" data-transitiongoal="30">
											<span class="sr-only">0%</span>
										</div>
									</div>

									<div class="progress vertical">
										<div class="progress-bar progress-bar-danger" data-transitiongoal-backup="60" data-transitiongoal="60">
											<span class="sr-only">0%</span>
										</div>
									</div>

									<div class="progress vertical">
										<div class="progress-bar progress-bar-info" data-transitiongoal-backup="90" data-transitiongoal="90">
											<span class="sr-only">0%</span>
										</div>
									</div>
								</div>

								<button type="button" class="btn btn-primary btn-sm" id="v-default-basic-start">Start</button>
								<button type="button" class="btn btn-danger btn-sm" id="v-default-basic-reset">Reset</button>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Bottom progress bars</h6>
								<p class="content-group-sm text-muted">Bottom animated progress bars</p>
								...
								<button type="button" class="btn btn-primary btn-sm" id="v-bottom-basic-start">Start</button>
								<button type="button" class="btn btn-danger btn-sm" id="v-bottom-basic-reset">Reset</button>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Filled percentages</h6>
								<p class="content-group-sm text-muted">Percentages display on top</p>

								<div class="content-group-sm" id="v-fill-basic" style="height: 200px">
									<div class="progress vertical">
										<div class="progress-bar progress-bar-primary" data-transitiongoal-backup="30" data-transitiongoal="30">
											<span class="sr-only">0%</span>
										</div>
								...
								<button type="button" class="btn btn-primary btn-sm" id="v-fill-basic-start">Start</button>
								<button type="button" class="btn btn-danger btn-sm" id="v-fill-basic-reset">Reset</button>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Filled custom text</h6>
								<p class="content-group-sm text-muted">Custom text displays on top</p>

								<div class="content-group-sm" id="v-fill-nonpercentage-basic" style="height: 200px">
									<div class="progress vertical">
										<div class="progress-bar progress-bar-primary" data-transitiongoal-backup="30" data-transitiongoal="30">
											<span class="sr-only">0%</span>
										</div>
								...
								<button type="button" class="btn btn-primary btn-sm" id="v-fill-nonpercentage-basic-start">Start</button>
								<button type="button" class="btn btn-danger btn-sm" id="v-fill-nonpercentage-basic-reset">Reset</button>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								...
								<div class="content-group-sm" id="v-center-basic" style="height: 200px">
									<div class="progress vertical">
										<div class="progress-bar progress-bar-primary" data-transitiongoal-backup="30" data-transitiongoal="30">
											<span class="sr-only">0%</span>
										</div>
								...
								<button type="button" class="btn btn-primary btn-sm" id="v-center-basic-start">Start</button>
								<button type="button" class="btn btn-danger btn-sm" id="v-center-basic-reset">Reset</button>
							</div>
							...
							<div class="panel panel-body border-top-primary text-center">
								...
								<div class="content-group-sm" id="v-center-nonpercentage-basic" style="height: 200px">
									<div class="progress vertical">
										<div class="progress-bar progress-bar-primary" data-transitiongoal-backup="30" data-transitiongoal="30">
											<span class="sr-only">0%</span>
										</div>
								...
								<button type="button" class="btn btn-primary btn-sm" id="v-center-nonpercentage-basic-start">Start</button>
								<button type="button" class="btn btn-danger btn-sm" id="v-center-nonpercentage-basic-reset">Reset</button>
							</div>
						</div>
					</div>
					<!-- /vertical progress bars -->
