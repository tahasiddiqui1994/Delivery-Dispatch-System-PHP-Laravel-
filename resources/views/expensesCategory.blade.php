...
<table style="white-space: nowrap;" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                        	<th>ID</th>
                        ...
                        @if($data)
							@foreach($data as $rrr)
								<tr >
									...
									@if(Auth::user()->type == "admin")
										<td >
	                                       <a href="/expenseCategory/{{$rrr->id}}/edit" class="btn btn-info btn-xs pull-left" data-toggle="tooltip" data-placement="left" title="Update">
