...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/colors_green.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="colors_green">Green palette</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Colors</span> - Green Palette</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="colors_green">Colors</a></li>
							<li class="active">Green palette</li>
						</ul>
				...
				<div class="content">
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#558B2F</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#green_800"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#689F38</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#green_700"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#7CB342</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#green_600"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#8BC34A</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#green_500"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#9CCC65</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#green_400"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#AED581</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#green_300"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="content-group-lg">
						...
						<!-- Basic alert -->
						<div class="alert alpha-green-600 border-green alert-styled-left">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.text-green</code> classes</p>
								</div>

								<input type="text" class="form-control text-green text-uppercase text-semibold text-size-small" value="Input field text">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-green</code> or classes</p>
								</div>

								<input type="text" class="form-control border-green border-lg" placeholder="Input field border">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-green</code> classes</p>
								</div>

								<input type="text" class="form-control bg-green-600" placeholder="Input field background">
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								...
								<div class="has-feedback">
									<input type="text" class="form-control bg-green-600" placeholder="Icon feedback, green input">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								...
								<select class="form-control bg-green-600">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								...
								<div class="input-group">
									<span class="input-group-addon bg-green-600"><i class="icon-menu7"></i></span>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								...
								<div class="input-group">
									<span class="input-group-addon bg-green-700"><i class="icon-lock2"></i></span>
									<input type="text" class="form-control bg-green-600" placeholder="Solid background color">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
										<button class="btn bg-green-600" type="button">Button</button>
									</span>									
								</div>
							</div>
				    	</div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<label class="radio-inline">
									<input type="radio" class="styled" name="green-radio" checked="checked">
									Selected
								</label>

								<label class="radio-inline">
									<input type="radio" class="styled" name="green-radio">
									Unselected
								</label>
							</div>
				    	</div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								...
								<select class="select bg-green-600">
									<optgroup label="Mountain Time Zone">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-green</code> or classes</p>

									<select class="selectbox bg-green-600">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								<div class="text-center">
									...
									<select class="bootstrap-select" data-style="bg-green-600">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										...
										<div class="tab-content bg-green-600">
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<span class="label bg-green-600">Green label</span>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<span class="badge bg-green-600">390</span>
							</div>
				    	</div>
				    </div>
				    <!-- /text options -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-green-600" style="width: 55%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-green-600 progress-bar-striped" style="width: 65%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-green-600 progress-bar-striped active" style="width: 75%">
				    ...
				    <div class="row">
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th>Last Name</th>
												<th class="bg-green-600">Username</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												...
												<td>Kopyov</td>
												<td class="bg-green-600">@Kopyov</td>
											</tr>
											<tr>
												<td>2</td>
												<td class="alpha-green">Victoria</td>
												<td>Baker</td>
												<td class="bg-green-600">@Vicky</td>
											</tr>
											<tr>
												<td>3</td>
												<td class="alpha-green">James</td>
												<td>Alexander</td>
												<td class="bg-green-600">@Alex</td>
											</tr>
										</tbody>
										<tfoot>
											<tr>
				    	...
				    	<div class="col-md-6">
				    		<div class="panel panel-flat">
								...
								<div class="table-responsive">
									<table class="table bg-green-600">
										<thead>
											<tr>
												<th>#</th>
												<th>First Name</th>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<button type="button" class="btn bg-green-600"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<button type="button" class="btn bg-green-600 btn-labeled"><b><i class="icon-menu7"></i></b> Labeled button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<button type="button" class="btn text-green-800 border-green btn-flat"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    </div>
				    <!-- /buttons -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel">
								<div class="panel-heading bg-green-600">
									<h6 class="panel-title">Green panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Green panel using <code>.bg-green</code> class added to the panel heading
								</div>
							</div>
				    	</div>

				    	<div class="col-md-4">
				    		<div class="panel border-green-600">
								<div class="panel-heading bg-green-600">
									<h6 class="panel-title">Green bordered panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Bordered green panel using <code>.bg-green</code> and <code>.border-green</code> classes
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel bg-green-600">
								<div class="panel-heading">
									<h6 class="panel-title">Green solid panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Solid green panel using <code>.bg-green</code> class added to the panel container
								</div>
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<button type="button" class="btn bg-green-600" data-popup="tooltip-custom" title="Green tooltip" data-placement="bottom" data-container="body"><i class="icon-comment position-left"></i> Tooltip</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<button type="button" class="btn bg-green-600" data-popup="popover-custom" title="Green popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<button type="button" class="btn bg-green-600" data-popup="popover-solid" title="Green popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<button type="button" class="btn bg-green-600" data-toggle="modal" data-target="#modal_green"><i class="icon-menu7 position-left"></i> Modal dialog</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<p class="mb-15 text-muted">Using <code>.bg-green</code> color classes</p>

								<button class="btn bg-green-600 growl-launch">jGrowl notification</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green text-center">
								...
								<button class="btn bg-green-600 pnotify-launch">Pnotify notification</button>
							</div>
				    	</div>
				    </div>
				    <!-- /notifications and dialogs -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-green</code> color classes</p>
								</div>

								<ul class="dropdown-menu border-green-600 border-lg" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								...
								<ul class="dropdown-menu bg-green-600" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-green">
								...
								<ul class="dropdown-menu bg-green-600" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> <span class="label bg-green pull-right">Label</span> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> <span class="badge bg-green pull-right">98</span> Another action</a></li>
									<li class="divider"></li>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn bg-green-600">Save changes</button>
								</div>
							</div>
						</div>
					</div>
