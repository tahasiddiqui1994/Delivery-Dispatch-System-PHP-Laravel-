...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/form_validation.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="form_validation">Validation</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="form_validation">Forms</a></li>
