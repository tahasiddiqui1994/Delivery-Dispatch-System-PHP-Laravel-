							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="appearance_panel_heading">Panel heading elements</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Appearance</span> - Panel Heading</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="appearance_panel_heading">Appearance</a></li>
							<li class="active">Panel heading</li>
						</ul>
				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title"><i class="icon-cog3 position-left"></i> Left title icon</h6>
								</div>
								
								<div class="panel-body">
									Panel title with left icon
								</div>
							</div>
							<!-- /title with left icon -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Subtitle <small>Some alt description</small></h6>
								</div>
								
								<div class="panel-body">
									Panel title with subtitle using <code>small</code> element
								</div>
							</div>
							<!-- /title with subtitle -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Inline list</h6>
									<div class="heading-elements">
								...
								<div class="panel-body">
									Panel heading with simple inline list
								</div>
							</div>
							<!-- /inline list -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Title label <span class="label label-success position-right">New</span></h6>
								</div>
								
								<div class="panel-body">
									Panel title with label element
								</div>
							</div>
							<!-- /title label -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Title badge <span class="badge bg-grey-700 position-right">387</span></h6>
								</div>
								
								<div class="panel-body">
									Panel title with badge element
								</div>
							</div>
							<!-- /title badge -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Pagination</h6>
									<div class="heading-elements">
								...
								<div class="panel-body">
									Panel heading pagination. Available in 3 sizes
								</div>
							</div>
							<!-- /pagination -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Right title icon <i class="icon-cog3 position-right"></i></h6>
								</div>
								
								<div class="panel-body">
									Panel title with right icon
								</div>
							</div>
							<!-- /title with right icon -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Heading text</h6>
									<div class="heading-elements">
										<span class="heading-text"><i class="icon-github4"></i>&nbsp; Some text or <a href="#">link</a> and icon</span>
									</div>
								</div>
								
								<div class="panel-body">
									Custom heading text using <code>heading-text</code> class
								</div>
							</div>
							<!-- /custom text -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Bullet list</h6>
									<div class="heading-elements">
								...
								<div class="panel-body">
									Panel heading with bullet inline list
								</div>
							</div>
							<!-- /bullet list -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Heading label</h6>
									<div class="heading-elements">
								...
								<div class="panel-body">
									Panel heading with <code>.label</code> element
								</div>
							</div>
							<!-- /heading label -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Heading badge</h6>
									<div class="heading-elements">
										<span class="badge bg-indigo-400 heading-text">578</span>
									</div>
								</div>
								
								<div class="panel-body">
									Panel heading with <code>.badge</code> element
								</div>
							</div>
							<!-- /heading badge -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Heading pager</h6>
									<div class="heading-elements">
								...
								<div class="panel-body">
									Panel heading pager. Available in 3 sizes
								</div>
							</div>
							<!-- /pager -->
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Single thumbnail</h6>
									<div class="heading-elements">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Thumbnail group</h6>
									<div class="heading-elements">
										<ul class="heading-thumbnails">
											<li><img src="assets/images/placeholder.jpg" alt=""></li>
											<li><img src="assets/images/placeholder.jpg" alt=""></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Thumb with badge</h6>
									<div class="heading-elements">
										<ul class="heading-thumbnails">
											<li>
												<img src="assets/images/placeholder.jpg" alt="">
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Linked thumbnail</h6>
									<div class="heading-elements">
										<ul class="heading-thumbnails">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Linked thumbnail group</h6>
									<div class="heading-elements">
										<ul class="heading-thumbnails">
											<li><a href="#"><img src="assets/images/placeholder.jpg" alt=""></a></li>
											<li><a href="#"><img src="assets/images/placeholder.jpg" alt=""></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Thumb with status mark</h6>
									<div class="heading-elements">
										<ul class="heading-thumbnails">
											<li>
												<img src="assets/images/placeholder.jpg" alt="">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Single icon</h6>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									Panel heading with single icon
								</div>
							</div>
							<!-- /single icon -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Multiple icons</h6>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									Panel heading with multiple icons set
								</div>
							</div>
							<!-- /multiple icons -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Basic controls</h6>
									<div class="heading-elements">
										<ul class="icons-list">
						...
						<div class="col-md-6">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Icon dropdown</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li class="dropdown">
								...
								<div class="panel-body">
									Panel heading with single icon dropdown
								</div>
							</div>
							<!-- /single icon dropdown -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Icons set with dropdown</h6>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									Panel heading with multiple icon and dropdown menu
								</div>
							</div>
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Additional controls</h6>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									Additional panel controls - <code>move</code>, <code>modal</code> and <code>dropdown</code> buttons
								</div>
							</div>
							<!-- /additional panel controls -->
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Single checkbox</h6>
									<div class="heading-elements">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Checkbox group</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
								...
								<div class="panel-body">
									Heading with group of inline checkboxes
								</div>
							</div>
							<!-- /checkbox group -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Switchery toggle</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Text input</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
								...
								<div class="panel-body">
									Heading with basic text input field
								</div>
							</div>
							<!-- /input field -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">File input</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
								...
								<div class="panel-body">
									Panel heading with styled file input field
								</div>
							</div>
							<!-- /file input -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Single radio</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Radio group</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
								...
								<div class="panel-body">
									Heading with group of inline radios
								</div>
							</div>
							<!-- /radio group -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Toggle switch</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
								...
								<div class="panel-body">
									Panel heading with Bootstrap toggle switch
								</div>
							</div>
							<!-- /toggle switch -->
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Input with icon</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Touchspin spinners</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									Panel heading with basic select
								</div>
							</div>
							<!-- /basic select -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">SelectBoxIt select</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
								...
								<div class="panel-body">
									Panel heading with <code>SelectBoxIt</code> select
								</div>
							</div>
							<!-- /selectBoxIt select -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Single multiselect</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
						...
						<div class="col-md-6">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Select2 select</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
												<select class="select">
								...
								<div class="panel-body">
									Panel heading with <code>Select2</code> select
								</div>
							</div>
							<!-- /select2 select -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
												<select class="bootstrap-select" data-width="200">
													<optgroup label="Alaskan/Hawaiian Time Zone">
														<option value="AK">Alaska</option>
														<option value="HI">Hawaii</option>
													</optgroup>
								...
								<div class="panel-body">
									Panel heading with <code>Bootstrap</code> custom select
								</div>
							</div>
							<!-- /bootstrap select -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Multiselect</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Single button</h6>
									<div class="heading-elements">
								...
								<div class="panel-body">
									Heading with basic button. Available in 3 smallest sizes
								</div>
							</div>
							<!-- /single button -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Button dropdown</h6>
									<div class="heading-elements">
								...
								<div class="panel-body">
									Heading with single button dropdown menu
								</div>
							</div>
							<!-- /single button dropdown -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Segmented button</h6>
									<div class="heading-elements">
										<div class="btn-group heading-btn">
								...
								<div class="panel-body">
									Panel heading with segmented button
								</div>
							</div>
							<!-- /segmented button -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Icon button</h6>
									<div class="heading-elements">
										<button type="button" class="btn btn-success btn-icon heading-btn"><i class="icon-task"></i></button>
									</div>
								</div>
								
								<div class="panel-body">
									Panel heading with single icon button
								</div>
							</div>
							<!-- /icon button -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Icon button dropdown</h6>
									<div class="heading-elements">
										<div class="btn-group heading-btn">
								...
								<div class="panel-body">
									Panel heading with icon button dropdown
								</div>
							</div>
							<!-- /icon button dropdown -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Segmented icon button</h6>
									<div class="heading-elements">
										<div class="btn-group heading-btn">
								...
								<div class="panel-body">
									Panel heading with segmented icon button
								</div>
							</div>
							<!-- /segmented icon button -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Multiple icon buttons</h6>
									<div class="heading-elements">
										<div class="heading-btn">
								...
								<div class="panel-body">
									Panel heading with multiple icon buttons
								</div>
							</div>
							<!-- /multiple icon buttons -->
					...
					<div class="row">
						<div class="col-md-6">
									...
									<div class="heading-elements panel-nav">
										<ul class="nav nav-tabs nav-tabs-bottom">
											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="#panel-tab3" tabindex="-1" data-toggle="tab"><i class="icon-people"></i> Profile settings</a></li>
													<li><a href="#panel-tab4" tabindex="-1" data-toggle="tab"><i class="icon-stack"></i> Layout settings</a></li>
												</ul>
											</li>
										</ul>
				                	</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Progress bar</h6>
									<div class="heading-elements">
										<div class="progress">
								...
								<div class="panel-body">
									Panel heading with progress bar. Available in all sizes
								</div>
							</div>
							<!-- /progress bar -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">jQuery UI slider</h6>
									<div class="heading-elements">
										<div class="ui-slider ui-slider-info"></div>
				                	</div>
								</div>
								
								<div class="panel-body">
									Heading with jQuery UI slider. Available in all sizes
								</div>
							</div>
							<!-- /jquery ui slider -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<div class="panel-title h6 btn-group">
										<a href="#" data-toggle="dropdown">Title <span class="text-semibold">Dropdown</span> <span class="caret"></span></a>
								...
								<div class="panel-body">
									Panel heading with title as a dropdown menu
								</div>
							</div>
							<!-- /dropdown title -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">NoUI slider</h6>
									<div class="heading-elements">
										<div class="noui-slider noui-slider-danger" id="noui-slider-demo"></div>
				                	</div>
								</div>
								
								<div class="panel-body">
									Panel heading with NoUI slider. Available in all sizes
								</div>
							</div>
							<!-- /noui slider -->
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Input and button</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Checkbox and dropdown</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
												<label class="checkbox-inline">
							...
							<!-- Switchery and panel controls -->
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Switch and controls</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
												<label class="checkbox-inline checkbox-right checkbox-switchery switchery-sm">
								...
								<div class="panel-body">
									Mixing switchery toggle and panel control buttons
								</div>
							</div>
							<!-- /switchery and panel controls -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Label and button</h6>
									<div class="heading-elements">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Spinner and progress</h6>
									<div class="heading-elements">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Multiple elements</h6>
									<div class="heading-elements">
										<ul class="icons-list">
