...
								<!-- /main -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="navbar_multiple_navbar_header">Navbar + header</a></li>
			...
			<div class="content-wrapper">
				...
				<!-- Second navbar -->
				<div class="navbar navbar-default navbar-default-secondary navbar-xs">
					...
					<div class="page-header-content">
						<div class="page-title">
							...
							<ul class="breadcrumb position-right">
								...
								<li><a href="navbar_multiple_navbar_header">Navbars</a></li>
								<li class="active">Navbar + page header</li>
							</ul>
						</div>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Navbar before page header</h6>
						Here secondary navbar placed inside content area before page header. This navbar is static by default and requires custom changes in order to make it fixed.
				    </div>
				    <!-- /info alert -->
