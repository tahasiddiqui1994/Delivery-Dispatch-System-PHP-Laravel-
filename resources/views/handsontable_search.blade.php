...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/handsontable_search.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="handsontable_search">Search</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Handsontable</span> - Search</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="handsontable_search">Handsontable</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Basic functionality</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<p class="content-group">Search plugin provides an easy interface to perform data search across Handsontable. First thing you should do, is enabling the plugin by setting the <code>search</code> option to <code>true</code>. When enabled, <strong>searchPlugin</strong> exposes a new method <strong>query(queryStr)</strong>, where <code>queryStr</code> is a string to find within the table. By default, the search is case insensitive.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Custom search result class</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Custom query method</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">The <code>queryMethod</code> is responsible for determining whether a <code>queryStr</code> matches the value stored in a cell. It takes 2 arguments: <code>queryStr</code> and <code>cellData</code>. The first is a string passed to <code>query()</code> method. The second is a value returned by <code>getDataAtCell()</code>. The <code>queryMethod</code> function should return true if there is a match.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Custom callback</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							...
							<p class="content-group"><span class="text-semibold" id="result-count">0</span> results found</p>
