								...
								<table width="100%" border="0" align="center" cellspacing="0" >
                                    ...
                                    <div class="col-sm-10 form-group">
										...
										<div class="input-group date">
											...
											<input name="medicalCardRenewal" type="text" class="form-control daterange-single pull-right" value="{{$data->medicalCardRenewal}}">
										...
										<td >
                                          ...
                                          <td>
                                          	<div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('emergencyPhoneNo', $data->emergencyPhoneNo, [ 'required'=>"", 'class' => "form-control", 'placeholder' => "Enter Person No."]) }}
