...
<table style="white-space: nowrap;" class="table table-bordered table-hover pull-left">
                                    <thead>
                                        <tr>
                                        	<th>ID</th>
                        ...
                        @if($data)
							@foreach($data as $rrr)
								<tr>
									...
									@if(Auth::user()->type == "admin")
										<td>
	                                       <a href="/maintenanceType/{{$rrr->id}}/edit" class="btn btn-info btn-xs pull-left" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
