									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="job_list_panel">Panel view</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Job Search</span> - Panel List</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="job_list_panel">Job search</a></li>
				...
				<div class="content">
					...
					<div class="container-detached">
						<div class="content-detached">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Open positions</h6>
								</div>
