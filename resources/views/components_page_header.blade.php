...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/components_page_header.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_page_header">Page header</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Components</span> - Page Header</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="components_page_header">Components</a></li>
				...
				<div class="content">
					...
					<!-- Page header sizing title -->
					<h6 class="content-group text-semibold">
						Header sizing
						<small class="display-block">1 main and 3 optional sizes</small>
					</h6>
					<!-- /page header sizing title -->
					...
					<div class="content-group-lg">
						...
						<div class="content-group border-top-lg border-top-primary">
							<div class="page-header page-header-default page-header-lg" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
								<div class="page-header-content">
									<div class="page-title">
										<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page Header</span> - Large</h4>
									</div>

									<div class="heading-elements">
										<div class="btn-group heading-btn">
			                                <button class="btn bg-purple btn-icon btn-sm dropdown-toggle" data-toggle="dropdown">
			                                	<i class="icon-wrench"></i>
			                                	<span class="caret"></span>
		                                	</button>

											<ul class="dropdown-menu dropdown-menu-right">
												<li><a href="#"><i class="icon-pin-alt pull-right"></i> Action</a></li>
								...
								<div class="breadcrumb-line">
									<ul class="breadcrumb">
										<li><a href="index"><i class="icon-home2 position-left"></i> Home</a></li>
										<li><a href="components_page_header">Current</a></li>
						...
						<div class="content-group border-top-lg border-top-primary">
							<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
								<div class="page-header-content">
									<div class="page-title">
										<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page Header</span> - Default</h4>
									</div>

									<div class="heading-elements">
										<div class="btn-group heading-btn">
			                                <button class="btn bg-brown btn-icon btn-sm dropdown-toggle" data-toggle="dropdown">
			                                	<i class="icon-cog3"></i>
			                                	<span class="caret"></span>
		                                	</button>
						...
						<div class="content-group border-top-lg border-top-primary">
							<div class="page-header page-header-default page-header-sm" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
								<div class="page-header-content">
									<div class="page-title">
										<h5><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page Header</span> - Small</h5>
									</div>
						...
						<div class="content-group border-top-lg border-top-primary">
							<div class="page-header page-header-default page-header-xs" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
								<div class="page-header-content">
									<div class="page-title">
										<h5><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page Header</span> - Mini</h5>
									</div>
					...
					<h6 class="content-group text-semibold">
						Header styling
						<small class="display-block">Basic styling options</small>
					</h6>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												...
												<span class="text-semibold">Page Header</span> - Transparent
												<small class="display-block">Transparent background color</small>
											</h5>
										</div>

										<div class="heading-elements">
			                                <button class="btn bg-primary btn-icon btn-sm heading-btn"><i class="icon-gear"></i></button>
										</div>
									</div>
								...
								<div class="page-header page-header-default" style="border: 1px solid #ddd; border-bottom: 0;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Page Header</span> - Default
												<small class="display-block">White background color</small>
											</h5>
										</div>

										<div class="heading-elements">
			                                <button class="btn bg-teal-400 btn-icon btn-sm heading-btn"><i class="icon-gear"></i></button>
										</div>
									</div>
								...
								<div class="page-header page-header-default has-cover" style="border: 1px solid #ddd; border-bottom: 0;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Page Header</span> - Image
												<small class="display-block">With light image</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-inverse" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content bg-indigo-400">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Page Header</span> - Custom Color
												<small class="display-block">Custom background color</small>
											</h5>
										</div>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Page Header</span> - Image
												<small class="display-block">With dark image</small>
											</h5>
										</div>
					...
					<h6 class="content-group text-semibold">
						Header subtitles
						<small class="display-block">Page header subtitle options</small>
					</h6>
					<!-- /page header subtitles title -->
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Header</span> - Styled
												<small>Default inline subtitle</small>
											</h5>
										</div>
									</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Header</span> - Styled
												<small class="display-block">Custom block subtitle</small>
											</h5>
										</div>
									</div>
					...
					<h6 class="content-group text-semibold">
						Optional borders
						<small class="display-block">Custom styled horizontal borders</small>
					</h6>
					<!-- /optional borders title -->
					...
					<div class="row">
							...
							<div class="content-group">
								<div class="page-header page-header-default border-bottom border-bottom-primary" style="border-top: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Basic <code>bottom</code> border with custom color</small>
											</h5>
										</div>
									</div>
						...
						<div class="col-lg-6">
								...
								<div class="page-header page-header-default" style="border-top: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content border-bottom border-bottom-success">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Basic <code>top</code> border with custom color</small>
											</h5>
										</div>
									</div>
							...
							<div class="content-group">
								<div class="page-header page-header-default" style="border-top: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content border-bottom-lg border-bottom-danger">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Large <code>top</code> border with custom color</small>
											</h5>
										</div>
									</div>
					...
					<h6 class="content-group text-semibold">
						Page title sizing
						<small class="display-block">Usage of <code>headings</code> in page title</small>
					</h6>
					<!-- /title sizing title -->
						...
						<div class="col-lg-6">
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h1><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">H1</span> - Heading</h1>
										</div>
									</div>
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h3><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">H3</span> - Heading</h3>
										</div>
									</div>
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">H5</span> - Heading</h5>
										</div>
									</div>
						...
						<div class="col-lg-6">
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h2><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">H2</span> - Heading</h2>
										</div>
									</div>
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">H4</span> - Heading</h4>
										</div>
									</div>
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h6><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">H6</span> - Heading</h6>
										</div>
									</div>
					...
					<h6 class="content-group text-semibold">
						Header elements
						<small class="display-block">Components adjusted for page header</small>
					</h6>
					<!-- /header elements title -->
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Basic button, available in 3 sizes</small>
											</h5>
										</div>

										<div class="heading-elements">
											<button type="button" class="btn btn-primary heading-btn">Button</button>
										</div>
									</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Icon button, available in 3 sizes</small>
											</h5>
										</div>

										<div class="heading-elements">
											<button type="button" class="btn bg-teal-400 btn-icon heading-btn"><i class="icon-download7"></i></button>
										</div>
									</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Icon button with dropdown</small>
											</h5>
										</div>

										<div class="heading-elements">
											<div class="btn-group heading-btn">
				                                <button class="btn btn-danger btn-icon dropdown-toggle" data-toggle="dropdown"><i class="icon-pin-alt"></i> <span class="caret"></span></button>
												<ul class="dropdown-menu dropdown-menu-right">
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Floating icon buttons</small>
											</h5>
										</div>

										<div class="heading-elements">
											<a href="#" class="btn btn-primary btn-float btn-rounded heading-btn"><i class="icon-facebook"></i></a>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Simple text input field</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Input field with left icon</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Basic select, available in all sizes</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Input group with icon</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Multiple select component</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Right positioned toggle</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Right positioned checkboxes</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Right positioned radios</small>
											</h5>
										</div>
											...
											<form class="heading-form" action="#">
												<div class="form-group">
													<label class="radio-inline radio-right">
														<input type="radio" name="header-radio-right" class="styled" checked="checked">
														Selected
													</label>

													<label class="radio-inline radio-right">
														<input type="radio" name="header-radio-right" class="styled">
														Unselected
													</label>
												</div>
											</form>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Custom daterange picker layout</small>
											</h5>
										</div>
											...
											<form class="heading-form" action="#">
												<div class="form-group">
													<div class="daterange-custom" id="reportrange">
														...
														<span class="badge badge-success">59</span>
													</div>
												</div>
											</form>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Progress bar, available in all sizes</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Simple text, link and label</small>
											</h5>
										</div>

										<div class="heading-elements">
											<span class="heading-text">Plain text, <a href="#">link</a>, <span class="label label-danger">Label</span> or <span class="badge bg-primary">89</span> badge</span>
										</div>
									</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Button with dropdown menu</small>
											</h5>
										</div>

										<div class="heading-elements">
											<div class="btn-group heading-btn">
				                                <button class="btn btn-success dropdown-toggle" data-toggle="dropdown">Menu <span class="caret"></span></button>
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="#">Action</a></li>
													<li><a href="#">Another action</a></li>
													<li><a href="#">Something else here</a></li>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Segmented button dropdown</small>
											</h5>
										</div>
										...
										<div class="heading-elements">
											<div class="btn-group heading-btn">
				                                ...
				                                <button class="btn bg-indigo-400 dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="#">Action</a></li>
													<li><a href="#">Another action</a></li>
													<li><a href="#">Something else here</a></li>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Labeled button with icon</small>
											</h5>
										</div>

										<div class="heading-elements">
											<button class="btn bg-slate btn-labeled heading-btn" type="button"><b><i class="icon-three-bars"></i></b> Labeled button</button>
										</div>
									</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Floating buttons with text</small>
											</h5>
										</div>

										<div class="heading-elements">
											<div class="heading-btn-group">
												<a href="#" class="btn btn-link btn-float has-text"><i class="icon-bars-alt text-indigo-400"></i><span>Statistics</span></a>
												<a href="#" class="btn btn-link btn-float has-text"><i class="icon-calculator text-indigo-400"></i><span>Invoices</span></a>
												<a href="#" class="btn btn-link btn-float has-text"><i class="icon-calendar5 text-indigo-400"></i><span>Schedule</span></a>
											</div>
										</div>
									</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Input field with right icon</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Select2 select, available in all sizes</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Input group with button dropdown</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Styled single file input</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Left positioned toggle</small>
											</h5>
										</div>
										...
										<div class="heading-elements">
											<form class="heading-form" action="#">
												<div class="form-group">
													<label class="checkbox-inline checkbox-switchery switchery-sm">
														<input type="checkbox" class="switchery" checked="checked">
														Left toggle
													</label>
												</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Left positioned checkboxes</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Left positioned radios</small>
											</h5>
										</div>
											...
											<form class="heading-form" action="#">
												<div class="form-group">
													<label class="radio-inline">
														<input type="radio" name="header-radio-left" class="styled" checked="checked">
														Selected
													</label>

													<label class="radio-inline">
														<input type="radio" name="header-radio-left" class="styled">
														Unselected
													</label>
												</div>
											</form>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Basic daterange picker</small>
											</h5>
										</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Icon list with dropdown</small>
											</h5>
										</div>
										...
										<div class="heading-elements">
											<ul class="icons-list">
												...
												<li class="dropdown">
													<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-trash"></i> <span class="caret"></span></a>
													<ul class="dropdown-menu dropdown-menu-right">
														<li><a href="#">Action</a></li>
														<li><a href="#">Another action</a></li>
														<li><a href="#">Something else here</a></li>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Page</span> - Header
												<small class="display-block">Simple content with icon</small>
											</h5>
										</div>

										<div class="heading-elements">
											<span class="heading-text"><i class="icon-spinner2 spinner position-left"></i> Processing...</span>
										</div>
									</div>
