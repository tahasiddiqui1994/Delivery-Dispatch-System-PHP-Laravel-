	...
	<div class="navbar navbar-inverse">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav">
				...
				<li>
					<a class="sidebar-control sidebar-secondary-hide hidden-xs" data-popup="tooltip" title="Hide secondary" data-placement="bottom" data-container="body">
						<i class="icon-transmission"></i>
					</a>
				</li>

				<li>
					<a class="sidebar-control sidebar-opposite-toggle hidden-xs" data-popup="tooltip" title="Opposite - collapse main" data-placement="bottom" data-container="body">
						<i class="icon-enter2 rotate-180"></i>
					</a>
				</li>
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="sidebar_dual_double_collapse">Dual double collapse</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Dual Double Collapse</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_dual_double_collapse">Sidebars</a></li>
							<li class="active">Dual double collapse</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Dual double sidebar. Collapse</h6>
						When the opposite sidebar is shown, main sidebar width changes from <code>260px</code> to <code>56px</code>.
				    </div>
				    <!-- /info alert -->
