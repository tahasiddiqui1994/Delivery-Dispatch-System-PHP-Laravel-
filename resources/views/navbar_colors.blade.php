...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="navbar_colors">Color options</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Navbars</span> - Colors</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navbar_colors">Navbars</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Default navbar</h5>
						...
						<div class="panel-body">
							<p class="content-group">Default navbar is a basic Bootstrap navbar with <code>light grey</code> background color. Default navbar is the only navbar style that has light color scheme. By default, basic Bootstrap styling has only 2 color presets: <code>default</code> and <code>inverse</code>. To use default navbar styling, add <code>.navbar-default</code> class to the base <code>.navbar</code> class, all navbar components styles will adjusted to the light background theme automatically.</p>
							...
							<div class="navbar navbar-default navbar-component" style="position: relative; z-index: 30; border: 1px solid #d5d5d5">
								<div class="navbar-header">
									<a class="navbar-brand" href="index"><img src="assets/images/logo_dark.png" alt=""></a>
...
&lt;!-- /default navbar -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Inversed navbar</h5>
						...
						<div class="panel-body">
							<p class="content-group">Inversed navbar is a basic Bootstrap navbar with <code>dark blue/grey</code> background color. Basically, inversed navbar color can be added using <a href="colors_slate">custom color</a> system, so styles for <code>.navbar-inverse</code> is added to the template just to overwrite default Bootstrap styling for inversed navbar, which has darker color, to match general layout. Feel free to use both these methods.</p>
							...
							<p class="text-semibold">Example markup</p>
							<pre class="language-markup" data-line="2"><code>&lt;!-- Inversed navbar -->
&lt;div class="navbar navbar-inverse">
...
&lt;!-- /inversed navbar -->
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<p class="content-group">Add custom colors to the navbar and navbar components using <a href="colors_primary">custom color system</a>. Custom color system allows you to use additional colors from palettes for navbar components or navbar in general. All components inside navbar are automatically adjust text, placeholder and background colors according to the specified color class.</p>

							<p class="text-semibold">Example navbar</p>
							<div class="navbar navbar-inverse bg-blue-600 navbar-component" style="position: relative; z-index: 28">
								<div class="navbar-header">
									<a class="navbar-brand" href="index"><img src="assets/images/logo_light.png" alt=""></a>

									<ul class="nav navbar-nav pull-right visible-xs-block">
										<li><a data-toggle="collapse" data-target="#navbar-demo3"><i class="icon-grid3"></i></a></li>
									</ul>
								</div>

								<div class="navbar-collapse collapse" id="navbar-demo3">
									<ul class="nav navbar-nav">
										<li class="active"><a href="#">Active</a></li>
										<li><a href="#">Link</a></li>
										<li class="dropdown">
							...
							<p class="text-semibold">Example markup</p>
							<pre class="language-markup" data-line="2"><code>&lt;!-- Colored navbar -->
...
&lt;!-- /colored navbar -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Mixing navbar colors</h5>
						...
						<div class="panel-body">
							<p class="content-group">Color schemes in multiple navbars can be mixed: you can specify custom background colors for <code>main</code> and <code>secondary</code> navbars or make them identical. All navbars have bottom borders, so if both navbars have the same background color, they will have a visual separation. All these mixes support different sizing and components as well.</p>

							<p class="text-semibold">Example navbars</p>
							<div class="navbar-component">
								<div class="navbar navbar-inverse bg-teal-400" style="position: relative; z-index: 27">
									<div class="navbar-header">
										<a class="navbar-brand" href="index"><img src="assets/images/logo_light.png" alt=""></a>

										<ul class="nav navbar-nav pull-right visible-xs-block">
											<li><a data-toggle="collapse" data-target="#navbar-demo4"><i class="icon-grid3"></i></a></li>
										</ul>
									</div>

									<div class="navbar-collapse collapse" id="navbar-demo4">
										<ul class="nav navbar-nav">
											<li class="active"><a href="#">Active</a></li>
											<li><a href="#">Link</a></li>
											<li class="dropdown">
								...
								<div class="navbar navbar-inverse bg-slate-700 navbar-xs" style="position: relative; z-index: 26;">
									<ul class="nav navbar-nav no-border visible-xs-block">
										<li><a class="text-center collapsed" data-toggle="collapse" data-target="#navbar-demo5"><i class="icon-circle-down2"></i></a></li>
									</ul>

									<div class="navbar-collapse collapse" id="navbar-demo5">
										<ul class="nav navbar-nav">
											<li><a href="#"><i class="icon-git-branch position-left"></i> Branches</a></li>
											<li><a href="#"><i class="icon-git-merge position-left"></i> Merges <span class="badge bg-blue-400 badge-inline position-right">81</span></a></li>
										...
										<ul class="nav navbar-nav navbar-right">
											<li>
												<a href="#">
													...
													<span class="visible-xs-inline-block position-right">Upload files</span>
												</a>
											</li>
											...
											<li class="dropdown">
												<a href="#" class="dropdown-toggle" data-toggle="dropdown">
													...
													<span class="caret position-right"></span>
												</a>
