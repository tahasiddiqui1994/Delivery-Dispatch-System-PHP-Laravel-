	...
	<div class="navbar navbar-inverse">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav">
				<li>
					<a class="sidebar-control sidebar-main-hide hidden-xs" data-popup="tooltip" title="Show main" data-placement="bottom" data-container="body">
						<i class="icon-lan3"></i>
					</a>
				</li>
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="sidebar_hidden">Hidden sidebar</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Hidden</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_hidden">Sidebars</a></li>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Hidden sidebar</h6>
						This page has main sidebar hidden by default. Click <strong>Show main</strong> button above to show sidebar. This option works for all sidebars.
				    </div>
				    <!-- /info alert -->
