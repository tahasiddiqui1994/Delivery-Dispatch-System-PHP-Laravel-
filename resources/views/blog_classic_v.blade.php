								...
								<li>
									...
									<ul>
										...
										<li>
											<a href="#">Blog</a>
											<ul>
												<li class="active"><a href="blog_classic_v">Classic vertical</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Blog</span> - Vertical Layout</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="blog_classic_v">Blog</a></li>
							<li class="active">Vertical layout</li>
						</ul>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Layout #1
						<small class="display-block">Panel with transparent footer</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title text-semibold"><a href="#">Blog post layout #1 with image</a></h5>
								</div>

								<div class="panel-body">
									<div class="thumb content-group">
										<img src="assets/images/placeholder.jpg" alt="" class="img-responsive">
										<div class="caption-overflow">
											<span>
												<a href="blog_single" class="btn btn-flat border-white text-white btn-rounded btn-icon"><i class="icon-arrow-right8"></i></a>
											</span>
										</div>
									</div>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title text-semibold"><a href="#">Blog post layout #1 with video</a></h5>
								</div>
					...
					<h6 class="content-group text-semibold">
						Layout #2
						<small class="display-block">Panel with default footer</small>
					</h6>
							...
							<div class="panel panel-flat">
								<div class="panel-body">
									...
									<h5 class="text-semibold content-group-sm">
										<a href="#" class="text-default">Blog post layout #2 with image</a>
									</h5>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-body">
									...
									<h5 class="text-semibold content-group-sm">
										<a href="#" class="text-default">Blog post layout #2 with video</a>
									</h5>
					...
					<h6 class="content-group text-semibold">
						Layout #3
						<small class="display-block">Layout with labeled tags</small>
					</h6>
							...
							<div class="panel panel-flat">
								...
								<div class="panel-footer panel-footer-transparent pb-20">
									<div class="heading-elements">
										...
										<a href="#" class="btn bg-teal heading-btn pull-right">Read more <i class="icon-arrow-right14 position-right"></i></a>
									</div>
								</div>
							</div>
							<!-- /blog layout #3 with image -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								...
								<div class="panel-footer panel-footer-transparent pb-20">
									<div class="heading-elements">
										<ul class="list-inline list-inline-condensed heading-text">
											<li><a href="#"><span class="label bg-blue-300">Video</span></a></li>
											<li><a href="#"><span class="label bg-blue-300">Blog</span></a></li>
											<li><a href="#"><span class="label bg-blue-300">Post</span></a></li>
										</ul>

										<a href="#" class="btn bg-blue heading-btn pull-right">Read more <i class="icon-arrow-right14 position-right"></i></a>
									</div>
								</div>
							</div>
							<!-- /blog layout #3 with video -->
					...
					<h6 class="content-group text-semibold">
						Layout #4
						<small class="display-block">Display details as icons</small>
					</h6>
							...
							<div class="panel panel-flat">
								<div class="panel-body">
									...
									<ul class="list-inline list-inline-separate text-muted content-group">
										<li>By <a href="#" class="text-muted">Eugene</a></li>
										<li>July 5th, 2016</li>
										<li><a href="#" class="text-muted">video</a>, <a href="#" class="text-muted">blog</a>, <a href="#" class="text-muted">post</a></li>
									</ul>
					...
					<h6 class="content-group text-semibold">
						Layout #5
						<small class="display-block">Centered blog post</small>
					</h6>
					...
					<div class="row">
							...
							<div class="panel panel-flat">
								<div class="panel-body">
									...
									<div class="text-center">
										...
										<p class="content-group">When suspiciously goodness labrador understood rethought yawned grew piously endearingly inarticulate oh goodness jeez trout distinct hence cobra despite taped laughed the much audacious less inside tiger groaned darn stuffily metaphoric unihibitedly inside cobra.</p>

										<a href="#" class="btn btn-primary">Read more <i class="icon-arrow-right14 position-right"></i></a>
									</div>
								</div>
							</div>
							<!-- /blog layout #5 with image -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-body">
									<div class="embed-responsive embed-responsive-16by9 content-group">
										<iframe class="embed-responsive-item" allowfullscreen="" frameborder="0" mozallowfullscreen="" src="https://player.vimeo.com/video/173387642?title=0&amp;byline=0&amp;portrait=0" webkitallowfullscreen=""></iframe>
									</div>
									...
									<div class="text-center">
										...
										<p class="content-group">Pernicious drooled tryingly over crud peaceful gosh yet much following brightly mallard hey gregariously far gosh until earthworm python some impala belched darn a sighed unicorn much changed and astride cat and burned grizzly when jeez wonderful the outside tedious.</p>
