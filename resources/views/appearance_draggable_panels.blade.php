...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/appearance_draggable_panels.js')}}"></script>
	<!-- /еheme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="appearance_draggable_panels">Draggable panels</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Appearance</span> - Draggable Panels</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="appearance_draggable_panels">Appearance</a></li>
							<li class="active">Draggable panels</li>
						</ul>
				...
				<div class="content">
					...
					<div class="row row-sortable">
						<div class="col-md-6">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Multiple columns panel 2</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
						...
						<div class="col-md-6">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Multiple columns panel 3</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Multiple columns panel 4</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
					...
					<!-- Define column with sorting panels -->
					<h6 class="content-group text-semibold">
						Define sorting column
						<small class="display-block">Specify column where to sort panels</small>
					</h6>

					<div class="row">
						<div class="col-md-6 column-panel-sortable">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">This is a sortable panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Another sortable panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
						...
						<div class="col-md-6">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Here sorting is disabled</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Here is also disabled</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
					...
					<!-- Exclude specified panels from sorting -->
					<h6 class="content-group text-semibold">
						Exclude panels from sort
						<small class="display-block">Exclude specified panels from sorting</small>
					</h6>
					...
					<div class="row sortable-exclude">
						<div class="col-md-6">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Sortable panel 1</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Sortable panel 2</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
						...
						<div class="col-md-6">
							<div class="panel panel-white skip-sort">
								<div class="panel-heading">
									<h6 class="panel-title">Non-sortable panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Sortable panel 3</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
					...
					<h6 class="content-group text-semibold">
						Sorting handles
						<small class="display-block">Handles are <code>panel title</code> and <code>move icon</code></small>
					</h6>
					...
					<div class="row sortable-heading">
						<div class="col-md-6">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title cursor-move">Title handle 1</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title cursor-move">Title handle 2</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
						...
						<div class="col-md-6">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title cursor-move">Title handle 3</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
					...
					<h6 class="content-group text-semibold">
						Panel as a handle
						<small class="display-block">The whole panel is a sorting handle</small>
					</h6>

					<div class="row sortable-panel">
						<div class="col-md-6">
							<div class="panel panel-white cursor-move">
								<div class="panel-heading">
									<h6 class="panel-title">Sortable panel 1</h6>
									<div class="heading-elements">
										<ul class="icons-list">
						...
						<div class="col-md-6">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title cursor-move">Sortable panel 3</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title cursor-move">Sortable panel 4</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="move"></a></li>
