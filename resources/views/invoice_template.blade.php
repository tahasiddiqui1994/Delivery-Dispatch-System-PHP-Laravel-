...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/invoice_template.js')}}"></script>
	<!-- /theme JS files -->
								...
								<li>
									...
									<ul>
										...
										<li>
											<a href="#">Invoicing</a>
											<ul>
												<li class="active"><a href="invoice_template">Invoice template</a></li>
					...
					<div class="page-header-content">
						<div class="page-title">
							...
							<ul class="breadcrumb position-right">
								...
								<li><a href="invoice_template">Invoices</a></li>
