...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="{{url('assets/js/plugins/maps/jvectormap/jvectormap.min.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/maps/jvectormap/map_files/world.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/maps/jvectormap/map_files/countries/usa.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/maps/jvectormap/map_files/countries/germany.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/demo_data/maps/vector/gdp_demo_data.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/vector/vector_maps_demo.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="maps_vector">Vector maps</a></li>
									</ul>
								</li>
								<!-- /data visualization -->
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="maps_vector">Maps</a></li>
