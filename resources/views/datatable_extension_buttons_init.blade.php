...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/datatables_extension_buttons_init.js')}}"></script>
	<!-- /theme JS files -->
								...
								<li>
									...
									<ul>
										...
										<li>
											<a href="#">Buttons</a>
											<ul>
												<li class="active"><a href="datatable_extension_buttons_init">Initialization</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Datatables</span> - Buttons Init</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="datatable_extension_buttons_init">Datatables</a></li>
							<li class="active">Buttons init</li>
						</ul>
