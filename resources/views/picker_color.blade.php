...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="picker_color">Color pickers</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Pickers</span> - Color</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="pickers_color">Pickers</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Basic options
						<small class="display-block">Examples with basic picker options</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Basic color picker</h6>
								<p class="content-group-sm text-muted">Color picker with default options</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Custom button text</h6>
								<p class="content-group-sm text-muted">Specify custom text for each button</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Hide picker buttons</h6>
								<p class="content-group-sm text-muted">Display only color picker area</p>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Disable color picker</h6>
								<p class="content-group-sm text-muted">Enable or disable color picker</p>

								<input type="text" class="form-control colorpicker-disabled" value="#20BF7E">
								<button type="button" class="btn btn-link btn-icon" id="toggle-disabled"><i class="icon-reload-alt"></i></button>
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Container color</h6>
								<p class="content-group-sm text-muted">Custom container color class</p>

								<input type="text" class="form-control colorpicker-container-class" value="#20BF7E">
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Replacer color</h6>
								<p class="content-group-sm text-muted">Custom replacer color class</p>

								<input type="text" class="form-control colorpicker-replacer-class" value="#20BF7E">
							</div>
						</div>
					</div>
					<!-- /basic options -->
					...
					<h6 class="content-group text-semibold">
						Picker additions
						<small class="display-block">Show additional picker elements</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Show initial color</h6>
								<p class="content-group-sm text-muted">Show color that was initially set</p>

								<input type="text" class="form-control colorpicker-show-initial" value="#E63E3E">
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Show input field</h6>
								<p class="content-group-sm text-muted">Add input for free form typing</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Show alpha channel</h6>
								<p class="content-group-sm text-muted">Allow alpha transparency selection</p>

								<input type="text" class="form-control colorpicker-show-alpha" value="#E63E3E">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Clear selection</h6>
								<p class="content-group-sm text-muted">Reset current color selection</p>

								<input type="text" class="form-control colorpicker-clear" value="#E63E3E">
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Input and initial</h6>
								<p class="content-group-sm text-muted">Combining different elements</p>

								<input type="text" class="form-control colorpicker-input-initial" value="#E63E3E">
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Full leatured</h6>
								<p class="content-group-sm text-muted">Full featured picker example</p>

								<input type="text" class="form-control colorpicker-full" value="#E63E3E">
							</div>
						</div>
					</div>
					<!-- /picker additions -->
					...
					<h6 class="content-group text-semibold">
						Color palettes
						<small class="display-block">Add a color palette to the picker</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-success text-center">
								<h6 class="no-margin text-semibold">Show color palette</h6>
								<p class="content-group-sm text-muted">Display recently used colors</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-success text-center">
								<h6 class="no-margin text-semibold">Show palette only</h6>
								<p class="content-group-sm text-muted">Show palette and nothing else</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-success text-center">
								<h6 class="no-margin text-semibold">Toggle palette only</h6>
								<p class="content-group-sm text-muted">Toggle picker next to the palette</p>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-success text-center">
								<h6 class="no-margin text-semibold">Selection palette</h6>
								<p class="content-group-sm text-muted">Keep track of selected colors</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-success text-center">
								<h6 class="no-margin text-semibold">Limit selections</h6>
								<p class="content-group-sm text-muted">Palette colors are limited to 3</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-success text-center">
								<h6 class="no-margin text-semibold">Hide after select</h6>
								<p class="content-group-sm text-muted">Hide picker after color select</p>
					...
					<h6 class="content-group text-semibold">
						Color formats
						<small class="display-block">Display different color formats</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-warning text-center">
								<h6 class="no-margin text-semibold">HEX color format</h6>
								<p class="content-group-sm text-muted">Display colors in HEX format</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-warning text-center">
								<h6 class="no-margin text-semibold">HEX3 color format</h6>
								<p class="content-group-sm text-muted">Display colors in HEX3 format</p>

								<input type="text" class="form-control colorpicker-show-input" data-preferred-format="hex3" value="#f75d1c">
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-warning text-center">
								<h6 class="no-margin text-semibold">HSL color format</h6>
								<p class="content-group-sm text-muted">Display colors in HSL format</p>

								<input type="text" class="form-control colorpicker-show-input" data-preferred-format="HSL" value="#f75d1c">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-warning text-center">
								<h6 class="no-margin text-semibold">RGB color format</h6>
								<p class="content-group-sm text-muted">Display colors in RGB format</p>

								<input type="text" class="form-control colorpicker-show-input" data-preferred-format="rgb" value="#f75d1c">
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-warning text-center">
								<h6 class="no-margin text-semibold">HTML color names</h6>
								<p class="content-group-sm text-muted">HTML color names support</p>

								<input type="text" class="form-control colorpicker-show-input" data-preferred-format="name" value="orangered">
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-warning text-center">
								<h6 class="no-margin text-semibold">Mix color formats</h6>
								<p class="content-group-sm text-muted">Change formats in the input</p>

								<input type="text" class="form-control colorpicker-show-input" data-preferred-format="name" value="#f75d1c">
							</div>
						</div>
					</div>
					<!-- /color formats -->
					...
					<h6 class="content-group text-semibold">
						Picker events
						<small class="display-block">Basic usage of the picker events</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Change event</h6>
								<p class="content-group-sm text-muted">Called as the input changes</p>

								<input type="text" class="form-control colorpicker-event-change" value="#45818e">
								<div class="mt-15 hidden" id="change-result"></div>
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Move event</h6>
								<p class="content-group-sm text-muted">Called as the user moves around</p>

								<input type="text" class="form-control colorpicker-event-move" value="#45818e">
								<div class="mt-15 hidden" id="move-result"></div>
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Hide event</h6>
								<p class="content-group-sm text-muted">Called after the picker is hidden</p>

								<input type="text" class="form-control colorpicker-event-hide" value="#45818e">
								<div class="mt-15 hidden" id="hide-result"></div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Show event</h6>
								<p class="content-group-sm text-muted">Called after the picker is opened</p>

								<input type="text" class="form-control colorpicker-event-show" value="#45818e">
								<div class="mt-15 hidden" id="show-result"></div>
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Dragstart event</h6>
								<p class="content-group-sm text-muted">Called as the drag event starts</p>

								<input type="text" class="form-control colorpicker-event-dragstart" value="#45818e">
								<div class="mt-15 hidden" id="dragstart-result"></div>
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-info text-center">
								<h6 class="no-margin text-semibold">Dragstop event</h6>
								<p class="content-group-sm text-muted">Called as the drag event stops</p>

								<input type="text" class="form-control colorpicker-event-dragstop" value="#45818e">
								<div class="mt-15 hidden" id="dragstop-result"></div>
							</div>
						</div>
					</div>
					<!-- /picker events -->
					...
					<h6 class="content-group text-semibold">
						Flat pickers
						<small class="display-block">Display a full size color picker</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Basic flat picker</h6>
								<p class="content-group-sm text-muted">Basic full size color picker</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Flat color palette</h6>
								<p class="content-group-sm text-muted">Display both palette and picker</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Set picker color</h6>
								<p class="content-group-sm text-muted">Custom flat color picker color</p>

								<input type="text" class="form-control colorpicker-flat-custom" value="#45818e">
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Full featured</h6>
								<p class="content-group-sm text-muted">Full featured flat picker</p>
