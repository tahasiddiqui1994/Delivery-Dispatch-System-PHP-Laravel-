...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/extra_trees.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="extra_trees">Dynamic tree views</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="extra_trees">Extras</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Initialization options
						<small class="display-block">Data type and data source options</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Unordered list markup</h6>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									<p class="mb-15">Current example demonstrates multi level file tree with default options, initialized from an <code>&lt;ul></code> element.</p>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Load JSON data</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="mb-15">In this example multi level file tree initialized from <code>JSON</code> data type and attached to <code>&lt;div></code> block element.</p>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Embed JSON data</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="mb-15">To embed JSON data in the markup, specify data type via <code>data-type</code> attribute and hide is using <code>.hidden</code> class.</p>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Drag and drop support</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="mb-15">Fancytree supports drag'n'drop of tree nodes and behave like a standard jQuery UI draggable and droppable.</p>

									<div class="tree-drag well border-left-info border-left-lg"></div>
								</div>
							</div>
							<!-- /tree with drag and drop support -->
					...
					<h6 class="content-group text-semibold">
						Selectable nodes
						<small class="display-block">Single an multiple selections</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Multiple select</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="mb-15">This tree has multi selection enabled: a single-click handler selects the node; a keydown handler selects on <kbd>space</kbd>.</p>

									<div class="tree-checkbox well border-left-danger border-left-lg"></div>
								</div>
							</div>
							<!-- /tree with checkbox -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Disable selection</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									...
									<div class="tree-checkbox-options well border-left-danger border-left-lg">
										<ul>
											<li class="folder expanded">Expanded folder with children
												<ul>
													<li class="expanded">Expanded sub-item
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Tree persistence</h6>
									<div class="heading-elements">
										<button type="button" class="btn btn-danger btn-xs reset-cookies heading-btn">Reset cookies</button>
				                	</div>
								</div>
								
								<div class="panel-body">
									<p class="mb-15">Store and restore tree status using cookies or local storage: click, expand or select nodes and reload the page.</p>

									<div class="tree-persistence well border-left-danger border-left-lg"></div>
								</div>
							</div>
							<!-- /tree persistence -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									<p class="mb-15">Change checkboxes state programmatically using <code>setSelected()</code> parameter with <code>true</code> or <code>false</code> properties.</p>

									<div class="tree-checkbox-toggle well border-left-danger border-left-lg"></div>
								</div>
							</div>
							<!-- /select all/deselect all checkboxes -->
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Hierarchical select</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Single select</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="mb-15">Single select example: a double-click handler selects a document node; a keydown handler selects on <kbd>space</kbd>.</p>
					...
					<h6 class="content-group text-semibold">
						Various examples
						<small class="display-block">Fancytree examples with options</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Editable nodes</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="mb-15">Node titles can be changed via inline editing using <code>dblclick</code>, <kbd>Shift + click [F2]</kbd> or <kbd>Enter</kbd> (on Mac only).</p>

									<div class="tree-editable well border-left-success border-left-lg"></div>
								</div>
							</div>
							<!-- /tree editable -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Child counter</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="mb-15">The following example demonstrates optional tiny badges that display count of children elements at parent node.</p>

									<div class="tree-child-count well border-left-success border-left-lg"></div>
								</div>
							</div>
							<!-- /tree with child counter -->
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Toggle state</h6>
									<div class="heading-elements">
								...
								<div class="panel-body">
									<p class="mb-15">This example demonstrates the usage of some Fancytree API functions, such as disabling and enabling file tree.</p>

									<div class="tree-toggle well border-left-success border-left-lg"></div>
								</div>
							</div>
							<!-- /enable/disable tree -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Tree sorting</h6>
									<div class="heading-elements">
										<div class="heading-btn">
											<button type="button" class="btn btn-primary btn-xs sort-tree">Sort tree</button>
											<button type="button" class="btn btn-success btn-xs sort-branch">Sort active</button>
										</div>
				                	</div>
								</div>
								
								<div class="panel-body">
									<p class="mb-15">This example demonstrates a <code>sorting</code> feature of child list by title in 2 ways: full tree and in active nodes only.</p>

									<div class="tree-sorting well border-left-success border-left-lg">
										<ul>
											<li class="expanded">Document with some children (expanded on init)
												<ul>
													<li>Document sub-item</li>
