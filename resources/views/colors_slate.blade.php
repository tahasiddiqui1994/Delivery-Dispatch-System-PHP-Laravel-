...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/colors_slate.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="colors_slate">Slate palette</a></li>
									</ul>
								</li>
								<li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Colors</span> - Slate Palette</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="colors_slate">Colors</a></li>
							<li class="active">Slate palette</li>
						</ul>
				...
				<div class="content">
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#37474F</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#slate_800"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#455A64</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#slate_700"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#546E7A</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#slate_600"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#607D8B</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#slate_500"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#78909C</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#slate_400"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#90A4AE</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#slate_300"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="content-group-lg">
					    ...
					    <!-- Solid alert -->
					    <div class="alert bg-slate alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Close</span></button>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.text-slate</code> classes</p>
								</div>

								<input type="text" class="form-control text-slate text-uppercase text-semibold text-size-small" value="Input field text">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-slate</code> or classes</p>
								</div>

								<input type="text" class="form-control border-slate border-lg" placeholder="Input field border">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-slate</code> classes</p>
								</div>

								<input type="text" class="form-control bg-slate" placeholder="Input field background">
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate">
								...
								<div class="has-feedback">
									<input type="text" class="form-control bg-slate" placeholder="Icon feedback, slate input">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate">
								...
								<select class="form-control bg-slate">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate">
								...
								<div class="input-group">
									<span class="input-group-addon bg-slate"><i class="icon-menu7"></i></span>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control bg-slate" placeholder="Solid background color">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
								...
								<label class="radio-inline">
									<input type="radio" class="styled" name="slate-radio" checked="checked">
									Selected
								</label>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-slate</code> or classes</p>

									<select class="selectbox bg-slate">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate">
								<div class="text-center">
									...
									<select class="bootstrap-select" data-style="bg-slate">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										<ul class="nav nav-tabs bg-slate">
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										...
										<div class="tab-content bg-slate">
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
								...
								<span class="label bg-slate">Slate label</span>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
								...
								<span class="badge bg-slate">390</span>
							</div>
				    	</div>
				    </div>
				    <!-- /text options -->
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-slate progress-bar-striped" style="width: 65%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-slate progress-bar-striped active" style="width: 75%">
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-6">
				    		<div class="panel panel-flat">
								...
								<div class="table-responsive bg-slate">
									<table class="table">
										<thead>
											<tr>
												<th>#</th>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
								...
								<button type="button" class="btn bg-slate"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
								...
								<button type="button" class="btn bg-slate btn-labeled"><b><i class="icon-menu7"></i></b> Labeled button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
								...
								<button type="button" class="btn text-slate-800 border-slate btn-flat"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    </div>
				    <!-- /buttons -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel">
								<div class="panel-heading bg-slate">
									<h6 class="panel-title">Slate panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Slate panel using <code>.bg-slate</code> class added to the panel heading
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel border-slate">
								<div class="panel-heading bg-slate">
									<h6 class="panel-title">Slate bordered panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Bordered slate panel using <code>.bg-slate</code> and <code>.border-slate</code> classes
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel bg-slate">
								<div class="panel-heading">
									<h6 class="panel-title">Slate solid panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Solid slate panel using <code>.bg-slate</code> class added to the panel container
								</div>
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
								...
								<button type="button" class="btn bg-slate" data-popup="tooltip-custom" title="Slate tooltip" data-placement="bottom" data-container="body"><i class="icon-comment position-left"></i> Tooltip</button>
							</div>
				    	</div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
								...
								<button type="button" class="btn bg-slate" data-toggle="modal" data-target="#modal_slate"><i class="icon-menu7 position-left"></i> Modal dialog</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
								...
								<p class="mb-15 text-muted">Using <code>.bg-slate</code> color classes</p>

								<button class="btn bg-slate growl-launch">jGrowl notification</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate text-center">
								...
								<button class="btn bg-slate pnotify-launch">Pnotify notification</button>
							</div>
				    	</div>
				    </div>
				    <!-- /notifications and dialogs -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-slate</code> color classes</p>
								</div>

								<ul class="dropdown-menu border-slate border-lg" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate">
								...
								<ul class="dropdown-menu bg-slate" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-slate">
								...
								<ul class="dropdown-menu bg-slate" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> <span class="label bg-slate pull-right">Label</span> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> <span class="badge bg-slate pull-right">98</span> Another action</a></li>
									<li class="divider"></li>
