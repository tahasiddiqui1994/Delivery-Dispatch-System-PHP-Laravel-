								...
								<li>
									...
									<ul>
										...
										<li>
											<a href="#">Selects</a>
											<ul>
												<li class="active"><a href="form_select2">Select2 selects</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Forms</span> - Select2 Selects</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="form_select2">Forms</a></li>
							<li class="active">Select2 selects</li>
						</ul>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Basic setup
						<small class="display-block">Examples with basic options</small>
					</h6>
					...
					<div class="row">
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<select data-placeholder="Select a State..." class="select">
											<option></option>
											<optgroup label="Mountain Time Zone">
												<option value="AZ">Arizona</option>
												<option value="CO">Colorado</option>
									...
									<div class="form-group">
										...
										<select data-placeholder="Select a state..." class="select-icons">
									...
									<div class="form-group">
										...
										<select class="select-custom-colors">
											<optgroup label="Mountain Time Zone">
												<option value="AZ">Arizona</option>
												<option value="CO">Colorado</option>
												<option value="ID">Idaho</option>
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Multiple select</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<select multiple="multiple" class="select-fixed-multiple">
											<optgroup label="Mountain Time Zone">
												<option value="AZ" selected="selected">Arizona</option>
												<option value="CO">Colorado</option>
												<option value="ID">Idaho</option>
									...
									<div class="form-group">
										...
										<select class="select-multiple-drag" multiple="multiple">
											<option value="AZ" selected="selected">Arizona</option>
											<option value="CO">Colorado</option>
											<option value="ID">Idaho</option>
											<option value="WY">Wyoming</option>
									...
									<div class="form-group">
										<label>Disabled select</label>
										<select multiple="multiple" class="select" disabled="disabled">
											<option value="AZ" selected="selected">Arizona</option>
											<option value="CO">Colorado</option>
									...
									<div class="form-group">
										...
										<select multiple="multiple" class="select-results-color">
											<optgroup label="Mountain Time Zone">
												<option value="AZ" selected="selected">Arizona</option>
												<option value="CO">Colorado</option>
												<option value="ID">Idaho</option>
									...
									<div class="form-group">
										...
										<select multiple="multiple" class="select-menu2-color">
											<optgroup label="Mountain Time Zone">
												<option value="AZ" selected="selected">Arizona</option>
												<option value="CO">Colorado</option>
												<option value="ID">Idaho</option>
					...
					<h6 class="content-group text-semibold">
						Select sizing
						<small class="display-block">Single and multiple selects sizing</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Single select sizing</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<select data-placeholder="Select a State..." class="select-size-sm">
											<option></option>
											<optgroup label="Mountain Time Zone">
												<option value="AZ">Arizona</option>
												<option value="CO">Colorado</option>
									...
									<div class="form-group">
										...
										<select data-placeholder="Select a State..." class="select-size-xs">
											<option></option>
											<optgroup label="Mountain Time Zone">
												<option value="AZ">Arizona</option>
												<option value="CO">Colorado</option>
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Multiple select sizing</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="form-group">
										<label>Large select</label>
										<select multiple="multiple" data-placeholder="Select a State..." class="select-size-lg">
											<option></option>
											<optgroup label="Mountain Time Zone">
												<option value="AZ">Arizona</option>
												<option value="CO">Colorado</option>
									...
									<div class="form-group">
										<label>Default select</label>
										<select multiple="multiple" data-placeholder="Select a State..." class="select">
											<option></option>
											<optgroup label="Mountain Time Zone">
												<option value="AZ" selected="selected">Arizona</option>
												<option value="CO">Colorado</option>
									...
									<div class="form-group">
										<label>Small select</label>
										<select multiple="multiple" data-placeholder="Select a State..." class="select-size-sm">
											<option></option>
											<optgroup label="Mountain Time Zone">
												<option value="AZ">Arizona</option>
												<option value="CO">Colorado</option>
									...
									<div class="form-group">
										<label>Mini select</label>
										<select multiple="multiple" data-placeholder="Select a State..." class="select-size-xs">
											<option></option>
											<optgroup label="Mountain Time Zone">
												<option value="AZ">Arizona</option>
					...
					<h6 class="content-group text-semibold">
						Advanced usage
						<small class="display-block">More complex configurations</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Advanced single selects</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="content-group-lg">
										<h6 class="text-semibold">Minimum input</h6>
										<p class="content-group-sm">Select2 supports a minimum input setting which is useful for large remote datasets where short search terms are not very useful. Simply specify a number of input characters using <code>minimumInputLength</code> option:</p>

										<select data-placeholder="Enter 'as'" class="select-minimum">
											<option></option>
											<optgroup label="Mountain Time Zone">
												<option value="AZ">Arizona</option>
												<option value="CO">Colorado</option>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Customizing how results are matched</h6>
										<p class="content-group-sm">Example of how matched results can be customized. Unlike other dropdowns on this page, this one matches options only if the term appears in the beginning of the string as opposed to anywhere.</p>

										<select class="select-matched-customize">
											<optgroup label="Mountain Time Zone">
												<option value="AZ">Arizona</option>
												<option value="CO">Colorado</option>
												<option value="ID">Idaho</option>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Loading array data</h6>
										<p class="content-group-sm">Select2 provides a way to load the data from a local array. You can provide initial selections with array data by providing the option tag for the selected values, similar to how it would be done for a standard select.</p>

										<div class="content-group">
											<p>1. Example below loads array:</p>
											<select class="select-data-array"></select>
										</div>

										<div class="content-group">
											<p>2. Example below loads array with selected option:</p>
											<select class="select-data-array">
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Loading remote data</h6>
										<p class="content-group-sm">Select2 comes with AJAX support built in, using jQuery's AJAX methods. In this example, we can search for repositories using GitHub's API. Example also includes infinite scrolling feature:</p>

										<select class="select-remote-data">
											<option value="3620194" selected="selected">select2/select2</option>
										</select>
									</div>

									<div class="content-group-lg">
										<h6 class="text-semibold">Diacritics support in single select</h6>
										<p class="content-group-sm">Select2's default matcher will ignore diacritics, making it easier for users to filter results in international selects. Type <strong>"aero"</strong> into the select below:</p>

										<select data-placeholder="Type 'aero'" class="select-search">
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Clearing results</h6>
										<p class="content-group-sm">Whether or not a clear button is displayed when the select box has a selection. The button, when clicked, resets the value of the select box back to the placeholder.</p>

										<select data-placeholder="Select a state" class="select-clear">
											<option></option>
											<optgroup label="Mountain Time Zone">
												<option value="AZ">Arizona</option>
												<option value="CO">Colorado</option>
									...
									<div class="content-group">
										<h6 class="text-semibold">Programmatic access</h6>
										<p class="content-group-sm">Select2 supports methods that allow programmatic control of the component: you can set and get single or multiple values, control menu visibility by opening and closing it, make the menu enabled or disabled.</p>

										<div class="content-group">
											<p>1. Set and get value:</p>
											<p class="content-group-sm">
												<select data-placeholder="Select something" class="select-access-value">
													<option></option>
										...
										<div class="content-group">
											...
											<p class="content-group-sm">
												<select data-placeholder="Select something" class="select-access-enable">
													<option></option>
													<option value="CA">California</option>
													<option value="AZ">Arizona</option>
													<option value="CO">Colorado</option>
										...
										<div class="content-group">
											...
											<p class="content-group-sm">
												<select data-placeholder="Select something" class="select-access-create">
													<option></option>
													<option value="CA">California</option>
													<option value="AZ">Arizona</option>
													<option value="CO">Colorado</option>
										...
										<div>
											...
											<p class="content-group-sm">
												<select data-placeholder="Select something" class="select-access-open">
													<option></option>
													<option value="CA">California</option>
													<option value="AZ">Arizona</option>
													<option value="CO">Colorado</option>
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Advanced multiple selects</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="content-group-lg">
										<h6 class="text-semibold">Tagging support</h6>
										<p class="content-group-sm">Select2 can be used to quickly set up fields used for tagging. When tagging is enabled the user can select from pre-existing tags or create a new tag by picking the first choice.</p>

										<select class="select-multiple-tags" multiple="multiple">
											<option value="AZ">Arizona</option>
											<option value="CO" selected="selected">Colorado</option>
											<option value="ID">Idaho</option>
											<option value="WY">Wyoming</option>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Maximum input length</h6>
										<p class="content-group-sm">Select2 can be set a limit on the number of characters that can be entered per tag. You would not be able to enter any input of more than 5 characters long.</p>

										<select class="select-multiple-maximum-length" multiple="multiple">
											<option value="AZ">Arizona</option>
											<option value="CO" selected="selected">Colorado</option>
											<option value="ID">Idaho</option>
											<option value="WY">Wyoming</option>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Auto tokenization</h6>
										<p class="content-group-sm">Select2 supports ability to add choices automatically as the user is typing into the search field. Try typing in the search field below and entering a space or a comma.</p>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Limiting the number of selections</h6>
										<p class="content-group-sm">Select2 multi-value select boxes can set restrictions regarding the maximum number of options selected. The select below is declared with <code>maximumSelectionLength</code> option.</p>

										<select class="select-multiple-limited" multiple="multiple">
											<option value="AZ">Arizona</option>
											<option value="CO">Colorado</option>
											<option value="ID">Idaho</option>
											<option value="WY">Wyoming</option>
									...
									<div class="content-group">
										<h6 class="text-semibold">Diacritics support in multiple select</h6>
										<p class="content-group-sm">Select2's default matcher will ignore diacritics, making it easier for users to filter results in international selects. Type <strong>"aero"</strong> into the select below:</p>

										<select data-placeholder="Type 'aero'" multiple="multiple" class="select">
											<option>Aeróbics</option>
											<option>Aeróbics en Agua</option>
											<option>Aerografía</option>
											<option>Aeromodelaje</option>
									...
									<div class="content-group">
										...
										<div class="content-group">
											...
											<p class="content-group-sm">
												<select data-placeholder="Select something" multiple="multiple" class="select-access-multiple-value">
										...
										<div class="content-group">
											<p>2. Enable and disable menu:</p>
											<p class="content-group-sm">
												<select data-placeholder="Select something" multiple="multiple" class="select-access-multiple-enable">
													<option value="AK">Alaska</option>
													<option value="CA">California</option>
													<option value="AZ" selected="selected">Arizona</option>
													<option value="CO">Colorado</option>
										...
										<div class="content-group">
											<p>3. Destroy and create menu:</p>
											<p class="content-group-sm">
												<select data-placeholder="Select something" multiple="multiple" class="select-access-multiple-create">
													<option value="AK">Alaska</option>
													<option value="CA">California</option>
													<option value="AZ" selected="selected">Arizona</option>
													<option value="CO">Colorado</option>
										...
										<div class="content-group">
											...
											<p class="content-group-sm">
												<select data-placeholder="Select states" multiple="multiple" class="select-access-multiple-clear">
													<option value="AK">Alaska</option>
													<option value="CA">California</option>
													<option value="AZ" selected="selected">Arizona</option>
													<option value="CO">Colorado</option>
										...
										<div>
											...
											<p class="content-group-sm">
												<select data-placeholder="Select something" multiple="multiple" class="select-access-multiple-open">
													<option value="AK">Alaska</option>
													<option value="CA">California</option>
													<option value="AZ" selected="selected">Arizona</option>
													<option value="CO">Colorado</option>
