	...
	<div class="navbar navbar-inverse">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav">
				<li>
					<a class="sidebar-control sidebar-opposite-main-hide hidden-xs" data-popup="tooltip" title="Opposite - hide main" data-placement="bottom" data-container="body">
						<i class="icon-indent-decrease2"></i>
					</a>
				</li>

				<li>
					<a class="sidebar-control sidebar-opposite-secondary-hide hidden-xs" data-popup="tooltip" title="Opposite - hide secondary" data-placement="bottom" data-container="body">
						<i class="icon-transmission"></i>
					</a>
				</li>

				<li>
					<a class="sidebar-control sidebar-opposite-hide hidden-xs" data-popup="tooltip" title="Opposite - hide all" data-placement="bottom" data-container="body">
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="sidebar_dual_double_hide">Dual double hide</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Dual Double Hide</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_dual_double_hide">Sidebars</a></li>
							<li class="active">Dual double hide</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Dual double sidebar. Hide</h6>
						In this example all left sidebars are hidden when opposite sidebar is shown, separately or all together. Click on top buttons to see it in action.
				    </div>
				    <!-- /info alert -->
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category">
						...
						<div class="category-content">
							<ul class="media-list">
								<li class="media">
									<div class="media-left"><a href="#" class="btn bg-blue btn-icon btn-rounded btn-sm"><i class="icon-alignment-unalign"></i></a></div>
									<div class="media-body">
										Drop the IE <a href="#">specific hacks</a> for temporal inputs
										<div class="media-annotation">4 minutes ago</div>
									</div>
								...
								<li class="media">
									<div class="media-left"><a href="#" class="btn bg-warning-400 btn-icon btn-rounded btn-sm"><i class="icon-plus2"></i></a></div>
									<div class="media-body">
										Add full font overrides for popovers and tooltips
										<div class="media-annotation">36 minutes ago</div>
									</div>
								...
								<li class="media">
									<div class="media-left"><a href="#" class="btn bg-brown-400 btn-icon btn-rounded btn-sm"><i class="icon-menu7"></i></a></div>
									<div class="media-body">
										<a href="#">Chris Arney</a> created a new <span class="text-semibold">Design</span> branch
										<div class="media-annotation">2 hours ago</div>
									</div>
								...
								<li class="media">
									<div class="media-left"><a href="#" class="btn bg-success-400 btn-icon btn-rounded btn-sm"><i class="icon-font"></i></a></div>
									<div class="media-body">
										<a href="#">Eugene Kopyov</a> merged <span class="text-semibold">Master</span> and <span class="text-semibold">Dev</span> branches
										<div class="media-annotation">Dec 18, 18:36</div>
									</div>
								...
								<li class="media">
									<div class="media-left"><a href="#" class="btn bg-pink-400 btn-icon btn-rounded btn-sm"><i class="icon-cross"></i></a></div>
									<div class="media-body">
										Have Carousel ignore keyboard events
										<div class="media-annotation">Dec 12, 05:46</div>
									</div>
						...
						<div class="category-content">
							<form action="#">
								...
								<div class="text-right">
									<button type="button" class="btn bg-info-400 btn-sm btn-block">Save settings</button>
								</div>
							</form>
						</div>
					</div>
