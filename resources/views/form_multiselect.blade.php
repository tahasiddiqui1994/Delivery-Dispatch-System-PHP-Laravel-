...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/form_multiselect.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="form_multiselect">Bootstrap multiselect</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="form_multiselect">Forms</a></li>
