									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="sidebar_detached_right">Right position</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Detached Right</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_detached_right">Sidebars</a></li>
							<li class="active">Detached right</li>
						</ul>
					...
					<div class="container-detached">
						<div class="content-detached">
							...
							<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
								...
								<h6 class="alert-heading text-semibold">Detached right sidebar</h6>
								Detached sidebar is used inside content area, has fixed width and supports all sidebar components. Here sidebar is placed <code>after</code> main content.
						    </div>
						    <!-- /info alert -->
