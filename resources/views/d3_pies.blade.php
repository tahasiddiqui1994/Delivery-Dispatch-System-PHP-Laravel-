...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/d3/pies/pie_basic.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/pies/pie_entry_animation.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/pies/pie_multiple.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/pies/pie_multiple_nesting.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/pies/pie_update.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/pies/pie_arc_tween.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/pies/donut_basic.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/pies/donut_entry_animation.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/pies/donut_multiple.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/pies/donut_multiple_nesting.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/pies/donut_update.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/pies/donut_arc_tween.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="d3_pies">Pie charts</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">D3</span> - Pie Charts</h4>
						</div>
				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Pie charts</h5>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									<div class="content-group">
										<h6 class="text-semibold">Basic pie chart</h6>
										<p class="content-group">Example of a simple <code>pie chart</code> constructed from a CSV file. The chart employs a number of D3 features: <code>d3.csv</code> - load and parse data; <code>d3.scale.ordinal</code> - color encoding; <code>d3.svg.arc</code> - display arcs; <code>d3.layout.pie</code> - compute arc angles from data.</p>
									...
									<div class="content-group">
										<h6 class="text-semibold">Pie entry transition</h6>
										<p class="content-group">Example of simple entry transition of a <code>pie chart</code>. A transition is a special type of selection where the operators apply smoothly over time rather than instantaneously. You derive a transition from a selection using the transition operator.</p>
										
										<div class="chart-container text-center">
											<button type="button" class="btn btn-primary btn-xs pie-animation content-group">Animate</button>
											<div class="chart svg-center" id="d3-pie-entry-animation"></div>
										</div>
									</div>

									<div class="content-group">
										<h6 class="text-semibold">Pie chart update</h6>
										<p class="content-group">This variation of a <code>pie chart</code> demonstrates how to update values with an animated transition. Clicking on the radio buttons changes the displayed metric.</p>

										<div class="chart-container text-center">
											<div class="pie-radios content-group">
												<label class="radio-inline"><input type="radio" name="pie-dataset" value="apples" checked="checked"> Apples</label>
												<label class="radio-inline"><input type="radio" name="pie-dataset" value="oranges"> Oranges</label>
											</div>
									...
									<div class="content-group">
										<h6 class="text-semibold">Pie arc tween</h6>
										<p class="content-group">An example of <code>pie chart</code> tweening arcs, <code>attrTween</code> transitions the value of the attribute with the specified name according to the specified <code>tween</code> function. The starting and ending value of the transition are determined by <code>tween</code>.</p>
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Donut charts</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="content-group">
										<h6 class="text-semibold">Basic donut chart</h6>
										<p class="content-group">Example of a simple <code>donut chart</code> constructed from a CSV file. The chart employs a number of D3 features: <code>d3.csv</code> - load and parse data; <code>d3.scale.ordinal</code> - color encoding; <code>d3.svg.arc</code> - display arcs; <code>d3.layout.pie</code> - compute arc angles from data.</p>
									...
									<div class="content-group">
										<h6 class="text-semibold">Donut entry transition</h6>
										<p class="content-group">Example of simple entry transition of a <code>donut chart</code>. A transition is a special type of selection where the operators apply smoothly over time rather than instantaneously. You derive a transition from a selection using the transition operator.</p>

										<div class="chart-container text-center">
											<button type="button" class="btn btn-primary btn-xs donut-animation content-group">Animate</button>
											<div class="chart svg-center" id="d3-donut-entry-animation"></div>
										</div>
									</div>

									<div class="content-group">
										<h6 class="text-semibold">Donut chart update</h6>
										<p class="content-group">This variation of a <code>donut chart</code> demonstrates how to update values with an animated transition. Clicking on the radio buttons changes the displayed metric.</p>

										<div class="chart-container text-center">
											<div class="donut-radios content-group">
												<label class="radio-inline"><input type="radio" name="donut-dataset" value="lemons" checked="checked"> Lemons</label>
												<label class="radio-inline"><input type="radio" name="donut-dataset" value="melons"> Melons</label>
											</div>
									...
									<div class="content-group">
										<h6 class="text-semibold">Donut arc tween</h6>
										<p class="content-group">An example of <code>donut chart</code> tweening arcs, <code>attrTween</code> transitions the value of the attribute with the specified name according to the specified <code>tween</code> function. The starting and ending value of the transition are determined by <code>tween</code>.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Pie multiples</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							...
							<div class="content-group">
								<h6 class="text-semibold">Donut multiples</h6>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Nesting pie charts</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<div class="content-group">
								<h6 class="text-semibold">Pie multiples with nesting</h6>
							...
							<div class="content-group">
								<h6 class="text-semibold">Donut multiples with nesting</h6>
