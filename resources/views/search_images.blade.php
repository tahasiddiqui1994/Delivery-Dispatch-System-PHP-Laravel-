									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="search_images">Image search results</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Search</span> - Image Results</h4>

							<ul class="breadcrumb position-right">
								<li><a href="index">Home</a></li>
								<li><a href="search_images">Search</a></li>
								<li class="active">Image results</li>
							</ul>
						</div>
				...
				<div class="content">
					...
					<ul class="nav nav-lg nav-tabs nav-tabs-bottom search-results-tabs">
						...
						<li class="active"><a href="search_images"><i class="icon-image2 position-left"></i> Images</a></li>
							...
							<div class="row">
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Am of friendly</a></h6>
											Unpleasant it sufficient simplicity am by friendship no inhabiting. Goodness escape
										</div>
									</div>
								</div>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Dear mean she way</a></h6>
											He otherwise me incommode explained so in remaining. Polite barton in it warmly do
										</div>
									</div>
								</div>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Am no an listening</a></h6>
											Enough around remove to barton agreed regret in or it. Advantage mr estimable
										</div>
									</div>
								</div>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Year well shot deny</a></h6>
											Shall downs stand marry taken his for out. Do related mr account brandon an up
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Village did removed</a></h6>
											Style too own civil out along. Perfectly offending attempted add arranging gentleman
										</div>
									</div>
								</div>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Securing as informed</a></h6>
											Certainty determine at of arranging perceived situation or. Or wholly pretty county
										</div>
									</div>
								</div>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Request norland</a></h6>
											In astonished apartments resolution so an it. Unsatiable contrasted to reasonable
										</div>
									</div>
								</div>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">On even feet</a></h6>
											Real sold my in call. Invitation on an advantages collecting. But event old above
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Unwilling sportsmen</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Attacks may set</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Missed he engage</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Still tried means</a></h6>
							...
							<div class="row">
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Up is opinion</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Disposing commanded</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Be an as cordially</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="thumbnail">
										...
										<div class="caption">
											<h6 class="text-semibold no-margin-top"><a href="#" class="text-default">Northward affection</a></h6>
