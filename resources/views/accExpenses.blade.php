                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="cpa90TSeTV">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="cpa90TSeTV" data-index="0">
                                <div class="panel-heading ui-sortable-handle">
                                    <div class="btn-group"> 
                                       <a class="btn btn-success" href="accExpense/create"> <i class="fa fa-plus"></i> Add Expense</a> 
                                    </div>
                        ...
                        @if($data)
							@foreach($data as $rrr)
								<tr>
									...
									@if(Auth::user()->type == "admin")
										<td>
	                                       <a href="/accExpense/{{$rrr->id}}/edit" class="btn btn-info btn-xs pull-left" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>

	                                       {!! Form::open(['action'=> ['accExpensesController@destroy',$rrr->id], 'method'=>'POST'], ['class'=>'col-sm-6']) !!}
	                                       &nbsp;<button href="/accExpense/{{$rrr->id}}/destroy" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete">
