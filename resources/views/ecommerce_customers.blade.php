...
<head>
	...
	<!-- Core JS files -->
	<script type="text/javascript" data-pace-options='{"restartOnPushState": false}' src="{{url('assets/js/plugins/loaders/pace.min.js')}}"></script>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/ecommerce_customers.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="ecommerce_customers">Customers</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="ecommerce_customers">ECommerce</a></li>
						...
						<table class="table table-striped text-nowrap table-customers">
							...
							<tbody>
								<tr>
									<td>
										<div class="media">
											<a href="user_pages_profile_tabbed" class="media-left">
												<img src="assets/images/placeholder.jpg" width="40" height="40" class="img-circle img-md" alt="">
											</a>

											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">James Alexander</a>
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Jeremy Victorino</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 1,432.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Margo Baker</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 489.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Monica Smith</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 940.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Jemmy Royle</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 772.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Ashlynn Ben</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 662.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Ray Sammy</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 499.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Brian Leslie</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 946.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Patrick Marilynn</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 538.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Roland Cydney</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 432.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Deanna Joss</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 472.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Dawn Justin</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 402.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Blondie Madison</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 839.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Derryl Carrie</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 471.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Vincent Doris</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 902.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Diantha Royston</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 543.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Lilian Knox</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 2,472.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Toria Eveline</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 2,372.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Tiffany Willemina</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 1,930.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Trenton Alison</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 830.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Brandon Gilbert</a>
												<div class="text-muted text-size-small">
													Latest order: 2016.11.25
												</div>
											</div>
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 903.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Troy Webster</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 394.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Elbert Cailyn</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 192.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Coen Grant</a>
												<div class="text-muted text-size-small">
													Latest order: 2016.12.24
												</div>
											</div>
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 252.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
								...
								<tr>
									<td>
										<div class="media">
											...
											<div class="media-body media-middle">
												<a href="user_pages_profile_tabbed" class="text-semibold">Charles Elian</a>
												<div class="text-muted text-size-small">
									...
									<td>
										<h6 class="no-margin text-semibold">&euro; 2,345.00</h6>
									</td>
									<td class="text-right">
										<ul class="icons-list">
											<li class="dropdown">
