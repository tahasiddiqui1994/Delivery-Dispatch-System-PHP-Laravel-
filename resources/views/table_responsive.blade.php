...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/table_responsive.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="table_responsive">Responsive basic tables</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="table_responsive">Tables</a></li>
