...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/maps/google/controls/disable_ui.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/google/controls/adding_controls.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/google/controls/control_options.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/google/controls/control_positioning.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										<li>
											...
											<ul>
												...
												<li class="active"><a href="maps_google_controls">Controls</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="maps_google_controls">Google maps</a></li>
