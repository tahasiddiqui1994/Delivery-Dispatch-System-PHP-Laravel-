...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/components_thumbnails.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_thumbnails">Thumbnails</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Components</span> - Thumbnails</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="components_thumbnails">Components</a></li>
				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Basic thumbnail</h6>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									...
									<div class="thumbnail">
										<a href="{{url('assets/images/placeholder.jpg" data-popup="lightbox">
											<img src="assets/images/placeholder.jpg" alt="">
										</a>
									</div>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Zooming</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p>Extend thumb with simple zoomable <code>lightbox</code>. The icon is inserted directly in HTML and can be easily changed.</p>
						...
						<div class="col-md-4">
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									<p>Insert as many buttons or links as you want, all of them will be vertically and horizontally centered.</p>
									...
									<div class="thumbnail">
										<div class="thumb">
											...
											<div class="caption-overflow">
												<span>
													<a href="{{url('assets/images/placeholder.jpg" class="btn bg-warning-300 btn-icon" data-popup="lightbox"><i class="icon-zoomin3"></i></a>
					...
					<h6 class="content-group text-semibold">
						Overlay effects
						<small class="display-block">Optinal thumbnail overlays</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Scale effect</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="mb-15">Optional effect with scaling overlay. Uses standard CSS box-shadow property (10px spread) that matches main overlay color.</p>
									...
									<div class="thumbnail">
										<div class="thumb">
											...
											<div class="caption-overflow caption-zoom">
												<span>
													<a href="{{url('assets/images/placeholder.jpg" class="btn bg-warning-300 btn-icon" data-popup="lightbox"><i class="icon-plus2"></i></a>
													<a href="#" class="btn bg-warning-300 btn-icon"><i class="icon-link"></i></a>
												</span>
											</div>
										</div>
						...
						<div class="col-md-4">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Stack effect</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="mb-15">Optional stack effect which changes top and left edges of the overlay. Uses standard CSS transition for position animation.</p>

									<div class="thumbnail">
										<div class="thumb">
											<img src="assets/images/placeholder.jpg" alt="">
											<div class="caption-overflow caption-offset">
												<span>
													<a href="{{url('assets/images/placeholder.jpg" class="btn bg-warning-300 btn-icon" data-popup="lightbox"><i class="icon-plus2"></i></a>
												</span>
											</div>
						...
						<div class="col-md-4">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Slide effect</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="mb-15">Optional overlay effect that slides from bottom to top. Also uses standard CSS transition for position animation with a bit faster speed.</p>
					...
					<h6 class="content-group text-semibold">
						Title options
						<small class="display-block">Optional thumbnail title</small>
					</h6>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top"><a href="#">Linked title</a></h6>
									Me smallness is existence attending he enjoyment favourite affection. Feebly do engage of narrow. Small meant in so doubt hopes.
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top"><i class="icon-menu7 position-left"></i> Title icons <i class="icon-cog3 pull-right"></i></h6>
					...
					<h6 class="content-group text-semibold">
						Thumbnail heading
						<small class="display-block">Optional heading with elements</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="thumbnail">
								<div class="panel-heading">
									<h6 class="panel-title">Icons list</h6>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="thumb">
									...
									<div class="caption-overflow">
										<span>
											<a href="{{url('assets/images/placeholder.jpg" class="btn bg-teal-300 btn-rounded btn-icon" data-popup="lightbox"><i class="icon-zoomin3"></i></a>
											<a href="#" class="btn bg-teal-300 btn-rounded btn-icon"><i class="icon-link"></i></a>
										</span>
									</div>
								</div>
						...
						<div class="col-md-4">
							<div class="thumbnail">
								<div class="panel-heading">
									<h6 class="panel-title">Switcher</h6>
									<div class="heading-elements">
								...
								<div class="caption">
									 A wonderful serenity has taken possession of my soul, like these sweet mornings of spring which I enjoy with my whole heart.
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="thumbnail">
								<div class="panel-heading">
									<h6 class="panel-title">Checkbox</h6>
									<div class="heading-elements">
										<form class="heading-form" action="#">
											<div class="form-group">
								...
								<div class="caption">
									Oh, would I could describe these conceptions, could impress upon paper all that is living so full and warm within me.
								</div>
							</div>
						</div>
					</div>
					...
					<h6 class="content-group text-semibold">
						Thumbnail footer
						<small class="display-block">Optional footer with elements</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="thumbnail">
								<div class="thumb">
									...
									<div class="caption-overflow">
										<span>
											<a href="{{url('assets/images/placeholder.jpg" class="btn btn-flat border-white text-white btn-rounded btn-icon" data-popup="lightbox"><i class="icon-zoomin3"></i></a>
								...
								<div class="caption">
									<h6 class="text-semibold no-margin-top">Man behaviour</h6>
									Way extensive and dejection get delivered deficient sincerity gentleman age. Calling offence six joy feeling.
								</div>

								<div class="panel-footer panel-footer-transparent">
									<div class="heading-elements">
										<a href="#" class="heading-text text-default"><i class="icon-thumbs-up3 position-left"></i> 38</a>
										<a href="#" class="heading-text text-default pull-right"><i class="icon-eye8 position-left"></i> 148</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="text-semibold no-margin-top">Subjects wondered</h6>
									Coming merits and was talent enough far. Sir joy northward sportsmen education. Put still any about manor heard.
								</div>

								<div class="panel-footer panel-footer-transparent">
									<div class="heading-elements">
										<a href="#" class="btn btn-link heading-btn"><i class="icon-comment-discussion position-left"></i> 210</a>
										<a href="#" class="btn btn-link heading-btn pull-right">Continue &rarr;</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="text-semibold no-margin-top">Thing of judge</h6>
									Now eldest new tastes plenty mother called misery get. Delighted promotion improving acuteness an newspaper offending.
								</div>

								<div class="panel-footer panel-footer-transparent">
									<div class="heading-elements">
										<ul class="list-inline list-inline-condensed heading-text">
											<li><a href="#" class="text-default"><i class="icon-twitter"></i></a></li>
											<li><a href="#" class="text-default"><i class="icon-skype"></i></a></li>
											<li><a href="#" class="text-default"><i class="icon-github"></i></a></li>
										</ul>

										<ul class="heading-text list-inline pull-right">
											<li class="dropdown">
												<a href="#" class="dropdown-toggle text-default" data-toggle="dropdown"><i class="icon-cog5"></i><span class="caret"></span></a>
												<ul class="dropdown-menu dropdown-menu-right">
					...
					<h6 class="content-group text-semibold">
						Thumbnail examples
						<small class="display-block">Different possible ways of usage</small>
					</h6>
								...
								<div class="thumb">
									...
									<div class="caption-overflow">
										<span>
											...
											<a href="#" class="btn bg-success-400 btn-icon"><i class="icon-gear"></i></a>
										</span>
									</div>
								</div>

								<div class="caption text-center">
									<h6 class="text-semibold no-margin">Leonardo Di Baggio</h6>
						...
						<div class="col-md-4">
							<div class="thumbnail">
								<div class="thumb">
									...
									<div class="caption-overflow">
										<span>
											<a href="#" class="btn btn-flat border-white text-white btn-icon"><i class="icon-comment-discussion"></i></a>
											<a href="#" class="btn btn-flat border-white text-white btn-icon"><i class="icon-phone2"></i></a>
										</span>
									</div>
								</div>

								<div class="caption text-center">
									<h6 class="text-semibold no-margin">Jason Browning</h6>
									<p class="text-muted mb-15 mt-5">Be me shall purse my ought times. Joy years doors all would again rooms</p>

									<a href="#" class="btn btn-flat btn-rounded btn-icon border-purple text-purple-800"><i class="icon-pin-alt"></i></a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-6 col-md-4">
							<div class="thumbnail">
								<div class="thumb">
									...
									<div class="caption-overflow">
										<span>
											<a href="#" class="btn bg-warning-300">Conversation</a>
										</span>
									</div>
								</div>
								...
								<div class="caption">
									<div class="media">
										...
										<div class="media-body">
											<h6 class="media-heading"><a href="#">Eugene Kopyov</a></h6>
											Delivered is to ye belonging enjoyment preferred. Astonished and acceptance men two discretion. Law education recommend...
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-6 col-md-4">
							<div class="thumbnail">
								<div class="thumb">
									...
									<div class="caption-overflow">
										<span>
											<a href="#" class="btn bg-success-300">Comments</a>
										</span>
									</div>
								</div>
								...
								<div class="caption">
									<div class="media">
										<a href="#" class="media-left"><img src="assets/images/placeholder.jpg" class="img-circle img-md" alt=""></a>
										<div class="media-body">
											Delighted promotion improving acuteness an newspaper offending he. Misery in am secure theirs giving an
											<div class="media-annotation mt-5"><i class="icon-pin-alt position-left"></i> 4 hours ago from Thailand</div>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-6 col-md-4">
							<div class="thumbnail">
								<div class="thumb">
									...
									<div class="caption-overflow">
										<span>
											<button class="btn btn-success btn-float btn-rounded" type="button"><i class="icon-google-drive"></i></button>
											<button class="btn bg-warning-300 btn-float btn-rounded" type="button"><i class="icon-share3"></i></button>
											<button class="btn btn-info btn-float btn-rounded" type="button"><i class="icon-twitter"></i></button>
										</span>
									</div>
								</div>
								...
								<div class="caption">
									<div class="media-heading">
										<h6 class="pull-left no-margin"><span class="text-semibold">Amsterdam</span> - the heart of Europe</h6>
										<ul class="icons-list pull-right">
					                		<li><a href="#"><i class="icon-twitter"></i></a></li>
					                		<li><a href="#"><i class="icon-google-drive"></i></a></li>
										</ul>
									</div>
									<div class="media-annotation mt-5"><i class="icon-pin-alt position-left"></i> Phuket, Thailand</div>
								</div>
							</div>
						</div>
					</div>
