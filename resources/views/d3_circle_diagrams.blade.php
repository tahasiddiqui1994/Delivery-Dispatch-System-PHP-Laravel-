...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/visualization/d3/venn.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/venn/venn_basic.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/venn/venn_colors.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/venn/venn_rings.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/venn/venn_weighted.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/venn/venn_interactive.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/venn/venn_tooltip.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/chords/chord_basic.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/chords/chord_chart.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/chords/chord_tweens.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/chords/chord_arcs.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/sunburst/sunburst_basic.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/sunburst/sunburst_distortion.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/sunburst/sunburst_zoom.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/sunburst/sunburst_combined.js')}}"></script>
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="d3_circle_diagrams">Circle diagrams</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">D3</span> - Circle Diagrams</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="d3_circle_diagrams">D3</a></li>
							<li class="active">Circle diagrams</li>
						</ul>
				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Basic Venn diagrams</h5>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									...
									<div class="content-group">
										<h6 class="text-semibold">Custom colors</h6>
										<p class="content-group">Since basic example of Venn diagram has a set of default colors (example above), custom colors can be also applied. This example demonstrates a basic set of <code>D3.js</code> categorical colors that applied to the circles.</p>
									...
									<div class="content-group">
										<h6 class="text-semibold">Custom layout</h6>
										<p class="content-group">Venn diagram layout uses <code>SVG</code> for drawing circles, that means it supports all available shape styling. This example demonstrates flexibility of SVG's <code>stroke</code> and <code>fill</code> properties and shows rings instead of circles.</p>
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Advanced Venn diagrams</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="content-group">
										<h6 class="text-semibold">Weighted diagram</h6>
										<p class="content-group">An example providing weights on the importance of each intersection area. This defines the non-overlapping intersection areas as being unimportant - so that the sets cluster around set '2' here.</p>
									...
									<div class="content-group">
										<h6 class="text-semibold">Simple interaction</h6>
										<p class="content-group">Example of Venn diagram with simple <code>interaction</code>. On circle hover, text changes the size and circles change fill opacity. Basically all nodes support custom styling. Also added optional callback on circle click.</p>
									...
									<div class="content-group">
										<h6 class="text-semibold">Tooltip</h6>
										<p class="content-group">Example of Venn diagram with optional <code>tooltip</code>. Tooltip appears on <code>mouseover</code>, follows the cursor position on <code>moucemove</code> while it's on the circle and disappears on <code>mouseout</code>. Fully customizable via CSS.</p>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Basic chords</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="content-group">
										<h6 class="text-semibold">Basic chord diagram</h6>
										<p class="content-group">Basic example of <code>chord</code> diagram. Chord diagrams show directed relationships among a group of entities. This example also demonstrates simple interactivity by using mouseover filtering.</p>

										<div class="chart-container has-scroll text-center">
											<div class="content-group">
												<button type="button" class="btn btn-danger btn-xs" id="clear-basic">Clear</button>
												<button type="button" class="btn btn-info btn-xs" id="render-basic">Render</button>
											</div>
									...
									<div class="content-group">
										<h6 class="text-semibold">Simple update and render</h6>
										<p class="content-group">A cleaner interface for updating and rendering the chart: chord returns an object; chord takes a container as its argument; <code>chord.update</code>, <code>chord.render</code> and <code>chord.clear</code> chart functions.</p>

										<div class="chart-container has-scroll text-center">
											<div class="content-group">
												<button type="button" class="btn btn-primary btn-xs" id="update-chart">Update</button>
												<button type="button" class="btn btn-danger btn-xs" id="clear-chart">Clear</button>
												<button type="button" class="btn btn-info btn-xs" id="render-chart">Render</button>
											</div>
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Chord tweens</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="content-group">
										<h6 class="text-semibold">Chord and tick tweens</h6>
										<p class="content-group">Example of <code>chord</code> and <code>tick</code> tweens for updates. Demonstrates an <code>animation</code> of ticks, labels and quadratic Bézier curves between arcs. During animation, all ticks and labels are hidden and appear after update.</p>

										<div class="chart-container has-scroll text-center">
											<div class="content-group">
												<button type="button" class="btn btn-primary btn-xs" id="update-tween">Update</button>
												<button type="button" class="btn btn-danger btn-xs" id="clear-tween">Clear</button>
												<button type="button" class="btn btn-info btn-xs" id="render-tween">Render</button>
											</div>
									...
									<div class="content-group">
										<h6 class="text-semibold">Arc tweens</h6>
										<p class="content-group">Example of <code>arc</code> tweens for updates. The chord layout is designed to work in conjunction with the chord shape and the arc shape. Animation of these arc shapes are demonstrated in this example.</p>

										<div class="chart-container has-scroll text-center">
											<div class="content-group">
												<button type="button" class="btn btn-primary btn-xs" id="update-arc">Update</button>
												<button type="button" class="btn btn-danger btn-xs" id="clear-arc">Clear</button>
												<button type="button" class="btn btn-info btn-xs" id="render-arc">Render</button>
											</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Basic sunburst</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="content-group">
										<h6 class="text-semibold">Sunburst diagram</h6>
										<p class="content-group">A <code>sunburst</code> is similar to the treemap, except it uses a <code>radial</code> layout. The root node of the tree is at the center, with leaves on the circumference. The area of each arc corresponds to its value.</p>

										<div class="chart-container has-scroll text-center">
											<div class="basic-options content-group">
												<label class="radio-inline"><input type="radio" name="mode-basic" value="size"> Size</label>
												<label class="radio-inline"><input type="radio" name="mode-basic" value="count" checked="checked"> Count</label>
											</div>
									...
									<div class="content-group">
										<h6 class="text-semibold">Sunburst with distortion</h6>
										<p class="content-group">A sunburst (radial partition layout) built with <code>D3</code>, featuring interactive distortion based on InterRing: when you click on a node, it expands to fill 80% of the parent arc. Clicking on the root node resets all distortions.</p>
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Zoomable sunburst</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="content-group">
										<h6 class="text-semibold">Zoom and update</h6>
										<p class="content-group">Example of <code>zooming</code> and <code>updating</code> data combination. Click on any arc to zoom in, and click on the center circle to zoom out. Use the Size/Count radio buttons to update the data.</p>

										<div class="chart-container has-scroll text-center">
											<div class="combined-options content-group">
												<label class="radio-inline"><input type="radio" name="mode-combined" value="size"> Size</label>
												<label class="radio-inline"><input type="radio" name="mode-combined" value="count" checked> Count</label>
											</div>
									...
									<div class="content-group">
										<h6 class="text-semibold">Zoomable sunburst</h6>
										<p class="content-group">Example of <code>zoomable</code> sunburst diagram. Presents child levels as a parent level on arc click. Demo data has 3 levels, click on any arc to zoom in and click on the center circle to zoom out.</p>
