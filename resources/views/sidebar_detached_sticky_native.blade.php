									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="sidebar_detached_sticky_native">Sticky (native scroll)</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Sticky Custom</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_detached_sticky_custom">Sidebars</a></li>
							<li class="active">Sticky custom</li>
						</ul>
					...
					<div class="container-detached">
						<div class="content-detached">
							...
							<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
								...
								<h6 class="alert-heading text-semibold">Sticky with native scroll</h6>
								You can also use <code>native</code> scrollbar, but it looks different in all browsers and operating systems.
						    </div>
						    <!-- /info alert -->
								...
								<div class="sidebar-category">
									...
									<div class="category-content no-padding">
										<ul class="navigation navigation-alt navigation-accordion">
											...
											<li><a href="#"><i class="icon-portfolio"></i> Create project</a>
												<ul>
													<li><a href="#"><i class="icon-googleplus5"></i> Create task</a></li>
													<li><a href="#"><i class="icon-googleplus5"></i> Create task</a></li>
													<li><a href="#"><i class="icon-googleplus5"></i> Create task</a></li>
