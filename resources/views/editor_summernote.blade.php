...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="editor_summernote">Summernote editor</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Editors</span> - Summernote</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="editors_summernote">Editors</a></li>
