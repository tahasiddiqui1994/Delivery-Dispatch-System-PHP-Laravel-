...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_notifications_pnotify">PNotify notifications</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Components</span> - PNotify</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="components_notifications_pnotify">Components</a></li>
							<li class="active">PNotify</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">PNotify notifications</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="table-responsive">
							<table class="table">
								<tbody>
									...
									<tr>
										<td>Danger notice</td>
										<td><button type="button" class="btn btn-danger btn-sm" id="pnotify-solid-danger">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Danger notice. To use, add <code>.bg-danger</code> color class to the plugin configuration options</td>
									</tr>
									<tr>
										<td>Success notice</td>
										<td><button type="button" class="btn btn-success btn-sm" id="pnotify-solid-success">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Success notice. To use, add <code>.bg-success</code> color class to the plugin configuration options</td>
									</tr>
									<tr>
										<td>Warning notice</td>
										<td><button type="button" class="btn btn-warning btn-sm" id="pnotify-solid-warning">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Warning notice. To use, add <code>.bg-warning</code> color class to the plugin configuration options</td>
									</tr>
									<tr>
										<td>Info notice</td>
										<td><button type="button" class="btn btn-info btn-sm" id="pnotify-solid-info">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr class="border-solid">
										...
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-solid-custom">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Notice with custom background color. To use, add custom <code>.bg-*</code> color class to the plugin configuration options</td>
									</tr>
									<tr>
										<td>Left icon</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-solid-styled-left">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Solid color notification with left icon. To use, add <code>'bg-* alert-styled-left'</code> to the <code>addclass: '...'</code> option</td>
									</tr>
									<tr>
										<td>Right icon</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-solid-styled-right">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td style="width: 20%;"><button type="button" class="btn btn-primary btn-sm" id="pnotify-default">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Basic pnotify notification. All notification color styles correspond to the Boostrap's <code>alert</code> component</td>
									</tr>
									<tr>
										<td>Danger notice</td>
										<td><button type="button" class="btn btn-danger btn-sm" id="pnotify-danger">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Danger notice. To use, add <code>type: 'error'</code> to the plugin configuration</td>
									</tr>
									<tr>
										<td>Success notice</td>
										<td><button type="button" class="btn btn-success btn-sm" id="pnotify-success">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Success notice. To use, add <code>type: 'success'</code> to the plugin configuration</td>
									</tr>
									<tr>
										<td>Warning notice</td>
										<td><button type="button" class="btn btn-warning btn-sm" id="pnotify-warning">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Warning notice. To use, add <code>type: 'warning'</code> to the plugin configuration</td>
									</tr>
									<tr>
										<td>Info notice</td>
										<td><button type="button" class="btn btn-info btn-sm" id="pnotify-info">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Info notice. To use, add <code>type: 'info'</code> to the plugin configuration</td>
									</tr>
									<tr class="border-solid">
										<td>Left positioned icon</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-styled-left">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-styled-right">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Notification with right positioned icon. To use, add <code>'alert-styled-right'</code> to the <code>addclass: '...'</code> option</td>
									</tr>
									<tr>
										<td>Display arrow</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-styled-arrow">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-custom-styled">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-primary btn-sm" id="pnotify-desktop-default">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>Danger notice</td>
										<td><button type="button" class="btn btn-danger btn-sm" id="pnotify-desktop-danger">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Danger desktop notification using a custom contextual icon. If permission denied, this icon will be hidden</td>
									</tr>
									<tr>
										<td>Success notice</td>
										<td><button type="button" class="btn btn-success btn-sm" id="pnotify-desktop-success">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Success desktop notification using a custom contextual icon. If permission denied, this icon will be hidden</td>
									</tr>
									<tr>
										<td>Warning notice</td>
										<td><button type="button" class="btn btn-warning btn-sm" id="pnotify-desktop-warning">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Warning desktop notification using a custom contextual icon. If permission denied, this icon will be hidden</td>
									</tr>
									<tr>
										<td>Info notice</td>
										<td><button type="button" class="btn btn-info btn-sm" id="pnotify-desktop-info">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>No title</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-no-title">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>Rich notice</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-rich">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-click">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>Form notice</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-form">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Notification with <code>form</code> components. Form is inserted as a DOM object</td>
									</tr>
									<tr>
										<td>Sticky notice</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-sticky">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Sticky notification. To use, add <code>hide: false</code> to the notification configuration</td>
									</tr>
									<tr>
										<td>No sticky button</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-sticky-buttons">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-permanent-buttons">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>Permanotice</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-permanotice">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>Confirmation</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-confirm">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Confirmation dialog with callbacks. To use, add <code>confirm.confirm: true</code> to the notice config</td>
									</tr>
									<tr>
										<td>Prompt</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-prompt">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Prompt dialog with callbacks. To use, add <code>confirm.prompt: true</code> to the notice config</td>
									</tr>
									<tr>
										<td>Multi line</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-multiline">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-buttons">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Notification with <code>custom</code> buttons and callbacks</td>
									</tr>
									<tr>
										<td>With callbacks</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-callbacks">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-switching">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-progress">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Notification with dynamic <code>progress</code>bar. Here <code>before_open</code> callback is used</td>
									</tr>
									<tr>
										<td>Dynamic loader</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-dynamic">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr class="border-double">
										<th colspan="3" class="active">PNotify stacks</th>
									</tr>
									<tr>
										<td>Top left</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-stack-top-left">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Top left stack. Moves down, then right. Pushes to stack top</td>
									</tr>
									<tr>
										<td>Bottom left</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-stack-bottom-left">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Bottom left stack. Moves right, then up. Pushes to stack top</td>
									</tr>
									<tr>
										<td>Bottom right</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-stack-bottom-right">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Bottom right stack. Moves up, then left. Pushes to stack bottom</td>
									</tr>
									<tr>
										<td>Custom left</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-stack-custom-left">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Left stack with custom position. Moves right, then down. Pushes to stack bottom</td>
									</tr>
									<tr>
										<td>Custom right</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-stack-custom-right">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Right stack with custom position. Moves left, then up. Pushes to stack top</td>
									</tr>
									<tr>
										<td>Top bar</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-stack-custom-top">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Top bar stack style. Moves down, then right. Pushes to stack top</td>
									</tr>
									<tr>
										<td>Bottom bar</td>
										<td><button type="button" class="btn btn-default btn-sm" id="pnotify-stack-custom-bottom">Launch <i class="icon-play3 position-right"></i></button></td>
						...
						<div id="form_notice" class="hide">
							<form action="#">
								<h6 class="no-margin-top mb-15">Login to Continue</h6>
