                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-primary" href="/load/"> <i class="fa fa-fw fa-plus-square"></i>  View Load</a>  
                                        </div>
                                    </div>
                                    <div class="panel-body">
										{!! Form::open(['action'=> ['loadController@store', $data->id], 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
										
										<table width="100%" border="0" align="center" cellspacing="0">
										
										<tbody><tr> <td colspan="2" bgcolor="#009688"> <strong><font color="white">Basic Details</font> </strong></td> </tr>
										<tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                <label> Load Number </label>

                                                {{ Form::text('loadNo', $data->loadNo, ['class' => "form-control", 'placeholder' => "Load No"]) }}
                                          ...
                                          <td><div class="col-sm-8 form-group">
                                               ...
                                               <select name="customerName" id="customerName" value="{{$data->customerName}}" class="form-control" placeholder="Select Customer Name">
                                                  @foreach($customers as $cust)
													<option value="{{$cust->companyName}}">{{$cust->companyName}}
													</option>
                                                  @endforeach
                                                </select>
												...
												<a class="btn btn-primary" href="/customer/create/"> <i class="fa fa-fw fa-plus-circle"></i> Quick Add</a></div>
									...
									<tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                ...
                                                {{ Form::text('from', {{$data->from}}, ['class' => "form-control", 'placeholder' => "From"]) }}
										...
										<td bgcolor="">
											<div class="col-sm-10 form-group">
                                                ...
                                                {{ Form::text('to', {{$data->to}}, ['class' => "form-control", 'placeholder' => "To"]) }}
									  ...
									  <tr>
										<td bgcolor=""><div class="col-sm-8 form-group">
                                               ...
                                               <select name="driverName" id="driverName" class="form-control" value="{{$data->customerName}}" placeholder="Select">
                                                  @foreach($drivers as $driv)
													<option value="{{$driv->firstName}}">{{$driv->firstName}}
													</option>
                                                  @endforeach

                                                </select> 
                                            </div> <div> <label></label><br>
												<a class="btn btn-primary" href="/driver/create"> <i class="fa fa-fw fa-plus-circle"></i>Quick Add</a></div></td>
                                          ...
                                          <td><div class="col-sm-8 form-group">
                                               ...
                                               <select name="truckNo" id="truckNo" class="form-control" placeholder="Select">
                                                  @foreach($trucks as $truck)
													<option value="{{$truck->truckNo}}">{{$truck->truckNo}}
													</option>
                                                  @endforeach

                                                </select> </div> <div> <label></label><br>
												<a class="btn btn-primary" href="http://testlayout.net/admin/add_truck.php"> <i class="fa fa-fw fa-plus-circle"></i>Quick Add</a></div>
									 ...
									 <tr> <td colspan="2" bgcolor="#009688"> <strong><font color="white">Pickup</font> </strong></td> </tr>
									 
									 <tr>
										<td bgcolor=""><div class="col-sm-8 form-group">
                                                 <label>Shipper <font color="red">*</font></label>
                                               <select name="shipper" id="shipper" class="form-control" placeholder="Enter Guardian Name">
                                                  @foreach($shippers as $shipper)
													<option value="{{$shipper->companyName}}">{{$shipper->companyName}}
													</option>
                                                  @endforeach

                                                </select> </div> <div> <label></label><br>
												<a class="btn btn-primary" href="http://testlayout.net/admin/add_shipper.php"> <i class="fa fa-fw fa-plus-circle"></i>Quick Add</a></div></td>
                                               ...
                                               <label>Pickup Date <font color="red">*</font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                    ...
                                                    <input type="date" name="pickup" class="form-control pull-right" id="date_reported" required="">
                                                   </div>
                                            </div>
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                <label>BOL</label>
                                                 <input type="text" name="bol" class="form-control" placeholder="Enter bill of lading" required="">
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                                ...
                                                <input type="text" name="customerInfo" class="form-control" placeholder="Enter Customer Required Infog" required="">
										...
										<td bgcolor=""><div class="col-sm-10 form-group">
                                          ...
                                          <td><div class="col-sm-8 form-group">
                                               ...
                                               <input type="text" name="quantity" class="form-control" placeholder="Enter Quantity" required="">
												 ...
												 <select name="unit" id="p_id" placeholder="Enter Guardian Name">
                                     ...
                                     <label>Note</label><br>
                                     <textarea name="comments" class="form-control" rows="1" placeholder="problem">                                     </textarea>
                                 </div>
											</td> 
                                     </tr>
									 ...
									 <tr> <td colspan="2" bgcolor="#009688"> <strong><font color="white">Delivery</font> </strong></td> </tr>
									 
									 <tr>
										<td bgcolor=""><div class="col-sm-8 form-group">
                                                 <label>Consignee <font color="red">*</font></label>
                                               <select name="delivery" id="delivery" class="form-control" placeholder="Enter Consignee">
                                                  @foreach($deliveries as $delivery)
													<option value="{{$delivery->companyName}}">{{$delivery->companyName}}
													</option>
                                                  @endforeach

                                                </select> </div> <div> <label></label><br>
												<a class="btn btn-primary" href="delivery/create"> <i class="fa fa-fw fa-plus-circle"></i>Quick Add</a></div></td>
                                               ...
                                               <label>Pickup Date <font color="red">*</font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                    ...
                                                    <input type="date" name="deliveryDate" class="form-control pull-right" id="date_reported" required="">
                                                   </div>
                                            </div>
									  ...
									  <tr> <td colspan="2" bgcolor="#009688"> <strong><font color="white">Fees / Charges </font> </strong></td> </tr>
									 
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                 <label>Primary Fee </label>
                                                 <input type="text" name="primaryFee" class="form-control" placeholder="$ 0.00" required="">
											   </div></td>

    
                                          <td><div class="col-sm-10 form-group">
                                               <label>Primary Fee Type</label>
                                                 <select name="primaryFeeType" id="primaryFeeType" class="form-control" placeholder="Enter Guardian Name">
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                 ...
                                                 <input type="text" name="fscAmount" class="form-control" placeholder="$ 0.00" required="">
											   </div></td>

    
                                          <td><div class="col-sm-10 form-group">
                                               <label>FSC Amount Type</label>
                                                 <select name="fscAmountType" id="fscAmountType" class="form-control" placeholder="Enter Guardian Name">
                                                  <option value="Flat Fee">  Flat Fee</option>
                                                  <option value="Per Mile"> Per Mile</option>
									 ...
									 <tr> <td colspan="2" bgcolor="#009688"> <strong><font color="white">Accessory Fees </font> </strong></td> </tr>
									 
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                 <label>Additional </label>
                                                 <input type="text" name="additional" class="form-control" placeholder="$ 0.00" required="">
											   </div></td>
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               <label>Detention</label>
												  ...
												  <input type="text" name="detention" class="form-control" placeholder="$ 0.00" required="">
												 </div>
									  ...
									  <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                 <label>Lumper</label>
                                                 <input type="text" name="lumper" class="form-control" placeholder="$ 0.00" required="">
											   </div></td>
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               <label>Stop Off</label>
												  ...
												  <input type="text" name="topoff" class="form-control" placeholder="$ 0.00" required="">
												 </div>
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                 ...
                                                 <input type="text" name="tarp" class="form-control" placeholder="$ 0.00" required="">
											   </div></td>
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               <label>Invoice Advance</label>
												  ...
												  <input type="text" name="invoiceAdvance" class="form-control" placeholder="$ 0.00" required="">
												 </div>
