...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/tables/datatables/extensions/jszip/jszip.min.js')}}"></script>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/datatables_extension_buttons_html5.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="datatable_extension_buttons_html5">HTML5 buttons</a></li>
											</ul>
										</li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Datatables</span> - HTML5 Buttons</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="datatable_extension_buttons_html5">Datatables</a></li>
							<li class="active">HTML5 buttons</li>
						</ul>
