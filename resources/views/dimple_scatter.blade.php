...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/scatter/scatter_basic.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/scatter/scatter_horizontal_lollipop.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/scatter/scatter_vertical_lollipop.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/scatter/scatter_lollipop_grouped.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/scatter/scatter_matrix.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="dimple_scatter">Scatter charts</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Dimple</span> - Scatter Charts</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="dimple_scatter">Dimple</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Basic scatter chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Horizontal lollipop chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Vertical lollipop chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Grouped horizontal lollipop</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Scatter dot matrix</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
