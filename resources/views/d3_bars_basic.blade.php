...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/d3/bars/bars_basic_vertical.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/bars/bars_basic_horizontal.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/bars/bars_basic_tooltip.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/bars/bars_basic_grouped.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/bars/bars_basic_stacked.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/bars/bars_basic_stacked_normalized.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="d3_bars_basic">Simple bars</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">D3</span> - Basic Bars</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="d3_bars_basic">D3</a></li>
							<li class="active">Basic bars</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Vertical bar chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Horizontal bar chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">Example of simple <code>horizontal</code> bar chart based on <code>D3.js</code> library. This simple bar chart is constructed from a TSV file storing the demo data. The chart employs conventional margins and a number of D3 features: <code>d3.tsv</code> - load and parse data; <code>d3.format</code> - format percentages; <code>d3.scale.ordinal</code> - x-position encoding; <code>d3.scale.linear</code> - y-position encoding; <code>d3.max</code> - compute domains; <code>d3.svg.axis</code> - display axes.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Tooltip implementation</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Grouped bar chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<p class="content-group">This <code>stacked</code> bar chart is constructed from a CSV file storing the demo data. The chart employs conventional margins and a number of D3 features: <code>d3.csv</code> - load and parse data; <code>d3.scale.ordinal</code> - x-position encoding and color encoding; <code>d3.scale.linear</code> - y-position encoding; <code>d3.format</code> - SI prefix formatting (e.g., “10M” for 10,000,000); <code>d3.max</code> - compute domains; <code>d3.keys</code> - compute column names; <code>d3.svg.axis</code> - display axes.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Normalized stacked bar chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
