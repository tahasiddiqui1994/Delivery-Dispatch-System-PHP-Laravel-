...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/area/area_vertical.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/area/area_vertical_stacked.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/area/area_vertical_stacked_normalized.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/area/area_vertical_grouped.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/area/area_vertical_stacked_grouped.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="dimple_area_vertical">Vertical orientation</a></li>
											</ul>
										</li>
										<li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Dimple</span> - Vertical Areas</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="dimple_area_vertical">Dimple</a></li>
							<li class="active">Vertical areas</li>
						</ul>
