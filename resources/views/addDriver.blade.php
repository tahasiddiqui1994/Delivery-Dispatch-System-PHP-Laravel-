                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="ekiAi16e04">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="ekiAi16e04" data-index="0">
                                <div class="panel-heading ui-sortable-handle">
                                    <div class="btn-group"> 
                                        <a style="background-color:#26a69a; border-color: #26a69a" class="btn btn-primary" href="/driver/"> <i class="fa fa-plus"></i> View Drivers</a>  
                                    </div>
								...
								<tr>
									<td bgcolor="">
										<div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('streetNo', old('streetNo'), [ 'required'=>"", 'class' => "form-control", 'placeholder' => "Enter Street"]) }}
									...
									<td>
										<div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('aptOrSuiteOrOther', old('aptOrSuiteOrOther'), ['class' => "form-control", 'placeholder' => "Enter Apt/Suite/Other"]) }}
								...
								<tr>
					    			...
					    			<td>
					    				<div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('state', old('state'), [ 'required'=>"", 'class' => "form-control", 'placeholder' => "Enter state"]) }}
								...
								<tr>
									<td bgcolor="">
										<div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('zipCode', old('zipCode'), ['class' => "form-control", 'placeholder' => "Enter Zip code"]) }}
                                    ...
                                    <td>
                                       	<div class="col-sm-10 form-group">
                                            <label>Phone Number</label>
                                               ...
                                               {{ Form::text('phoneNo', old('phoneNo'), ['class' => "form-control", 'placeholder' => "Enter Phone no."]) }}
								...
								<tr>
                                    ...
                                    <td>
	                                    <div class="col-sm-10 form-group">
											<label>Medical Card Renewal</label>
											<div class="input-group date">
												<div class="input-group-addon">
													<i class="icon-calendar22"></i>
												</div>

												<input value="{{old('medicalCardRenewal')}}" name="medicalCardRenewal" type="text" class="form-control daterange-single pull-right">
                                    ...
                                    <td>
                                        <div class="col-sm-10 form-group">
                                            <label>Phone<font color="red">*</font>
                                               ...
                                               {{ Form::text('emergencyPhoneNo', old('emergencyPhoneNo'), [ 'required'=>"", 'class' => "form-control", 'placeholder' => "Enter Person No."]) }}
										</div>
									</td> 
                                </tr>
