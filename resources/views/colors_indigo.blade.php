...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/colors_indigo.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="colors_indigo">Indigo palette</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Colors</span> - Indigo Palette</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="colors_indigo">Colors</a></li>
							<li class="active">Indigo palette</li>
						</ul>
				...
				<div class="content">
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#283593</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#indigo_800"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#303F9F</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#indigo_700"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#3949AB</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#indigo_600"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#3F51B5</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#indigo_500"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#5C6BC0</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#indigo_400"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#7986CB</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#indigo_300"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="content-group-lg">
					    ...
					    <!-- Solid alert -->
					    <div class="alert bg-indigo alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Close</span></button>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.text-indigo</code> classes</p>
								</div>

								<input type="text" class="form-control text-indigo text-uppercase text-semibold text-size-small" value="Input field text">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-indigo</code> or classes</p>
								</div>

								<input type="text" class="form-control border-indigo border-lg" placeholder="Input field border">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-indigo</code> classes</p>
								</div>

								<input type="text" class="form-control bg-indigo" placeholder="Input field background">
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo">
								...
								<div class="has-feedback">
									<input type="text" class="form-control bg-indigo" placeholder="Icon feedback, indigo input">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo">
								...
								<select class="form-control bg-indigo">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo">
								...
								<div class="input-group">
									<span class="input-group-addon bg-indigo"><i class="icon-menu7"></i></span>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo">
								...
								<div class="input-group">
									<span class="input-group-addon bg-indigo-700"><i class="icon-lock2"></i></span>
									<input type="text" class="form-control bg-indigo" placeholder="Solid background color">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo text-center">
								...
								<label class="radio-inline">
									<input type="radio" class="styled" name="indigo-radio" checked="checked">
									Selected
								</label>

								<label class="radio-inline">
									<input type="radio" class="styled" name="indigo-radio">
									Unselected
								</label>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-indigo</code> or classes</p>

									<select class="selectbox bg-indigo">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo">
								<div class="text-center">
									...
									<select class="bootstrap-select" data-style="bg-indigo">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										<ul class="nav nav-tabs bg-indigo">
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										...
										<div class="tab-content bg-indigo">
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo text-center">
								...
								<span class="label bg-indigo">Indigo label</span>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo text-center">
								...
								<span class="badge bg-indigo">390</span>
							</div>
				    	</div>
				    </div>
				    <!-- /text options -->
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-indigo progress-bar-striped" style="width: 65%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-indigo progress-bar-striped active" style="width: 75%">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo text-center">
								...
								<button type="button" class="btn bg-indigo"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo text-center">
								...
								<button type="button" class="btn bg-indigo btn-labeled"><b><i class="icon-menu7"></i></b> Labeled button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo text-center">
								...
								<button type="button" class="btn text-indigo-800 border-indigo btn-flat"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    </div>
				    <!-- /buttons -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel">
								<div class="panel-heading bg-indigo">
									<h6 class="panel-title">Indigo panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Indigo panel using <code>.bg-indigo</code> class added to the panel heading
								</div>
							</div>
				    	</div>

				    	<div class="col-md-4">
				    		<div class="panel border-indigo">
								<div class="panel-heading bg-indigo">
									<h6 class="panel-title">Indigo bordered panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Bordered indigo panel using <code>.bg-indigo</code> and <code>.border-indigo</code> classes
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel bg-indigo">
								<div class="panel-heading">
									<h6 class="panel-title">Indigo solid panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Solid indigo panel using <code>.bg-indigo</code> class added to the panel container
								</div>
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo text-center">
								...
								<button type="button" class="btn bg-indigo" data-popup="tooltip-custom" title="Indigo tooltip" data-placement="bottom" data-container="body"><i class="icon-comment position-left"></i> Tooltip</button>
							</div>
				    	</div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo text-center">
								...
								<button type="button" class="btn bg-indigo" data-toggle="modal" data-target="#modal_indigo"><i class="icon-menu7 position-left"></i> Modal dialog</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo text-center">
								...
								<p class="mb-15 text-muted">Using <code>.bg-indigo</code> color classes</p>

								<button class="btn bg-indigo growl-launch">jGrowl notification</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo text-center">
								...
								<button class="btn bg-indigo pnotify-launch">Pnotify notification</button>
							</div>
				    	</div>
				    </div>
				    <!-- /notifications and dialogs -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-indigo</code> color classes</p>
								</div>

								<ul class="dropdown-menu border-indigo border-lg" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo">
								...
								<ul class="dropdown-menu bg-indigo" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-indigo">
								...
								<ul class="dropdown-menu bg-indigo" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> <span class="label bg-indigo pull-right">Label</span> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> <span class="badge bg-indigo pull-right">98</span> Another action</a></li>
									<li class="divider"></li>
