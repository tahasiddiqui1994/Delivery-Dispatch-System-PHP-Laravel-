...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="form_inputs_grid">Inputs grid</a></li>
									</ul>
								</li>
								<li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Forms</span> - Inputs Grid</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="form_inputs_grid">Forms</a></li>
				...
				<div class="content">
	                ...
	                <div class="row">
	                    <div class="col-lg-6">
				            <div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Right inputs</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
				                	...
				                	<form action="#" class="form-horizontal">
										...
										<div class="form-group">
											<div class="col-md-11 col-md-offset-1">
				                                <input type="text" class="form-control" placeholder="col-md-11 col-md-offset-1">
											</div>
										</div>

										<div class="form-group">
											<div class="col-md-10 col-md-offset-2">
				                                <input type="text" class="form-control" placeholder="col-md-10 col-md-offset-2">
											</div>
										</div>

										<div class="form-group">
											<div class="col-md-9 col-md-offset-3">
				                                <input type="text" class="form-control" placeholder="col-md-9 col-md-offset-3">
											</div>
										</div>

										<div class="form-group">
											<div class="col-md-8 col-md-offset-4">
				                                <input type="text" class="form-control" placeholder="col-md-8 col-md-offset-4">
											</div>
										</div>

										<div class="form-group">
											<div class="col-md-7 col-md-offset-5">
				                                <input type="text" class="form-control" placeholder="col-md-7 col-md-offset-5">
											</div>
										</div>

										<div class="form-group">
											<div class="col-md-6 col-md-offset-6">
				                                <input type="text" class="form-control" placeholder="col-md-6 col-md-offset-6">
											</div>
										</div>

										<div class="form-group">
											<div class="col-md-5 col-md-offset-7">
				                                <input type="text" class="form-control" placeholder="col-md-5 col-md-offset-7">
											</div>
										</div>

										<div class="form-group">
											<div class="col-md-4 col-md-offset-8">
				                                <input type="text" class="form-control" placeholder="col-md-4 col-md-offset-8">
											</div>
										</div>
	                    ...
	                    <div class="col-lg-6">
				            <div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Left inputs</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
		            ...
		            <div class="row">
		                <div class="col-lg-6">
				            <div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Centered horizontal inputs</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
				                ...
				                <div class="panel-body">
				                	<form action="#" class="form-horizontal">
										<div class="form-group">
											<label class="control-label col-lg-2 text-right">Label</label>
											<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-md-10 col-md-offset-1">
												<div class="row">
													<label class="control-label col-lg-2 text-right">Label</label>
													<div class="col-lg-10">
						                                <input type="text" class="form-control" placeholder="col-md-10 col-md-offset-1">
					                                </div>
				                                </div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-md-8 col-md-offset-2">
												<div class="row">
													<label class="control-label col-lg-2 text-right">Label</label>
													<div class="col-lg-10">
						                                <input type="text" class="form-control" placeholder="col-md-8 col-md-offset-2">
					                                </div>
				                                </div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-md-6 col-md-offset-3">
												<div class="row">
													<label class="control-label col-lg-2 text-right">Label</label>
													<div class="col-lg-10">
						                                <input type="text" class="form-control" placeholder="col-md-6 col-md-offset-3">
					                                </div>
				                                </div>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-md-4 col-md-offset-4">
												<div class="row">
													<label class="control-label col-lg-4 text-right">Label</label>
													<div class="col-lg-8">
						                                <input type="text" class="form-control" placeholder="col-md-4 col-md-offset-4">
					                                </div>
				                                </div>
											</div>
										</div>
		                ...
		                <div class="col-lg-6">
				            <div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Centered vertical inputs</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
					...
					<div class="row">
						<div class="col-md-6">
				            <div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Vertical row label</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
						...
						<div class="col-md-6">
				            <div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Vertical input label</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
		            ...
		            <div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title">Horizontal row labels</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
		            ...
		            <div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title">Horizontal input labels</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
		            ...
		            <div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title">Multiple vertical inputs</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
		            ...
		            <div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title">Multiple horizontal inputs</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
		                ...
		                <div class="panel-body">
		                	<form class="form-horizontal" action="#">
								<div class="form-group">
									<label class="col-lg-2 control-label">First form group</label>
									<div class="col-lg-10">
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
