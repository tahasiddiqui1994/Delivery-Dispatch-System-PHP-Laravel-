...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="{{url('assets/js/plugins/tables/datatables/datatables.min.js')}}">
	</script>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/forms/selects/select2.min.js')}}">
	</script>
	<script type="text/javascript" src="{{url('assets/js/pages/datatables_basic.js')}}">
	</script>
	<!-- /theme JS files -->
...
@if(Auth::user()->type == "admin")
	                        ...
	                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="cpa90TSeTV">
	                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="cpa90TSeTV" data-index="0">
	                                <div class="panel-heading ui-sortable-handle">
	                                    <div class="btn-group"> 
	                                       <a style="background-color:#26a69a; border-color: #26a69a"  class="btn btn-success" href="\driver\"> <i class="fa fa-plus"></i> Go back</a> 
	                                    </div>
	                ...
	                <div class=" col-md-9 col-lg-9 "> 
	                  <table class="table table-user-information" style="align-items: center;">
	                    <tbody>
	                      ...
	                      <tr>
	                        ...
	                        <td>{{$data->paymentType}}</td>
	                         ...
	                         <tr>
	                             <tr>
	                        <td>Address</td>
	                        <td>{{$data->streetNo}}, {{$data->city}}, {{$data->state}}</td>
	                      </tr>
	                        <tr>
	                        <td>Phone-No</td>
	                        <td>{{$data->phoneNo}}</td>
	                      ...
	                      <tr>
	                        <td>Medical Renewal Date</td>
	                        <td>{{$data->medicalCardRenewal}} </td>
	                      </tr>
	                      <tr>
	                        <td>Hire Date</td>
	                        <td>{{$data->hireDate}}</td>
	...
	<!--                        <a data-original-title="Broadcast Message" data-toggle="tooltip" type="button" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-envelope"></i></a>-->
	                        <span class="pull-right">
	                            <a title="Edit" href="/driver/{{$data->id}}/edit" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-info btn-xs"><i class="glyphicon glyphicon-edit"></i></a>
	                            <a title="Delete" href="/driver/{{$data->id}}/destroy" data-original-title="Remove this user" data-toggle="tooltip" type="button" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-remove"></i></a>&nbsp;
	                        </span>
	                    </div>
