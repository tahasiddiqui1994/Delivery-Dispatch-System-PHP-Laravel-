...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/colors_success.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="colors_success">Success palette</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Colors</span> - Success Palette</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="colors_success">Colors</a></li>
							<li class="active">Success palette</li>
						</ul>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#2E7D32</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#success_800"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#388E3C</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#success_700"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#43A047</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#success_600"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#4CAF50</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#success_500"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#66BB6A</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#success_400"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#81C784</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#success_300"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.text-success</code> classes</p>
								</div>

								<input type="text" class="form-control text-success text-uppercase text-semibold text-size-small" value="Input field text">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-success</code> or classes</p>
								</div>

								<input type="text" class="form-control border-success border-lg" placeholder="Input field border">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-success</code> classes</p>
								</div>

								<input type="text" class="form-control bg-success" placeholder="Input field background">
							</div>
				    	</div>
				    </div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success">
								...
								<div class="has-feedback">
									<input type="text" class="form-control bg-success" placeholder="Icon feedback, success input">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success">
								...
								<div class="input-group">
									<span class="input-group-addon bg-success"><i class="icon-menu7"></i></span>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success">
								...
								<div class="input-group">
									<span class="input-group-addon bg-success-700"><i class="icon-lock2"></i></span>
									<input type="text" class="form-control bg-success" placeholder="Solid background color">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success text-center">
								...
								<label class="radio-inline">
									<input type="radio" class="styled" name="success-radio" checked="checked">
									Selected
								</label>

								<label class="radio-inline">
									<input type="radio" class="styled" name="success-radio">
									Unselected
								</label>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-success</code> or classes</p>

									<select class="selectbox bg-success">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success">
								<div class="text-center">
									...
									<select class="bootstrap-select" data-style="bg-success">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success text-center">
								...
								<span class="label bg-success">Success label</span>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success text-center">
								...
								<span class="badge bg-success">390</span>
							</div>
				    	</div>
				    </div>
				    <!-- /text options -->
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-success progress-bar-striped active" style="width: 75%">
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											<tr>
												<td>1</td>
												<td class="success">Eugene</td>
												<td>Kopyov</td>
												<td class="bg-success">@Kopyov</td>
											</tr>
											<tr>
												<td>2</td>
												<td class="success">Victoria</td>
												<td>Baker</td>
												<td class="bg-success">@Vicky</td>
											</tr>
											<tr>
												<td>3</td>
												<td class="success">James</td>
												<td>Alexander</td>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success text-center">
								...
								<button type="button" class="btn bg-success"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success text-center">
								...
								<button type="button" class="btn bg-success btn-labeled"><b><i class="icon-menu7"></i></b> Labeled button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success text-center">
								...
								<button type="button" class="btn text-success-800 border-success btn-flat"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    </div>
				    <!-- /buttons -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel">
								<div class="panel-heading bg-success">
									<h6 class="panel-title">Success panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Success panel using <code>.bg-success</code> class added to the panel heading
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel border-success">
								<div class="panel-heading bg-success">
									<h6 class="panel-title">Success bordered panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Bordered success panel using <code>.bg-success</code> and <code>.border-success</code> classes
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel bg-success">
								<div class="panel-heading">
									<h6 class="panel-title">Success solid panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Solid success panel using <code>.bg-success</code> class added to the panel container
								</div>
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success text-center">
								...
								<button type="button" class="btn bg-success" data-popup="tooltip-custom" title="Success tooltip" data-placement="bottom" data-container="body"><i class="icon-comment position-left"></i> Tooltip</button>
							</div>
				    	</div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success text-center">
								...
								<button type="button" class="btn bg-success" data-toggle="modal" data-target="#modal_success"><i class="icon-menu7 position-left"></i> Modal dialog</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success text-center">
								...
								<p class="mb-15 text-muted">Using <code>.bg-success</code> color classes</p>

								<button class="btn bg-success growl-launch">jGrowl notification</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success text-center">
								...
								<button class="btn bg-success pnotify-launch">Pnotify notification</button>
							</div>
				    	</div>
				    </div>
				    <!-- /notifications and dialogs -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-success</code> color classes</p>
								</div>

								<ul class="dropdown-menu border-success border-lg" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success">
								...
								<ul class="dropdown-menu bg-success" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-success">
								...
								<ul class="dropdown-menu bg-success" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> <span class="label bg-success pull-right">Label</span> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> <span class="badge bg-success pull-right">98</span> Another action</a></li>
									<li class="divider"></li>
