...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/layout_navbar_hideable.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="layout_navbar_hideable">Hideable navbar</a></li>
