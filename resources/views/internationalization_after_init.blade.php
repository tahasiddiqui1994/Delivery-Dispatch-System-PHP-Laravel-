							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="internationalization_after_init" data-i18n="nav.int.afterinit"></a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Translation</span> - Set After Init</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="internationalization_after_init">Translation</a></li>
							<li class="active">Set after init</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Language after init</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<p class="content-group">Example of languages that can be set <code>after init</code>. Basically, direct language switching is based on this option: i18next library sets the language based on user navigator on init, this language can be changed to any available language after initinalization by calling <code>i18n.setLng(...)</code> function. Since i18next uses cookies by default, after page reload you'll see the language that you've selected before reload.</p>

							<p class="text-semibold">Set language after init:</p>
