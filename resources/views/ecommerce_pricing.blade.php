									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="ecommerce_pricing">Pricing tables</a></li>
											</ul>
										</li>
									</ul>
								</li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">ECommerce</span> - Pricing Tables</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="ecommerce_pricing">ECommerce</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Table view
						<small class="display-block">Simple table with content</small>
					</h6>
							...
							<table class="table table-hover table-striped table-bordered text-center">
				    			<thead>
				    				<tr>
				    					...
				    					<th class="text-center">
				    						<h6 class="text-semibold mt-5 mb-5">Basic</h6>
				    						<h4 class="text-semibold no-margin">
				    							€25
				    							<span class="text-size-base text-muted text-regular">/ month</span>
			    							</h4>
			    						</th>
				    					<th class="text-center">
				    						<h6 class="text-semibold mt-5 mb-5">Professional</h6>
				    						<h4 class="text-semibold no-margin">
				    							€35
				    							<span class="text-size-base text-muted text-regular">/ month</span>
			    							</h4>
				    					...
				    					<th class="text-center">
				    						<h6 class="text-semibold mt-5 mb-5">Business</h6>
				    						<h4 class="text-semibold no-margin">
				    							€49
				    							<span class="text-size-base text-muted text-regular">/ month</span>
			    							</h4>
				    					...
				    					<th class="text-center">
				    						<h6 class="text-semibold mt-5 mb-5">Enterprise</h6>
				    						<h4 class="text-semibold no-margin">
				    							€60
				    							<span class="text-size-base text-muted text-regular">/ month</span>
			    							</h4>
				    			...
				    			<tbody>
				    				...
				    				<tr class="border-solid">
				    					<td> </td>
				    					<td><a class="btn bg-blue" href="#"><i class="icon-cart position-left"></i> Order</a></td>
				    					<td><a class="btn bg-blue" href="#"><i class="icon-cart position-left"></i> Order</a></td>
				    					<td><a class="btn bg-blue" href="#"><i class="icon-cart position-left"></i> Order</a></td>
				    					<td><a class="btn bg-blue" href="#"><i class="icon-cart position-left"></i> Order</a></td>
				    				</tr>
					...
					<h6 class="content-group text-semibold">
						Seamless panels
						<small class="display-block">Panel with pricing boxes</small>
					</h6>
	                ...
	                <div class="panel pricing-table pricing-table-panel" style="margin-bottom: 40px;">
		                <div class="row row-seamless">
		                    ...
		                    <div class="col-sm-6 col-lg-3">
	                            <div class="pricing-table-body">
	                                <h4>Business</h4>
	                                <h1 class="pricing-table-price"><span>$</span>39</h1>
	                                <ul class="list-unstyled content-group">
	                                ...
	                                <a href="#" class="btn bg-indigo-400 btn-lg text-uppercase text-size-small text-semibold">Purchase</a>
	                            </div>
		                    ...
		                    <div class="col-sm-6 col-lg-3">
	                            <div class="pricing-table-body">
	                                <h4>Corporate</h4>
	                                <h1 class="pricing-table-price"><span>$</span>49</h1>
	                                <ul class="list-unstyled content-group">
		                    ...
		                    <div class="col-sm-6 col-lg-3">
	                            <div class="pricing-table-body">
	                                <h4>Enterprise</h4>
	                                <h1 class="pricing-table-price"><span>$</span>59</h1>
	                                <ul class="list-unstyled content-group">
					...
					<h6 class="content-group text-semibold">
						Color highlight
						<small class="display-block">Custom color background</small>
					</h6>
	                    ...
	                    <div class="col-sm-6 col-lg-3">
	                        <div class="panel text-center">
	                            <div class="panel-body">
	                                ...
	                                <a href="#" class="btn bg-pink-400 btn-lg text-uppercase text-size-small text-semibold">Purchase</a>
	                            </div>
	                        </div>
	                    </div>
	                    ...
	                    <div class="col-sm-6 col-lg-3">
	                        <div class="panel text-center bg-pink-400">
	                            <div class="panel-body">
	                                ...
	                                <a href="#" class="btn bg-pink-800 btn-lg text-uppercase text-size-small text-semibold">Purchase</a>
