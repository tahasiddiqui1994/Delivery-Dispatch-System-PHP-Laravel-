					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<!-- Main -->
								<li class="navigation-header"><span>Main <span class="label bg-slate">Category</span></span> <i class="icon-menu" title="Main pages"></i></li>
...
								<!-- /main -->
								...
								<li>
									<a href="#"><i class="icon-footprint"></i> <span>Wizards <span class="label bg-teal-400">With child</span></span></a>
									<ul>
								...
								<!-- Appearance -->
								<li class="navigation-header"><span>Appearance <span class="badge bg-purple-300">239</span></span> <i class="icon-menu" title="Appearance"></i></li>
								<li>
								...
								<li>
									<a href="#"><i class="icon-spinner2 spinner"></i> <span>Animations <span class="badge bg-blue-400">9</span></span></a>
									<ul>
								...
								<!-- Layout -->
								<li class="navigation-header"><span>Layout <span class="label label-transparent">Text label</span></span> <i class="icon-menu" title="Layout options"></i></li>
								<li>
								...
								<li>
									...
									<ul>
										...
										<li><a href="navigation_vertical_accordion">Accordion menu <span class="label label-transparent">Default</span></a></li>
										...
										<li class="active"><a href="navigation_vertical_labels_badges">Labels and badges <span class="label label-transparent">New</span></a></li>
								...
								<li>
									<a href="#"><i class="icon-tree5"></i> <span>Menu levels <span class="label label-transparent">40</span></span></a>
									<ul>
								...
								<li>
									<a href="#"><i class="icon-graph"></i> <span>Echarts library <span class="label bg-teal-400">Popular</span></span></a>
									<ul>
								...
								<li>
									<a href="#"><i class="icon-stats-bars"></i> <span>C3 library <span class="label bg-slate">V 3.29</span></span></a>
									<ul>
								...
								<li>
									<a href="#"><i class="icon-popout"></i> <span>JQuery UI <span class="label bg-brown-400">Updated</span></span></a>
									<ul>
								...
								<li>
									<a href="#"><i class="icon-grid7"></i> <span>Data tables <span class="label bg-warning-400">U</span></span></a>
									<ul>
								...
								<li>
									<a href="#"><i class="icon-file-spreadsheet"></i> <span>Handsontable <span class="badge bg-teal-400">40+</span></span></a>
									<ul>
								...
								<li>
									<a href="#"><i class="icon-cash3"></i> <span>Invoicing <span class="label bg-purple-300">$25,900</span></span></a>
									<ul>
								...
								<li>
									<a href="#"><i class="icon-lifebuoy"></i> <span>Support <span class="label bg-info">Updated</span></span></a>
									<ul>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Vertical Nav</span> - Labels &amp; Badges</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navigation_vertical_labels_badges">Vertical nav</a></li>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Labels and badges in navigation</h6>
						Navigation menu items can contain labels and badges in all navigation levels. The can be either colored or transparent. Parent level labels/badges have the same style in active item - white color without background. Same for mini sidebar labels.
				    </div>
				    <!-- /info alert -->
