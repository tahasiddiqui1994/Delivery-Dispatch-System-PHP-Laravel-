...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/pickers/datepicker.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/pagination/bootpag.min.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/pagination/bs_pagination.min.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/pagination/datepaginator.min.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/pages/components_pagination.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_pagination">Pagination</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Components</span> - Pagination</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="components_pagination">Components</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Pagination layouts
						<small class="display-block">Basic pagination layout examples</small>
					</h6>
					<!-- /pagination layouts title -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Bordered pagination</h6>
								<p class="content-group-sm text-muted">Default bordered pagination</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Flat pagination</h6>
								<p class="content-group-sm text-muted">Using <code>pagination-flat</code> class</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Separated pagination</h6>
								<p class="content-group-sm text-muted">Using <code>pagination-separated</code> class</p>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Bordered rounded</h6>
								<p class="content-group-sm text-muted">Using <code>.pagination-rounded</code> class</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Flat rounded</h6>
								<p class="content-group-sm text-muted">Using <code>.pagination-rounded-all</code> class</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Separated rounded</h6>
								<p class="content-group-sm text-muted">Using <code>.pagination-rounded-all</code> class</p>
					...
					<h6 class="content-group text-semibold">
						Pagination options
						<small class="display-block">Pagination sizes and positions</small>
					</h6>
					<!-- /pagination options title -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Bordered pagination</h6>
								<p class="content-group-sm text-muted">Sizes of a <code>default</code> pagination</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Flat pagination</h6>
								<p class="content-group-sm text-muted">Sizes of a <code>flat</code> pagination</p>

								<div class="content-group-sm">
									<ul class="pagination pagination-flat pagination-lg">
										<li><a href="#">&lsaquo;</a></li>
										<li class="active"><a href="#">1</a></li>
										<li><a href="#">2</a></li>
										<li><a href="#">3</a></li>
								...
								<ul class="pagination pagination-flat pagination-xs">
									<li><a href="#">&lsaquo;</a></li>
									<li class="active"><a href="#">1</a></li>
									<li><a href="#">2</a></li>
									<li><a href="#">3</a></li>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Separated pagination</h6>
								<p class="content-group-sm text-muted">Sizes of a <code>separated</code> pagination</p>
								...
								<div class="content-group-sm">
									<ul class="pagination pagination-separated pagination-sm">
										<li><a href="#">&lsaquo;</a></li>
										<li class="active"><a href="#">1</a></li>
										<li><a href="#">2</a></li>
										<li><a href="#">3</a></li>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Left position</h6>
									<p class="content-group-sm text-muted">Default left pagination position</p>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Center position</h6>
									<p class="content-group-sm text-muted">Centered pagination position</p>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Right position</h6>
									<p class="content-group-sm text-muted">Right pagination position</p>
								</div>
					...
					<h6 class="content-group text-semibold">
						Pager component
						<small class="display-block">Simple pager component</small>
					</h6>
					<!-- /pager title -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Default pager</h6>
								<p class="content-group-sm text-muted">Basic pager example</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Aligned pager links</h6>
								<p class="content-group-sm text-muted">Links aligned to the sides</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								...
								<p class="content-group-sm text-muted">Pager with <code>disabled</code> utility class</p>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Rounded pager</h6>
								<p class="content-group-sm text-muted">Example of a <code>rounded</code> pager</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Aligned pager links</h6>
								<p class="content-group-sm text-muted">Aligned <code>rounded</code> links</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Disabled state</h6>
								<p class="content-group-sm text-muted">Disabled state of <code>rounded</code> link</p>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Linked pager</h6>
								<p class="content-group-sm text-muted">Pager buttons as grouped links</p>

								<ul class="pager pager-linked">
									<li><a href="#">&larr; Previous</a></li>
									<li><a href="#">Next &rarr;</a></li>
								</ul>
							</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Aligned pager links</h6>
								<p class="content-group-sm text-muted">Aligned <code>linked</code> buttons</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Disabled state</h6>
								<p class="content-group-sm text-muted">Disabled state of <code>linked</code> pager</p>
					...
					<h6 class="content-group text-semibold">
						Pager options
						<small class="display-block">Pager sizes and positions</small>
					</h6>
					<!-- /pager options title -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Default pager sizes</h6>
								<p class="content-group-sm text-muted">Large, default and small sizes</p>

								<ul class="pager pager-lg content-group-sm">
									<li><a href="#">&larr; Previous</a></li>
									<li><a href="#">Next &rarr;</a></li>
								</ul>

								<ul class="pager content-group-sm">
									<li><a href="#">&larr; Previous</a></li>
									<li><a href="#">Next &rarr;</a></li>
								</ul>

								<ul class="pager pager-sm content-group-sm">
									<li><a href="#">&larr; Previous</a></li>
									<li><a href="#">Next &rarr;</a></li>
								</ul>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Rounded pager sizes</h6>
								<p class="content-group-sm text-muted">Large, default and small sizes</p>

								<ul class="pager pager-rounded pager-lg content-group-sm">
									<li><a href="#">&larr; Previous</a></li>
									<li><a href="#">Next &rarr;</a></li>
								</ul>

								<ul class="pager pager-rounded content-group-sm">
									<li><a href="#">&larr; Previous</a></li>
									<li><a href="#">Next &rarr;</a></li>
								</ul>

								<ul class="pager pager-rounded pager-sm content-group-sm">
									<li><a href="#">&larr; Previous</a></li>
									<li><a href="#">Next &rarr;</a></li>
								</ul>

								<ul class="pager pager-rounded pager-xs">
									<li><a href="#">&larr; Previous</a></li>
									<li><a href="#">Next &rarr;</a></li>
								</ul>
							</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Linked pager sizes</h6>
								<p class="content-group-sm text-muted">Large, default and small sizes</p>

								<ul class="pager pager-linked pager-lg content-group-sm">
									<li><a href="#">&larr; Previous</a></li>
									<li><a href="#">Next &rarr;</a></li>
								</ul>

								<ul class="pager pager-linked content-group-sm">
									<li><a href="#">&larr; Previous</a></li>
									<li><a href="#">Next &rarr;</a></li>
								</ul>

								<ul class="pager pager-linked pager-sm content-group-sm">
									<li><a href="#">&larr; Previous</a></li>
									<li><a href="#">Next &rarr;</a></li>
								</ul>

								<ul class="pager pager-linked pager-xs">
									<li><a href="#">&larr; Previous</a></li>
									<li><a href="#">Next &rarr;</a></li>
								</ul>
							</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Left position</h6>
								<p class="content-group-sm text-muted">Optional <code>left</code> pager position</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Centered position</h6>
								<p class="content-group-sm text-muted">Default <code>centered</code> pager position</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Right position</h6>
								<p class="content-group-sm text-muted">Optional <code>right</code> pager position</p>
					...
					<!-- Bootpag pagination title -->
					<h6 class="content-group text-semibold">
						Dynamic pagination
						<small class="display-block">Based on <code>bootpag.js</code> plugin</small>
					</h6>
					<!-- /bootpag pagination title -->


					<!-- Bootpag pagination layouts -->
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Basic example</h6>
									<p class="content-group-sm text-muted">Basic example with default options</p>
								</div>

								<div class="well content-group content-default">Dynamic content goes here.</div>
								<div class="text-center bootpag-default"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Flat pagination</h6>
									<p class="content-group-sm text-muted">Example with <code>flat</code> pagination</p>
								</div>

								<div class="well content-group content-flat">Dynamic content goes here.</div>
								<div class="text-center bootpag-flat"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Separated pagination</h6>
									<p class="content-group-sm text-muted">Example with <code>separated</code> pagination</p>
								</div>

								<div class="well content-group content-separated">Dynamic content goes here.</div>
								<div class="text-center bootpag-separated"></div>
							</div>
						</div>
					</div>
					<!-- /bootpag pagination layouts -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal">
								...
								<div class="well content-group content-prev-next">Add text to the Prev and Next buttons</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Set starting page</h6>
									<p class="content-group-sm text-muted">Specify page to show on start</p>
								</div>

								<div class="well content-group content-page-start">Starting page is 3</div>
								<div class="text-center bootpag-page-start"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Plugin events</h6>
									<p class="content-group-sm text-muted">Using <code>.on('page')</code> click event</p>
								</div>

								<div class="well content-group content-callback">Bootpag events</div>
								<div class="text-center bootpag-callback"></div>
							</div>
						</div>
					</div>
					<!-- /bootpag pagination options -->
					...
					<h6 class="content-group text-semibold">
						<span class="text-semibold">TWBS</span> Pagination 
						<small class="display-block">Another dynamic pagination for Bootstrap</small>
					</h6>
					<!-- /dynamic pagination title -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								...
								<div class="well content-group twbs-content-default text-left">Dynamic content here.</div>
								<ul class="pagination-sm twbs-default"></ul>
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Flat pagination layout</h6>
								<p class="content-group-sm text-muted">Example with <code>flat</code> pagination</p>

								<div class="well content-group twbs-content-flat text-left">Dynamic content here.</div>
								<ul class="pagination-flat pagination-sm twbs-flat"></ul>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								...
								<div class="well content-group twbs-content-separated text-left">Dynamic content here.</div>
								<ul class="pagination-separated pagination-sm twbs-separated"></ul>
							</div>
						</div>
					</div>
					<!-- /dynamic pagination layouts -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								...
								<div class="well content-group twbs-content-prev-next text-left">Dynamic content here.</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								...
								<div class="well content-group twbs-content-page-start text-left">Dynamic content here.</div>
								<ul class="pagination-flat pagination-sm twbs-page-start"></ul>
							</div>
						</div>

						<div class="col-md-4">
							<div class="panel panel-body border-top-teal text-center">
								<h6 class="no-margin text-semibold">Visible pages</h6>
								<p class="content-group-sm text-muted">Display visible amount of pages</p>

								<div class="well content-group twbs-content-visible-pages text-left">Dynamic content here.</div>
								<ul class="pagination-flat pagination-sm twbs-visible-pages"></ul>
							</div>
						</div>
					</div>
					<!-- /dynamic pagination options -->
					...
					<h6 class="content-group text-semibold">
						Date paginator 
						<small class="display-block">Pagination with date picker</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Basic configuration</h6>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									<p class="content-group-sm">A jQuery plugin which takes Twitter Bootstrap's already great pagination component and injects a bit of date based magic. In the process creating a hugely simplified and modularised way of paging date based results in your application.</p>
									<div class="datepaginator-default"></div>
								</div>
							</div>

							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Set item width</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group-sm">Example below demonstrates custom item width using <code>itemWidth</code> option. Default item with is <code>35px</code>, you can set any custom width in pixels, total number of days displayed will be calculated based on this value.</p>
									<div class="datepaginator-item-width"></div>
								</div>
							</div>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Days format</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group-sm">Example below demonstrates custom text format that can be changed using <code>text</code> option. Default value is <code>ddd&lt;br/>Do</code>, string tokens are parsed against a given date. In this example week days have a full name.</p>
									<div class="datepaginator-days-format"></div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Disable calendar</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group-sm">Choose whether or not to display the clickable calendar icon visible on selected date using <code>showCalendar</code> option. By setting to <code>false</code> you are effectively removing the calendar date select functionality from the user.</p>
									<div class="datepaginator-calendar"></div>
								</div>
							</div>

							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Highlight selected date</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group-sm">Example below demonstrates <code>highlightSelectedDate</code> plugin option. By setting this option to <code>false</code> you can choose whether or not to distinguish visually the selected date. Here only today's date is highlighted.</p>
									<div class="datepaginator-highlight-selected"></div>
								</div>
							</div>

							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Highlight today's date</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group-sm">Example below demonstrates <code>highlightToday</code> plugin option. By setting this option to <code>false</code> you can choose whether or not to distinguish visually today's date. Here only selected date is highlighted..</p>
									<div class="datepaginator-highlight-today"></div>
								</div>
							</div>
