								...
								<li>
									...
									<ul>
										...
										<li>
											<a href="#">Learning</a>
											<ul>
												<li class="active"><a href="learning_list">List view</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Learning</span> - List Layout</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="learning_list">Learning</a></li>
