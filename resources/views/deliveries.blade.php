                    ...
                    <div class="row">
                        ...
                        @if($data)
							@foreach($data as $rrr)
								...
								@if(Auth::user()->type == "admin")
									<td>
                                       <a href="/delivery/{{$rrr->id}}/edit" class="btn btn-info btn-xs pull-left" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        
                                       {!! Form::open(['action'=> ['deliveriesController@destroy',$rrr->id], 'method'=>'POST'], []) !!}
