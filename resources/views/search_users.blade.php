									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="search_users">User search results</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Search</span> - User Results</h4>

							<ul class="breadcrumb position-right">
								<li><a href="index">Home</a></li>
								<li><a href="search_users">Search</a></li>
				...
				<div class="content">
					...
					<ul class="nav nav-lg nav-tabs nav-tabs-bottom search-results-tabs">
						...
						<li class="active"><a href="search_users"><i class="icon-people position-left"></i> Users</a></li>
