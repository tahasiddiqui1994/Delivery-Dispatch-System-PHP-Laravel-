                        ...
                        @if($data)
							@foreach($data as $rrr)
								<tr style="text-align: center;">
									...
									@if(Auth::user()->type == "admin")
										<td>
	                                       <a href="/customer/{{$rrr->id}}/edit" class="btn btn-info btn-xs pull-left" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
