...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/c3/c3_lines_areas.js')}}"></script>
	<!-- /theme JS files -->
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										<li class="active"><a href="c3_lines_areas">Lines and areas</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">C3</span> - Lines &amp; Areas</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="c3_lines_areas">C3</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Basic line chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Chart with regions</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Area chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Step chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
