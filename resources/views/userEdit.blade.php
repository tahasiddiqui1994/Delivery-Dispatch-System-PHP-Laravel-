                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="ekiAi16e04">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="ekiAi16e04" data-index="0">
                                <div class="panel-heading ui-sortable-handle">
                                    <div class="btn-group"> 
                                        <a style="background-color:#26a69a; border-color: #26a69a" class="btn btn-primary" href="/users/"> <i class="fa fa-plus"></i> View Users</a>  
                                    </div>
                                ...
                                <div class="panel-body">
                                    {!! Form::open(['action'=> ['usersController@update', $data->id], 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
									...
									<tbody><tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('name', $data->name, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Name"]) }}

                                            </div></td>
                                          <td><div class="col-sm-10 form-group">
                                                <label>User Type<font color="red">*</font></label>

                                                {{ Form::select('type', ['admin'=>'admin', 'supervisor'=>'supervisor', 'employee'=>'employee'], $data->type, ['required'=>"", 'class'=>'form-control', 'placeholder'=>"Select user type"]) }}
									 ...
									 <tr>
									 	<td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('email', $data->email, ['required'=>"", 'class' => "form-control", 'placeholder' => "Email"]) }}
                                    ...
                                    <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::password('password', ['required'=>"", 'class' => "form-control", 'placeholder' => "", 'value'=>""]) }}
