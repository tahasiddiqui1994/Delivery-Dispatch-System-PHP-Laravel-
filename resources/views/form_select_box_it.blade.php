...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/form_selectbox.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="form_select_box_it">SelectBoxIt selects</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Forms</span> - SelectBoxIt Selects</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="form_select_box_it">Forms</a></li>
							<li class="active">SelectBoxIt selects</li>
						</ul>
				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									...
									<!-- Custom default text -->
									<div class="form-group">
										<label>Custom default text</label>
										<select class="selectbox-default-text">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<!-- Disabled and selected options -->
									<div class="form-group">
										<label>Disabled and selected options</label>
										<select class="selectbox">
											<option value="AK">Alaska</option>
									...
									<!-- Optgroups support -->
									<div class="form-group">
										<label>Support of optgroups</label>
									...
									<div class="form-group">
										<label>Aggressive change mode</label>
									...
									<div class="form-group">
										<label>Native mousedown mode</label>
										<select class="selectbox-mousedown">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Styling options</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									...
									<!-- Custom icon support -->
									<div class="form-group">
										<label>Custom icon support</label>
										<select class="selectbox-custom-icon">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<div class="form-group">
										<label>Custom image support</label>
										<select class="selectbox">
											<option value="eugene" data-iconurl="assets/images/placeholder.jpg">
												Eugene Kopyov
											</option>
											<option value="barnaba" data-iconurl="assets/images/placeholder.jpg">
												Barnaba Losey
											</option>
											<option value="john" data-iconurl="assets/images/placeholder.jpg">
												John Carter
											</option>
											<option value="lucy" data-iconurl="assets/images/placeholder.jpg">
												Lucy Abernatti
											</option>
										</select>
									</div>
									...
									<div class="form-group">
										<label>HTML option support</label>
										<select class="selectbox">
										    <option value="selectboxit">SelectBoxIt is:</option>
										    <option value="plugin" data-text="a <strong>jQuery</strong> Plugin"></option>
										    <option value="replacement" data-text="a <strong>Select Box </strong> Replacement"></option>
										    <option value="widget" data-text="a Stateful UI <strong>Widget</strong>"></option>
										</select>
									</div>
									<!-- /HTML options support -->


									<!-- jQuery animated select -->
									<div class="form-group">
										<label>jQuery animated select</label>
										<select class="selectbox-animated-jquery">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<div class="form-group">
										<label>Custom selected text</label>
										<select class="selectbox">
											<option value="select">Select California</option>
											<option value="HI">Hawaii</option>
											<option value="CA" data-selectedtext="Los Angeles">California</option>
											<option value="NV">Nevada</option>
											<option value="OR">Oregon</option>
										</select>
									</div>
									...
									<div class="form-group">
										<label>Trigger native select</label>
										<select class="selectbox-trigger-native">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Options manipulation</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label>Add options dynamically</label>
										<select class="selectbox-dynamic-options">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<!-- Removing single option dynamically -->
									<div class="form-group">
										<label>First option is removed dynamically</label>
										<select class="selectbox-removing-option">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<!-- Removing multiple options dynamically -->
									<div class="form-group">
										<label>Multiple options are removed dynamically</label>
										<select class="selectbox-removing-options">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<!-- Removing all options dynamically -->
									<div class="form-group">
										<label>All options are removed dynamically</label>
										<div class="input-group">
											<select class="selectbox-remove-all">
												<option value="AK">Alaska</option>
												<option value="HI">Hawaii</option>
												<option value="CA">California</option>
												<option value="NV">Nevada</option>
									...
									<div class="form-group">
										<label>Hide the first option</label>
									...
									<!-- Hide current option -->
									<div class="form-group">
										<label>Hide current option</label>
									...
									<div class="form-group">
										<label>Bootstrap popover support</label>
										<select class="selectbox">
											<option value="SelectBoxIt is:" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="right" title="SelectBoxIt" data-content="A jQuery Select Box Plugin for Mobile, Tablet, and Desktop">
												SelectBoxIt is:
											</option>
											<option value="a jQuery Plugin" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="right" title="SelectBoxIt" data-content="a jQuery plugin">
												a jQuery Plugin
											</option>
											<option value="a Select Box Replacement" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="right" title="SelectBoxIt" data-content="a SelectBox Replacement">
												a Select Box Replacement
											</option>
											<option value="a Stateful UI Widget" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="right" title="SelectBoxIt" data-content="a Stateful UI Widget">
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<select class="selectbox">
											<option value="select">Select Nevada</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV" data-preventclose="true">Nevada</option>
											<option value="OR">Oregon</option>
										</select>
									</div>
									<!-- /prevent closing -->
									...
									<div class="form-group">
										<label>jQuery deferred object</label>
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<select class="selectbox selectbox-xs">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									...
									<!-- Grid based width -->
									<div class="form-group">
										<label class="display-block">Grid based width</label>
										<div class="row">
											<div class="col-xs-8">
												<select class="selectbox">
													<option value="AK">Alaska</option>
									...
									<!-- Fixed width -->
									<div class="form-group">
										<label class="display-block">Fixed width</label>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Grid sizing</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label>Default select</label>
										<select class="selectbox-bootstrap btn-default">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<div class="form-group">
										...
										<select class="selectbox-bootstrap btn-primary">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<div class="form-group">
										...
										<select class="selectbox-bootstrap btn-danger">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<div class="form-group">
										...
										<select class="selectbox-bootstrap btn-success">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<div class="form-group">
										...
										<select class="selectbox-bootstrap btn-warning">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<div class="form-group">
										...
										<select class="selectbox-bootstrap btn-info">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<select class="selectbox btn bg-teal">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<!-- Solid custom color -->
									<div class="form-group">
										<label>Solid custom color</label>
										<select class="selectbox-container bg-slate">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<div class="form-group">
										...
										<select class="selectbox border-lg border-teal-400">
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
