...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/echarts/combinations.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="echarts_combinations">Chart combinations</a></li>
									</ul>
								</li>
								<li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="echarts_combinations">ECharts</a></li>
