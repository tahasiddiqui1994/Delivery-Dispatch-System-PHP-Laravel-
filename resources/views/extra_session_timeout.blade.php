...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="{{url('assets/js/plugins/extensions/session_timeout.min.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/ui/prism.min.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/pages/extra_session_timeout.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="extra_session_timeout">Session timeout</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Extras</span> - Session Timeout</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="extra_session_timeout">Extras</a></li>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Session timeout</h6>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Session Timeout</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<div class="content-group">
								...
								<p>After a set amount of idle time, a <span class="text-semibold">Bootstrap warning dialog</span> is shown to the user with the option to either log out, or stay connected. If <span class="text-semibold">"Logout"</span> button is selected, the page is redirected to a logout URL. If <span class="text-semibold">"Stay Connected"</span> is selected, the dialog closes and the session is kept alive. If <span class="text-semibold">no option</span> is selected after another set amount of idle time, the page is automatically redirected to a set timeout URL.</p>
							...
							<h6 class="text-semibold">Plugin usage</h6>
							<ol class="list">
						...
						<div class="table-responsive">
							<table class="table table-lg">
								...
								<tbody>
									...
									<tr>
										<td><span class="text-semibold">message</span></td>
									...
									<tr>
										<td><span class="text-semibold">keepAliveUrl</span></td>
									...
									<tr>
										<td><span class="text-semibold">keepAlive</span></td>
									...
									<tr>
										<td><span class="text-semibold">keepBtnClass</span></td>
									...
									<tr>
										<td><span class="text-semibold">keepBtnText</span></td>
									...
									<tr>
										<td><span class="text-semibold">logoutBtnClass</span></td>
									...
									<tr>
										<td><span class="text-semibold">logoutBtnText</span></td>
									...
									<tr>
										<td><span class="text-semibold">ignoreUserActivity</span></td>
									...
									<tr>
										<td><span class="text-semibold">onWarn</span></td>
										<td><code>false</code></td>
									...
									<tr>
										<td><span class="text-semibold">onRedir</span></td>
										<td><code>false</code></td>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Timeout examples</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
...
<pre class="language-javascript"><code>$.sessionTimeout({
    ...
    redirAfter: 120000
							...
							<div class="content-group-lg">
								<h6 class="text-semibold">With onWarn Callback</h6>
...
<pre class="language-javascript"><code>$.sessionTimeout({
    ...
    onWarn: function{
        alert('Warning!');
							...
							<div class="content-group-lg">
								<h6 class="text-semibold">With both onWarn and onRedir Callback</h6>
...
<pre class="language-javascript"><code>$.sessionTimeout({
    ...
    onRedir: function{
        alert('Your session has expired!');
							...
							<div class="content-group">
								<h6 class="text-semibold">Full featured example</h6>
