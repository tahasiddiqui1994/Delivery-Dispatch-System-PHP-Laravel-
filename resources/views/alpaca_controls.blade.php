...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/alpaca_controls.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="alpaca_controls">Controls</a></li>
									</ul>
								</li>
								<li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="alpaca_controls">Alpaca</a></li>
