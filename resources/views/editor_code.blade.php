...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="{{url('assets/js/plugins/editors/ace/ace.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/pages/editor_code.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="editor_code">Code editor</a></li>
									</ul>
								</li>
								<li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="editors_code">Editors</a></li>
