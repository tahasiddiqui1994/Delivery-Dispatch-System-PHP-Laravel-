...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/internationalization_on_init.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="internationalization_on_init" data-i18n="nav.int.oninit"></a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Translation</span> - Set On Init</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="internationalization_on_init">Translation</a></li>
							<li class="active">Set on init</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Language on init</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<p class="content-group">In this example English language is set <code>on init</code>. If language is set on init, resources will be resolved in this order: first - <span class="text-semibold">languageCode</span> plus <span class="text-semibold">countryCode</span>, eg. <code>'en-US'</code>; second - alternative look it up in <span class="text-semibold">languageCode</span> only, eg. <code>'en'</code>; third - finally look it up in definded <span class="text-semibold">fallback</span> language, default: <code>'dev'</code>.
							Basically, <code>lng</code> option sets a specified language that is loaded on every initialization. With basic settings all options will be reset on a new init.</p>

							<p class="text-semibold">Set language on init:</p>
