...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="navigation_vertical_bordered">Bordered navigation</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Vertical Nav</span> - Bordered</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navigation_vertical_bordered">Vertical nav</a></li>
							<li class="active">Bordered</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Bordered navigation</h6>
						Add optional borders to the first level of main navigation by adding <code>.navigation-bordered</code> class to the navigation container.
				    </div>
				    <!-- /info alert -->
