...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/d3/tree/tree_basic.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/tree/tree_collapsible.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/tree/tree_bracket.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/tree/tree_radial.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/tree/tree_dendrogram.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/tree/tree_dendrogram_radial.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="d3_tree">Tree layout</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">D3</span> - Tree Layouts</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="d3_tree">D3</a></li>
							<li class="active">Tree layouts</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Basic tree layout</h5>
							<div class="heading-elements">
								<ul class="icons-list">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Cluster dendrogram</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Bracket tree</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Radial tree layout</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Radial dendrogram</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">Basic example of <code>tree dendrogram</code> in <code>radial</code> orientation. A dendrogram is a node-link diagram that places leaf nodes of the tree at the same depth. In this example, the classes (leaf nodes) are aligned on the right edge, with the packages (internal nodes) to the left. Data shows the Flare class hierarchy. Demo data is stored in <code>json</code> file format. By default, the tree isn't scalable and has fixed width for better readability, all levels are visible.</p>
