...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_popups">Tooltips and popovers</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Components</span> - Popups</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="components_popups">Components</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Tooltip component</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<p class="content-group">Tooltip is a small text block with information about the item being hovered, clicked or focused on. Bootstrap tooltip extensions supports four alignment options: <code>top</code>, <code>right</code>, <code>bottom</code> and <code>left</code>. The tooltip plugin generates content and markup on demand, and by default places tooltips <code>after</code> their trigger element. The required markup for a tooltip is only a <code>data</code> attribute and <code>title</code> on the HTML element you wish to have a tooltip.</p>

							<div class="row">
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class="mb-15">
					            		<p><span class="text-semibold">Top tooltip</span> <span class="display-block text-muted">data-placement="top"</span></p>
					            		<div class="well well-sm">
						                    <div class="tooltip top in" style="display: block; position: relative; margin: 0; padding: 0; z-index: 100;">
												<div class="tooltip-inner" style="max-width: none;">
													Some tooltip text!
												</div>
												<div class="tooltip-arrow" style="bottom: -4px;"></div>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class="mb-15">
					            		<p><span class="text-semibold">Right tooltip</span> <span class="display-block text-muted">data-placement="right"</span></p>
					            		<div class="well well-sm">
						                    <div class="tooltip right in" style="display: block; position: relative; margin: 0; padding: 0; z-index: 100;">
												<div class="tooltip-inner" style="max-width: none;">
													Some tooltip text!
												</div>
												<div class="tooltip-arrow" style="left: -4px;"></div>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class="mb-15">
					            		<p><span class="text-semibold">Bottom tooltip</span> <span class="display-block text-muted">data-placement="bottom"</span></p>
					            		<div class="well well-sm">
						                    <div class="tooltip bottom in" style="display: block; position: relative; margin: 0; padding: 0; z-index: 100;">
												<div class="tooltip-inner" style="max-width: none;">
													Some tooltip text!
												</div>
												<div class="tooltip-arrow" style="top: -4px;"></div>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class="mb-15">
					            		<p><span class="text-semibold">Left tooltip</span> <span class="display-block text-muted">data-placement="left"</span></p>
					            		<div class="well well-sm">
						                    <div class="tooltip left in" style="display: block; position: relative; margin: 0; padding: 0; z-index: 100;">
												<div class="tooltip-inner" style="max-width: none;">
													Some tooltip text!
												</div>
												<div class="tooltip-arrow" style="right: -4px;"></div>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Tooltip examples</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
							...
							<table class="table">
								<tbody>
									...
									<tr>
										...
										<td style="width: 20%;"><button type="button" class="btn btn-primary btn-sm" data-popup="tooltip" title="Left tooltip" data-placement="left" id="left">Tooltip <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-primary btn-sm" data-popup="tooltip" title="Top tooltip">Tooltip <i class="icon-play3 position-right"></i></button></td>
										<td>Tooltip in <code>left</code> direction. To use, add <code>data-placement="left"</code> to the tooltip element</td>
									</tr>
									<tr>
										<td>Right tooltip position</td>
										<td><button type="button" class="btn btn-primary btn-sm" data-popup="tooltip" title="Right tooltip" data-placement="right">Tooltip <i class="icon-play3 position-right"></i></button></td>
										<td>Tooltip in default <code>top</code> direction, <code>data-placement="top"</code> is optional</td>
									</tr>
									<tr>
										<td>Bottom tooltip position</td>
										<td><button type="button" class="btn btn-primary btn-sm" data-popup="tooltip" title="Bottom tooltip" data-placement="bottom">Tooltip <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>Click trigger</td>
										<td><button type="button" class="btn btn-default btn-sm" data-popup="tooltip" title="I'm a tooltip" data-trigger="click">Tooltip <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>Focus trigger</td>
										<td><button type="button" class="btn btn-default btn-sm" data-popup="tooltip" title="I'm a tooltip" data-trigger="focus">Tooltip <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>HTML support</td>
										<td><button type="button" class="btn btn-default btn-sm" data-popup="tooltip" title="<strong>Tooltip</strong> <i>with</i> <u>HTML</u>" data-html="true">Tooltip <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm" data-popup="tooltip" title="I'm a tooltip" data-animation="false">Tooltip <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm" data-popup="tooltip" title="I'm a tooltip" data-delay="600">Tooltip <i class="icon-play3 position-right"></i></button></td>
										<td>Delay showing and hiding the tooltip in <code>ms</code>. If a number is supplied, delay is applied to both hide/show</td>
									</tr>
									<tr>
										<td>Custom color</td>
										<td><button type="button" class="btn btn-default btn-sm" data-popup="tooltip-custom" title="I'm a teal tooltip">Tooltip <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>Show event</td>
										<td><button type="button" class="btn btn-default btn-sm" id="tooltip-show">Tooltip <i class="icon-play3 position-right"></i></button></td>
										<td>Example of a <code>show</code> event. This event fires immediately when the <code>show</code> instance method is called</td>
									</tr>
									<tr>
										<td>Shown event</td>
										<td><button type="button" class="btn btn-default btn-sm" id="tooltip-shown">Tooltip <i class="icon-play3 position-right"></i></button></td>
										<td>Example of a <code>shown</code> event. This event is fired when the tooltip has been made visible to the user</td>
									</tr>
									<tr>
										<td>Hide event</td>
										<td><button type="button" class="btn btn-default btn-sm" id="tooltip-hide">Tooltip <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>Hidden event</td>
										<td><button type="button" class="btn btn-default btn-sm" id="tooltip-hidden">Tooltip <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td>
											<div class="btn-group">
												<button type="button" class="btn btn-info btn-sm" id="show-tooltip-method-target" data-popup="tooltip" title="I'm a tooltip" data-trigger="manual" data-container="body">Target</button>
												<button type="button" class="btn btn-danger btn-icon btn-sm" id="show-tooltip-method"><i class="icon-play3"></i></button>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="btn-group">
												<button type="button" class="btn btn-info btn-sm" id="hide-tooltip-method-target" data-popup="tooltip" title="I'm a tooltip" data-trigger="manual" data-container="body">Target</button>
												<button type="button" class="btn btn-danger btn-icon btn-sm" id="hide-tooltip-method"><i class="icon-play3"></i></button>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="btn-group">
												<button type="button" class="btn btn-info btn-sm" id="toggle-tooltip-method-target" data-popup="tooltip" title="I'm a tooltip" data-trigger="manual" data-container="body">Target</button>
												<button type="button" class="btn btn-danger btn-icon btn-sm" id="toggle-tooltip-method"><i class="icon-play3"></i></button>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="btn-group">
												<button type="button" class="btn btn-info btn-sm" id="destroy-tooltip-method-target" data-popup="tooltip" title="I'm a tooltip" data-trigger="click" data-container="body">Target</button>
												<button type="button" class="btn btn-danger btn-icon btn-sm" id="destroy-tooltip-method"><i class="icon-play3"></i></button>
											</div>
										</td>
										<td>Example of a <code>destroy</code> method. This method hides and destroys an element's tooltip. Click on <code>Target</code> button and then <code>play</code> button to destroy a tooltip</td>
									</tr>
								</tbody>
							</table>
						</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Popover component</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">Popover is a small container with content that hovers over its parent element. Since popovers are built on top of tooltip plugin, it is required to include both of them. Popover supports all availbale tooltip options, but has a different template - title, content and arrow. Bootstrap popover extension supports four alignment options: <code>top</code>, <code>right</code>, <code>bottom</code> and <code>left</code>. The popover plugin generates content and markup on demand, and by default places tooltips <code>after</code> their trigger element.</p>

							<div class="row">
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class="mb-15">
					            		<p><span class="text-semibold">Top popover</span> <small class="display-block text-muted">data-placement="top"</small></p>
					            		<div class="well well-sm">
						                    <div class="popover top" style="position: relative; display: block; margin: 0; width: 100%; max-width: none; z-index: 101">
						                        <div class="arrow"></div>
								...
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class="mb-15">
					            		<p><span class="text-semibold">Right popover</span> <span class="display-block text-muted">data-placement="right"</span></p>
					            		<div class="well well-sm">
						                    <div class="popover right" style="position: relative; display: block; margin: 0; width: 100%; max-width: none; z-index: 101">
						                        <div class="arrow"></div>
								...
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class="mb-15">
					            		<p><span class="text-semibold">Bottom popover</span> <span class="display-block text-muted">data-placement="bottom"</span></p>
					            		<div class="well well-sm">
						                    <div class="popover bottom" style="position: relative; display: block; margin: 0; width: 100%; max-width: none; z-index: 101">
						                        <div class="arrow"></div>
								...
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class="mb-15">
					            		<p><span class="text-semibold">Left popover</span> <span class="display-block text-muted">data-placement="left"</span></p>
					            		<div class="well well-sm">
						                    <div class="popover left" style="position: relative; display: block; margin: 0; width: 100%; max-width: none; z-index: 101">
						                        <div class="arrow"></div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Popover examples</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
							...
							<table class="table">
								<tbody>
									...
									<tr>
										...
										<td style="width: 20%;"><button type="button" class="btn btn-primary btn-sm" data-popup="popover" data-placement="left" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?">Popover <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-primary btn-sm" data-popup="popover" data-placement="top" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?">Popover <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-primary btn-sm" data-popup="popover" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?">Popover <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-primary btn-sm" data-popup="popover" data-placement="bottom" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?">Popover <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>Hover trigger</td>
										<td><button type="button" class="btn btn-default btn-sm" data-popup="popover" title="Popover title" data-trigger="hover" data-content="And here's some amazing content. It's very engaging. Right?">Popover <i class="icon-play3 position-right"></i></button></td>
										<td>Popover triggered on <code>hover</code>. To use, add <code>data-trigger="hover"</code> to the popover element.</td>
									</tr>
									<tr>
										<td>Focus trigger</td>
										<td><button type="button" class="btn btn-default btn-sm" data-popup="popover" title="Popover title" data-trigger="focus" data-content="And here's some amazing content. It's very engaging. Right?">Popover <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>HTML support</td>
										<td><button type="button" class="btn btn-default btn-sm" data-popup="popover" title="Popover title" data-html="true" data-content="Add <u>some</u> <i>HTML</i> <strong>stuff</strong>.">Popover <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>Disabled animation</td>
										<td><button type="button" class="btn btn-default btn-sm" data-popup="popover" title="Popover title" data-animation="false" data-content="And here's some amazing content. It's very engaging. Right?">Popover <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm" data-popup="popover" title="Popover title" data-delay="600" data-content="And here's some amazing content. It's very engaging. Right?">Popover <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm" data-popup="popover-custom" data-placement="bottom" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?">Popover <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm" data-popup="popover-solid" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?">Popover <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										<td>Show event</td>
										<td><button type="button" class="btn btn-default btn-sm" id="popover-show">Popover <i class="icon-play3 position-right"></i></button></td>
										<td>Example of a <code>show</code> event. This event fires immediately when the <code>show</code> instance method is called.</td>
									</tr>
									<tr>
										<td>Shown event</td>
										<td><button type="button" class="btn btn-default btn-sm" id="popover-shown">Popover <i class="icon-play3 position-right"></i></button></td>
										<td>Example of a <code>shown</code> event. This event is fired when the popover has been made visible to the user.</td>
									</tr>
									<tr>
										<td>Hide event</td>
										<td><button type="button" class="btn btn-default btn-sm" id="popover-hide">Popover <i class="icon-play3 position-right"></i></button></td>
										<td>Example of a <code>hide</code> event. This event is fired immediately when the <code>hide</code> instance method has been called.</td>
									</tr>
									<tr>
										<td>Hidden event</td>
										<td><button type="button" class="btn btn-default btn-sm" id="popover-hidden">Popover <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td>
											<div class="btn-group">
												<button type="button" class="btn btn-info btn-sm" id="show-popover-method-target" data-popup="popover" data-placement="top" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?" data-trigger="manual" data-container="body">Target</button>
												<button type="button" class="btn btn-danger btn-icon btn-sm" id="show-popover-method"><i class="icon-play3"></i></button>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="btn-group">
												<button type="button" class="btn btn-info btn-sm" id="hide-popover-method-target" data-popup="popover" data-placement="top" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?" data-trigger="manual" data-container="body">Target</button>
												<button type="button" class="btn btn-danger btn-icon btn-sm" id="hide-popover-method"><i class="icon-play3"></i></button>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="btn-group">
												<button type="button" class="btn btn-info btn-sm" id="toggle-popover-method-target" data-popup="popover" data-placement="top" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?" data-trigger="manual" data-container="body">Target</button>
												<button type="button" class="btn btn-danger btn-icon btn-sm" id="toggle-popover-method"><i class="icon-play3"></i></button>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="btn-group">
												<button type="button" class="btn btn-info btn-sm" id="destroy-popover-method-target" data-popup="popover" data-placement="top" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?" data-container="body">Target</button>
												<button type="button" class="btn btn-danger btn-icon btn-sm" id="destroy-popover-method"><i class="icon-play3"></i></button>
											</div>
										</td>
										<td>Example of a <code>destroy</code> method. This method hides and destroys an element's popover. Click on <code>Target</code> button and then <code>play</code> button to destroy a popover.</td>
									</tr>
								</tbody>
							</table>
						</div>
