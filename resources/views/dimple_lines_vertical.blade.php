...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/lines/line_vertical_single.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/lines/line_vertical_single_grouped.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/lines/line_vertical_multiple.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/lines/line_vertical_multiple_grouped.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										<li>
											...
											<ul>
												...
												<li class="active"><a href="dimple_lines_vertical">Vertical orientation</a></li>
											</ul>
										</li>
										<li>
											<a href="#">Bar charts</a>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Dimple</span> - Vertical Lines</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="dimple_lines_vertical">Dimple</a></li>
							<li class="active">Vertical lines</li>
						</ul>
