							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="appearance_text_styling">Text styling</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="appearance_text_styling">Appearance</a></li>
				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Contextual colors</h5>
									<div class="heading-elements">
										<ul class="icons-list">
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Contextual backgrounds</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="table-responsive">
									<table class="table table-lg">
										...
										<tbody>
											...
											<tr>
												<td><span class="bg-indigo-400 text-highlight">Custom background</span></td>
												<td>For a <a href="colors_primary">custom background</a> color use <code>.bg-*</code> class</td>
											</tr>
										</tbody>
									</table>
								</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Text options</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
