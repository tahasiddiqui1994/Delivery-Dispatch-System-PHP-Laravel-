...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/extra_fullcalendar.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="extension_fullcalendar_views">Basic views</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Fullcalendar</span> - Basic Views</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="extension_fullcalendar_views">Fullcalendar</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<p class="content-group">FullCalendar has a number of different "views", or ways of displaying days and events. The following 5 views are all built in to FullCalendar: <code>month</code>, <code>basicWeek</code>, <code>basicDay</code>, <code>agendaWeek</code>, <code>agendaDay</code>. You can define header buttons to allow the user to switch between them. Also you can set the initial view of the calendar with the defaultView option. The following example demonstrates <code>agenda</code> views.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">List view</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">A list view is a type of available views that displays events in a flat list. Only days with events are displayed. A list view displays events during a specific interval of time. There are 4 preset list views: <code>listDay</code>, <code>listWeek</code>, <code>listMonth</code>, and <code>listYear</code>. The following example demonstrates <code>listWeek</code>, <code>listDay</code> and <code>listMonth</code> views.</p>
