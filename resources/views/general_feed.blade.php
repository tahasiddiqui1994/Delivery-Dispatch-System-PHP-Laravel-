...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="general_feed">Feed</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">General Pages</span> - Feed</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="general_feed">General pages</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Feed list styles
						<small class="display-block">Circle, square and rhombus. Empty and filled</small>
					</h6>
					...
					<h6 class="content-group text-semibold">
						Color options
						<small class="display-block">Background, border and line colors</small>
					</h6>
					...
					<h6 class="content-group text-semibold">
						Time and date
						<small class="display-block">Various date and time options</small>
					</h6>
						...
						<div class="col-sm-6">
							...
							<div class="panel panel-body border-top-teal">
								<ul class="list-feed list-feed-time">
									...
									<li>
										<span class="feed-time text-muted">08:28</span>
										<a href="#">Eugene Kopyov</a> merged <strong>Master</strong>, <strong>Demo</strong> and <strong>Dev</strong> branches
									</li>

									<li>
										<span class="feed-time text-muted">07:58</span>
										All sellers have received payouts for December, 2016!
									</li>
							...
							<div class="panel panel-body border-top-teal">
								<ul class="list-feed media-list">
									<li class="media">
										...
										<div class="media-right text-nowrap text-muted text-size-small">12:47</div>
									</li>
									...
									<li class="media">
										...
										<div class="media-right text-nowrap text-muted text-size-small">10:25</div>
									</li>
									...
									<li class="media">
										...
										<div class="media-right text-nowrap text-muted text-size-small">09:37</div>
									</li>
									...
									<li class="media">
										...
										<div class="media-right text-nowrap text-muted text-size-small">08:28</div>
									</li>
									...
									<li class="media">
										...
										<div class="media-right text-nowrap text-muted text-size-small">07:58</div>
									</li>
									...
									<li class="media">
										...
										<div class="media-right text-nowrap text-muted text-size-small">06:32</div>
									</li>
								</ul>
							</div>
							<!-- /right aligned -->
					...
					<h6 class="content-group text-semibold">
						Other options
						<small class="display-block">Icon list and dropdown menu</small>
					</h6>
