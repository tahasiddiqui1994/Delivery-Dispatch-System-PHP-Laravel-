...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/components_notifications_other.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_notifications_others">Other notifications</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Components</span> - Notifications</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="components_notifications_other">Components</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Noty notifications</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="table-responsive">
							<table class="table">
								<tbody>
									<tr>
										<th colspan="3" class="active">Notification layouts</th>
									</tr>
									<tr>
										<td style="width: 20%;">Error notice</td>
										<td style="width: 20%;"><button type="button" class="btn btn-danger btn-sm noty-runner" data-layout="topRight" data-type="error">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Error notification. To use, add <code>type: 'error'</code> option to the notification configuration</td>
									</tr>
									<tr>
										<td>Success notice</td>
										<td><button type="button" class="btn btn-success btn-sm noty-runner" data-layout="topRight" data-type="success">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-warning btn-sm noty-runner" data-layout="topRight" data-type="warning">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-info btn-sm noty-runner" data-layout="topRight" data-type="information">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Info notification. To use, add <code>type: 'info'</code> option to the notification configuration</td>
									</tr>
									<tr>
										<td>Alert notice</td>
										<td><button type="button" class="btn btn-primary btn-sm noty-runner" data-layout="topRight" data-type="alert">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm noty-runner" data-layout="topRight" data-type="confirm">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr class="border-double">
										<th colspan="3" class="active">Notification position. Top</th>
									</tr>
									<tr>
										<td>Top position</td>
										<td><button type="button" class="btn btn-default btn-sm noty-runner" data-layout="top" data-type="success">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm noty-runner" data-layout="topLeft" data-type="error">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm noty-runner" data-layout="topCenter" data-type="error">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm noty-runner" data-layout="topRight" data-type="error">Launch <i class="icon-play3 position-right"></i></button></td>
										<td>Top right notification position. To use, add <code>layout: 'topRight'</code> option to the notification configuration</td>
									</tr>

									<tr class="border-double">
										<th colspan="3" class="active">Notification position. Center</th>
									</tr>
									<tr>
										<td>Center left position</td>
										<td><button type="button" class="btn btn-default btn-sm noty-runner" data-layout="centerLeft" data-type="error">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm noty-runner" data-layout="center" data-type="error">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm noty-runner" data-layout="centerRight" data-type="error">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr class="border-double">
										<th colspan="3" class="active">Notification position. Bottom</th>
									</tr>
									<tr>
										<td>Bottom left position</td>
										<td><button type="button" class="btn btn-default btn-sm noty-runner" data-layout="bottomLeft" data-type="information">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm noty-runner" data-layout="bottomCenter" data-type="information">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm noty-runner" data-layout="bottomRight" data-type="information">Launch <i class="icon-play3 position-right"></i></button></td>
									...
									<tr>
										...
										<td><button type="button" class="btn btn-default btn-sm noty-runner" data-layout="bottom" data-type="alert">Launch <i class="icon-play3 position-right"></i></button></td>
