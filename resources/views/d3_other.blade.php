...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/d3/other/treemap.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/other/bubbles.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/other/streamgraph.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/other/waterfall.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="d3_other">Other charts</a></li>
									</ul>
								</li>
								<li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">D3</span> - Other Charts</h4>
						</div>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Waterfall chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">Basic example of <code>waterfall</code> chart. The waterfall chart is normally used for understanding how an initial value is affected by a series of intermediate positive or negative values. Usually the initial and the final values are represented by whole columns, while the intermediate values are denoted by floating columns. The columns are color-coded for distinguishing between positive and negative values. Axis labels rotated just for fun.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Bubble chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Zoomable treemap</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">Treemaps display hierarchical (tree-structured) data as a set of nested rectangles. Each branch of the tree is given a rectangle, which is then tiled with smaller rectangles representing sub-branches. A leaf node's rectangle has an area proportional to a specified dimension on the data. Often the leaf nodes are colored to show a separate dimension of the data.</p>

							<div class="content-group">
								<label class="radio-inline"><input type="radio" class="treemap_actions" name="treemap-mode" value="size" checked="checked"> Size</label>
								<label class="radio-inline"><input type="radio" class="treemap_actions" name="treemap-mode" value="count"> Count</label>
							</div>
