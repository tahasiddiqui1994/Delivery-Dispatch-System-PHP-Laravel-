...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/handsontable_custom_checks.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="handsontable_custom_checks">Custom &amp; checkboxes</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="handsontable_custom_checks">Handsontable</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Custom renderers</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<div class="content-group-lg">
								<h6 class="text-semibold">Rendering custom HTML in cells</h6>
								<p class="content-group">This example shows how to use custom cell renderers to display HTML content in a cell. This is a very powerful feature. Just remember to escape any HTML code that could be used for XSS attacks. In the below configuration all columns except the first one use built-in HTML renderer that allows any HTML. Icon column accepts image URL as a string and converts it to a <code>&lt;img></code> in the renderer.</p>
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<div class="content-group-lg">
								<h6 class="text-semibold">Checkbox true/false values</h6>
							...
							<div class="content-group-lg">
								<h6 class="text-semibold">Checkbox labels</h6>
							...
							<div class="content-group-lg">
								<h6 class="text-semibold">Checkbox template</h6>
