									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="navbar_multiple_top_bottom">Top + bottom</a></li>
											</ul>
										</li>
			...
			<div class="content-wrapper">
					...
					<div class="page-header-content">
						<div class="page-title">
							...
							<ul class="breadcrumb position-right">
								...
								<li><a href="navbar_multiple_top_bottom">Navbars</a></li>
								<li class="active">Top + bottom</li>
							</ul>
						</div>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Top and bottom navbars</h6>
						This page demonstrates both top and bottom fixed navbars. Bottom navbar is <strong>always</strong> sticked to the bottom of the window.
				    </div>
				    <!-- /info alert -->
