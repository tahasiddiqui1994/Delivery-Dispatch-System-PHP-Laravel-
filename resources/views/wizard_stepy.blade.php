...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="{{url('assets/js/plugins/forms/wizards/stepy.min.js')}}"></script>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/wizard_stepy.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="wizard_stepy">Stepy wizard</a></li>
									</ul>
								</li>
								<li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Wizards</span> - Stepy</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="wizards_stepy">Wizards</a></li>
