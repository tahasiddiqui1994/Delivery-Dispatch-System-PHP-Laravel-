...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/colors_orange.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="colors_orange">Orange palette</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Colors</span> - Orange Palette</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="colors_orange">Colors</a></li>
							<li class="active">Orange palette</li>
						</ul>
				...
				<div class="content">
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#EF6C00</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#orange_800"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#F57C00</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#orange_700"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#FB8C00</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#orange_600"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#FF9800</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#orange_500"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#FFA726</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#orange_400"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#FFB74D</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#orange_300"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="content-group-lg">
					    ...
					    <!-- Solid alert -->
					    <div class="alert bg-orange-600 alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Close</span></button>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.text-orange</code> classes</p>
								</div>

								<input type="text" class="form-control text-orange text-uppercase text-semibold text-size-small" value="Input field text">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-orange</code> or classes</p>
								</div>

								<input type="text" class="form-control border-orange border-lg" placeholder="Input field border">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-orange</code> classes</p>
								</div>

								<input type="text" class="form-control bg-orange-600" placeholder="Input field background">
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								...
								<div class="has-feedback">
									<input type="text" class="form-control bg-orange-600" placeholder="Icon feedback, orange input">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								...
								<select class="form-control bg-orange-600">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								...
								<div class="input-group">
									<span class="input-group-addon bg-orange-600"><i class="icon-menu7"></i></span>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								...
								<div class="input-group">
									<span class="input-group-addon bg-orange-700"><i class="icon-lock2"></i></span>
									<input type="text" class="form-control bg-orange-600" placeholder="Solid background color">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
										<button class="btn bg-orange-600" type="button">Button</button>
									</span>									
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<label class="radio-inline">
									<input type="radio" class="styled" name="orange-radio" checked="checked">
									Selected
								</label>

								<label class="radio-inline">
									<input type="radio" class="styled" name="orange-radio">
									Unselected
								</label>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-orange</code> or classes</p>

									<select class="selectbox bg-orange-600">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								<div class="text-center">
									...
									<select class="bootstrap-select" data-style="bg-orange-600">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										<ul class="nav nav-tabs bg-orange-600">
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										...
										<div class="tab-content bg-orange-600">
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<span class="label bg-orange-600">Orange label</span>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<span class="badge bg-orange-600">390</span>
							</div>
				    	</div>
				    </div>
				    <!-- /text options -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-orange-600" style="width: 55%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-orange-600 progress-bar-striped" style="width: 65%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-orange-600 progress-bar-striped active" style="width: 75%">
				    ...
				    <div class="row">
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th>Last Name</th>
												<th class="bg-orange-600">Username</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												...
												<td>Kopyov</td>
												<td class="bg-orange-600">@Kopyov</td>
											</tr>
											<tr>
												<td>2</td>
												<td class="alpha-orange">Victoria</td>
												<td>Baker</td>
												<td class="bg-orange-600">@Vicky</td>
											</tr>
											<tr>
												<td>3</td>
												<td class="alpha-orange">James</td>
												<td>Alexander</td>
												<td class="bg-orange-600">@Alex</td>
											</tr>
										</tbody>
										<tfoot>
											<tr>
				    	...
				    	<div class="col-md-6">
				    		<div class="panel panel-flat">
								...
								<div class="table-responsive">
									<table class="table bg-orange-600">
										<thead>
											<tr>
												<th>#</th>
												<th>First Name</th>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<button type="button" class="btn bg-orange-600"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<button type="button" class="btn bg-orange-600 btn-labeled"><b><i class="icon-menu7"></i></b> Labeled button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<button type="button" class="btn text-orange-800 border-orange btn-flat"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    </div>
				    <!-- /buttons -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel">
								<div class="panel-heading bg-orange-600">
									<h6 class="panel-title">Orange panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Orange panel using <code>.bg-orange</code> class added to the panel heading
								</div>
							</div>
				    	</div>

				    	<div class="col-md-4">
				    		<div class="panel border-orange-600">
								<div class="panel-heading bg-orange-600">
									<h6 class="panel-title">Orange bordered panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Bordered orange panel using <code>.bg-orange</code> and <code>.border-orange</code> classes
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel bg-orange-600">
								<div class="panel-heading">
									<h6 class="panel-title">Orange solid panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Solid orange panel using <code>.bg-orange</code> class added to the panel container
								</div>
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<button type="button" class="btn bg-orange-600" data-popup="tooltip-custom" title="Orange tooltip" data-placement="bottom" data-container="body"><i class="icon-comment position-left"></i> Tooltip</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<button type="button" class="btn bg-orange-600" data-popup="popover-custom" title="Orange popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<button type="button" class="btn bg-orange-600" data-popup="popover-solid" title="Orange popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<button type="button" class="btn bg-orange-600" data-toggle="modal" data-target="#modal_orange"><i class="icon-menu7 position-left"></i> Modal dialog</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<p class="mb-15 text-muted">Using <code>.bg-orange</code> color classes</p>

								<button class="btn bg-orange-600 growl-launch">jGrowl notification</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange text-center">
								...
								<button class="btn bg-orange-600 pnotify-launch">Pnotify notification</button>
							</div>
				    	</div>
				    </div>
				    <!-- /notifications and dialogs -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-orange</code> color classes</p>
								</div>

								<ul class="dropdown-menu border-orange-600 border-lg" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								...
								<ul class="dropdown-menu bg-orange-600" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-orange">
								...
								<ul class="dropdown-menu bg-orange-600" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> <span class="label bg-orange pull-right">Label</span> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> <span class="badge bg-orange pull-right">98</span> Another action</a></li>
									<li class="divider"></li>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn bg-orange-600">Save changes</button>
								</div>
							</div>
						</div>
					</div>
