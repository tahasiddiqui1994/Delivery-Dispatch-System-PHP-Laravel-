									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="timelines_right">Right timeline</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Timelines</span> - Right Position</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="timelines_right">Timelines</a></li>
							<li class="active">Right position</li>
						</ul>
