		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				<!-- /page header -->
                    ...
                    <!-- Main content -->
                    <section class="content " style="white-space: nowrap;">
                            ...
                            <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="bPxkEV9ghY">
                                ...
                                <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="bPxkEV9ghY" data-index="1">
                                    ...
                                    <div class="panel-body">
                                    	...
                                    	<tr>  
                                            <td>
                                                         <label class="b">{{$rrr->LoadNo}}</label>   
                                            </td>
											<td>{{$rrr->pickup}}</td>
											<td>{{$rrr->delivery}}</td>
                                            <td>{{$rrr->driverName}}</td>
                                            <td>{{$rrr->truckNo}}</td>
                                            <td>{{$rrr->from}}</td>
                                            <td>{{$rrr->to}}</td>
											<td>{{$rrr->bol}}</td>
                                        @if(Auth::user()->type == "admin")
                                            <td>
                                       			<a href="/load/{{$rrr->id}}/edit" class="btn btn-info btn-xs pull-left" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        
                                       			{!! Form::open(['action'=> ['customersController@destroy',$rrr->id], 'method'=>'POST'], ['class'=>'col-sm-6']) !!}
                                       				&nbsp;<button href="/load/{{$rrr->id}}/destroy" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete">
