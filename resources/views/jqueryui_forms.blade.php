...
<head>
	...
	<!-- Core JS files -->
	<script type="text/javascript" data-pace-options='{"ajax": false}' src="{{url('assets/js/plugins/loaders/pace.min.js')}}"></script>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/extensions/mousewheel.min.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/core/libraries/jquery_ui/globalize/globalize.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/core/libraries/jquery_ui/globalize/cultures/globalize.culture.de-DE.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/core/libraries/jquery_ui/globalize/cultures/globalize.culture.ja-JP.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/pages/jqueryui_forms.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="jqueryui_forms">Forms</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">jQuery UI</span> - Forms</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="jqueryui_forms">jQuery UI</a></li>
						...
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="content-group-lg">
										<h6 class="text-semibold">Default functionality</h6>
										<p class="content-group-sm">Enables users to quickly find and select from a pre-populated list of values as they type, leveraging searching and filtering. This example demonstrates basic setup with default functionality.</p>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Categories</h6>
										<p class="content-group-sm">A categorized search result with opgroup-like display option. All items under certain category have doubled horizontal padding. Built with <code>_renderMenu</code> and <code>_create</code> widget's methods.</p>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Multiple results</h6>
										<p class="content-group-sm">Select a value, then continue typing to add more. This is an example showing how to use the source-option along with some events to enable <code>autocompleting</code> multiple values into a single field.</p>
									...
									<div class="content-group">
										...
										<p class="content-group-sm">Here the suggestions are car names, displayed when at least two characters are entered. The datasource is a server-side script which returns JSON data, specified via a simple URL for the <code>source</code> option.</p>
								...
								<div class="col-md-6">
									<div class="content-group-lg">
										<h6 class="text-semibold">Accent folding</h6>
										<p class="content-group-sm">If the text includes accented characters in the text field, Autocomplete is smart enough not to show results that aren't accented. Try typing "Jo" to see "John" and "Jörn", then type "Jö" to see only "Jörn".</p>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Custom data and display</h6>
										<p class="content-group-sm">You can use your own custom data formats and displays by simply overriding the default <code>focus</code> and <code>select</code> actions. Try typing "i" letter to display a list of projects or just press the down arrow.</p>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Combobox</h6>
										<p class="content-group-sm">A custom widget built by composition of Autocomplete and Button. You can either type something into the field to get filtered suggestions based on your input or use the button to get the full list of items.</p>
									...
									<div class="content-group">
										<h6 class="text-semibold">Remote with caching</h6>
										<p class="content-group-sm">Similar to the remote datasource demo, though this adds some local caching to improve performance. The cache here saves just one query, and could be extended to cache multiple values, one for each term.</p>
						...
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="content-group-lg">
										<h6 class="text-semibold">Default functionality</h6>
										<p class="content-group-sm">Selectmenu component with default functionality. The styling is similar to other custom select components. Also supports 4 different sizes using <code>.ui-select-lg, *-sm, *-xs</code> classes added to the parent container.</p>

										<select name="speed" class="select-basic">
											<option value="AZ">Arizona</option>
											<option value="CO">Colorado</option>
											<option disabled="disabled" value="ID">Idaho</option>
											<option disabled="disabled" value="WY">Wyoming</option>
											<option value="AL">Alabama</option>
											<option disabled="disabled" value="AR">Arkansas</option>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">With icons</h6>
										<p class="content-group-sm">Selectmenu with icons and option groups. Uses <code>_renderItem</code> method that controls the creation of each option in the widget's menu. The method must create a new <code>&lt;li></code> element, append it to the menu, and return it.</p>

										<select name="speed" id="select-icons">
									...
									<div class="content-group">
										<h6 class="text-semibold">Custom width</h6>
										<p class="content-group-sm">Example os Selectmenu component with auto width. This is the default width of the select that depends on the value size. For custom width use <code>width</code> option. When the value is null, the width of the native select is used.</p>

										<select name="speed" id="select-width">
								...
								<div class="col-md-6">
									<div class="content-group-lg">
										<h6 class="text-semibold">Option groups</h6>
										<p class="content-group-sm">Example of Selectmenu with option groups. Select's opgroups are supported by default and use optgroup's <code>label</code> attribute as a text label. The styling is similar to optgroups in other custom select components.</p>

										<select name="speed" id="select-optgroups">
											<optgroup label="Mountain Time Zone">
												<option value="AZ">Arizona</option>
												<option value="CO">Colorado</option>
												<option value="ID">Idaho</option>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">With images</h6>
										<p class="content-group-sm">Selectmenu with images. Uses <code>_renderItem</code> method that controls the creation of each option in the widget's menu. The method must create a new <code>&lt;li></code> element, append it to the menu, and return it. Image size is equal to icons size.</p>

										<select name="speed" id="select-images">
									...
									<div class="content-group">
										<h6 class="text-semibold">Disabled state</h6>
										<p class="content-group-sm">The following example demonstrates <code>disabled</code> state of select menu. Select can be disabled either on init if <code>disabled</code> option is set to <code>true</code> or after init using <code>("option", "disabled", true)</code> setter.</p>

										<select name="speed" id="select-disabled">
											<option value="AZ">Arizona</option>
											<option value="CO">Colorado</option>
											<option value="ID">Idaho</option>
											<option value="WY">Wyoming</option>
						...
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="content-group-lg">
										<h6 class="text-semibold">Default functionality</h6>
										<p class="content-group-sm">This example demonstrates the very basic functionality with default options. Starting value is specified in input's <code>value</code>, mouse wheel support is added by default. Buttons styling and icons can be changed in CSS.</p>

										<input id="spinner-basic" class="form-control" value="10">
									</div>

									<div class="content-group-lg">
										<h6 class="text-semibold">Decimal spinner</h6>
										<p class="content-group-sm">Decimal spinner with <code>0.01</code> step. The code handling the culture change reads the current spinner value, then changes the culture, then sets the value again, resulting in an updated formatting, based on the new culture.</p>
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<select class="select-basic" id="spinner-decimal-culture">
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Time spinner</h6>
										<p class="content-group-sm">A custom widget extending spinner. Use the <code>globalization.js</code> plugin to parse and output a timestamp, with custom <code>step</code> and <code>page</code> options. Cursor up/down spins minutes, page up/down spins hours.</p>
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<select class="select-basic" id="spinner-time-culture">
													<option value="en-EN" selected="selected">English</option>
													<option value="de-DE">German</option>
												</select>
											</div>
									...
									<div class="content-group">
										<h6 class="text-semibold">Spinner min/max limits</h6>
										<p class="content-group-sm">Example with <code>minimum</code> and <code>maximum</code> allowed values. If <code>globalize.js</code> is included, the <code>min</code> and <code>max</code> options can be passed as a string which will be parsed based on the <code>numberFormat</code> and culture options.</p>

										<input id="spinner-limits" class="form-control" value="10">
									</div>
								</div>

								<div class="col-md-6">
									<div class="content-group-lg">
										<h6 class="text-semibold">Currency</h6>
										<p class="content-group-sm">Example of a currency selection and amount spinner. Uses <code>numberFormat</code> option to specify a format of numbers passed to Globalize, if available. Most common are "n" for a decimal number and "C" for a currency value.</p>
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<select class="select-basic" id="spinner-currency-culture">
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Spinner overflow</h6>
										<p class="content-group-sm">The following example demonstrates <strong>overflow</strong> feature used together with <code>spin</code> event. Overflowing spinner restricted to a range of -10 to 10. For anything above 10, it'll overflow to -10, and the other way round.</p>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold">Disabled state</h6>
										<p class="content-group-sm">The following example demonstrates <code>disabled</code> state of a spinner. Spinner can be disabled either on init if <code>disabled</code> option is set to <code>true</code> or after init using <code>("option", "disabled", true)</code> setter.</p>

										<input id="spinner-disabled" class="form-control" value="10">
									</div>

									<div class="content-group">
										<h6 class="text-semibold">Spinner step</h6>
										<p class="content-group-sm">The spinner's <code>step</code> option controls the size of the step to take when spinning via buttons or via the <code>stepUp()</code>/<code>stepDown()</code> methods. The element's step attribute is used if it exists and the option is not explicitly set.</p>

										<input id="spinner-step" class="form-control" value="10">
									</div>
								</div>
							</div>
						</div>
