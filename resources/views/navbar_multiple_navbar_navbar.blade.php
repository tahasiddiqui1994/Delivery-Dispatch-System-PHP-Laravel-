								...
								<li>
									...
									<ul>
										...
										<li>
											...
											<ul>
												<li class="active"><a href="navbar_multiple_navbar_navbar">Navbar + navbar</a></li>
				...
				<div class="page-header page-header-default">
						...
						<div class="heading-elements">
							<form class="heading-form">
								<div class="form-group">
									<select data-placeholder="Single navbar" id="single">
										<option></option>
										<option value="main_top">Main top fixed</option>
										<option value="secondary_top">Secondary top fixed</option>
										<option value="main_bottom">Main bottom fixed</option>
										<option value="reset">Reset to static</option>
									</select>
								</div>

								<div class="form-group">
									<select data-placeholder="Multiple navbars" id="multiple">
										<option></option>
										<option value="multiple_top">Multiple fixed top</option>
										<option value="multiple_bottom">Multiple fixed bottom</option>
										<option value="reset">Reset to static</option>
									</select>
								</div>
							</form>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navbar_multiple_navbar_navbar">Navbars</a></li>
							<li class="active">Navbar + navbar</li>
						</ul>
