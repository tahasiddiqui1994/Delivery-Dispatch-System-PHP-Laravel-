...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/sidebar_detached_sticky_custom.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="sidebar_detached_sticky_custom">Sticky (custom scroll)</a></li>
