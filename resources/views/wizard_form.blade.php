...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/forms/wizards/form_wizard/form.min.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/forms/wizards/form_wizard/form_wizard.min.js')}}"></script>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/wizard_form.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="wizard_form">Form wizard</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="wizards_form">Wizards</a></li>
				...
				<div class="content">
		            ...
		            <div class="panel panel-white">
	                	...
	                	<form class="form-ajax" action="assets/demo_data/wizard/json" method="post">
		            ...
		            <div class="panel panel-white">
	                	...
	                	<form class="form-post-cancel" action="assets/demo_data/wizard/json" method="post">
