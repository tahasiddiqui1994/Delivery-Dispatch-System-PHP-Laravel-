...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_breadcrumbs">Breadcrumbs</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Components</span> - Breadcrumbs</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="components_breadcrumbs">Components</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						...
						<small class="display-block">Page header, top, bottom etc.</small>
					</h6>
					<!-- /breadcrumb placement title -->
					...
					<div class="content-group border-top-lg border-top-primary">
						<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
							<div class="page-header-content">
								<div class="page-title">
									<h5>
										<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Header</span> - Breadcrumb
					...
					<div class="content-group border-top-lg border-top-primary">
						<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
							...
							<div class="page-header-content">
								<div class="page-title">
									<h5>
										<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Breadcrumb</span> - Top Full Width
										<small class="display-block">Top position - placed before page header content</small>
									</h5>
								</div>
					...
					<div class="content-group border-top-lg border-top-primary">
						<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
							<div class="page-header-content">
								...
								<div class="page-title">
									<h5>
										<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Breadcrumb</span> - Top Transparent 
										<small class="display-block">No border, background color and bigger padding</small>
									</h5>
								</div>
					...
					<!-- Top component -->
					<div class="content-group border-top-lg border-top-primary">
						<div class="page-header page-header-default pt-20" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
							...
							<div class="page-header-content">
								<div class="page-title">
									<h5>
										<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Breadcrumb</span> - Top Component 
										<small class="display-block">Navbar as a component</small>
									</h5>
								</div>
					...
					<div class="content-group border-top-lg border-top-primary">
						<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
							<div class="page-header-content">
								<div class="page-title">
									<h5>
										<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Breadcrumb</span> - Bottom Full Width 
										<small class="display-block">Default bottom position</small>
									</h5>
								</div>
					...
					<div class="content-group border-top-lg border-top-primary">
						<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
							<div class="page-header-content">
								<div class="page-title">
									<h5>
										<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Breadcrumb</span> - Bottom Transparent 
										<small class="display-block">No border, background color and bigger padding</small>
									</h5>
								</div>
					...
					<!-- Bottom component -->
					<div class="content-group border-top-lg border-top-primary">
						<div class="page-header page-header-default pb-20" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
							<div class="page-header-content">
								<div class="page-title">
									<h5>
										<i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Breadcrumb</span> - Bottom Component 
										<small class="display-block">Navbar as a component</small>
									</h5>
								</div>
					...
					<h6 class="content-group text-semibold pt-10">
						Inside page title
						<small class="display-block">Above or below page title</small>
					</h6>
					<!-- /breadcrumb inside title -->
						...
						<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
							<div class="page-header-content">
								<div class="page-title">
									...
									<h5><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Breadcrumb</span> - Top Condensed</h5>
								</div>
						...
						<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
							<div class="page-header-content">
								<div class="page-title">
									...
									<h5><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Breadcrumb</span> - Top Condensed Spaced</h5>
								</div>
					...
					<div class="content-group border-top-lg border-top-primary">
						<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
							<div class="page-header-content">
								<div class="page-title">
									<h5><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Breadcrumb</span> - Bottom Condensed</h5>
					...
					<div class="content-group border-top-lg border-top-primary">
						<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
							<div class="page-header-content">
								<div class="page-title">
									<h5><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Breadcrumb</span> - Bottom Condensed Spaced</h5>
					...
					<h6 class="content-group text-semibold pt-10">
						...
						<small class="display-block">Use breadcrumb as a component</small>
					</h6>

					<div class="breadcrumb-line breadcrumb-line-component content-group-lg">
						<ul class="breadcrumb">
							<li><a href="#"><i class="icon-home2 position-left"></i> Stand</a></li>
							<li><a href="#">Alone</a></li>
							<li class="active">Component</li>
						</ul>

						<ul class="breadcrumb-elements">
							<li><a href="#"><i class="icon-comment-discussion position-left"></i> Chats</a></li>
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">
									<i class="icon-gear position-left"></i>
									Actions
					...
					<h6 class="content-group text-semibold">
						Breadcrumb options 
						<small class="display-block">Custom breadcrumb styling options</small>
					</h6>
						...
						<div class="col-md-6">
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												...
												<small class="display-block">Default breadcrumb styling</small>
											</h5>
										</div>
									</div>
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Add text using <code>.location-text</code> class</small>
											</h5>
										</div>
									</div>
									...
									<div class="breadcrumb-line">
										<ul class="breadcrumb">
											<li class="location-text text-size-mini text-uppercase text-muted">You are here:</li>
											<li><a href="#">Home</a></li>
											<li><a href="#">Current</a></li>
											<li class="active">Location</li>
										</ul>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Breadcrumb list with <code>home</code> icon only</small>
											</h5>
										</div>
									</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Breadcrumb list with icons</small>
											</h5>
										</div>
									</div>
									...
									<div class="breadcrumb-line">
										<ul class="breadcrumb">
											...
											<li><a href="#"><i class="icon-menu7 position-left"></i> Current</a></li>
											<li class="active"><i class="icon-pin-alt position-left"></i> Location</li>
										</ul>
									</div>
								</div>
							</div>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Breadcrumb with icons only and a <code>tooltip</code></small>
											</h5>
										</div>
									</div>

									<div class="breadcrumb-line">
										<ul class="breadcrumb breadcrumb-liquid">
											<li class="location-text text-size-mini text-uppercase text-muted">You are here:</li>
											<li><a href="#"><i class="icon-home2" data-popup="tooltip" title="Home"></i></a></li>
											<li><a href="#"><i class="icon-hash" data-popup="tooltip" title="Main"></i></a></li>
											<li><a href="#"><i class="icon-menu7" data-popup="tooltip" title="Current"></i></a></li>
											<li class="active"><i class="icon-pin" data-popup="tooltip" title="Location"></i></li>
										</ul>
									</div>
								</div>
							</div>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Arrows divider using <code>ul.breadcrumb-arrows</code></small>
											</h5>
										</div>
									</div>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Dash divider using <code>ul.breadcrumb-dash</code></small>
											</h5>
										</div>
									</div>

									<div class="breadcrumb-line">
										<ul class="breadcrumb breadcrumb-dash">
											<li><a href="#"><i class="icon-home2 position-left"></i> Home</a></li>
											<li><a href="#">Current</a></li>
											<li class="active">Location</li>
										</ul>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Caret divider using <code>ul.breadcrumb-caret</code></small>
											</h5>
										</div>
									</div>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Arrow divider using <code>ul.breadcrumb-arrow</code></small>
											</h5>
										</div>
									</div>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Links with dropdown menu</small>
											</h5>
										</div>
									</div>
										...
										<ul class="breadcrumb">
											<li>
												...
												<ul class="dropdown-menu">
													...
													<li><a href="#">Intranet dashboard</a></li>
													<li><a href="#">Front end dashboard</a></li>
													<li><a href="#">Simplified dashboard</a></li>
												</ul>
											</li>
											<li>
												<a href="#">Forms</a>
												<ul class="dropdown-menu">
													...
													<li class="dropdown-submenu">
														<a href="#">Selects</a>
														<ul class="dropdown-menu">
															<li><a href="#">Select2 selects</a></li>
															<li><a href="#">Bootstrap multiselect</a></li>
															<li><a href="#">SelectBoxIt selects</a></li>
															<li><a href="#">Bootstrap selects</a></li>
														</ul>
													</li>
													<li><a href="#">Advanced components</a></li>
													<li><a href="#">Editable forms</a></li>
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Links with dropdown menu and <code>carets</code></small>
											</h5>
										</div>
									</div>
									...
									<div class="breadcrumb-line">
										<ul class="breadcrumb">
											<li>
												<a href="#"><i class="icon-home2 position-left"></i> Home <span class="caret"></span></a>
												<ul class="dropdown-menu">
													<li><a href="#">Default dashboard</a></li>
													<li><a href="#">Statistics dashboard</a></li>
													<li><a href="#">Ecommerce dashboard</a></li>
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Dropdown animation using <code>animate.css</code></small>
											</h5>
										</div>
									</div>
									...
									<div class="breadcrumb-line">
										<ul class="breadcrumb">
											<li>
												<a href="#"><i class="icon-home2"></i> <span class="caret"></span></a>
					...
					<h6 class="content-group text-semibold">
						Breadcrumb elements
						<small class="display-block">Basic breadcrumb line elements</small>
					</h6>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Breadcrumb line with single button</small>
											</h5>
										</div>
									</div>
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Single button with icon</small>
											</h5>
										</div>
									</div>
									...
									<div class="breadcrumb-line">
										...
										<ul class="breadcrumb-elements">
											<li><a href="#"><i class="icon-screen-full position-left"></i> Left icon</a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									...
									<div class="breadcrumb-line">
										...
										<ul class="breadcrumb-elements">
											<li><a href="#">Right icon <i class="icon-three-bars position-right"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Single button with icon only</small>
											</h5>
										</div>
									</div>
									...
									<div class="breadcrumb-line">
										...
										<ul class="breadcrumb-elements">
											<li><a href="#"><i class="icon-sphere"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
								...
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Breadcrumb line with button group</small>
											</h5>
										</div>
									</div>
									...
									<div class="breadcrumb-line">
										...
										<ul class="breadcrumb-elements">
											...
											<li class="dropdown">
												<a href="#" class="dropdown-toggle" data-toggle="dropdown">Third <span class="caret"></span></a>
												<ul class="dropdown-menu dropdown-menu-right">
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Breadcrumb line with button dropdown</small>
											</h5>
										</div>
									</div>
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Button dropdown with icon and caret</small>
											</h5>
										</div>
									</div>
									...
									<div class="breadcrumb-line">
										...
										<ul class="breadcrumb-elements">
											<li>
												<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-bubbles3 position-left"></i> Menu <span class="caret"></span></a>
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="#">Action</a></li>
													<li><a href="#">Another action</a></li>
													<li><a href="#">Something else here</a></li>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">With single icon button dropdown</small>
											</h5>
										</div>
									</div>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Button group with icons only</small>
											</h5>
										</div>
									</div>
							...
							<div class="content-group border-top-lg border-top-primary">
								<div class="page-header page-header-default" style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Breadcrumb line buttons with label</small>
											</h5>
										</div>
									</div>
									...
									<div class="breadcrumb-line">
										...
										<ul class="breadcrumb-elements">
											<li><a href="#">Messages <span class="label label-warning position-right">New</span></a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<h6 class="content-group text-semibold">
						Breadcrumb colors 
						<small class="display-block">Custom breadcrumb <a href="colors_primary">color options &rarr;</a></small>
					</h6>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Primary <a href="colors_primary">color theme</a> with single button</small>
											</h5>
										</div>
									</div>
								</div>
									...
									<div class="page-header-content">
										<div class="page-title">
											<h5>
												<i class="icon-arrow-left52 position-left"></i>
												<span class="text-semibold">Components</span> - Breadcrumb
												<small class="display-block">Teal <a href="colors_teal">color theme</a> with button dropdown</small>
											</h5>
										</div>
									</div>
