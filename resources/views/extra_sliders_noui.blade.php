...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/extra_sliders_noui.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="extra_sliders_noui">NoUI sliders</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Extra</span> - NoUI Sliders</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="extra_sliders_noui">Components</a></li>
							<li class="active">NoUI sliders</li>
						</ul>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						NoUI sliders
						<small class="display-block">Basic NoUI slider examples</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Slider handles</h6>
									<p class="content-group-sm text-muted">Set handles using <code>start</code> option</p>
								</div>

								<div id="noui-slider-handles"></div>

								<div class="clearfix">
									<span class="val-demo pull-left">Value: <span id="noui-handles-lower-val"></span></span>
									<span class="val-demo pull-right">Value: <span id="noui-handles-upper-val"></span></span>
								</div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Non-linear slider</h6>
									<p class="content-group-sm text-muted">Displays non-linear slider example</p>
								</div>

								<div id="noui-slider-nonlinear"></div>

								<span class="val-demo">Value: <span id="noui-nonlinear-val"></span></span>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Values range</h6>
									<p class="content-group-sm text-muted">Slider values are part of a range</p>
								</div>

								<div id="noui-slider-range"></div>

								<span class="val-demo">Value: <span id="noui-range-val"></span></span>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Non-linear stepping</h6>
									<p class="content-group-sm text-muted">Displays steps in non-linear slider</p>
								</div>

								<div id="noui-slider-nonlinear-stepping"></div>

								<div class="clearfix">
									<span class="val-demo pull-left">Value: <span id="noui-nonlinear-stepping-lower-val"></span></span>
									<span class="val-demo pull-right">Value: <span id="noui-nonlinear-stepping-upper-val"></span></span>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Stepping and snapping</h6>
									<p class="content-group-sm text-muted">Set slider steps with <code>step</code> option</p>
								</div>

								<div id="noui-slider-stepping"></div>

								<span class="val-demo">Value: <span id="noui-stepping-val"></span></span>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Snapping between steps</h6>
									<p class="content-group-sm text-muted">Force slider to jump between values</p>
								</div>

								<div id="noui-slider-snapping"></div>

								<div class="clearfix">
									<span class="val-demo pull-left">Value: <span id="noui-slider-snapping-lower-val"></span></span>
									<span class="val-demo pull-right">Value: <span id="noui-slider-snapping-upper-val"></span></span>
								</div>
							</div>
						</div>
					</div>
					...
					<h6 class="content-group text-semibold">
						Slider Behaviour
						<small class="display-block">Tapping, dragging, snapping etc.</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Slider behaviour</h6>
									<p class="content-group-sm text-muted">Add behaviour to the slider</p>
								</div>

								<div id="noui-slider-behaviour"></div>

								<div class="clearfix">
									<span class="val-demo pull-left">Value: <span id="noui-slider-behaviour-lower-val"></span></span>
									<span class="val-demo pull-right">Value: <span id="noui-slider-behaviour-upper-val"></span></span>
								</div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Fixed dragging</h6>
									<p class="content-group-sm text-muted">Distance between handles is fixed</p>
								</div>

								<div id="noui-slider-drag-fixed"></div>

								<div class="clearfix">
									<span class="val-demo pull-left">Value: <span id="noui-slider-fixed-lower-val"></span></span>
									<span class="val-demo pull-right">Value: <span id="noui-slider-fixed-upper-val"></span></span>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Tap behaviour</h6>
									<p class="content-group-sm text-muted">A handle slides to a clicked location</p>
								</div>

								<div id="noui-slider-tap"></div>

								<span class="val-demo">Value: <span id="noui-slider-tap-val"></span></span>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Snap behaviour</h6>
									<p class="content-group-sm text-muted">A handle snaps to a clicked location</p>
								</div>

								<div id="noui-slider-snap"></div>

								<span class="val-demo">Value: <span id="noui-slider-snap-val"></span></span>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Drag behaviour</h6>
									<p class="content-group-sm text-muted">Makes the range dragable</p>
								</div>

								<div id="noui-slider-drag"></div>

								<div class="clearfix">
									<span class="val-demo pull-left">Value: <span id="noui-slider-drag-lower-val"></span></span>
									<span class="val-demo pull-right">Value: <span id="noui-slider-drag-upper-val"></span></span>
								</div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Combined options</h6>
									<p class="content-group-sm text-muted">Behaviour flags can be combined</p>
								</div>

								<div id="noui-slider-combined"></div>

								<div class="clearfix">
									<span class="val-demo pull-left">Value: <span id="noui-slider-combined-lower-val"></span></span>
									<span class="val-demo pull-right">Value: <span id="noui-slider-combined-upper-val"></span></span>
								</div>
							</div>
						</div>
					</div>
					...
					<h6 class="content-group text-semibold">
						Pips and scales
						<small class="display-block">Adding a scale/pips to a slider</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Slider with pips</h6>
									<p class="content-group-sm text-muted">Slider pips in <code>range</code> mode</p>
								</div>

								<div class="noui-slider-info has-pips" id="noui-slider-pips-range"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Count mode</h6>
									<p class="content-group-sm text-muted">Slider pips in <code>count</code> mode</p>
								</div>

								<div class="noui-slider-info has-pips" id="noui-slider-pips-count"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Filtered steps</h6>
									<p class="content-group-sm text-muted">Slider with filtered pip labels</p>
								</div>
							...
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Values mode</h6>
									<p class="content-group-sm text-muted">Slider pips in <code>values</code> mode</p>
								</div>

								<div class="noui-slider-info has-pips" id="noui-slider-pips-values"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">RTL direction</h6>
									<p class="content-group-sm text-muted">Slider pips in <code>RTL</code> direction</p>
								</div>

								<div class="noui-slider-info has-pips" id="noui-slider-pips-rtl"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Positions mode</h6>
									<p class="content-group-sm text-muted">Slider pips in <code>positions</code> mode</p>
								</div>

								<div class="noui-slider-info has-pips" id="noui-slider-pips-positions"></div>
							</div>
						</div>
					</div>
					<!-- /pips and scales -->
					...
					<h6 class="content-group text-semibold">
						Advanced examples
						<small class="display-block">More complex NoUI slider examples</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Slider with tooltips</h6>
									<p class="content-group-sm text-muted">Add tooltips with <code>serialization</code> feature</p>
								</div>

								<div class="noui-slider-danger" id="noui-slider-tooltip"></div>

								<div class="clearfix">
									<span class="val-demo pull-left">Value: <span id="noui-slider-tooltip-lower-val"></span></span>
									<span class="val-demo pull-right">Value: <span id="noui-slider-tooltip-upper-val"></span></span>
								</div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Connect to lower side</h6>
									<p class="content-group-sm text-muted">Connect handle to the <code>lower</code> side</p>
								</div>

								<div class="noui-slider-primary" id="noui-slider-connect-lower"></div>

								<span class="val-demo">Value: <span id="noui-slider-connect-lower-val"></span></span>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Min handles distance</h6>
									<p class="content-group-sm text-muted">Set minimum distance between handles</p>
								</div>

								<div class="noui-slider-danger" id="noui-slider-margin"></div>

								<div class="clearfix">
									<span class="val-demo pull-left">Value: <span id="noui-slider-margin-lower-val"></span></span>
									<span class="val-demo pull-right">Value: <span id="noui-slider-margin-upper-val"></span></span>
								</div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Skipping steps</h6>
									<p class="content-group-sm text-muted">Skip certain steps with <code>snap</code> option</p>
								</div>

								<div class="noui-slider-primary" id="noui-slider-skip-steps"></div>

								<div class="clearfix">
									<span class="val-demo pull-left">Value: <span id="noui-slider-skip-lower-val"></span></span>
									<span class="val-demo pull-right">Value: <span id="noui-slider-skip-upper-val"></span></span>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">RTL slider direction</h6>
									<p class="content-group-sm text-muted">Change direction with <code>direction</code> option</p>
								</div>

								<div class="noui-slider-danger" id="noui-slider-direction"></div>

								<span class="val-demo">Value: <span id="noui-slider-direction-val"></span></span>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Connect to upper side</h6>
									<p class="content-group-sm text-muted">Connect handle to the <code>upper</code> side</p>
								</div>

								<div class="noui-slider-primary" id="noui-slider-connect-upper"></div>
								<span class="val-demo">Value: <span id="noui-slider-connect-upper-val"></span></span>
							</div>
						</div>
					</div>
					<!-- /advanced examples -->
					...
					<h6 class="content-group text-semibold">
						Vertical sliders
						<small class="display-block">NoUI vertical slider orientation</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Default vertical slider</h6>
								<p class="content-group-sm text-muted">Vertical direction slider example</p>

								<div id="noui-slider-values1"></div>
								<div id="noui-slider-values2"></div>
								<div id="noui-slider-values3"></div>
								<div id="noui-slider-values4"></div>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Vertical ranges</h6>
								<p class="content-group-sm text-muted">Add ranges to vertical slider</p>

								<div class="noui-slider-primary" id="noui-slider-range1"></div>
								<div class="noui-slider-primary" id="noui-slider-range2"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								...
								<div class="noui-slider-primary" id="noui-slider-upper1"></div>
								<div class="noui-slider-success" id="noui-slider-upper2"></div>
								<div class="noui-slider-danger" id="noui-slider-upper3"></div>
								<div class="noui-slider-info" id="noui-slider-upper4"></div>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Top to bottom pips</h6>
								<p class="content-group-sm text-muted">Scale pips from top to bottom</p>

								<div class="noui-slider-primary has-pips" id="noui-slider-top1"></div>
								<div class="noui-slider-primary has-pips" id="noui-slider-top2"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								...
								<div class="noui-slider-primary" id="noui-slider-lower1"></div>
								<div class="noui-slider-success" id="noui-slider-lower2"></div>
								<div class="noui-slider-danger" id="noui-slider-lower3"></div>
								<div class="noui-slider-info" id="noui-slider-lower4"></div>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Bottom to top pips</h6>
								<p class="content-group-sm text-muted">Scale pips from bottom to top</p>

								<div class="noui-slider-primary has-pips" id="noui-slider-bottom1"></div>
								<div class="noui-slider-primary has-pips" id="noui-slider-bottom2"></div>
							</div>
						</div>
					</div>
					<!-- /vertical sliders -->
					...
					<h6 class="content-group text-semibold">
						Slider colors
						<small class="display-block">Contextual NoUI slider alternatives</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Default slider</h6>
									<p class="content-group-sm text-muted">Default <code>dark grey</code> slider color</p>
								</div>

								<div class="mb-5" id="noui-slider-color-demo1"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Success slider style</h6>
									<p class="content-group-sm text-muted">Using <code>noui-slider-success</code> class</p>
								</div>

								<div class="noui-slider-success mb-5" id="noui-slider-color-demo2"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Primary slider style</h6>
									<p class="content-group-sm text-muted">Using <code>noui-slider-primary</code> class</p>
								</div>

								<div class="noui-slider-primary mb-5" id="noui-slider-color-demo3"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Warning slider style</h6>
									<p class="content-group-sm text-muted">Using <code>noui-slider-warning</code> class</p>
								</div>

								<div class="noui-slider-warning mb-5" id="noui-slider-color-demo4"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Danger slider style</h6>
									<p class="content-group-sm text-muted">Using <code>noui-slider-danger</code> class</p>
								</div>

								<div class="noui-slider-danger mb-5" id="noui-slider-color-demo5"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Info slider style</h6>
									<p class="content-group-sm text-muted">Using <code>noui-slider-info</code> class</p>
								</div>

								<div class="noui-slider-info mb-5" id="noui-slider-color-demo6"></div>
							</div>
						</div>
					</div>
					<!-- /slider colors -->
					...
					<h6 class="content-group text-semibold">
						...
						<small class="display-block">Optional slider settings</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Sizes. Default handle</h6>
									<p class="content-group-sm text-muted">Using <code>noui-slider-lg (sm, xs)</code> classes</p>
								</div>

								<div class="noui-slider-primary noui-slider-lg" id="slider-default-lg" style="margin-bottom: 30px;"></div>
								<div class="noui-slider-danger" id="slider-default-md" style="margin-bottom: 30px;"></div>
								<div class="noui-slider-success noui-slider-sm" id="slider-default-sm" style="margin-bottom: 30px;"></div>
								<div class="noui-slider-info noui-slider-xs mb-5" id="slider-default-xs"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Sizes. Solid handle</h6>
									<p class="content-group-sm text-muted">Using <code>noui-slider-solid</code> class</p>
								</div>

								<div class="noui-slider-primary noui-slider-solid noui-slider-lg" id="slider-solid-lg" style="margin-bottom: 30px;"></div>
								<div class="noui-slider-danger noui-slider-solid" id="slider-solid-md" style="margin-bottom: 30px;"></div>
								<div class="noui-slider-success noui-slider-solid noui-slider-sm" id="slider-solid-sm" style="margin-bottom: 30px;"></div>
								<div class="noui-slider-info noui-slider-solid noui-slider-xs mb-5" id="slider-solid-xs"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Sizes. White handle</h6>
									<p class="content-group-sm text-muted">Using <code>noui-slider-white</code> class</p>
								</div>

								<div class="noui-slider-primary noui-slider-white noui-slider-lg" id="slider-white-lg" style="margin-bottom: 30px;"></div>
								<div class="noui-slider-danger noui-slider-white" id="slider-white-md" style="margin-bottom: 30px;"></div>
								<div class="noui-slider-success noui-slider-white noui-slider-sm" id="slider-white-sm" style="margin-bottom: 30px;"></div>
								<div class="noui-slider-info noui-slider-white noui-slider-xs mb-5" id="slider-white-xs"></div>
							</div>
						</div>
					</div>
					<!-- /sizes and styles -->
