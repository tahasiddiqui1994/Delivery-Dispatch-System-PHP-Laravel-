							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="appearance_syntax_highlighter">Syntax highlighter</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Appearance</span> - Syntax Highlighter</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="appearance_syntax_highlighter">Appearance</a></li>
							<li class="active">Syntax highlighter</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Basic syntax highlighter</h5>
							<div class="heading-elements">
								<ul class="icons-list">
...
&lt;!-- /navbar markup --></code></pre>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Line highlight</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
...
&lt;!-- /navbar markup --></code></pre>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Line numbers</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
...
&lt;!-- /navbar markup --></code></pre>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Define starting line</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
...
&lt;!-- /navbar markup --></code></pre>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Available languages</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">By default, a complete prism.js build allows you to add up to 38 languages. Current build includes 21: markup, css, css-extras, clike, javascript, java, php, php-extras, coffeescript, scss, c, python, sql, ruby, csharp, aspnet, swift, objectivec, git, perl and handlebars. Available addons: line-highlight, line-numbers, autolinker, file-highlight and show-language. For a custom build, please go to <a href="http://prismjs.com/download">this page</a>.</p>

							<div class="row">
								<div class="col-md-6">
									<p class="text-semibold">CSS example</p>

<pre class="language-css content-group"><code>/* CSS highlight */
.line-highlight {
	position: absolute;
	left: 0;
	right: 0;
...
.line-highlight[data-end]:after {
	...
	color: #999;
								...
								<div class="col-md-6">
									<p class="text-semibold">JS example</p>

<pre class="language-javascript content-group"><code>/* JS highlight */
