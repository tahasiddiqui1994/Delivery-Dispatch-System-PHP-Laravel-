...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/google/pies/pie.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/pies/pie_exploded.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/pies/pie_rotate.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/pies/donut.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/pies/donut_rotate.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/pies/donut_exploded.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/pies/pie_3d.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/pies/3d_exploded.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/pies/pie_diff_radius.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/pies/pie_diff_border.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/pies/pie_diff_opacity.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/pies/pie_diff_invert.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="google_pies">Pie charts</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Google</span> - Pie Charts</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="google_pies">Google</a></li>
				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									<p class="content-group">A <code>pie chart</code> is a divided into sectors, illustrating numerical proportion. In a pie chart, the arc length of each sector (and consequently its central angle and area), is proportional to the quantity it represents. While it is named for its resemblance to a pie which has been sliced, there are variations on the way it can be presented.</p>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Rotated pie chart</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">By default, <code>pie</code> charts begin with the left edge of the first slice pointing straight up. You can change that with the <code>pieStartAngle</code> option. Here, we rotate the chart clockwise 180 degrees with an option of <code>pieStartAngle: 180</code>. So chosen because that particular angle happens to make the slices reflected.</p>

									<div class="chart-container text-center">
										<div class="display-inline-block" id="google-pie-rotate"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Rotated donut chart</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">By default, <code>donut</code> charts begin with the left edge of the first slice pointing straight up. You can change that with the <code>pieStartAngle</code> option. Here, we rotate the chart clockwise 180 degrees with an option of <code>pieStartAngle: 180</code>. So chosen because that particular angle happens to make the slices reflected.</p>

									<div class="chart-container text-center">
										<div class="display-inline-block" id="google-donut-rotate"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Exploded pie charts</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Diff pie charts</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="content-group">
										<h6 class="text-semibold">Inner circle radius</h6>
										<p class="content-group">Example of <code>diff</code> pie chart with <code>radius</code> factor - the relative size of the circles can be controlled with <code>diff.innerCircle.radiusFactor</code> option.</p>

										<div class="chart-container text-center">
											<div class="display-inline-block" id="google-pie-diff-radius"></div>
										</div>
									</div>

									<div class="content-group">
										<h6 class="text-semibold">Inner circle transparency</h6>
										<p class="content-group">Example of <code>diff</code> pie chart with <code>transparency</code> - the transparency of each data can be controlled with <code>diff.oldData.opacity</code> and <code>diff.newData.opacity</code>.</p>

										<div class="chart-container text-center">
											<div class="display-inline-block" id="google-pie-diff-opacity"></div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="content-group">
										<h6 class="text-semibold">Inner circle border</h6>
										<p class="content-group">Example of <code>diff</code> pie chart with <code>border</code> factor - the border between the two datas can be controlled with <code>diff.innerCircle.borderFactor</code> option.</p>

										<div class="chart-container text-center">
											<div class="display-inline-block" id="google-pie-diff-border"></div>
										</div>
									</div>

									<div class="content-group">
										<h6 class="text-semibold">Inverted difference</h6>
										<p class="content-group">Example of <code>diff</code> pie chart with <code>inverted</code> behaviour - the behavior can be inverted so that the oldest data surrounds the newest data with <code>diff.oldData.inCenter</code> option.</p>

										<div class="chart-container text-center">
											<div class="display-inline-block" id="google-pie-diff-invert"></div>
										</div>
									</div>
								</div>
							</div>
