...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/jqueryui_navigation.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="jqueryui_navigation">Navigation</a></li>
									</ul>
								</li>
								<li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">jQuery UI</span> - Navigation</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="jqueryui_navigation">jQuery UI</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Accordion component
						<small class="display-block">jQuery UI accordion widget with options</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									<p class="content-group">Click headers to expand/collapse content that is broken into logical sections, much like tabs. The underlying HTML markup is a series of headers (<code>span</code> tags) and content divs so the content is usable without JavaScript.</p>

									<div id="jui-accordion-basic">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Animation</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Control animation easing and duration using <code>animate</code> option. Accepts <code>true</code> or <code>false</code> values; <strong>number</strong> - duration in milliseconds; <strong>string</strong> - name of easing; <strong>object</strong> - containing <code>easing</code> and <code>duration</code> properties.</p>

									<div id="jui-accordion-animate">
										<span class="text-semibold">Section 1</span>
										<div>
											Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch.
										</div>
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Collapse content</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">By default, accordions always keep one section open. To allow for all sections to be be collapsible, set the <code>collapsible</code> option to <code>true</code> in widget configuration. Click on the currently open section to collapse its content pane.</p>

									<div id="jui-accordion-collapsible">
										<span class="text-semibold">Section 1</span>
										<div>
											Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch.
										</div>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Open on hover</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">By default, accordion uses <code>click</code> event to collapse/expand content. It can be changed using <code>event</code> option, that is responsible for activating the associated panel. Multiple events can be specified, separated by a space.</p>

									<div id="jui-accordion-hover">
										<span class="text-semibold">Section 1</span>
										<div>
											Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch.
										</div>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Sortable panels</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Accordion widget supports <strong>sortable</strong> functionality for panels re-ordering. To use, specify dragging <code>handle</code> and vertical <code>axis</code> in sortable accordion configuration and add accordion <code>refresh</code> when sorting is stopped.</p>

									<div id="jui-accordion-sortable">
					...
					<h6 class="content-group text-semibold">
						Menu component
						<small class="display-block">jQuery UI menu widget with options</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Basic configuration</h6>
									<p class="content-group text-muted">Basic menu with default functionality</p>
								</div>

								<ul class="jui-menu-basic">
							...
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Multiple levels</h6>
									<p class="content-group text-muted">Example of multi level sub menus</p>
								</div>
							...
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									...
									<p class="content-group text-muted">Basic header styling of label sections</p>
								</div>

								<ul class="jui-menu-header">
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									...
									<p class="content-group text-muted">Using <code>.ui-state-disabled</code> class</p>
								</div>
							...
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									...
									<p class="content-group text-muted">Dropdown icons in <code>left</code> position</p>
								</div>
							...
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									...
									<p class="content-group text-muted">Highlight header using <code>.highlight</code> class</p>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Disabled menu</h6>
									<p class="content-group text-muted">Disable menu using <code>disabled</code> option</p>
								</div>

								<ul class="jui-menu-disabled">
									<li><a href="#">Action</a></li>
									<li><a href="#">Another action</a></li>
									<li class="ui-state-disabled"><a href="#">Disabled item</a></li>
									<li class="ui-menu-divider"></li>
							...
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Element positions</h6>
									<p class="content-group text-muted">Components and their positions</p>
								</div>

								<ul class="jui-menu-basic">
									<li><a href="#"><i class="icon-gear pull-right"></i> <i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><span class="label label-primary pull-right">Added</span> <i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><span class="badge badge-danger pull-right">98</span> <i class="icon-mail5"></i> Something else here</a></li>
									<li class="ui-menu-divider"></li>
									<li><a href="#"><span class="pull-right text-size-large"><i class="icon-command"></i>F</span> <i class="icon-gear"></i> One more separated link</a></li>
								</ul>
							</div>
							...
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									...
									<p class="content-group text-muted">Display left/right positioned icons</p>
								</div>

								<ul class="jui-menu-header">
									<li class="ui-menu-header"><i class="icon-gear pull-right"></i> <i class="icon-menu7"></i> Header first</li>
									<li><a href="#">Action</a></li>
									<li><a href="#">Another action</a></li>
									<li class="ui-menu-header highlight"><i class="icon-gear pull-right"></i> <i class="icon-menu7"></i> Header second</li>
									<li><a href="#">Something else here</a></li>
									<li><a href="#">Another line</a></li>
								</ul>
							</div>
					...
					<h6 class="content-group text-semibold">
						Tabs component
						<small class="display-block">jQuery UI tabs widget with options</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Open on hover</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Tabs with icons</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="jui-tabs-basic">
										<ul>
											<li><a href="#tabs-basic-1"><i class="icon-menu7 position-left"></i> Active tab</a></li>
											<li><a href="#tabs-basic-2">Inactive tab <i class="icon-mention position-right"></i></a></li>
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Collapsible tabs</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="jui-tabs-collapsible">
										<ul>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Sortable tabs</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="jui-tabs-sortable" id="ui-tabs-sortable-container">
										<ul>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Labels and badges</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="jui-tabs-basic">
										<ul>
											<li><a href="#tabs-basic-1"><span class="label label-danger position-left">Bug</span> Active tab</a></li>
											<li><a href="#tabs-basic-2">Inactive tab <span class="badge bg-slate position-right">23</span></a></li>
											<li><a href="#tabs-basic-3"><span class="label bg-blue">Fixed</span></a></li>
										</ul>
										<div id="tabs-basic-1">
											Food truck fixie locavore, accusamus mcsweeney's marfa nulla single-origin coffee squid laeggin.
										</div>
