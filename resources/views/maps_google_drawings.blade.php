...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/maps/google/drawings/circles.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/google/drawings/polylines.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/google/drawings/polygons.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/google/drawings/rectangles.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										<li>
											...
											<ul>
												...
												<li class="active"><a href="maps_google_drawings">Map drawings</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Google Maps</span> - Drawings</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="maps_google_drawings">Google maps</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Circle shapes</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<p class="content-group">In addition to the generic <code>Polygon</code> class, the Google Maps JavaScript API includes a specific class for <code>Circle</code> objects, to simplify their construction. A <code>Circle</code> is similar to a <code>Polygon</code> in that you can define custom colors, weights, and opacities for the edge of the circle (the stroke) and custom colors and opacities for the area within the circle (the fill). Colors should be indicated in hexadecimal numeric HTML style.</p>

							<div class="map-container map-drawing-circles"></div>
						</div>
					</div>
					<!-- /circle shapes -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Polyline shapes</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Polygon shapes</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
