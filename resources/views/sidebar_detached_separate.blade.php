									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="sidebar_detached_separate">Separate categories</a></li>
											</ul>
										</li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Detached Separate</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_detached_separate">Sidebars</a></li>
							<li class="active">Detached separate</li>
						</ul>
					...
					<div class="container-detached">
						<div class="content-detached">
							...
							<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
								...
								<h6 class="alert-heading text-semibold">Separate categories</h6>
								You can use sidebar categories as separate widgets. To use, add <code>.sidebar-separate</code> class to detached sidebar.
						    </div>
						    <!-- /info alert -->
