...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/internationalization_callbacks.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="internationalization_callbacks" data-i18n="nav.int.callback"></a></li>
									</ul>
								</li>
								<!-- /extensions -->
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="internationalization_callbacks">Translation</a></li>
...
i18n.init({
	...
	// Callbacks
	alert("Library initialized, language file loaded."); //on init callback
	alert(i18n.lng()); //read out current language
