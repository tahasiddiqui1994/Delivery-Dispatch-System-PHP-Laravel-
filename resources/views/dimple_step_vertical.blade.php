...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/step/step_vertical_single.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/step/step_vertical_single_grouped.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/step/step_vertical_multiple.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/step/step_vertical_multiple_grouped.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="dimple_step_vertical">Vertical orientation</a></li>
											</ul>
										</li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Dimple</span> - Vertical Steps</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="dimple_step_vertical">Dimple</a></li>
							<li class="active">Vertical steps</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Single line</h6>
							<div class="heading-elements">
								<ul class="icons-list">
