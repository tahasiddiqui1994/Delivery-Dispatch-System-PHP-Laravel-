...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="form_dual_listboxes">Dual Listboxes</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Forms</span> - Dual Listboxes</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="form_dual_listboxes">Forms</a></li>
							<li class="active">Dual listboxes</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Multiple selection</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<select multiple="multiple" class="form-control listbox-filtered-results">
								<option value="option1">Classical mechanics</option>
								<option value="option2" selected="selected">Electromagnetism</option>
								...
								<option value="option12" selected="selected">Continuum mechanics</option>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Disable filter</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							...
							<select multiple="multiple" class="form-control listbox-filter-disabled">
								<option value="option1" selected="selected">Classical mechanics</option>
								<option value="option2">Electromagnetism</option>
								<option value="option4">Relativity</option>
								<option value="option5" selected="selected">Quantum mechanics</option>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Control boxes height</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Custom text support</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">This example demonstrates how custom text or language can be used in dual listbox controls. All this text labels and placeholders are fully editable through specified options, such as: <code>infoText</code>, <code>infoTextFiltered</code>, <code>infoTextEmpty</code>, <code>filterPlaceHolder</code> etc.</p>
							
							<select multiple="multiple" class="form-control listbox-custom-text">
								<option value="option1" selected="selected">Classical mechanics</option>
								<option value="option2">Electromagnetism</option>
								<option value="option4">Relativity</option>
								<option value="option5" selected="selected">Quantum mechanics</option>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Adding options dynamically</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
