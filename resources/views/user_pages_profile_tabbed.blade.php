...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/user_profile_tabbed.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="user_pages_profile_tabbed">Tabbed profile</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">User Pages</span> - Tabbed Profile</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="user_profile_tabbed">User pages</a></li>
								...
								<div class="content-group">
									...
									<div class="panel no-border-top no-border-radius-top">
										<ul class="navigation">
											...
											<li class="navigation-divider"></li>
											<li><a href="login_advanced"><i class="icon-switch2"></i> Log out</a></li>
										</ul>
									</div>
								</div>
								<!-- /user details -->
