...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_affix">Affix and Scrollspy</a></li>
									</ul>
								</li>
								<li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Components</span> - Affix &amp; Scrollspy</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="components_affix">Components</a></li>
							<li class="active">Affix &amp; scrollspy</li>
						</ul>
					...
					<div class="container-detached">
						<div class="content-detached">
							...
							<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
								...
								<h6 class="alert-heading text-semibold">Affix and Scrollspy</h6>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title" id="scrollspy">ScrollSpy component</h5>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									<div class="content-group-lg">
										<h6 class="text-semibold" id="scrollspy-data-attributes">Using Data Attributes</h6>
										<p class="content-group">To easily add scrollspy behavior to your topbar navigation, add <code>data-spy="scroll"</code> to the element you want to spy on (most typically this would be the <code>&lt;body&gt;</code>). Then add the <code>data-target</code> attribute with the ID or class of the parent element of any Bootstrap <code>.nav</code> component.</p>

<p>Add CSS styles:</p>
<pre class="language-css content-group"><code>body {
	position: relative;
}</code></pre>

<p>And add markup:</p>
<pre class="language-markup"><code>&lt;body data-spy="scroll" data-target=".navbar-example">
	...
...
&lt;/body></code></pre>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold" id="scrollspy-js">Using JavaScript</h6>
										<p>After adding <code>position: relative;</code> in your CSS, call the scrollspy via JavaScript:</p>

										<pre class="language-javascript content-group"><code>$('body').scrollspy({ target: '.navbar-example' });</code></pre>
									</div>


									<div class="content-group-lg">
										<h6 class="text-semibold" id="scrollspy-methods">Scrollspy Refresh Method</h6>
										<p>When using scrollspy in conjunction with adding or removing of elements from the DOM, you'll need to call the refresh method like so:</p>

<pre class="language-javascript content-group"><code>$('[data-spy="scroll"]').each(function () {
	var $spy = $(this).scrollspy('refresh')
									...
									<div class="content-group-lg">
										<h6 class="text-semibold" id="scrollspy-options">Scrollspy Options</h6>
									...
									<div class="content-group">
										<h6 class="text-semibold" id="scrollspy-events">Scrollspy Events</h6>
										...
										<p>Example code:</p>
<pre class="language-javascript content-group"><code>$('#myScrollspy').on('activate.bs.scrollspy', function () {
	// do something…
})</code></pre>
									</div>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title" id="affix">Affix component</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="content-group-lg">
										<h6 class="text-semibold">Positioning via CSS</h6>
										<p class="content-group">Use the affix plugin via data attributes or manually with your own JavaScript. In both situations, you must provide CSS for the positioning and width of your affixed content.
										The affix plugin toggles between three classes, each representing a particular state: <code>.affix</code>, <code>.affix-top</code>, and <code>.affix-bottom</code>. You must provide the styles for these classes yourself (independent of this plugin) to handle the actual positions.</p>

										<p class="text-semibold">Here's how the affix plugin works:</p>
										<ol class="list">
									...
									<div class="content-group-lg">
										<h6 class="text-semibold" id="affix-data-attributes">Using Data Attributes</h6>
...
<pre class="language-markup content-group"><code>&lt;div data-spy="affix" data-offset-top="60" data-offset-bottom="200">
  ...
&lt;/div></code></pre>
									</div>
									...
									<div class="content-group-lg">
										<h6 class="text-semibold" id="affix-js">Using JavaScript</h6>
										<p>Call the affix plugin via JavaScript:</p>

<pre class="language-javascript content-group"><code>$('#my-affix').affix({
	offset: {
		top: 100,
		bottom: function () {
			return (this.bottom = $('.footer').outerHeight(true))
									...
									<div class="content-group-lg">
										<h6 class="text-semibold" id="affix-options">Affix Options</h6>
									...
									<div class="content-group">
										<h6 class="text-semibold" id="affix-events">Affix Events</h6>
							...
							<div class="sidebar-content">
								...
								<div class="sidebar-category">
									<div class="category-title">
										...
										<i class="icon-cog5 pull-right"></i>
									</div>
									...
									<div class="category-content no-padding">
										<!-- <ul class="nav navigation">
											...
											<li><a href="#release">Initial release <span class="text-muted text-regular pull-right">20.08.2015</span></a></li>
											<li class="navigation-divider"></li>
											...
											<li><a href="http://themeforest.net/user/kopyov" target="_blank"><i class="icon-bug2 text-slate-400"></i> Bug report</a></li>
											<li><a href="http://themeforest.net/user/kopyov" target="_blank"><i class="icon-rocket text-slate-400"></i> Roadmap</a></li>
							            </ul> -->
										<ul class="nav navigation">
											<li class="navigation-header"><i class="icon-menu7 pull-right"></i> <span>ScrollSpy Plugin</span></li>
											<li><a href="#scrollspy">Overview</a></li>
							                <li>
								                <a href="#scrollspy-data-attributes">Basic usage</a>
												<ul>
													<li><a href="#scrollspy-data-attributes">Via data attributes</a></li>
													<li><a href="#scrollspy-js">Via JavaScript</a></li>
												</ul>
											</li>
											<li><a href="#scrollspy-methods">Plugin methods</a></li>
											<li><a href="#scrollspy-options">Plugin options</a></li>
											<li><a href="#scrollspy-events">Plugin events</a></li>
											<li class="navigation-header"><i class="icon-menu7 pull-right"></i> <span>Affix Plugin</span></li>
											<li><a href="#affix">Overview</a></li>
											<li>
												<a href="#affix-data-attributes">Basic usage</a>
												<ul>
													<li><a href="#affix-data-attributes">Via data attributes</a></li>
													<li><a href="#affix-js">Via JavaScript</a></li>
												</ul>
											</li>
											<li><a href="#affix-options">Plugin options</a></li>
											<li><a href="#affix-events">Plugin events</a></li>
							            </ul>
						            </div>
					            </div>
					            <!-- /navigation -->
