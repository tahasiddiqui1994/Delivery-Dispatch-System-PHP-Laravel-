...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/echarts/candlesticks_others.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="echarts_candlesticks_others">Candlesticks and others</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="echarts_candlesticks_others">ECharts</a></li>
