                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="cpa90TSeTV">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="cpa90TSeTV" data-index="0">
                                <div class="panel-heading ui-sortable-handle">
                                    <div class="btn-group"> 
                                       <a class="btn btn-success" href="users/create"> <i class="fa fa-plus"></i> Add User</a> 
                                    </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                    <!--{!! Form::open(['action'=> 'usersController@index', 'method'=>'GET'], ['class'=>'col-sm-6']) !!}
                                    <div class="col-sm-4">
                                            <div class="dataTables_length">
                                                <label>Display
	                                                <select onchange="this.form.submit()" name="dataPerPage">
	                                                    <option></option>
							...
							@foreach($data as $rrr)
								@if($rrr->id != 1)
									<tr style="text-align: center;">
										...
										@if(Auth::user()->type == "admin")
											<td>
		                                       <a href="/users/{{$rrr->id}}/edit" class="btn btn-info btn-xs pull-left" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
		                                        
		                                       {!! Form::open(['action'=> ['usersController@destroy',$rrr->id], 'method'=>'POST'], ['class'=>'col-sm-6']) !!}
		                                       &nbsp;<button href="/users/{{$rrr->id}}/destroy" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete">
