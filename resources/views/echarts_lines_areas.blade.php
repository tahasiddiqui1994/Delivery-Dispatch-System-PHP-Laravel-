...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/echarts/lines_areas.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="echarts_lines_areas">Lines and areas</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="echarts_lines_areas">ECharts</a></li>
