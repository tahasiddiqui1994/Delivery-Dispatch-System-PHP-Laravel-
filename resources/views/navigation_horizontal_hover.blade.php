...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/buttons/hover_dropdown.min.js')}}"></script>
							...
							<div class="row">
								...
								<div class="col-md-2">
									...
									<ul class="menu-list">
										...
										<li class="active"><a href="navigation_horizontal_hover">Submenu on hover</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navigation_horizontal_hover">Horizontal nav</a></li>
