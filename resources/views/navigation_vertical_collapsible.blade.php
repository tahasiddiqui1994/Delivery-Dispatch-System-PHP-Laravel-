...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="navigation_vertical_collapsible">Collapsible menu</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Vertical Nav</span> - Collapsible</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navigation_vertical_collapsible">Vertical nav</a></li>
							<li class="active">Collapsible</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Collapsible navigation</h6>
						Default navigation type is <code>collapsible</code> - when new item is expanded, current level remains opened. This logic works in all navigation levels.
				    </div>
				    <!-- /info alert -->
