...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/google/bars/column.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/bars/column_stacked.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/bars/bar.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/bars/bar_stacked.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/bars/histogram.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/bars/combo.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="google_bars">Bar charts</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Google</span> - Bar Charts</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="google_bars">Google</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<p class="content-group">A column graph is a chart that uses <code>vertical</code> bars to show comparisons among categories. One axis of the chart shows the specific categories being compared, and the other axis represents a discrete value. Like all Google charts, column charts display tooltips when the user hovers over the data. By default, text labels are hidden, but can be turned on in chart settings.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Stacked column chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">Stacked <code>column</code> charts present the information in the same sequence on each bar. The stacked bar chart stacks bars that represent different groups on top of each other. The height of the resulting bar shows the combined result of the groups. However, stacked bar charts are not suited to datasets where some groups have negative values. In such cases, grouped bar charts are preferable.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Bar chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Simple histogram</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Combo chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
