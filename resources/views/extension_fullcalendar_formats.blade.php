...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/ui/fullcalendar/lang/all.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/pages/extra_fullcalendar_formats.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="extension_fullcalendar_formats">Language and time</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Fullcalendar</span> - Formats</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="extension_fullcalendar_formats">Fullcalendar</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Internationalization</h5>
							<div class="heading-elements">
						...
						<div class="panel-body">
							<p class="content-group">Customize the language and localization options for the calendar using <code>lang</code> option. If you are simply loading one language, you do not need to specify the <code>lang</code> option. FullCalendar will look at the most recent language file loaded and use it. However, if more than one language file is loaded, or the combined <code>all.js</code> file is loaded, you must explicitly specify which language to use via the lang option.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Date formats</h5>
							<div class="heading-elements">
								<ul class="icons-list">
