...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/colors_teal.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="colors_teal">Teal palette</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Colors</span> - Teal Palette</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="colors_teal">Colors</a></li>
							<li class="active">Teal palette</li>
						</ul>
				...
				<div class="content">
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#00695C</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#teal_800"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#00796B</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#teal_700"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#00897B</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#teal_600"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#009688</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#teal_500"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#26A69A</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#teal_400"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#4DB6AC</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#teal_300"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="content-group-lg">
					    ...
					    <!-- Solid alert -->
					    <div class="alert bg-teal alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Close</span></button>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.text-teal</code> classes</p>
								</div>

								<input type="text" class="form-control text-teal text-uppercase text-semibold text-size-small" value="Input field text">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-teal</code> or classes</p>
								</div>

								<input type="text" class="form-control border-teal border-lg" placeholder="Input field border">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-teal</code> classes</p>
								</div>

								<input type="text" class="form-control bg-teal" placeholder="Input field background">
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal">
								...
								<div class="has-feedback">
									<input type="text" class="form-control bg-teal" placeholder="Icon feedback, teal input">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal">
								...
								<select class="form-control bg-teal">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal">
								...
								<div class="input-group">
									<span class="input-group-addon bg-teal"><i class="icon-menu7"></i></span>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal">
								...
								<div class="input-group">
									<span class="input-group-addon bg-teal-700"><i class="icon-lock2"></i></span>
									<input type="text" class="form-control bg-teal" placeholder="Solid background color">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal text-center">
								...
								<label class="radio-inline">
									<input type="radio" class="styled" name="teal-radio" checked="checked">
									Selected
								</label>

								<label class="radio-inline">
									<input type="radio" class="styled" name="teal-radio">
									Unselected
								</label>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-teal</code> or classes</p>

									<select class="selectbox bg-teal">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal">
								<div class="text-center">
									...
									<select class="bootstrap-select" data-style="bg-teal">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal text-center">
								...
								<span class="label bg-teal">Teal label</span>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal text-center">
								...
								<span class="badge bg-teal">390</span>
							</div>
				    	</div>
				    </div>
				    <!-- /text options -->
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-teal progress-bar-striped" style="width: 65%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-teal progress-bar-striped active" style="width: 75%">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal text-center">
								...
								<button type="button" class="btn bg-teal"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal text-center">
								...
								<button type="button" class="btn bg-teal btn-labeled"><b><i class="icon-menu7"></i></b> Labeled button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal text-center">
								...
								<button type="button" class="btn text-teal-800 border-teal btn-flat"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    </div>
				    <!-- /buttons -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel">
								<div class="panel-heading bg-teal">
									<h6 class="panel-title">Teal panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Teal panel using <code>.bg-teal</code> class added to the panel heading
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel border-teal">
								<div class="panel-heading bg-teal">
									<h6 class="panel-title">Teal bordered panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Bordered teal panel using <code>.bg-teal</code> and <code>.border-teal</code> classes
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel bg-teal">
								<div class="panel-heading">
									<h6 class="panel-title">Teal solid panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Solid teal panel using <code>.bg-teal</code> class added to the panel container
								</div>
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal text-center">
								...
								<button type="button" class="btn bg-teal" data-popup="tooltip-custom" title="Teal tooltip" data-placement="bottom" data-container="body"><i class="icon-comment position-left"></i> Tooltip</button>
							</div>
				    	</div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal text-center">
								...
								<button type="button" class="btn bg-teal" data-toggle="modal" data-target="#modal_teal"><i class="icon-menu7 position-left"></i> Modal dialog</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal text-center">
								...
								<p class="mb-15 text-muted">Using <code>.bg-teal</code> color classes</p>

								<button class="btn bg-teal growl-launch">jGrowl notification</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal text-center">
								...
								<button class="btn bg-teal pnotify-launch">Pnotify notification</button>
							</div>
				    	</div>
				    </div>
				    <!-- /notifications and dialogs -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-teal</code> color classes</p>
								</div>

								<ul class="dropdown-menu border-teal border-lg" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal">
								...
								<ul class="dropdown-menu bg-teal" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-teal">
								...
								<ul class="dropdown-menu bg-teal" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> <span class="label bg-teal pull-right">Label</span> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> <span class="badge bg-teal pull-right">98</span> Another action</a></li>
									<li class="divider"></li>
