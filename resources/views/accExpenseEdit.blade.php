                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="739bvlxQsQ">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="739bvlxQsQ" data-index="0">
                              ...
                              <div class="panel-body">
                               ...
                               {!! Form::open(['action'=> ['accExpensesController@update', $data->id], 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
                                    <div class="form-group">
                                        <label>Expenses Category</label>

                                            <select name="expenseCategory" id="expenseCategory" class="form-control" value="{{$data->expenseCategory}}" required="">
                                               ...
                                               <label>Expense Date <font color="red">*</font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                    ...
                                                    {{ Form::date('expenseDate', $data->expenseDate, ['required'=>"", 'class' => "form-control pull-right", 'id'=>"expenseDate"])}}
                                                   </div>
                                            </div>
									...
									<div class="form-group">
										...
										{{ Form::text('amount', $data->amount, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter amount"]) }}
									...
									<div class="form-group">
                                        <label>Truck No</label>
											...
											<select name="truckNo" id="truckNo" class="form-control" value="{{$data->truckNo}}" required="">
									...
									<div class="form-group">
                                        <label>Load Number</label>
											<select name="loadNo" id="loadNo" class="form-control" value="{{$data->loadNo}}" required="">
									...
									<div class="form-group">
                                        ...
                                        {{ Form::text('odometerReading', $data->odometerReading, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Odometer reading"]) }}
                                    </div>
                                     ...
                                     <label>Description</label><br>
                                     	{{Form::textarea('comments', $data->comments, ['required'=>"", 'class'=>'form-control', 'rows'=>'4', 'placeholder'=>'Enter text ...'])}}
                                      </textarea>
