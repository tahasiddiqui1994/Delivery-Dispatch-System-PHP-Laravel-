...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/datatables_extension_buttons_print.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="datatable_extension_buttons_print">Print buttons</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Datatables</span> - Print Buttons</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="datatable_extension_buttons_print">Datatables</a></li>
							<li class="active">Print buttons</li>
						</ul>
