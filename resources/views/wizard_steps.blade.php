...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="wizard_steps">Steps wizard</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="wizards_steps">Wizards</a></li>
				...
				<div class="content">
		            ...
		            <div class="panel panel-white">
	                	...
	                	<form class="steps-async" action="#">
							<h6>Personal data</h6>
							<fieldset data-mode="async" data-url="assets/demo_data/wizard/personal_data"></fieldset>

							<h6>Your education</h6>
							<fieldset data-mode="async" data-url="assets/demo_data/wizard/education"></fieldset>

							<h6>Your experience</h6>
							<fieldset data-mode="async" data-url="assets/demo_data/wizard/experience"></fieldset>

							<h6>Additional info</h6>
							<fieldset data-mode="async" data-url="assets/demo_data/wizard/additional"></fieldset>
						</form>
		            </div>
		            <!-- /remote content source -->
