                        ...
                        @if($data)
							@foreach($data as $rrr)
								<tr>
									...
									@if(Auth::user()->type == "admin")
										<td>
	                                       <a href="/webgeneral/{{$rrr->id}}/edit" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
