...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="sidebar_mini_collapse">Mini collapsible</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Mini Collapsible</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_mini_collapse">Sidebars</a></li>
							<li class="active">Mini collapsible</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Collapsible mini sidebar</h6>
						By default main sidebar is expanded. Use the button in top navbar to collapse <code>default</code> sidebar to mini size.
				    </div>
				    <!-- /info alert -->
