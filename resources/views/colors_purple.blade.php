...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/colors_purple.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="colors_purple">Purple palette</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Colors</span> - Purple Palette</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="colors_purple">Colors</a></li>
							<li class="active">Purple palette</li>
						</ul>
				...
				<div class="content">
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#4527A0</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#purple_800"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#512DA8</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#purple_700"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#5E35B1</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#purple_600"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#673AB7</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#purple_500"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#7E57C2</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#purple_400"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#9575CD</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#purple_300"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="content-group-lg">
						...
						<!-- Basic alert -->
						<div class="alert alpha-purple border-purple-400 alert-styled-left">
					    ...
					    <!-- Solid alert -->
					    <div class="alert bg-purple-400 alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Close</span></button>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.text-purple</code> classes</p>
								</div>

								<input type="text" class="form-control text-purple text-uppercase text-semibold text-size-small" value="Input field text">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-purple</code> or classes</p>
								</div>

								<input type="text" class="form-control border-purple border-lg" placeholder="Input field border">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-purple</code> classes</p>
								</div>

								<input type="text" class="form-control bg-purple-400" placeholder="Input field background">
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								...
								<div class="has-feedback">
									<input type="text" class="form-control bg-purple-400" placeholder="Icon feedback, purple input">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								...
								<select class="form-control bg-purple-400">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								...
								<div class="input-group">
									<span class="input-group-addon bg-purple-400"><i class="icon-menu7"></i></span>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								...
								<div class="input-group">
									<span class="input-group-addon bg-purple-700"><i class="icon-lock2"></i></span>
									<input type="text" class="form-control bg-purple-400" placeholder="Solid background color">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
										<button class="btn bg-purple-400" type="button">Button</button>
									</span>									
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<label class="radio-inline">
									<input type="radio" class="styled" name="purple-radio" checked="checked">
									Selected
								</label>

								<label class="radio-inline">
									<input type="radio" class="styled" name="purple-radio">
									Unselected
								</label>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-purple</code> or classes</p>

									<select class="selectbox bg-purple-400">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								<div class="text-center">
									...
									<select class="bootstrap-select" data-style="bg-purple-400">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										<ul class="nav nav-tabs bg-purple-400">
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										...
										<div class="tab-content bg-purple-400">
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<span class="label bg-purple-400">Purple label</span>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<span class="badge bg-purple-400">390</span>
							</div>
				    	</div>
				    </div>
				    <!-- /text options -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-purple-400" style="width: 55%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-purple-400 progress-bar-striped" style="width: 65%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-purple-400 progress-bar-striped active" style="width: 75%">
				    ...
				    <div class="row">
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th>Last Name</th>
												<th class="bg-purple-400">Username</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												...
												<td>Kopyov</td>
												<td class="bg-purple-400">@Kopyov</td>
											</tr>
											<tr>
												<td>2</td>
												<td class="alpha-purple">Victoria</td>
												<td>Baker</td>
												<td class="bg-purple-400">@Vicky</td>
											</tr>
											<tr>
												<td>3</td>
												<td class="alpha-purple">James</td>
												<td>Alexander</td>
												<td class="bg-purple-400">@Alex</td>
											</tr>
										</tbody>
										<tfoot>
											<tr>
				    	...
				    	<div class="col-md-6">
				    		<div class="panel panel-flat">
								...
								<div class="table-responsive">
									<table class="table bg-purple-400">
										<thead>
											<tr>
												<th>#</th>
												<th>First Name</th>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<button type="button" class="btn bg-purple-400"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<button type="button" class="btn bg-purple-400 btn-labeled"><b><i class="icon-menu7"></i></b> Labeled button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<button type="button" class="btn text-purple-800 border-purple btn-flat"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    </div>
				    <!-- /buttons -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel">
								<div class="panel-heading bg-purple-400">
									<h6 class="panel-title">Purple panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Purple panel using <code>.bg-purple</code> class added to the panel heading
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel border-purple-400">
								<div class="panel-heading bg-purple-400">
									<h6 class="panel-title">Purple bordered panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Bordered purple panel using <code>.bg-purple</code> and <code>.border-purple</code> classes
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel bg-purple-400">
								<div class="panel-heading">
									<h6 class="panel-title">Purple solid panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Solid purple panel using <code>.bg-purple</code> class added to the panel container
								</div>
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<button type="button" class="btn bg-purple-400" data-popup="tooltip-custom" title="Purple tooltip" data-placement="bottom" data-container="body"><i class="icon-comment position-left"></i> Tooltip</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<button type="button" class="btn bg-purple-400" data-popup="popover-custom" title="Purple popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<button type="button" class="btn bg-purple-400" data-popup="popover-solid" title="Purple popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<button type="button" class="btn bg-purple-400" data-toggle="modal" data-target="#modal_purple"><i class="icon-menu7 position-left"></i> Modal dialog</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<p class="mb-15 text-muted">Using <code>.bg-purple</code> color classes</p>

								<button class="btn bg-purple-400 growl-launch">jGrowl notification</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple text-center">
								...
								<button class="btn bg-purple-400 pnotify-launch">Pnotify notification</button>
							</div>
				    	</div>
				    </div>
				    <!-- /notifications and dialogs -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-purple</code> color classes</p>
								</div>

								<ul class="dropdown-menu border-purple-400 border-lg" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								...
								<ul class="dropdown-menu bg-purple-400" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-purple">
								...
								<ul class="dropdown-menu bg-purple-400" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> <span class="label bg-purple pull-right">Label</span> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> <span class="badge bg-purple pull-right">98</span> Another action</a></li>
									<li class="divider"></li>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn bg-purple-400">Save changes</button>
								</div>
							</div>
						</div>
					</div>
