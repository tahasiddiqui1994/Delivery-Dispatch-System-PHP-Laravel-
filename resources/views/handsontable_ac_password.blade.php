...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="{{url('assets/js/plugins/tables/handsontable/handsontable.min.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/pages/handsontable_ac_password.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="handsontable_ac_password">Autocomplete &amp; password</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Handsontable</span> - Cell Types</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="handsontable_ac_password">Handsontable</a></li>
							<li class="active">Cell types</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Autocomplete type</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							...
							<div class="content-group-lg">
								<h6 class="text-semibold">Autocomplete strict mode</h6>
								<p class="content-group">This is the same example as above with a difference that autocomplete now runs in <code>strict</code> mode. In this mode, the autocomplete cells will only accept values that are defined in the source array. The mouse and keyboard bindings are identical as in Handsontable cell type with some differences. In strict mode, the <code>allowInvalid</code> option determines the behaviour in case of manual user input.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Password type</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<div class="content-group-lg">
								<h6 class="text-semibold">Password cell type</h6>
							...
							<div class="content-group-lg">
								<h6 class="text-semibold">Fixed hash length</h6>
							...
							<div class="content-group-lg">
								<h6 class="text-semibold">Custom hash symbol</h6>
