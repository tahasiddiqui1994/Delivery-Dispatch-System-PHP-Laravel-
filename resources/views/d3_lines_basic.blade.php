...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_basic.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_basic_bivariate.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_basic_area.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_basic_multi_series.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_basic_stacked.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_basic_stacked_nest.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_basic_gradient.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="d3_lines_basic">Simple lines</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">D3</span> - Basic Lines</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="d3_lines_basic">D3</a></li>
							<li class="active">Basic lines</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Simple line chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Area chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Bivariate Area Chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">Example of <code>two-value</code> area chart. Lines as in previous example are optional. Data stored in <code>.tsv</code> file. The chart employs conventional margins and a number of D3 features: <code>d3.tsv</code> - load and parse data; <code>d3.time.format</code> - parse dates; <code>d3.time.scale</code> - x-position encoding; <code>d3.scale.linear</code> - y-position encoding; <code>d3.extent</code>, <code>d3.min</code> and <code>d3.max</code> - compute domains; <code>d3.svg.axis</code> - display axes; <code>d3.svg.area</code> - display area shape.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Multiple series</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Stacked areas</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">Example of <code>stacked area</code> chart. The chart employs conventional margins and a number of D3 features: <code>d3.tsv</code> - load and parse data; <code>d3.time.format</code> - parse dates; <code>d3.format</code> - format percentages; <code>d3.time.scale</code> - x-position encoding; <code>d3.scale.linear</code> - y-position encoding; <code>d3.scale.category20</code>, <code>d3.scale.ordinal</code> - color encoding; <code>d3.extent</code> and <code>d3.max</code> - compute domains; <code>d3.layout.stack</code> - compute stacked y-positions; <code>d3.keys</code> - compute column names; <code>d3.svg.axis</code> - display axes; <code>d3.svg.area</code> - display area shape.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Stacked areas via nest</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">Example of stacked areas via nest, constructed from a CSV file. The chart employs conventional margins and a number of D3 features: <code>d3.tsv</code> - load and parse data; <code>d3.time.format</code> - parse dates; <code>d3.format</code> - format percentages; <code>d3.time.scale</code> - x-position encoding; <code>d3.scale.linear</code> - y-position encoding; <code>d3.scale.category20</code>, <code>d3.scale.ordinal</code> - color encoding; <code>d3.extent</code> and <code>d3.max</code> - compute domains; <code>d3.layout.stack</code> - compute stacked y-positions; <code>d3.keys</code> - compute column names; <code>d3.svg.axis</code> - display axes; <code>d3.svg.area</code> - display area shape.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Gradient encoding</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">This variation of a line chart demonstrates how to use a <code>linear gradient</code> as a quantitative color encoding redundant with <code>y-position</code>. The gradient units are defined as userSpaceOnUse, such that the gradient stops can be positioned explicitly rather than based on the line’s bounding box.</p>
