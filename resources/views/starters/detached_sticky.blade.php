...
<head>
	...
	<script type="text/javascript" src="../assets/js/pages/sidebar_detached_sticky_custom.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="detached_sticky">Sticky sidebar</a></li>
											</ul>
										</li>
										<li><a href="layout_boxed">Boxed layout</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Starters</span> - Sticky Detached</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="detached_sticky">Starters</a></li>
							<li class="active">Sticky detached</li>
						</ul>
