	...
	<div class="navbar navbar-inverse">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav">
				<li><a href="../index"><i class="icon-arrow-left8 position-left"></i> Dashboard</a></li>

				<li class="dropdown mega-menu mega-menu-wide">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">Mega <span class="caret"></span></a>
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">Classic menu <span class="caret"></span></a>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Starters</span> - Horizontal Nav</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="horizontal_nav">Starters</a></li>
							<li class="active">Horizontal nav</li>
						</ul>
