									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="detached_right">Right sidebar</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Starters</span> - Right Detached</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="detached_right">Starters</a></li>
