...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/components_dropdowns.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_dropdowns">Dropdown menus</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Components</span> - Dropdown Menus</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="components_dropdowns">Components</a></li>
							<li class="active">Dropdown menus</li>
						</ul>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Dropdown menus
						<small class="display-block">Dropdown component states</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="text-semibold no-margin">Basic dropdown</h6>
									<p class="content-group-sm text-muted">Default dropdown menu styling</p>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Disabled items</h6>
									<p class="content-group-sm text-muted">Disable the link with <code>.disabled</code> class</p>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Active menu item</h6>
									<p class="content-group-sm text-muted">Make the link active with <code>.active</code> class</p>
								</div>
					...
					<h6 class="content-group text-semibold">
						Dropdown headers
						<small class="display-block">Dropdown header with options</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Default header</h6>
									<p class="content-group-sm text-muted">Basic <code>header</code> styling of label sections</p>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Highlighted header</h6>
									<p class="content-group-sm text-muted">Highlight header using <code>.highlight</code> class</p>
								</div>

								<ul class="dropdown-menu" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li class="dropdown-header highlight">Header first</li>
									<li><a href="#">Action</a></li>
									<li><a href="#">Another action</a></li>
									<li class="dropdown-header highlight">Header second</li>
									<li><a href="#">Something else here</a></li>
									<li><a href="#">One more line</a></li>
								</ul>
							</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Menu header icons</h6>
									<p class="content-group-sm text-muted">Display left/right positioned <code>icons</code></p>
								</div>

								<ul class="dropdown-menu" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li class="dropdown-header"><i class="icon-menu7"></i> <i class="icon-gear pull-right"></i> Header first</li>
									<li><a href="#">Action</a></li>
									<li><a href="#">Another action</a></li>
									<li class="dropdown-header highlight"><i class="icon-menu7"></i> <i class="icon-gear pull-right"></i> Header second</li>
									<li><a href="#">Something else here</a></li>
									<li><a href="#">One more line</a></li>
								</ul>
							</div>
					...
					<h6 class="content-group text-semibold">
						Dropdown submenu
						<small class="display-block">Multilevel submenu with options</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Basic submenu</h6>
									<p class="content-group-sm text-muted">Basic <code>multi</code> level menu example</p>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Dropup menu</h6>
									<p class="content-group-sm text-muted">Change <code>vertical</code> orientation to <code>top</code></p>
								</div>

								<ul class="dropdown-menu dropup" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#">Action</a></li>
									<li><a href="#">Another action</a></li>
									<li><a href="#">Something else here</a></li>
									<li class="divider"></li>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Left orientation</h6>
									<p class="content-group-sm text-muted">Change <code>horizontal</code> orientation to <code>left</code></p>
								</div>
					...
					<h6 class="content-group text-semibold">
						Additional sizes
						<small class="display-block">Dropdown sizes with elements</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Large menu size</h6>
									<p class="content-group-sm text-muted">Using <code>.dropdown-menu-lg</code> class</p>
								</div>

								<ul class="dropdown-menu dropdown-menu-lg" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Small menu size</h6>
									<p class="content-group-sm text-muted">Using <code>.dropdown-menu-sm</code> class</p>
								</div>

								<ul class="dropdown-menu dropdown-menu-sm" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><span class="label label-primary pull-right">Added</span> <i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><span class="badge badge-danger pull-right">98</span> <i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><span class="pull-right text-size-large"><i class="icon-command"></i>F</span> <i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Mini menu size</h6>
									<p class="content-group-sm text-muted">Using <code>.dropdown-menu-xs</code> class</p>
								</div>

								<ul class="dropdown-menu dropdown-menu-xs" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><span class="label label-primary pull-right">Added</span> <i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><span class="badge badge-danger pull-right">98</span> <i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><span class="pull-right text-size-large"><i class="icon-command"></i>F</span> <i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
					...
					<h6 class="content-group text-semibold">
						Dropdown components
						<small class="display-block">Icons, checkboxes, radios, switches etc.</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Left menu item icons</h6>
									<p class="content-group-sm text-muted">Dropdown icons in <code>left</code> position</p>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Right menu item icons</h6>
									<p class="content-group-sm text-muted">Dropdown icons in <code>right</code> position</p>
								</div>

								<ul class="dropdown-menu" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-git-commit pull-right"></i> Action</a></li>
									<li><a href="#"><i class="icon-git-branch pull-right"></i> Another action</a></li>
									<li><a href="#"><i class="icon-git-compare pull-right"></i> Something else here</a></li>
									<li class="divider"></li>
									<li><a href="#"><i class="icon-git-merge pull-right"></i> One more separated line</a></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Icons and text combo</h6>
									<p class="content-group-sm text-muted">Combine text and icons for annotations</p>
								</div>
								...
								<ul class="dropdown-menu" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									...
									<li class="divider"></li>
									<li><a href="#"><span class="pull-right text-size-large"><i class="icon-command"></i>I</span> Incremental Find</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<!-- Dropdowns with labels and badges -->
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Dropdown with labels</h6>
									<p class="content-group-sm text-muted">Dropdown menu items with <code>labels</code></p>
								</div>

								<ul class="dropdown-menu" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><span class="label label-primary pull-right">Added</span> Action</a></li>
									<li><a href="#"><span class="label label-danger pull-right">Bugs</span> Another action</a></li>
									<li><a href="#"><span class="label label-success pull-right">Done</span> Something else here</a></li>
									<li class="divider"></li>
									<li><a href="#"><span class="label label-info pull-right">New</span> One more separated line</a></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Dropdown with badges</h6>
									<p class="content-group-sm text-muted">Dropdown menu items with <code>badges</code></p>
								</div>

								<ul class="dropdown-menu" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><span class="badge badge-success pull-right">65</span> Action</a></li>
									<li><a href="#"><span class="badge badge-warning pull-right">23</span> Another action</a></li>
									<li><a href="#"><span class="badge badge-primary pull-right">83</span> Something else here</a></li>
									<li class="divider"></li>
									<li><a href="#"><span class="badge badge-danger pull-right">98</span> One more separated line</a></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Left positioned</h6>
									<p class="content-group-sm text-muted">Additional left side placement</p>
								</div>

								<ul class="dropdown-menu" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><span class="label label-info">New</span> Action</a></li>
									<li><a href="#"><span class="label label-success">Done</span> Another action</a></li>
									<li><a href="#">Something else here <span class="badge badge-primary">32</span></a></li>
									<li class="divider"></li>
									<li><a href="#">One more separated line <span class="badge badge-warning">54</span></a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Menu with checkboxes</h6>
									<p class="content-group-sm text-muted">Left and right positioned <code>checkboxes</code></p>
								</div>

								<ul class="dropdown-menu" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li class="checkbox"><label><input type="checkbox" class="styled"> Some action</label></li>
									<li class="checkbox active"><label><input type="checkbox" class="styled" checked="checked"> Active action</label></li>
									<li class="divider"></li>
									<li class="checkbox checkbox-right disabled"><label><input type="checkbox" class="styled" checked="checked" disabled="disabled"> Disabled action</label></li>
									<li class="checkbox checkbox-right"><label><input type="checkbox" class="styled"> One more action</label></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								...
								<ul class="dropdown-menu" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li class="radio"><label><input type="radio" name="dropdown-radio" class="styled"> Some action</label></li>
									<li class="radio active"><label><input type="radio" name="dropdown-radio" class="styled" checked="checked"> Active action</label></li>
									<li class="divider"></li>
									<li class="radio radio-right disabled"><label><input type="radio" class="styled" checked="checked" disabled="disabled"> Disabled action</label></li>
									<li class="radio radio-right"><label><input type="radio" name="dropdown-radio" class="styled"> One more action</label></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Menu with switches</h6>
									<p class="content-group-sm text-muted">Left and right positioned <code>switches</code></p>
								</div>

								<ul class="dropdown-menu" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li class="checkbox checkbox-switchery switchery-xs"><label><input type="checkbox" class="switchery" checked="checked"> Some action</label></li>
									<li class="checkbox checkbox-switchery switchery-xs active"><label><input type="checkbox" class="switchery"> Active action</label></li>
									<li class="divider"></li>
									<li class="checkbox checkbox-switchery switchery-xs checkbox-right disabled"><label><input type="checkbox" class="switchery" checked="checked" disabled="disabled"> Disabled action</label></li>
									<li class="checkbox checkbox-switchery switchery-xs checkbox-right"><label><input type="checkbox" class="switchery"> One more action</label></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<h6 class="content-group text-semibold">
						Custom menu colors
						<small class="display-block">Custom background and state colors</small>
					</h6>
					<!-- /additional styling title -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Solid dropdown menu</h6>
									<p class="content-group-sm text-muted">Example of a <code>solid</code> dropdown menu</p>
								</div>

								<ul class="dropdown-menu bg-teal-400" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#">Action</a></li>
									<li><a href="#">Another action</a></li>
									<li><a href="#">Something else here</a></li>
									<li class="divider"></li>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Disabled menu items</h6>
									<p class="content-group-sm text-muted">Disable menu items with <code>disabled</code> class</p>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Active menu item</h6>
									<p class="content-group-sm text-muted">Set active menu item with <code>active</code> class</p>
								</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Menu item icons</h6>
									<p class="content-group-sm text-muted">Left and right positioned icons</p>
								</div>

								<ul class="dropdown-menu bg-slate-600" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
									<li class="active"><a href="#"><i class="icon-screen-full"></i> Active action</a></li>
									<li class="divider"></li>
									<li class="disabled"><a href="#"><i class="icon-mail5 pull-right"></i> Disabled action</a></li>
									<li><a href="#"><i class="icon-gear pull-right"></i> Separated line</a></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Checkboxes and radios</h6>
									<p class="content-group-sm text-muted">Checkboxes and radios in <code>solid</code> menus</p>
								</div>

								<ul class="dropdown-menu bg-slate-600" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li class="checkbox"><label><input type="checkbox" class="styled"> Action</label></li>
									<li class="checkbox active"><label><input type="checkbox" class="styled" checked="checked"> Active action</label></li>
									<li class="divider"></li>
									<li class="radio radio-right disabled"><label><input type="radio" name="radio-solid" class="styled" checked="checked" disabled="disabled"> Disabled action</label></li>
									<li class="radio radio-right"><label><input type="radio" name="radio-solid" class="styled"> One more action</label></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Labels and switches</h6>
									<p class="content-group-sm text-muted">Labels, badges and switch toggles</p>
								</div>

								<ul class="dropdown-menu bg-slate-600" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><span class="label bg-danger-400 pull-right">New</span> Some label</a></li>
									<li><a href="#"><span class="badge bg-cyan-600 pull-right">98</span> And badge</a></li>
									<li class="divider"></li>
									<li class="checkbox-switchery switchery-xs active"><label><input type="checkbox" class="switchery" checked="checked"> Active action</label></li>
									<li class="checkbox-right checkbox-switchery switchery-xs"><label><input type="checkbox" class="switchery"> One more action</label></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<h6 class="content-group text-semibold">
						Border options
						<small class="display-block">Optional border customizations</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">No border shown</h6>
									<p class="content-group-sm text-muted">Hide border using <code>.no-border</code> class</p>
								</div>

								<ul class="dropdown-menu no-border" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#">Action</a></li>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Border color</h6>
									<p class="content-group-sm text-muted">Using <code>.border-*</code> class</p>
								</div>

								<ul class="dropdown-menu border-slate-700 no-border-radius" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#">Action</a></li>
									<li class="active"><a href="#">Active menu item</a></li>
									<li class="disabled"><a href="#">Something else here</a></li>
									<li class="divider"></li>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-info">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Stronger border</h6>
									<p class="content-group-sm text-muted">Using <code>.border-lg</code> class</p>
								</div>

								<ul class="dropdown-menu border-lg border-primary no-border-radius" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#">Action</a></li>
									<li class="active"><a href="#">Active menu item</a></li>
									<li class="disabled"><a href="#">Something else here</a></li>
									<li class="divider"></li>
