...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/tasks_grid.js')}}"></script>
	<!-- /theme JS files -->
								...
								<li>
									...
									<ul>
										<li>
											...
											<ul>
												<li class="active"><a href="task_manager_grid">Task grid</a></li>
					...
					<div class="page-header-content">
						<div class="page-title">
							...
							<ul class="breadcrumb position-right">
								...
								<li><a href="task_manager_grid">Task manager</a></li>
								<li class="active">Grid</li>
							</ul>
						</div>

						<div class="heading-elements">
							<a href="#" class="btn bg-blue btn-labeled heading-btn"><b><i class="icon-task"></i></b> Create task</a>
				...
				<div class="content">
					...
					<div class="container-detached">
						<div class="content-detached">
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-primary">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#24. Create UI design model</a></h6>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-danger">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#23. New icons set for an iOS app</a></h6>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-success">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#22. Create ad campaign banners set</a></h6>
													<p class="mb-15">That he had recently cut out of an illustrated magazine..</p>

							                		<a href="#"><img src="assets/images/placeholder.jpg" class="img-circle img-xs" alt=""></a>
							                		<a href="#"><img src="assets/images/placeholder.jpg" class="img-circle img-xs" alt=""></a>
							                		<a href="#"><img src="assets/images/placeholder.jpg" class="img-circle img-xs" alt=""></a>
							                		<a href="#" class="position-relative"><img src="assets/images/placeholder.jpg" class="img-circle img-xs" alt=""></a>
							                		<a href="#" class="text-default">&nbsp;<i class="icon-plus22"></i></a>
												</div>

												<div class="col-md-4">
													<ul class="list task-details">
														<li>10 January, 2015</li>
														<li class="dropdown">
									                		Priority: &nbsp; 
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												<span class="heading-text">Due: <span class="text-semibold">22 hours</span></span>

												<ul class="list-inline list-inline-condensed heading-text pull-right">
													<li class="dropdown">
														<a href="#" class="text-default dropdown-toggle" data-toggle="dropdown">Resolved <span class="caret"></span></a>
														<ul class="dropdown-menu dropdown-menu-right">
															<li><a href="#">Open</a></li>
															<li><a href="#">On hold</a></li>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-primary">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#21: Edit the draft for the icons</a></h6>
													<p class="mb-15">You've got to get enough sleep. Other travelling salesmen..</p>
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												<span class="heading-text">Due: <span class="text-semibold">27 hours</span></span>

												<ul class="list-inline list-inline-condensed heading-text pull-right">
													<li class="dropdown">
														<a href="#" class="text-default dropdown-toggle" data-toggle="dropdown">Invalid <span class="caret"></span></a>
														<ul class="dropdown-menu dropdown-menu-right">
															<li><a href="#">Open</a></li>
															<li><a href="#">On hold</a></li>
															<li><a href="#">Resolved</a></li>
															...
															<li class="divider"></li>
															<li><a href="#">Dublicate</a></li>
															<li class="active"><a href="#">Invalid</a></li>
															<li><a href="#">Wontfix</a></li>
														</ul>
													</li>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-primary">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#20. Fix validation issues and commit</a></h6>
													<p class="mb-15">But who knows, maybe that would be the best thing for me..</p>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-success">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#19. Support tickets list doesn't support commas</a></h6>
													<p class="mb-15">I'd have gone up to the boss and told him just what i think..</p>
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												<span class="heading-text">Due: <span class="text-semibold">30 hours</span></span>

												<ul class="list-inline list-inline-condensed heading-text pull-right">
													<li class="dropdown">
														<a href="#" class="text-default dropdown-toggle" data-toggle="dropdown">Closed <span class="caret"></span></a>
														<ul class="dropdown-menu dropdown-menu-right">
															<li><a href="#">Open</a></li>
															<li><a href="#">On hold</a></li>
															<li><a href="#">Resolved</a></li>
															<li class="active"><a href="#">Closed</a></li>
															<li class="divider"></li>
															<li><a href="#">Dublicate</a></li>
															<li><a href="#">Invalid</a></li>
															<li><a href="#">Wontfix</a></li>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-success">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#18. Help Web devs with HTML integration</a></h6>
													<p class="mb-15">Samsa was a travelling salesman - and above it there hung..</p>
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												<span class="heading-text">Due: <span class="text-semibold">31 hours</span></span>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-info">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#17. Another icon set</a></h6>
													<p class="mb-15">A wonderful serenity has taken possession of my entire soul..</p>
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												<span class="heading-text">Due: <span class="text-semibold">32 hours</span></span>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-danger">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#16. iOS application design mockups</a></h6>
													<p class="mb-15">Sweet mornings of spring which I enjoy with my whole heart..</p>
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												<span class="heading-text">Due: <span class="text-semibold">44 hours</span></span>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-info">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#15. UI/UX design review</a></h6>
													<p class="mb-15">I am alone, and feel the charm of existence in this spot..</p>
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												<span class="heading-text">Due: <span class="text-semibold">48 hours</span></span>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-primary">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#14. Marketing campaign review</a></h6>
													<p class="mb-15">Which was created for the bliss of souls like mine..</p>
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												<span class="heading-text">Due: <span class="text-semibold">2 days</span></span>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-danger">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#13. Fix website issues on mobile</a></h6>
													<p class="mb-15">I am so happy, my dear friend, so absorbed in the exquisite..</p>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-success">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#12. Add updated responsive styles</a></h6>
													<p class="mb-15">I should be incapable of drawing a single stroke at the present..</p>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-info">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#11. Merge latest changes</a></h6>
													<p class="mb-15">When, while the lovely valley teems with vapour around me..</p>
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												...
												<ul class="list-inline list-inline-condensed heading-text pull-right">
													<li class="dropdown">
														<a href="#" class="text-default dropdown-toggle" data-toggle="dropdown">Wontfix <span class="caret"></span></a>
														<ul class="dropdown-menu dropdown-menu-right">
															<li><a href="#">Open</a></li>
															<li><a href="#">On hold</a></li>
															<li><a href="#">Resolved</a></li>
															...
															<li><a href="#">Dublicate</a></li>
															<li><a href="#">Invalid</a></li>
															<li class="active"><a href="#">Wontfix</a></li>
														</ul>
													</li>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-primary">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#10. Create landing page for a new app</a></h6>
													<p class="mb-15">A few stray gleams steal into the inner sanctuary, I throw..</p>
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												<span class="heading-text">Due: <span class="text-semibold">3 days</span></span>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-danger">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#9. Update JS code in app.js file</a></h6>
													<p class="mb-15">When I hear the buzz of the little world among the stalks..</p>
							...
							<div class="text-center content-group text-muted content-divider">
								<span class="pt-10 pb-10">Apr 21, 10:38 am</span>
							</div>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-info">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#8. Combine .js files in /app/js/</a></h6>
													<p class="mb-15">Insects and flies, then I feel the presence of the Almighty..</p>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-primary">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#7. Create application Photoshop draft</a></h6>
													<p class="mb-15">Who formed us in his own image, and the breath of that universal..</p>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-danger">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#6. Cartoon characters for app ads</a></h6>
													<p class="mb-15">My friend, when darkness overspreads my eyes, and heaven..</p>
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												<span class="heading-text">Due: <span class="text-semibold">4 days</span></span>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-info">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#5. Google AdWords campain graphics</a></h6>
													<p class="mb-15">Seem to dwell in my soul and absorb its power, like the form..</p>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-success">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#4. Monthly statistics report</a></h6>
													<p class="mb-15">I sink under the weight of the splendour of these visions..</p>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-primary">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#3. Create invoice template</a></h6>
													<p class="mb-15">Far far away, behind the word mountains, far from the..</p>
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												<span class="heading-text">Due: <span class="text-semibold">5 days</span></span>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-danger">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#2. Add images to the product gallery</a></h6>
													<p class="mb-15">Countries Vokalia and Consonantia, there live the blind..</p>
								...
								<div class="col-md-6">
									<div class="panel border-left-lg border-left-danger">
										<div class="panel-body">
											<div class="row">
												<div class="col-md-8">
													<h6 class="no-margin-top"><a href="task_manager_detailed">#1. Update User profile page</a></h6>
													<p class="mb-15">A small river named Duden flows by their place and supplies it..</p>
										...
										<div class="panel-footer panel-footer-condensed">
											<div class="heading-elements">
												<span class="heading-text">Due: <span class="text-semibold">6 days</span></span>
								...
								<div class="sidebar-category">
									...
									<div class="category-content no-padding">
										<ul class="navigation navigation-alt navigation-accordion">
											...
											<li><a href="#"><i class="icon-make-group"></i> Assigned to my team <span class="badge badge-info">47</span></a></li>
