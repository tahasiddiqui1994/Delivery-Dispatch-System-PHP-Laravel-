								...
								<li>
									...
									<ul>
										...
										<li>
											...
											<ul>
												<li class="active"><a href="sidebar_double_collapse">Collapse main sidebar</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Double Collapse</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_double_collapse_left">Sidebars</a></li>
							<li class="active">Double collapse</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Double sidebar. Collapsible</h6>
