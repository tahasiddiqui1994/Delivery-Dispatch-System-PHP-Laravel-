...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/d3/bars/bars_advanced_simple_interaction.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/bars/bars_advanced_sortable_horizontal.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/bars/bars_advanced_sortable_vertical.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/bars/bars_advanced_stacked_multiple.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/bars/bars_advanced_histogram.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/bars/bars_advanced_hierarchical.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="d3_bars_advanced">Advanced bars</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">D3</span> - Advanced Bars</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="d3_bars_advanced">D3</a></li>
							<li class="active">Advanced bars</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Simple interaction</h5>
							<div class="heading-elements">
								<ul class="icons-list">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Sortable vertical bar chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Sortable horizontal bar chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Stacked to multiples</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Histogram with tooltip</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Hierarchical bar chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">This bar chart visualizes hierarchical data using D3. Each blue bar represents a folder, whose length encodes the total size of all files in that folder (and all subfolders). Clicking on a bar dives into that folder, while clicking on the background bubbles back up to the parent folder. Data stored in JSON file.</p>
