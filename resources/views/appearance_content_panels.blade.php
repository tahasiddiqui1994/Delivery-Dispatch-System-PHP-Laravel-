						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										<li class="active"><a href="appearance_content_panels">Content panels</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="appearance_content_panels">Appearance</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Panel heading options
						<small class="display-block">Panel heading controls and subtitles</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Panel title <small>With inline subtitle</small></h6>
								</div>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Panel title <small class="display-block">With block subtitle</small></h6>
								</div>
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Panel controls</h6>
									<div class="heading-elements">
										<ul class="icons-list">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Panel controls <small>and inline subtitle</small></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Panel controls <small class="display-block">and block subtitle</small></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
					...
					<h6 class="content-group text-semibold">
						Panel title options
						<small class="display-block">Panel heading font options for titles</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Regular <span class="text-semibold">Semibold</span></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title"><span class="text-semibold">Semibold</span> Regular</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Regular <span class="text-thin">Thin</span></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title"><span class="text-thin">Thin</span> Regular</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Regular <span class="text-bold">Bold</span></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title"><span class="text-bold">Bold</span> Regular</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title"><span class="text-semibold text-uppercase">Uppercase</span> Regular</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Regular <span class="text-semibold text-italic">Italic</span></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title"><span class="text-thin">Thin</span> <span class="text-semibold text-uppercase">Uppercase</span></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title"><span class="text-semibold text-uppercase">Uppercase</span> <small>Small tag</small></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Default <span class="text-muted">Muted</span></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Default <span class="text-primary">Primary</span></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Default <span class="text-danger">Danger</span></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Default <span class="text-success">Success</span></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Default <span class="text-warning">Warning</span></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Default <span class="text-info">Info</span></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Word <span class="text-highlight bg-primary">Highlighted</span></h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
					...
					<h6 class="content-group text-semibold">
						Basic panel styles
						<small class="display-block">Available panel styles and colors</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Flat panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Flat panel using <code>.panel-flat</code> class
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">White panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									Primary panel using <code>.panel-primary</code> class
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="panel panel-warning">
								...
								<div class="panel-body">
									Warning panel using <code>.panel-warning</code> class
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-danger">
								...
								<div class="panel-body">
									Danger panel using <code>.panel-danger</code> class
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="panel panel-info">
								...
								<div class="panel-body">
									Info panel using <code>.panel-info</code> class
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-danger panel-bordered">
								...
								<div class="panel-body">
									Danger bordered panel using <code>.panel-bordered</code> class
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="panel panel-success panel-bordered">
								...
								<div class="panel-body">
									Success bordered panel using <code>.panel-bordered</code> class
								</div>
							</div>
							...
							<div class="panel panel-warning panel-bordered">
								...
								<div class="panel-body">
									Warning bordered panel using <code>.panel-bordered</code> class
								</div>
							</div>
							...
							<div class="panel panel-info panel-bordered">
								...
								<div class="panel-body">
									Info bordered panel using <code>.panel-bordered</code> class
								</div>
							</div>
						</div>
					</div>
					...
					<h6 class="content-group text-semibold">
						Panel borders
						<small class="display-block">Custom 4 side borders for content panels</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat border-left-danger">
								<div class="panel-heading">
									<h6 class="panel-title">Left custom border</h6>
								</div>
								
								<div class="panel-body">
									Panel with left <code>danger</code> border
								</div>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat border-right-danger">
								<div class="panel-heading">
									<h6 class="panel-title">Right custom border</h6>
								</div>
								
								<div class="panel-body">
									Panel with right <code>danger</code> border
								</div>
							</div>

							<div class="panel panel-flat border-left-info border-right-info">
								<div class="panel-heading">
									<h6 class="panel-title">Left and right borders</h6>
								</div>
								
								<div class="panel-body">
									Panel with left and right <code>info</code> borders
								</div>
							</div>
						</div>
					</div>
					...
					<!-- Bordered panels border width -->
					<h6 class="content-group text-semibold">
						Border sizing
						<small class="display-block">Optional content panel border sizes</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat border-top-warning">
								<div class="panel-heading">
									<h6 class="panel-title"><span class="text-semibold">Basic</span> size</h6>
								</div>
							...
							<div class="panel panel-flat border-top-lg border-top-warning">
								<div class="panel-heading">
									<h6 class="panel-title"><span class="text-semibold">Large</span> size</h6>
								</div>
								
								<div class="panel-body">
									Large border size using <code>.border-*-lg</code> class
								</div>
							</div>

							<div class="panel panel-flat border-top-xlg border-top-warning">
								<div class="panel-heading">
									<h6 class="panel-title"><span class="text-semibold">Extra large</span> size</h6>
								</div>
					...
					<h6 class="content-group text-semibold">
						Panel title sizing
						<small class="display-block">Panel title font colors using standard html headings</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h1 class="panel-title">H1 title</h1>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									H1 title heading using <code>&lt;h1 class="panel-title"></code> markup
								</div>
							</div>

							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">H3 title</h3>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									H3 title heading using <code>&lt;h3 class="panel-title"></code> markup
								</div>
							</div>

							<div class="panel panel-default">
								<div class="panel-heading">
									<h5 class="panel-title">H5 title</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									H5 title heading using <code>&lt;h5 class="panel-title"></code> markup
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h2 class="panel-title">H2 title</h2>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									H2 title heading using <code>&lt;h2 class="panel-title"></code> markup
								</div>
							</div>

							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">H4 title</h4>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									H4 title heading using <code>&lt;h4 class="panel-title"></code> markup
								</div>
							</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									H6 title heading using <code>&lt;h6 class="panel-title"></code> markup
								</div>
							</div>
						</div>
					</div>
					...
					<h6 class="content-group text-semibold">
						Solid panels
						<small class="display-block">Optional solid color panels</small>
					</h6>
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="panel bg-info">
								<div class="panel-heading">
									<h6 class="panel-title">Info solid</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Info solid panel using <code>.bg-info</code> class
								</div>
							</div>

							<div class="panel bg-purple-300">
								<div class="panel-heading">
									<h6 class="panel-title">Custom color</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
