...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="general_embeds">Embeds</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">General Pages</span> - Responsive Embeds</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="general_embeds">General pages</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Video options
						<small class="display-block">Sources and aspect ratios</small>
					</h6>
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Youtube video</h5>
								</div>

								<div class="panel-body">
									<div class="content-group-lg">
										<h6 class="text-semibold no-margin-top">16:9 ratio</h6>
									...
									<h6 class="text-semibold">4:3 ratio</h6>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">IMDB video</h5>
								</div>
								...
								<div class="panel-body">
									...
									<h6 class="text-semibold no-margin-top">4:3 ratio</h6>
									<div class="embed-responsive embed-responsive-4by3">
						...
						<div class="col-sm-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Vimeo video</h5>
								</div>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">UStream video</h5>
								</div>
					...
					<h6 class="content-group text-semibold">
						Embedding options
						<small class="display-block">Iframe, embed or object elements</small>
					</h6>
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Using "embed" element</h5>
								</div>
						...
						<div class="col-sm-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Using "object" element</h5>
								</div>
