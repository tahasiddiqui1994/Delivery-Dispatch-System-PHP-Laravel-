...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_labels">Labels and badges</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Components</span> - Labels &amp; Badges</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="components_labels">Components</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Labels and badges</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="table-responsive">
							<table class="table">
								<tbody>
									<tr>
										<th colspan="3" class="active">Basic label styling</th>
									</tr>
									<tr>
										<td style="width: 25%;">Default label</td>
										<td style="width: 20%;"><span class="label label-default">Default</span></td>
										<td>Default label styling. To use, add <code>.label-default</code> to the base <code>.label</code> class</td>
									</tr>
									<tr>
										<td>Primary label</td>
										<td><span class="label label-primary">Primary</span></td>
										<td>Primary contextual alternative. To use, add <code>.label-primary</code> to the base <code>.label</code> class</td>
									</tr>
									<tr>
										<td>Danger label</td>
										<td><span class="label label-danger">Danger</span></td>
										<td>Danger contextual alternative. To use, add <code>.label-danger</code> to the base <code>.label</code> class</td>
									</tr>
									<tr>
										<td>Success label</td>
										<td><span class="label label-success">Success</span></td>
										<td>Success contextual alternative. To use, add <code>.label-success</code> to the base <code>.label</code> class</td>
									</tr>
									<tr>
										<td>Warning label</td>
										<td><span class="label label-warning">Warning</span></td>
										<td>Warning contextual alternative. To use, add <code>.label-warning</code> to the base <code>.label</code> class</td>
									</tr>
									<tr>
										<td>Info label</td>
										<td><span class="label label-info">Info</span></td>
										<td>Info contextual alternative. To use, add <code>.label-info</code> to the base <code>.label</code> class</td>
									</tr>
									<tr>
										<td>Custom label color</td>
										<td><span class="label bg-purple">Purple</span></td>
										<td>Add one of <a href="colors_primary">available</a> custom background colors. To use, add <code>.bg-*</code> color class to the <code>.label</code> element</td>
									</tr>

									<tr class="border-double">
										<th colspan="3" class="active">Basic label options</th>
									</tr>
									<tr>
										<td>Rounded label</td>
										<td><span class="label label-primary label-rounded">Rounded label</span></td>
										<td>Label with rounded corners. To use, add <code>.label-rounded</code> class to the <code>.label</code> element</td>
									</tr>
									<tr>
										<td>Roundless label</td>
										<td><span class="label label-success label-roundless">Roundless label</span></td>
										<td>This label doesn't have rounded borders. To use, add <code>.label-roundless</code> class to the <code>.label</code> element</td>
									</tr>
									<tr>
										<td>Block label</td>
										<td><span class="label label-danger label-block">Block label</span></td>
										<td>This label fills 100% width of a parent element. To use, add <code>.label-block</code> class to the <code>.label</code> element</td>
									</tr>
									<tr>
										<td>Linked label</td>
										<td><a href="#" class="label label-info">Linked label</a></td>
										<td>You can also use labels as a link in an <code>&lt;a></code> element</td>
									</tr>
									<tr>
										<td>Label with dropdown</td>
										<td>
											<div class="btn-group">
												<a href="#" class="label bg-brown dropdown-toggle" data-toggle="dropdown">Dropdown <span class="caret"></span></a>

												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="#"><span class="status-mark position-left border-danger"></span> High priority</a></li>
													<li><a href="#"><span class="status-mark position-left border-info"></span> Normal priority</a></li>
													<li><a href="#"><span class="status-mark position-left border-primary"></span> Low priority</a></li>
												</ul>
											</div>
										</td>
										<td>Dropdown menu attached to the label with optional caret</td>
									</tr>
									<tr class="border-solid">
										<td>Icon in label</td>
										<td><span class="label label-warning label-icon"><i class="icon-stars"></i></span></td>
										<td>Label with icon. To use, add icon and <code>.label-icon</code> class to the label. Available in 5 sizes</td>
									</tr>
									<tr>
										<td>Icon in linked label</td>
										<td><a href="#" class="label label-primary label-icon"><i class="icon-wrench"></i></a></td>
										<td>Linked label with icon. To use, add icon and <code>.label-icon</code> to the link</td>
									</tr>
									<tr>
										<td>Icon in rounded label</td>
										<td><span class="label label-success label-rounded label-icon"><i class="icon-home4"></i></span></td>
										<td>Rounded linked icon. Usage is the same, but with additional <code>.label-rounded</code> class</td>
									</tr>
									<tr>
										<td>Icon in linked rounded label</td>
										<td><a href="#" class="label bg-slate label-rounded label-icon"><i class="icon-pin-alt"></i></a></td>
										<td>The same as above, but inside link element</td>
									</tr>

									<tr class="border-double">
										<th colspan="3" class="active">Striped labels</th>
									</tr>
									<tr>
										<td>Default label</td>
										<td><span class="label border-left-grey label-striped">Default</span></td>
										<td>Basic striped label. To use with default label and <code>.label-striped</code> class</td>
									</tr>
									<tr>
										<td>Primary label</td>
										<td><span class="label border-left-primary label-striped">Primary</span></td>
										<td>Primary contextual alternative. To use with primary label and <code>.label-striped</code> class</td>
									</tr>
									<tr>
										<td>Danger label</td>
										<td><span class="label border-left-danger label-striped">Danger</span></td>
										<td>Danger contextual alternative. To use with danger label and <code>.label-striped</code> class</td>
									</tr>
									<tr>
										<td>Success label</td>
										<td><span class="label border-left-success label-striped">Success</span></td>
										<td>Success contextual alternative. To use with success label and <code>.label-striped</code> class</td>
									</tr>
									<tr>
										<td>Warning label</td>
										<td><span class="label border-left-warning label-striped">Warning</span></td>
										<td>Warning contextual alternative. To use with warning label and <code>.label-striped</code> class</td>
									</tr>
									<tr>
										<td>Info label</td>
										<td><span class="label border-left-info label-striped">Info</span></td>
										<td>Info contextual alternative. To use with info label and <code>.label-striped</code> class</td>
									</tr>
									<tr>
										<td>Custom border color</td>
										<td><span class="label border-left-violet label-striped">Violet</span></td>
										<td>Striped label with one of <a href="colors_primary">available</a> custom border colors</td>
									</tr>

									<tr class="border-double">
										<th colspan="3" class="active">Striped label options</th>
									</tr>
									<tr>
										<td>Right border</td>
										<td><span class="label border-right-success label-striped label-striped-right">Right border</span></td>
										<td>To highlight right border instead of left, add <code>.label-striped-right</code> class</td>
									</tr>
									<tr>
										<td>Linked label</td>
										<td><a href="#" class="label border-left-danger label-striped">Linked label</a></td>
										<td>Linked striped label. Use <code>.label-striped</code> and other label classes in <code>&lt;a></code> element</td>
									</tr>
									<tr>
										<td>Label with dropdown</td>
										<td>
											<div class="btn-group">
												<a href="#" class="label border-left-primary label-striped dropdown-toggle" data-toggle="dropdown">Dropdown <span class="caret"></span></a>
										...
										<td>Dropdown menu attached to the striped label with optional caret</td>
									</tr>
									<tr class="border-solid">
										<td>Icon in striped label</td>
										<td><span class="label label-striped border-left-teal-300 label-icon"><i class="icon-gear"></i></span></td>
										<td>Icon inside striped label. To use custom border color, add <code>.border-*</code> custom border color class. Available in 5 sizes</td>
									</tr>
									<tr>
										<td>Icon in linked striped label</td>
										<td><a href="#" class="label label-striped border-left-violet label-icon"><i class="icon-three-bars"></i></a></td>
										<td>Linked icon inside striped label</td>
									</tr>

									<tr class="border-double">
										<th colspan="3" class="active">Flat labels</th>
									</tr>
									<tr>
										<td>Default flat label</td>
										<td><span class="label label-flat border-grey text-grey-600">Default</span></td>
										<td>Flat label in default styling. To use with grey color classes and <code>.label-flat</code> class</td>
									</tr>
									<tr>
										<td>Primary label</td>
										<td><span class="label label-flat border-primary text-primary-600">Primary</span></td>
										<td>Flat label in primary contextual alternative. To use with primary color classes and <code>.label-flat</code> class</td>
									</tr>
									<tr>
										<td>Danger label</td>
										<td><span class="label label-flat border-danger text-danger-600">Danger</span></td>
										<td>Flat label in danger contextual alternative. To use with danger color classes and <code>.label-flat</code> class</td>
									</tr>
									<tr>
										<td>Success label</td>
										<td><span class="label label-flat border-success text-success-600">Success</span></td>
										<td>Flat label in success contextual alternative. To use with success color classes and <code>.label-flat</code> class</td>
									</tr>
									<tr>
										<td>Warning label</td>
										<td><span class="label label-flat border-warning text-warning-600">Warning</span></td>
										<td>Flat label in warning contextual alternative. To use with warning color classes and <code>.label-flat</code> class</td>
									</tr>
									<tr>
										<td>Info label</td>
										<td><span class="label label-flat border-info text-info-600">Info</span></td>
										<td>Flat label in info contextual alternative. To use with info color classes and <code>.label-flat</code> class</td>
									</tr>
									<tr>
										<td>Custom label color</td>
										<td><span class="label label-flat border-pink text-pink-600">Pink</span></td>
										<td>To use custom border and text colors, add <code>border-*</code> and <code>text-*</code> color classes to the <code>.label</code></td>
									</tr>

									<tr class="border-double">
										<th colspan="3" class="active">Flat label options</th>
									</tr>
									<tr>
										<td>Linked flat label</td>
										<td><a href="#" class="label label-flat border-primary text-primary-600">Linked label</a></td>
										<td>Use <code>.label-flat</code> and other label classes in <code>&lt;a></code> element</td>
									</tr>
									<tr>
										<td>Rounded flat label</td>
										<td><span class="label label-flat label-rounded border-success text-success-600">Rounded label</span></td>
										<td>Make flat label rounded with <code>.label-rounded</code> added to the base <code>.label-flat</code> element</td>
									</tr>
									<tr>
										<td>Block label</td>
										<td><span class="label label-flat label-block border-danger text-danger-600">Block label</span></td>
										<td>To make flat label full width, use <code>.label-block</code> class. Works with linked labels as well</td>
									</tr>
									<tr>
										<td>Flat label with dropdown</td>
										<td>
											<div class="btn-group">
												<a href="#" class="label label-flat border-info text-info-600 dropdown-toggle" data-toggle="dropdown">Dropdown <span class="caret"></span></a>
										...
										<td>Dropdown menu attached to the flat label with optional caret</td>
									</tr>
									<tr class="border-solid">
										<td>Icon in flat label</td>
										<td><span class="label label-flat border-brown text-brown-600 label-icon"><i class="icon-stars"></i></span></td>
										<td>Icon inside flat label. To use, add icon and <code>.label-icon</code> class to the label</td>
									</tr>
									<tr>
										<td>Icon in linked flat label</td>
										<td><a href="#" class="label label-flat border-primary text-primary-600 label-icon"><i class="icon-wrench"></i></a></td>
										<td>Icon inside linked flat label. To use, add icon and <code>.label-icon</code> to the link</td>
									</tr>
									<tr>
										<td>Icon in flat rounded label</td>
										<td><span class="label label-flat label-rounded label-icon border-purple text-purple-600"><i class="icon-home4"></i></span></td>
										<td>Icon inside rounded flat label. To use, add <code>.label-rounded</code> class</td>
									</tr>
									<tr>
										<td>Icon in linked rounded label</td>
										<td><a href="#" class="label label-flat label-rounded label-icon border-teal text-teal-600"><i class="icon-pin-alt"></i></a></td>
										<td>The same as above, but inside link element</td>
									</tr>
									...
									<tr>
										<td>Default badge</td>
										<td><span class="badge badge-default">78</span></td>
										<td>Basic badge. To use, add <code>.badge-default</code> to the badge element</td>
									</tr>
									<tr>
										<td>Primary badge</td>
									...
									<tr>
										...
										<td><span class="badge bg-pink">83</span></td>
									...
									<tr>
										<td>Linked badge</td>
										<td><a href="#" class="badge badge-danger">22</a></td>
									...
									<tr>
										...
										<td>
											<div class="btn-group">
												<a href="#" class="badge badge-primary dropdown-toggle" data-toggle="dropdown">57 <span class="caret"></span></a>
									...
									<tr class="border-double">
										<th colspan="3" class="active">Flat badges</th>
									</tr>
									<tr>
										<td>Default badge</td>
										<td><span class="badge badge-flat border-grey text-grey-600">63</span></td>
										<td>Flat badge in default style. To use with grey color classes and <code>.badge-flat</code> class</td>
									</tr>
									<tr>
										<td>Primary badge</td>
										<td><span class="badge badge-flat border-primary text-primary-600">59</span></td>
										<td>Primary contextual alternative. To use with primary color classes and <code>.badge-flat</code> class</td>
									</tr>
									<tr>
										<td>Danger badge</td>
										<td><span class="badge badge-flat border-danger text-danger-600">83</span></td>
										<td>Danger contextual alternative. To use with danger color classes and <code>.badge-flat</code> class</td>
									</tr>
									<tr>
										<td>Success badge</td>
										<td><span class="badge badge-flat border-success text-success-600">93</span></td>
										<td>Success contextual alternative. To use with success color classes and <code>.badge-flat</code> class</td>
									</tr>
									<tr>
										<td>Warning badge</td>
										<td><span class="badge badge-flat border-warning text-warning-600">38</span></td>
										<td>Warning contextual alternative. To use with warning color classes and <code>.badge-flat</code> class</td>
									</tr>
									<tr>
										<td>Info badge</td>
										<td><span class="badge badge-flat border-info text-info-600">67</span></td>
										<td>Info contextual alternative. To use with info color classes and <code>.badge-flat</code> class</td>
									</tr>
									<tr>
										<td>Custom badge color</td>
										<td><span class="badge badge-flat border-brown text-brown-600">43</span></td>
										<td>To use custom border and text colors, add <code>border-*</code> and <code>text-*</code> color classes to the badge element</td>
									</tr>

									<tr class="border-double">
										<th colspan="3" class="active">Flat badge options</th>
									</tr>
									<tr>
										<td>Linked badge</td>
										<td><a href="#" class="badge badge-flat border-danger text-danger-600">49</a></td>
										<td>Linked flat badge. Use <code>.badge</code> and other border/text color classes in an <code>&lt;a></code> element</td>
									</tr>
									<tr>
										<td>Badge with dropdown</td>
										<td>
											<div class="btn-group dropup">
												<a href="#" class="badge border-primary text-primary-600 badge-flat dropdown-toggle" data-toggle="dropdown">94 <span class="caret"></span></a>
