...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="{{url('assets/js/plugins/sliders/ion_rangeslider.min.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/ui/moment/moment_locales.min.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/pages/extra_sliders_ion.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="extra_sliders_ion">Ion range sliders</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Extra</span> - Ion Range Sliders</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="extra_sliders_ion">Components</a></li>
							<li class="active">Ion range sliders</li>
						</ul>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Basic examples
						<small class="display-block">Sliders with basic functionality</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									...
									<p class="content-group-sm text-muted">Default setup without parameters</p>
								</div>

								<input type="text" class="form-control" id="ion-basic">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Set up range and step</h6>
									<p class="content-group-sm text-muted">Set up range with negative values</p>
								</div>

								<input type="text" class="form-control" id="ion-negative">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Set start point</h6>
									<p class="content-group-sm text-muted">Set min value, max value and start point</p>
								</div>

								<input type="text" class="form-control" id="ion-start">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Custom stepping</h6>
									<p class="content-group-sm text-muted">Set slider step using <code>step</code> option</p>
								</div>

								<input type="text" class="form-control" id="ion-step">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Basic range slider</h6>
									<p class="content-group-sm text-muted">Set type to double and specify range</p>
								</div>

								<input type="text" class="form-control" id="ion-range">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Fractional step</h6>
									<p class="content-group-sm text-muted">Set up range with fractional values</p>
								</div>

								<input type="text" class="form-control" id="ion-fractional">
							</div>
						</div>
					</div>
					<!-- /basic examples -->
					...
					<h6 class="content-group text-semibold">
						Customizing values
						<small class="display-block">Prettify visual look of numbers</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Custom number values</h6>
									<p class="content-group-sm text-muted">Set up custom numbers in the grid</p>
								</div>

								<input type="text" class="form-control" id="ion-custom-numbers">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Disable prettify</h6>
									<p class="content-group-sm text-muted">Big numbers are ugly and unreadable</p>
								</div>

								<input type="text" class="form-control" id="ion-numbers-no-prettify">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Custom value names</h6>
									<p class="content-group-sm text-muted">Using any strings as your values</p>
								</div>

								<input type="text" class="form-control" id="ion-custom-strings">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Enable prettify</h6>
									<p class="content-group-sm text-muted">Looks much better with spacing</p>
								</div>

								<input type="text" class="form-control" id="ion-numbers-prettify">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Months values</h6>
									<p class="content-group-sm text-muted">Another example of using strings</p>
								</div>

								<input type="text" class="form-control" id="ion-custom-months">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Custom separator</h6>
									<p class="content-group-sm text-muted">Don't like spacing? Add your own separator</p>
								</div>

								<input type="text" class="form-control" id="ion-custom-separator">
							</div>
						</div>
					</div>
					<!-- /customizing values -->
					...
					<h6 class="content-group text-semibold">
						Decorating numbers
						<small class="display-block">Add prefixes, postfixes, symbols etc.</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Numbers with prefix</h6>
									<p class="content-group-sm text-muted">Adding custom prefix to the numbers</p>
								</div>

								<input type="text" class="form-control" id="ion-custom-prefix">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Decorate both values</h6>
									<p class="content-group-sm text-muted">Using <code>decorate_both</code> config option</p>
								</div>

								<input type="text" class="form-control" id="ion-decorate-both">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Numbers with postfix</h6>
									<p class="content-group-sm text-muted">Adding custom postfix to the numbers</p>
								</div>

								<input type="text" class="form-control" id="ion-custom-postfix">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Decoration separator</h6>
									<p class="content-group-sm text-muted">Change default separator to your own</p>
								</div>

								<input type="text" class="form-control" id="ion-decorate-both-custom">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Number with no limit</h6>
									<p class="content-group-sm text-muted">If max number is not the biggest one</p>
								</div>

								<input type="text" class="form-control" id="ion-max-no-limit">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Remove decoration</h6>
									<p class="content-group-sm text-muted">No decoration in the second value</p>
								</div>

								<input type="text" class="form-control" id="ion-decorate-both-remove">
							</div>
						</div>
					</div>
					<!-- /decorating numbers -->
					...
					<h6 class="content-group text-semibold">
						Advanced examples
						<small class="display-block">More complex slider examples</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Values inside container</h6>
									<p class="content-group-sm text-muted">Prevent numbers from overflowing</p>
								</div>

								<input type="text" class="form-control" id="ion-force-edges">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Grid values density</h6>
									<p class="content-group-sm text-muted">Control number of grid values</p>
								</div>

								<input type="text" class="form-control" id="ion-grid-values">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									...
									<p class="content-group-sm text-muted">Lock the slider using <code>disable</code> option</p>
								</div>

								<input type="text" class="form-control" id="ion-disabled">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Attach values to steps</h6>
									<p class="content-group-sm text-muted">Have predifined step? You can snap grid to it</p>
								</div>

								<input type="text" class="form-control" id="ion-grid-snap">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Keyboard controls</h6>
									<p class="content-group-sm text-muted">Arrow keys and WSAD slider control</p>
								</div>

								<input type="text" class="form-control" id="ion-keyboard">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Fractional step</h6>
									<p class="content-group-sm text-muted">Attach values to fractional steps</p>
								</div>

								<input type="text" class="form-control" id="ion-grid-snap-fractional">
							</div>
						</div>
					</div>
					<!-- /advanced examples -->
					...
					<h6 class="content-group text-semibold">
						Manipulations
						<small class="display-block">Manipulation intervals, handles etc.</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Minimum interval size</h6>
									<p class="content-group-sm text-muted">Set min interval using <code>min_interval</code> option</p>
								</div>

								<input type="text" class="form-control" id="ion-interval-min">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Lock left handle</h6>
									<p class="content-group-sm text-muted">Fix <strong>from</strong> handle with <code>from_fixed</code> option</p>
								</div>

								<input type="text" class="form-control" id="ion-lock-from">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Maximum interval size</h6>
									<p class="content-group-sm text-muted">Set max interval using <code>max_interval</code> option</p>
								</div>

								<input type="text" class="form-control" id="ion-interval-max">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Lock right handle</h6>
									<p class="content-group-sm text-muted">Fix <strong>to</strong> handle with <code>to_fixed</code> option</p>
								</div>

								<input type="text" class="form-control" id="ion-lock-to">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Dragging interval</h6>
									<p class="content-group-sm text-muted">Enable dragging with <code>drag_interval</code> option</p>
								</div>

								<input type="text" class="form-control" id="ion-interval-drag">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Lock both handles</h6>
									<p class="content-group-sm text-muted">You can even lock both slider handles</p>
								</div>

								<input type="text" class="form-control" id="ion-lock-both">
							</div>
						</div>
					</div>
					<!-- /manipulations -->
					...
					<h6 class="content-group text-semibold">
						Other examples
						<small class="display-block">Format date and time, setting limits etc.</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Movement limit</h6>
									<p class="content-group-sm text-muted">Set limits for slider movement</p>
								</div>

								<input type="text" class="form-control" id="ion-movement-limit">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Moment.js format</h6>
									<p class="content-group-sm text-muted">Format date using moment.js</p>
								</div>

								<input type="text" class="form-control" id="ion-moment-basic">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Highlight limited zone</h6>
									<p class="content-group-sm text-muted">Highlight the zone using <code>from_shadow</code> option</p>
								</div>

								<input type="text" class="form-control" id="ion-highlight-limit">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Time format</h6>
									<p class="content-group-sm text-muted">12 or 24 hours time format</p>
								</div>

								<input type="text" class="form-control" id="ion-moment-time">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Highlight in range</h6>
									<p class="content-group-sm text-muted">More complex example of zone highlight</p>
								</div>

								<input type="text" class="form-control" id="ion-highlight-range">
							</div>

							<div class="panel panel-body border-top-danger">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Localization</h6>
									<p class="content-group-sm text-muted">Moment.js date and time localization</p>
								</div>

								<input type="text" class="form-control" id="ion-moment-local">
							</div>
						</div>
					</div>
					<!-- /slider colors -->
