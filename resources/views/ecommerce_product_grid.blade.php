									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="ecommerce_product_grid">Product grid</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">ECommerce</span> - Product Grid</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="ecommerce_product_grid">ECommerce</a></li>
							...
							<div class="row">
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Fathom Backpack</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Mystery Air Long Sleeve T Shirt</a></h6>

											<ul class="list-inline list-inline-separate mb-10">
												<li><a href="#" class="text-muted">Men's Fashion</a></li>
											</ul>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Women’s Prospect Backpack</a></h6>

											<ul class="list-inline list-inline-separate mb-10">
												<li><a href="#" class="text-muted">Women's Accessories</a></li>
											</ul>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Overlook Short Sleeve T Shirt</a></h6>
							...
							<div class="row">
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Infinite Ride Liner</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Custom Snowboard</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Kids' Day Hiker 20L Backpack</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Lunch Sack</a></h6>
							...
							<div class="row">
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Cambridge Jacket</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Covert Jacket</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Day Hiker Pinnacle 31L Backpack</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Kids' Gromlet Backpack</a></h6>
							...
							<div class="row">
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Tinder Backpack</a></h6>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="panel">
										...
										<div class="panel-body panel-body-accent text-center">
											<h6 class="text-semibold no-margin"><a href="#" class="text-default">Almighty Snowboard Boot</a></h6>
