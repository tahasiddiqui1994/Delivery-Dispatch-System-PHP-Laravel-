...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/google/lines/lines.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/lines/area.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/lines/area_stacked.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/lines/line_intervals.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/lines/area_intervals.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/lines/area_stepped.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="google_lines">Line charts</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Google</span> - Line Charts</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="google_lines">Google</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Simple area chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Stacked area chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Line intervals</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">Example of <code>line intervals</code> in charts. Intervals around a series might be used to portray confidence intervals, minimum and maximum values around a value, percentile sampling, or anything else that requires a varying margin around a series. Line intervals are sometimes used to show the raw data from which a trendline was extracted. To draw a trendline on a chart, use the trendlines option and specify which data series to use.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Area intervals</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Stepped area chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">Example of <code>stepped area</code> chart. A stepped area chart is rendered within the browser using <code>SVG</code> or <code>VML</code>. Displays tips when hovering over steps. The Step Line chart type is similar to the Line chart type, but it does not use the shortest distance to connect two data points. Instead, this chart type uses vertical and horizontal lines to connect the data points in a series forming a step-like progression.</p>
