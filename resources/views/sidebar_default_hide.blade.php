...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="sidebar_default_hide">Default hideable</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Default Hideable</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_default_hide">Sidebars</a></li>
							<li class="active">Default hideable</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Hideable default sidebar</h6>
						Main sidebar can be completely hidden. To use this option, just change button class to <code>.sidebar-main-hide</code> and main sidebar will be hidden on button click.
				    </div>
				    <!-- /info alert -->
