...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/editors/wysihtml5/locales/bootstrap-wysihtml5.ua-UA.js')}}"></script>
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="editor_wysihtml5">WYSIHTML5 editor</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Editors</span> - WYSIHTML5</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="editors_wysihtml5">Editors</a></li>
							<li class="active">WYSIHTML5</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Simple toolbar</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<p class="content-group">The following example demonstrates WYSIHTML5 editor with <code>simplified</code> toolbar. Since browsers use a default style sheet to style elements, so if you use <code>b</code>, <code>i</code>, <code>ul</code> and <code>li</code>, there is already some styling visible in the editor. Please note: The textarea will always hold the editor's generated markup. Therefore wysihtml5 integrates smoothly with forms.</p>
							<form action="#">
								<div class="form-group">
									<textarea cols="18" rows="18" class="wysihtml5 wysihtml5-min form-control" placeholder="Enter text ...">
										<h1>WYSIHTML5 - A better approach to rich text editing</h1>
										<p>wysihtml5 is an <span class="wysiwyg-color-green"><a rel="nofollow" target="_blank" href="{{url('https://github.com/xing/wysihtml5">open source</a></span> rich text editor based on HTML5 technology and the progressive-enhancement approach.
...
<ul>
	...
	<li><strong>Graceful degradation:</strong> Unsupported browsers will get a textarea</li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">WYSIHTML5 events</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
...
<ul>
	...
	<li><strong>Graceful degradation:</strong> Unsupported browsers will get a textarea</li>
				                ...
				                <div class="text-right">
					                <button type="button" class="btn btn-primary wysihtml5-init">Create WYSIHTML5 editor from textarea</button>
								</div>
							</form>
						</div>
					</div>
