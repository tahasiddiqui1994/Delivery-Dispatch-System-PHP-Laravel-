...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/tables/datatables/extensions/natural_sort.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/forms/selects/select2.min.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/pages/tasks_list.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										<li>
											...
											<ul>
												...
												<li class="active"><a href="task_manager_list">Task list</a></li>
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Task Manager</span> - List</h4>

							<ul class="breadcrumb position-right">
								<li><a href="index">Home</a></li>
								<li><a href="task_manager_list">Task manager</a></li>
						...
						<table class="table tasks-list table-lg">
							...
							<tbody>
								<tr>
									...
									<td>Today</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">New blog layout</a></div>
								...
								<tr>
									...
									<td>Today</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Create UI design model</a></div>
								...
								<tr>
									...
									<td>Today</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">New icons set for an iOS app</a></div>
								...
								<tr>
									...
									<td>Today</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Create ad campaign banners set</a></div>
								...
								<tr>
									...
									<td>Yesterday</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Edit the draft for the icons</a></div>
								...
								<tr>
									...
									<td>Yesterday</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Fix validation issues and commit</a></div>
								...
								<tr>
									...
									<td>Yesterday</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Support tickets list doesn't support commas</a></div>
								...
								<tr>
									...
									<td>Yesterday</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Help Web devs with HTML integration</a></div>
								...
								<tr>
									...
									<td>2 days ago</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Another icon set</a></div>
								...
								<tr>
									...
									<td>2 days ago</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">iOS application design mockups</a></div>
								...
								<tr>
									...
									<td>2 days ago</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">UI/UX design review</a></div>
								...
								<tr>
									...
									<td>2 days ago</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Marketing campaign review</a></div>
								...
								<tr>
									...
									<td>2 days ago</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Fix website issues on mobile</a></div>
								...
								<tr>
									...
									<td>Last week</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Add updated responsive styles</a></div>
								...
								<tr>
									...
									<td>Last week</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Merge latest changes</a></div>
								...
								<tr>
									...
									<td>Last week</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Create landing page for a new app</a></div>
								...
								<tr>
									...
									<td>Last week</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Update JS code in app.js file</a></div>
								...
								<tr>
									...
									<td>Last week</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Combine .js files in /app/js/</a></div>
								...
								<tr>
									...
									<td>Last week</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Create application Photoshop draft</a></div>
								...
								<tr>
									...
									<td>Last week</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Cartoon characters for app ads</a></div>
								...
								<tr>
									...
									<td>Last week</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Google AdWords campain graphics</a></div>
								...
								<tr>
									...
									<td>Last week</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Monthly statistics report</a></div>
								...
								<tr>
									...
									<td>Last week</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Create invoice template</a></div>
								...
								<tr>
									...
									<td>Last week</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Add images to the product gallery</a></div>
								...
								<tr>
									...
									<td>Last week</td>
					                <td>
					                	<div class="text-semibold"><a href="task_manager_detailed">Update User profile page</a></div>
