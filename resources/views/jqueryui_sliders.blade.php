...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/jqueryui_sliders.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="jqueryui_sliders">Sliders</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">jQuery UI</span> - Sliders</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="jqueryui_sliders">jQuery UI</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Basic sliders
						<small class="display-block">Basic jQuery UI sliders</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Basic slider example</h6>
									<p class="content-group text-muted">Example of basic jQuery UI slider</p>
								</div>

								<div class="ui-slider mb-5"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Values range slider</h6>
									<p class="content-group text-muted">Use <code>range: true</code> to show ranges</p>
								</div>

								<div class="ui-slider-range mb-5"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Animated slider</h6>
									<p class="content-group text-muted">Use <code>animate: true</code> to animate slider</p>
								</div>

								<div class="ui-slider-animated mb-5"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Custom start value</h6>
									<p class="content-group text-muted">Set start value using <code>value</code> option</p>
								</div>

								<div class="ui-slider-value mb-5"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Fixed minimum range</h6>
									<p class="content-group text-muted">Set min value with <code>range: 'min'</code> option</p>
								</div>

								<div class="ui-slider-range-min mb-5"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin mb-5 text-semibold">Slider methods</h6>
									<p class="content-group text-muted">
										<label class="checkbox-inline checkbox-switchery switchery-xs switchery-double">
											Disable slider
								...
								<div class="ui-slider-methods mb-5"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Snap to increments</h6>
									<p class="content-group text-muted">Increment values with the <code>step</code> option</p>
								</div>

								<div class="ui-slider-increments mb-5"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Fixed maximum range</h6>
									<p class="content-group text-muted">Set max value with <code>range: 'max'</code> option</p>
								</div>

								<div class="ui-slider-range-max mb-5"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Disabled slider</h6>
									<p class="content-group text-muted">Use <code>disabled: true</code> to disable slider</p>
								</div>

								<div class="ui-slider-disabled mb-5"></div>
							</div>
						</div>
					</div>
					<!-- /jQuery UI basic sliders -->
					...
					<h6 class="content-group text-semibold">
						Advanced sliders
						<small class="display-block">Advanced jQuery UI sliders</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									...
									<p class="content-group text-muted">Using <code>.slider("pips")</code> method</p>
								</div>
							...
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Display handle tooltip</h6>
									<p class="content-group text-muted">Using <code>.slider("float")</code> method</p>
								</div>

								<div class="ui-slider-floats"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Display months</h6>
									<p class="content-group text-muted">Custom output: <span class="text-semibold" id="ui-slider-labels-custom-output">You selected</span></p>
								</div>

								<div class="ui-slider-labels-custom"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Display labels with pips</h6>
									<p class="content-group text-muted">Using <code>rest: 'label'</code> option</p>
								</div>

								<div class="ui-slider-labels"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Hide rest of the points</h6>
									<p class="content-group text-muted">Hide pips using <code>rest: false</code> option</p>
								</div>

								<div class="ui-slider-limits ui-slider-danger"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Label localization</h6>
									<p class="content-group text-muted">Display non-roman numbers/letters</p>
								</div>

								<div class="ui-slider-local"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Display pips only</h6>
									<p class="content-group text-muted">Add <code>'pips'</code> to the first/last points</p>
								</div>

								<div class="ui-slider-pips-only"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Display prefix and suffix</h6>
									<p class="content-group text-muted">Using <code>prefix</code> and <code>suffix</code> options</p>
								</div>

								<div class="ui-slider-suffix-prefix"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Display pips and float</h6>
									<p class="content-group text-muted">Using both <code>pips</code> and <code>float</code> methods</p>
								</div>

								<div class="ui-slider-floats-labels"></div>
							</div>
						</div>
					</div>
					<!-- /jQuery UI advanced sliders -->
					...
					<h6 class="content-group text-semibold">
						Vertical sliders
						<small class="display-block">Vertical slider orientation</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Basic vertical sliders</h6>
								<p class="content-group text-muted">Using <code>orientation: 'vertical'</code> option</p>

								<div class="ui-slider-vertical-default">
									<span>70</span>
									<span>52</span>
									<span>80</span>
									<span>34</span>
							...
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Vertical slider with pips</h6>
								<p class="content-group text-muted">Using <code>.slider("pips")</code> method</p>

								<div class="ui-slider-vertical-pips">
									<span class="ui-slider-success">2</span>
									<span class="ui-slider-danger">5</span>
									<span class="ui-slider-info">8</span>
								</div>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Sizes. Default handle</h6>
								<p class="content-group text-muted">Using <code>ui-slider-lg (sm, xs)</code> classes</p>

								<div class="ui-slider-vertical-handle-default">
									<span class="ui-slider-primary ui-slider-lg">70</span>
									<span class="ui-slider-danger">52</span>
									<span class="ui-slider-success ui-slider-sm">80</span>
									<span class="ui-slider-info ui-slider-xs">34</span>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Range with fixed minimum</h6>
								<p class="content-group text-muted">Set min value with <code>range: 'min'</code> option</p>

								<div class="ui-slider-vertical-range-min">
									<span class="ui-slider-primary">70</span>
									<span class="ui-slider-success">52</span>
									<span class="ui-slider-warning">80</span>
									<span class="ui-slider-info">34</span>
								</div>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Vertical slider with labels</h6>
								<p class="content-group text-muted">Using <code>rest: 'label'</code> option</p>

								<div class="ui-slider-vertical-labels">
									<span class="ui-slider-success">1</span>
									<span class="ui-slider-danger">2</span>
									<span class="ui-slider-info">3</span>
								</div>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Sizes. Solid handle</h6>
								<p class="content-group text-muted">Using <code>ui-slider-solid</code> class</p>

								<div class="ui-slider-vertical-handle-default">
									<span class="ui-slider-primary ui-slider-solid ui-slider-lg">70</span>
									<span class="ui-slider-danger ui-slider-solid">52</span>
									<span class="ui-slider-success ui-slider-solid ui-slider-sm">80</span>
									<span class="ui-slider-info ui-slider-solid ui-slider-xs">34</span>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Range with fixed maximum</h6>
								<p class="content-group text-muted">Set max value with <code>range: 'max'</code> option</p>

								<div class="ui-slider-vertical-range-max">
									<span class="ui-slider-primary">70</span>
									<span class="ui-slider-success">52</span>
									<span class="ui-slider-warning">80</span>
									<span class="ui-slider-info">34</span>
							...
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">With handle tooltips</h6>
								<p class="content-group text-muted">Using both <code>float</code> and <code>pips</code> methods</p>

								<div class="ui-slider-vertical-minmax">
									<span class="ui-slider-success">2</span>
									<span class="ui-slider-danger">5</span>
									<span class="ui-slider-info">8</span>
								</div>
							...
							<div class="panel panel-body border-top-primary text-center">
								...
								<p class="content-group text-muted">Using <code>ui-handle-white</code> class</p>

								<div class="ui-slider-vertical-handle-default">
									<span class="ui-slider-primary ui-handle-white ui-slider-lg">70</span>
									<span class="ui-slider-danger ui-handle-white">52</span>
									<span class="ui-slider-success ui-handle-white ui-slider-sm">80</span>
									<span class="ui-slider-info ui-handle-white ui-slider-xs">34</span>
								</div>
							</div>
						</div>
					</div>
					...
					<h6 class="content-group text-semibold">
						Slider colors
						<small class="display-block">jQuery UI contextual slider colors</small>
					</h6>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									...
									<p class="content-group text-muted">Default <code>dark grey</code> slider color</p>
								</div>
							...
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									...
									<p class="content-group text-muted">Using <code>ui-slider-success</code> class</p>
								</div>

								<div class="ui-slider-range ui-slider-success mb-5"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									...
									<p class="content-group text-muted">Using <code>ui-slider-primary</code> class</p>
								</div>

								<div class="ui-slider-range ui-slider-primary mb-5"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Warning slider style</h6>
									<p class="content-group text-muted">Using <code>ui-slider-warning</code> class</p>
								</div>

								<div class="ui-slider-range ui-slider-warning mb-5"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									...
									<p class="content-group text-muted">Using <code>ui-slider-danger</code> class</p>
								</div>

								<div class="ui-slider-range ui-slider-danger mb-5"></div>
							</div>

							<div class="panel panel-body border-top-primary">
								<div class="text-center">
									<h6 class="no-margin text-semibold">Info slider style</h6>
									<p class="content-group text-muted">Using <code>ui-slider-info</code> class</p>
								</div>

								<div class="ui-slider-range ui-slider-info mb-5"></div>
							</div>
						</div>
					</div>
					<!-- /jQuery UI slider colors -->
					...
					<h6 class="content-group text-semibold">
						...
						<small class="display-block">Options of jQuery UI sliders</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								...
								<div class="ui-slider-range ui-slider-primary ui-slider-lg" style="margin-bottom: 30px;"></div>
								<div class="ui-slider-range ui-slider-danger" style="margin-bottom: 30px;"></div>
								<div class="ui-slider-range ui-slider-success ui-slider-sm" style="margin-bottom: 30px;"></div>
								<div class="ui-slider-range ui-slider-info ui-slider-xs mb-5"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								...
								<div class="ui-slider-range ui-slider-primary ui-slider-solid ui-slider-lg" style="margin-bottom: 30px;"></div>
								<div class="ui-slider-range ui-slider-danger ui-slider-solid" style="margin-bottom: 30px;"></div>
								<div class="ui-slider-range ui-slider-success ui-slider-solid ui-slider-sm" style="margin-bottom: 30px;"></div>
								<div class="ui-slider-range ui-slider-info ui-slider-solid ui-slider-xs mb-5"></div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary">
								...
								<div class="ui-slider-range ui-slider-primary ui-handle-white ui-slider-lg" style="margin-bottom: 30px;"></div>
								<div class="ui-slider-range ui-slider-danger ui-handle-white" style="margin-bottom: 30px;"></div>
								<div class="ui-slider-range ui-slider-success ui-handle-white ui-slider-sm" style="margin-bottom: 30px;"></div>
								<div class="ui-slider-range ui-slider-info ui-handle-white ui-slider-xs mb-5"></div>
							</div>
						</div>
					</div>
