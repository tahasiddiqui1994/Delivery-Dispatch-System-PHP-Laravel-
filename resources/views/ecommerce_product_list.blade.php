								...
								<li>
									...
									<ul>
										...
										<li>
											...
											<ul>
												<li class="active"><a href="ecommerce_product_list">Product list</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">ECommerce</span> - Product List</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="ecommerce_product_list">ECommerce</a></li>
						...
						<div class="content-detached">
							...
							<ul class="media-list">
								<li class="media panel panel-body stack-media-on-mobile">
									<a href="{{url('assets/images/placeholder.jpg" class="media-left" data-popup="lightbox">
