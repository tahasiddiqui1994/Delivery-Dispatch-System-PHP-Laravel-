...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/colors_violet.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="colors_violet">Violet palette</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Colors</span> - Violet Palette</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="colors_violet">Colors</a></li>
							<li class="active">Violet palette</li>
						</ul>
				...
				<div class="content">
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#6A1B9A</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#violet_800"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#7B1FA2</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#violet_700"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#8E24AA</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#violet_600"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#9C27B0</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#violet_500"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#AB47BC</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#violet_400"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#BA68C8</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#violet_300"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="content-group-lg">
						...
						<!-- Basic alert -->
						<div class="alert alpha-violet-400 border-violet alert-styled-left">
					    ...
					    <!-- Solid alert -->
					    <div class="alert bg-violet-400 alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Close</span></button>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.text-violet</code> classes</p>
								</div>

								<input type="text" class="form-control text-violet text-uppercase text-semibold text-size-small" value="Input field text">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-violet</code> or classes</p>
								</div>

								<input type="text" class="form-control border-violet border-lg" placeholder="Input field border">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-violet</code> classes</p>
								</div>

								<input type="text" class="form-control bg-violet-400" placeholder="Input field background">
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								...
								<div class="has-feedback">
									<input type="text" class="form-control bg-violet-400" placeholder="Icon feedback, violet input">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								...
								<select class="form-control bg-violet-400">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								...
								<div class="input-group">
									<span class="input-group-addon bg-violet-400"><i class="icon-menu7"></i></span>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								...
								<div class="input-group">
									<span class="input-group-addon bg-violet-700"><i class="icon-lock2"></i></span>
									<input type="text" class="form-control bg-violet-400" placeholder="Solid background color">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
										<button class="btn bg-violet-400" type="button">Button</button>
									</span>									
								</div>
							</div>
				    	</div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								<div class="text-center">
				    		...
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<div class="text-center">
									<label class="radio-inline">
										<input type="radio" class="styled" name="violet-radio" checked="checked">
										Selected
									</label>

									<label class="radio-inline">
										<input type="radio" class="styled" name="violet-radio">
										Unselected
									</label>
								</div>
							</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-violet</code> or classes</p>

									<select class="selectbox bg-violet-400">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								<div class="text-center">
									...
									<select class="bootstrap-select" data-style="bg-violet-400">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										<ul class="nav nav-tabs bg-violet-400">
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										...
										<div class="tab-content bg-violet-400">
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<span class="label bg-violet-400">Violet label</span>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<span class="badge bg-violet-400">390</span>
							</div>
				    	</div>
				    </div>
				    <!-- /text options -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-violet-400" style="width: 55%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-violet-400 progress-bar-striped" style="width: 65%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-violet-400 progress-bar-striped active" style="width: 75%">
				    ...
				    <div class="row">
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th>Last Name</th>
												<th class="bg-violet-400">Username</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												...
												<td>Kopyov</td>
												<td class="bg-violet-400">@Kopyov</td>
											</tr>
											<tr>
												<td>2</td>
												<td class="alpha-violet">Victoria</td>
												<td>Baker</td>
												<td class="bg-violet-400">@Vicky</td>
											</tr>
											<tr>
												<td>3</td>
												<td class="alpha-violet">James</td>
												<td>Alexander</td>
												<td class="bg-violet-400">@Alex</td>
											</tr>
										</tbody>
										<tfoot>
											<tr>
				    	...
				    	<div class="col-md-6">
				    		<div class="panel panel-flat">
								...
								<div class="table-responsive">
									<table class="table bg-violet-400">
										<thead>
											<tr>
												<th>#</th>
												<th>First Name</th>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<button type="button" class="btn bg-violet-400"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<button type="button" class="btn bg-violet-400 btn-labeled"><b><i class="icon-menu7"></i></b> Labeled button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<button type="button" class="btn text-violet-800 border-violet btn-flat"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    </div>
				    <!-- /buttons -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel">
								<div class="panel-heading bg-violet-400">
									<h6 class="panel-title">Violet panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Violet panel using <code>.bg-violet</code> class added to the panel heading
								</div>
							</div>
				    	</div>

				    	<div class="col-md-4">
				    		<div class="panel border-violet-400">
								<div class="panel-heading bg-violet-400">
									<h6 class="panel-title">Violet bordered panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Bordered violet panel using <code>.bg-violet</code> and <code>.border-violet</code> classes
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel bg-violet-400">
								<div class="panel-heading">
									<h6 class="panel-title">Violet solid panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Solid violet panel using <code>.bg-violet</code> class added to the panel container
								</div>
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<button type="button" class="btn bg-violet-400" data-popup="tooltip-custom" title="Violet tooltip" data-placement="bottom" data-container="body"><i class="icon-comment position-left"></i> Tooltip</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<button type="button" class="btn bg-violet-400" data-popup="popover-custom" title="Violet popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<button type="button" class="btn bg-violet-400" data-popup="popover-solid" title="Violet popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<button type="button" class="btn bg-violet-400" data-toggle="modal" data-target="#modal_violet"><i class="icon-menu7 position-left"></i> Modal dialog</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<p class="mb-15 text-muted">Using <code>.bg-violet</code> color classes</p>

								<button class="btn bg-violet-400 growl-launch">jGrowl notification</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet text-center">
								...
								<button class="btn bg-violet-400 pnotify-launch">Pnotify notification</button>
							</div>
				    	</div>
				    </div>
				    <!-- /notifications and dialogs -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-violet</code> color classes</p>
								</div>

								<ul class="dropdown-menu border-violet-400 border-lg" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								...
								<ul class="dropdown-menu bg-violet-400" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-violet">
								...
								<ul class="dropdown-menu bg-violet-400" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> <span class="label bg-violet pull-right">Label</span> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> <span class="badge bg-violet pull-right">98</span> Another action</a></li>
									<li class="divider"></li>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn bg-violet-400">Save changes</button>
								</div>
							</div>
						</div>
					</div>
