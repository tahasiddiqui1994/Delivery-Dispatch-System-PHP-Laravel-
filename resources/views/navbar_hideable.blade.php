...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/ui/headroom/headroom.min.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/ui/headroom/headroom_jquery.min.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/forms/styling/switchery.min.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/pages/navbar_hideable.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="navbar_hideable">Hide on scroll</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Navbars</span> - Hide on Scroll</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navbar_hideable">Navbars</a></li>
							<li class="active">Hide on scroll</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Hide navbar on scroll</h6>
						Hideable navbar option is available for <strong>fixed navbar only</strong>. Works in both top and bottom positions, single and multiple navbars.
				    </div>
					<!-- /info alert -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Hide navbar on scroll</h5>
						...
						<div class="panel-body">
							...
							<h6 class="text-semibold">Plugin overview</h6>
							<p>Fixed navbar that slides out of view when scrolling down and slides back in when scrolling up. Based on a lightweight, high-performance <code>headroom.js</code> widget that allows you to react to the user's scroll. This is a perfect solution, if you alqays want to access your navbar, but bring elements into view when appropriate, and give focus to your content the rest of the time. Table below contains all plugin options available and can be applied to both top and bottom <code>fixed</code> navbars:</p>
							</div>

							<div class="content-group-lg">
								<h6 class="text-semibold">Plugin options</h6>
								<p class="content-group">At it's most basic headroom.js simply adds and removes CSS classes from an element in response to a scroll event. Headroom.js can also accept an options object to alter the way it behaves. You can see the default options by inspecting <code>Headroom.options</code>. The structure of an options object is as follows:</p>
									...
									<table class="table table-bordered">
										...
										<tbody>
											<tr>
												...
												<td>Vertical offset in px before element is first unpinned. Value for default navbar is <code>47px</code>.</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>CSS classes to apply: <strong>initial</strong> - when element is initialised, <strong>pinned</strong> - when scrolling up, <strong>unpinned</strong> - when scrolling down, <strong>top</strong> - when above offset, <strong>notTop</strong> - when below offset.</td>
											</tr>
											<tr>
							...
							<div class="row">
								<div class="col-md-6">
									<p>Top navbar position example:</p>
									<pre class="language-javascript content-group"><code>/* Top position */
$(".navbar-fixed-top").headroom({
	classes: {
		pinned: "headroom-top-pinned",
		unpinned: "headroom-top-unpinned"
	},
	offset: $('.navbar').outerHeight(), // navbar height
	onUnpin : function() {
		$('.navbar .dropdown-menu').parent().removeClass('open'); // close dropdowns on hide
	}
});
</code></pre>
								</div>
								...
								<div class="col-md-6">
									<p>Bottom navbar position example:</p>
									<pre class="language-javascript content-group"><code>/* Bottom position */
$(".navbar-fixed-bottom").headroom({
	...
	onPin : function() {
		$('.navbar .dropdown-menu').parent().removeClass('open'); // close dropdowns on hide
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Navbar component</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<div class="content-group-lg">
								<p class="content-group">Navbar is a navigation component, usually displayed on top of the page and includes brand logo, navigation and other components. By default, navbar has top <code>static</code> position. Navbar placement can be top and bottom, types can be static and fixed. Navbar available in 4 different sizes - large, default, small and mini. All navbar components automatically adjust their height to match chosen navbar height.</p>

								<p class="text-semibold">Example navbar</p>
								<div class="navbar navbar-inverse bg-info-700 navbar-component" style="position: relative; z-index: 30;">
									<div class="navbar-header">
										<a class="navbar-brand" href="index"><img src="assets/images/logo_light.png" alt=""></a>
									...
									<div class="navbar-collapse collapse" id="navbar-demo-mobile">
										<form class="navbar-form navbar-left">
											<label class="checkbox-inline checkbox-switchery switchery-sm switchery-double">
												Top
												<input type="checkbox" class="toggle-position">
												Bottom
											</label>
										</form>
							...
							<div class="content-group-lg">
								<h6 class="text-semibold">1. Fixed top navbar</h6>
								<p>By default, navbar has top <code>static</code> position. To use, just add <code>.navbar-fixed-top</code> class to the navbar container and one of top navbar classes to the <code>&lt;body></code> element. The fixed navbar will overlay your other content, unless you add necessary class to the top of the <code>&lt;body></code> according to the size and placement.</p>
							</div>

							<div class="content-group">
								<h6 class="text-semibold">2. Fixed bottom navbar</h6>
								<p>Since navbars are available in 4 different sizes, it's required to specify proper class in <code>&lt;body></code> tag to set correct padding. If single navbar is <strong>sticked to the bottom</strong> of the page, correct body classes will be <code>.navbar-bottom</code> for default height and <code>.navbar-bottom-*</code> for given size - large (<code>*-lg</code>), small (<code>*-sm</code>) and mini (<code>*-xs</code>).</p>
							</div>

							<h6 class="text-semibold">2. Multiple fixed navbars</h6>
							<p>This kind of navbar group supports both static and fixed positions. Also fixed position is available for 2 navbars (both are sticked) and for the first (only first is sticked). If you need to stick only secondary navbar when it becomes fixed only after scroll to its position, the best way to achieve this effect is by using <code>affix</code> component.</p>
						</div>
					</div>
					<!-- /single top navbar -->
