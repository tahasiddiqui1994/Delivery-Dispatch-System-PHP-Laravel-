...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/handsontable_advanced.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="handsontable_advanced">Advanced setup</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Handsontable</span> - Advanced</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="handsontable_advanced">Handsontable</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Conditional formatting</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<p class="content-group">The following example demonstrates how to use the cell type renderer feature to make some conditional formatting: first row is read-only and formatted in <span class="text-success-700 text-semibold">green bold</span> text; empty cells have <span class="text-muted">grey</span> background; negative numbers are written in <span class="text-danger">red</span>. First column has the same styling as first row, but cells are editable. All colors and other styles can be set in table configuration.</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Sorting data</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Pagination</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							...
							<div class="text-right">
								<ul class="pagination pagination-flat" id="hot-pagination">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Pre-populating new rows</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Highlighting current</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Bootstrap integration</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">The following example demonstrates integration of Handsontable with Bootstrap table styles using <code>tableClassName</code> option. This option specifies class name for all tables inside container element. In this example all tables include 3 additional classes: <code>table-striped</code> - striped rows; <code>table-hover</code> - highlight current hovered row.</p>

							<div class="hot-container">
								<div id="hot_bootstrap"></div>
							</div>
						</div>
					</div>
					<!-- /bootstrap integration -->
