				...
				<div class="content pb-20">
					...
					<div class="panel panel-body login-form">
						...
						<div class="content-group">
							...
							<button type="button" class="btn bg-blue btn-block" data-toggle="modal" data-target="#modal-login"><i class="icon-comment position-left"></i> Launch modal</button>
						</div>


						<div class="content-group">
							<div class="content-divider text-muted form-group"><span>Registration form</span></div>
							<button type="button" class="btn bg-blue btn-block" data-toggle="modal" data-target="#modal-registration"><i class="icon-comment position-left"></i> Launch modal</button>
						</div>


						<div class="content-group">
							<div class="content-divider text-muted form-group"><span>Unlock user form</span></div>
							<button type="button" class="btn bg-blue btn-block" data-toggle="modal" data-target="#modal-unlock"><i class="icon-comment position-left"></i> Launch modal</button>
						</div>


						<div class="content-group">
							<div class="content-divider text-muted form-group"><span>Password recover form</span></div>
							<button type="button" class="btn bg-blue btn-block" data-toggle="modal" data-target="#modal-recover"><i class="icon-comment position-left"></i> Launch modal</button>
						</div>


						<div class="content-group">
							<div class="content-divider text-muted form-group"><span>Tabbed form</span></div>
						...
						<div class="content-group-sm">
							<div class="content-divider text-muted form-group"><span>Form with validation</span></div>
							<button type="button" class="btn bg-blue btn-block" data-toggle="modal" data-target="#modal-validation"><i class="icon-comment position-left"></i> Launch modal</button>
						</div>
					</div>
					<!-- /form inside modals -->
						...
						<div class="modal-dialog">
							<div class="modal-content login-form">
								...
								<form class="modal-body" action="index">
									...
									<a href="login_registration" class="btn btn-default btn-block content-group">Sign up</a>
		            ...
		            <!-- Unlock form -->
					<div id="modal-unlock" class="modal fade">
						<div class="modal-dialog">
							<div class="modal-content login-form">
								...
								<form class="modal-body" action="index">
									...
									<button type="submit" class="btn bg-slate btn-block">Unlock <i class="icon-circle-right2 position-right"></i></button>
									<button type="button" class="btn btn-default btn-block" data-dismiss="modal">Cancel</button>
								</form>
								<!-- /form -->
