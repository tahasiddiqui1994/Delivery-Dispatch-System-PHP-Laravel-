...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/uploader_plupload.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="uploader_plupload">Plupload</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="uploader_plupload">Uploaders</a></li>
