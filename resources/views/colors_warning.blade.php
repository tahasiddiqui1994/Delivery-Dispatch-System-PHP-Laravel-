...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/colors_warning.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="colors_warning">Warning palette</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Colors</span> - Warning Palette</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="colors_warning">Colors</a></li>
							<li class="active">Warning palette</li>
						</ul>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#D84315</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#warning_800"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#E64A19</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#warning_700"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#F4511E</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#warning_600"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#FF5722</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#warning_500"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#FF7043</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#warning_400"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#FF8A65</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#warning_300"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.text-warning</code> classes</p>
								</div>

								<input type="text" class="form-control text-warning text-uppercase text-semibold text-size-small" value="Input field text">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-warning</code> or classes</p>
								</div>

								<input type="text" class="form-control border-warning border-lg" placeholder="Input field border">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-warning</code> classes</p>
								</div>

								<input type="text" class="form-control bg-warning-400" placeholder="Input field background">
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								...
								<div class="has-feedback">
									<input type="text" class="form-control bg-warning-400" placeholder="Icon feedback, warning input">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								...
								<select class="form-control bg-warning-400">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								...
								<div class="input-group">
									<span class="input-group-addon bg-warning-400"><i class="icon-menu7"></i></span>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								...
								<div class="input-group">
									<span class="input-group-addon bg-warning-700"><i class="icon-lock2"></i></span>
									<input type="text" class="form-control bg-warning-400" placeholder="Solid background color">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
										<button class="btn bg-warning-400" type="button">Button</button>
									</span>									
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<label class="radio-inline">
									<input type="radio" class="styled" name="warning-radio" checked="checked">
									Selected
								</label>

								<label class="radio-inline">
									<input type="radio" class="styled" name="warning-radio">
									Unselected
								</label>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-warning</code> or classes</p>

									<select class="selectbox bg-warning-400">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								<div class="text-center">
									...
									<select class="bootstrap-select" data-style="bg-warning-400">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										<ul class="nav nav-tabs bg-warning-400">
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										...
										<div class="tab-content bg-warning-400">
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<span class="label bg-warning-400">Warning label</span>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<span class="badge bg-warning-400">390</span>
							</div>
				    	</div>
				    </div>
				    <!-- /text options -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-warning-400" style="width: 55%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-warning-400 progress-bar-striped" style="width: 65%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-warning-400 progress-bar-striped active" style="width: 75%">
				    ...
				    <div class="row">
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th>Last Name</th>
												<th class="bg-warning-400">Username</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td>1</td>
												<td class="warning">Eugene</td>
												<td>Kopyov</td>
												<td class="bg-warning-400">@Kopyov</td>
											</tr>
											<tr>
												<td>2</td>
												<td class="warning">Victoria</td>
												<td>Baker</td>
												<td class="bg-warning-400">@Vicky</td>
											</tr>
											<tr>
												<td>3</td>
												<td class="warning">James</td>
												<td>Alexander</td>
												<td class="bg-warning-400">@Alex</td>
											</tr>
										</tbody>
										<tfoot>
											<tr>
				    	...
				    	<div class="col-md-6">
				    		<div class="panel panel-flat">
								...
								<div class="table-responsive">
									<table class="table bg-warning-400">
										<thead>
											<tr>
												<th>#</th>
												<th>First Name</th>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<button type="button" class="btn bg-warning-400"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<button type="button" class="btn bg-warning-400 btn-labeled"><b><i class="icon-menu7"></i></b> Labeled button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<button type="button" class="btn text-warning-800 border-warning btn-flat"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    </div>
				    <!-- /buttons -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel">
								<div class="panel-heading bg-warning-400">
									<h6 class="panel-title">Warning panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Warning panel using <code>.bg-warning</code> class added to the panel heading
								</div>
							</div>
				    	</div>

				    	<div class="col-md-4">
				    		<div class="panel border-warning-400">
								<div class="panel-heading bg-warning-400">
									<h6 class="panel-title">Warning bordered panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Bordered warning panel using <code>.bg-warning</code> and <code>.border-warning</code> classes
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel bg-warning-400">
								<div class="panel-heading">
									<h6 class="panel-title">Warning solid panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Solid warning panel using <code>.bg-warning</code> class added to the panel container
								</div>
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<button type="button" class="btn bg-warning-400" data-popup="tooltip-custom" title="Warning tooltip" data-placement="bottom" data-container="body"><i class="icon-comment position-left"></i> Tooltip</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<button type="button" class="btn bg-warning-400" data-popup="popover-custom" title="Warning popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<button type="button" class="btn bg-warning-400" data-popup="popover-solid" title="Warning popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<button type="button" class="btn bg-warning-400" data-toggle="modal" data-target="#modal_warning"><i class="icon-menu7 position-left"></i> Modal dialog</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<p class="mb-15 text-muted">Using <code>.bg-warning</code> color classes</p>

								<button class="btn bg-warning-400 growl-launch">jGrowl notification</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning text-center">
								...
								<button class="btn bg-warning-400 pnotify-launch">Pnotify notification</button>
							</div>
				    	</div>
				    </div>
				    <!-- /notifications and dialogs -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-warning</code> color classes</p>
								</div>

								<ul class="dropdown-menu border-warning-400 border-lg" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								...
								<ul class="dropdown-menu bg-warning-400" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-warning">
								...
								<ul class="dropdown-menu bg-warning-400" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> <span class="label bg-warning pull-right">Label</span> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> <span class="badge bg-warning pull-right">98</span> Another action</a></li>
									<li class="divider"></li>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn bg-warning-400">Save changes</button>
								</div>
							</div>
						</div>
					</div>
