...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="sidebar_light">Light sidebar</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Light Version</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_light">Sidebars</a></li>
							<li class="active">Light version</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Light sidebar version</h6>
						Change default dark sidebar theme to light by adding <code>.sidebar-default</code> class to the sidebar container. Works with all sidebar types.
				    </div>
				    <!-- /info alert -->
