...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/extra_idle_timeout.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="extra_idle_timeout">Idle timeout</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Extras</span> - Idle Timeout</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="extra_idle_timeout">Extras</a></li>
							<li class="active">Idle timeout</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Idle Timeout</h5>
							<div class="heading-elements">
								<ul class="icons-list">
