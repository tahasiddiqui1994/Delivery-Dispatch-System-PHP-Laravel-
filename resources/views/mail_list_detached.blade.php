									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="mail_list_detached">Mail list (detached)</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Mailbox</span> - List (detached)</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="mail_list_detached">Mailbox</a></li>
							<li class="active">List (detached)</li>
						</ul>
