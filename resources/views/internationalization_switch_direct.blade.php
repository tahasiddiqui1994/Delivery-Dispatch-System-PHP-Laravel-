...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/internationalization_switch_direct.js')}}"></script>
	<!-- /theme JS files -->
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										<li class="active"><a href="internationalization_switch_direct" data-i18n="nav.int.direct"></a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Translation</span> - Direct Switch</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="internationalization_switch_direct">Translation</a></li>
							<li class="active">Direct switch</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Direct switching</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<p class="content-group">This example demonstrates <code>direct</code> language switching on button or link click. Every time the link is clicked, i18next loads <code>json</code> file with selected language and initialize translation again, so new language appears <span class="text-semibold">without page reload</span>. By default, i18next automatically <span class="text-semibold">detects</span> user navigator language and sets it on init, but if this language is missed in locales, user will see the language specified in <code>&lt;html lang="..."></code> or specified as a <code>fallback</code> language. Since i18next uses <code>cookies</code> by default, after page reload you'll see the language that you've selected before reload.</p>

							<p class="text-semibold">Change language directly:</p>
