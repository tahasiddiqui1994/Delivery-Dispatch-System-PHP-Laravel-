...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/job_apply.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="job_apply">Apply</a></li>
											</ul>
										</li>
										<li>
											<a href="#">Learning</a>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Job Search</span> - Apply</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="job_apply">Job search</a></li>
						...
						<div class="content-detached">
							...
							<div class="panel panel-flat">
								<div class="panel-body no-padding-bottom">
									<div class="media stack-media-on-mobile text-left">
										...
										<div class="media-body">
											<h5 class="media-heading text-semibold">
												<a href="job_detailed">Interaction UX/UI Industrial Designer</a>
											</h5>
										...
										<div class="media-right media-middle text-nowrap">
											<a href="#" class="btn bg-teal-400"><i class="icon-checkmark3 position-left"></i> Save this job</a>
										</div>
									</div>
								</div>

								<form class="form-horizonal" action="#">
									<fieldset class="panel-body pb-10">
										<h6 class="text-semibold content-group">Personal details</h6>
									...
									<fieldset class="panel-body pb-10">
										<h6 class="text-semibold content-group mt-5">Your education</h6>
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Degree level: <span class="text-danger">*</span></label>
				                                    <select name="level1" data-placeholder="Choose an option..." class="select-simple">
				                                        <option></option> 
										...
										<div class="content-group pt-5">
											<div class="content-divider content-divider-muted text-muted">
												<span><i class="icon-circle-down2"></i></span>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Degree level: <span class="text-danger">*</span></label>
				                                    <select name="level2" data-placeholder="Choose an option..." class="select-simple">
				                                        <option></option> 
				                                        <option value="student">Student</option> 
				                                        <option value="bsc">Bachelor</option> 
				                                        <option value="msc">Master</option> 
									...
									<fieldset class="panel-body pb-10">
										<h6 class="text-semibold content-group mt-5">Your experience</h6>

										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Location:</label>
				                                    <select name="location1" data-placeholder="Choose an option..." class="select">
				                                        <option></option> 
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Location:</label>
				                                    <select name="location2" data-placeholder="Choose an option..." class="select">
				                                        <option></option> 
				                                        <option value="netherlands">Netherlands</option> 
				                                        <option value="hungary">Hungary</option> 
				                                        <option value="uk">United Kingdom</option> 
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Location:</label>
				                                    <select name="location3" data-placeholder="Choose an option..." class="select">
				                                        <option></option> 
				                                        <option value="netherlands">Netherlands</option> 
				                                        <option value="hungary">Hungary</option> 
				                                        <option value="uk">United Kingdom</option> 
									...
									<fieldset class="panel-body pb-10">
										<h6 class="text-semibold content-group mt-5">Upload files</h6>

										<div class="form-group">
											<label class="control-label display-block">Upload your CV: <span class="text-danger">*</span></label>
											<input type="file" class="file-styled">
											<span class="help-block">Accepted formats: doc, docx, pdf. Max file size 2Mb</span>
										</div>

										<div class="form-group">
											<label class="control-label display-block">Upload cover letter: <span class="text-danger">*</span></label>
											<input type="file" class="file-styled">
											<span class="help-block">Accepted formats: doc, docx, pdf. Max file size 2Mb</span>
										</div>

										<div class="form-group">
											<label class="control-label display-block">Upload recommendations:</label>
											<input type="file" class="file-styled">
											<span class="help-block">Accepted formats: doc, docx, pdf. Max file size 2Mb</span>
										</div>
									</fieldset>
									...
									<fieldset class="panel-body">
										<h6 class="text-semibold content-group mt-5">Other information</h6>
