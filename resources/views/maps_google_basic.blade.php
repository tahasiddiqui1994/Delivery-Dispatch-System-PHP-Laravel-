...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/maps/google/basic/basic.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/google/basic/geolocation.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/google/basic/coordinates.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/google/basic/click_event.js')}}"></script>
	<!-- /theme JS files -->
								...
								<li>
									...
									<ul>
										<li>
											...
											<ul>
												<li class="active"><a href="maps_google_basic">Basics</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="maps_google_basic">Google maps</a></li>
