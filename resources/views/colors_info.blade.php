...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/colors_info.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="colors_info">Info palette</a></li>
										<li class="navigation-divider"></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Colors</span> - Info Palette</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="colors_info">Colors</a></li>
							<li class="active">Info palette</li>
						</ul>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#0097A7</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#info_700"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#00ACC1</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#info_600"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#00BCD4</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#info_500"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#26C6DA</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#info_400"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#4DD0E1</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#info_300"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.text-info</code> classes</p>
								</div>

								<input type="text" class="form-control text-info text-uppercase text-semibold text-size-small" value="Input field text">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-info</code> or classes</p>
								</div>

								<input type="text" class="form-control border-info border-lg" placeholder="Input field border">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-info</code> classes</p>
								</div>

								<input type="text" class="form-control bg-info" placeholder="Input field background">
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info">
								...
								<div class="has-feedback">
									<input type="text" class="form-control bg-info" placeholder="Icon feedback, info input">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info">
								...
								<select class="form-control bg-info">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info">
								...
								<div class="input-group">
									<span class="input-group-addon bg-info"><i class="icon-menu7"></i></span>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info">
								...
								<div class="input-group">
									<span class="input-group-addon bg-info-700"><i class="icon-lock2"></i></span>
									<input type="text" class="form-control bg-info" placeholder="Solid background color">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info text-center">
								...
								<label class="radio-inline">
									<input type="radio" class="styled" name="info-radio" checked="checked">
									Selected
								</label>

								<label class="radio-inline">
									<input type="radio" class="styled" name="info-radio">
									Unselected
								</label>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-info</code> or classes</p>

									<select class="selectbox bg-info">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info">
								<div class="text-center">
									...
									<select class="bootstrap-select" data-style="bg-info">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info text-center">
								...
								<span class="label bg-info">Info label</span>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info text-center">
								...
								<span class="badge bg-info">390</span>
							</div>
				    	</div>
				    </div>
				    <!-- /text options -->
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-info progress-bar-striped" style="width: 65%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-info progress-bar-striped active" style="width: 75%">
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											<tr>
												<td>1</td>
												<td class="info">Eugene</td>
												<td>Kopyov</td>
												<td class="bg-info">@Kopyov</td>
											</tr>
											<tr>
												<td>2</td>
												<td class="info">Victoria</td>
												<td>Baker</td>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info text-center">
								...
								<button type="button" class="btn bg-info"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info text-center">
								...
								<button type="button" class="btn bg-info btn-labeled"><b><i class="icon-menu7"></i></b> Labeled button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info text-center">
								...
								<button type="button" class="btn text-info-800 border-info btn-flat"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    </div>
				    <!-- /buttons -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel">
								...
								<div class="panel-body">
									Info panel using <code>.bg-info</code> class added to the panel heading
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel border-info">
								<div class="panel-heading bg-info">
									<h6 class="panel-title">Info bordered panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Bordered info panel using <code>.bg-info</code> and <code>.border-info</code> classes
								</div>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel bg-info">
								<div class="panel-heading">
									<h6 class="panel-title">Info solid panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Solid info panel using <code>.bg-info</code> class added to the panel container
								</div>
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info text-center">
								...
								<button type="button" class="btn bg-info" data-popup="tooltip-custom" title="Info tooltip" data-placement="bottom" data-container="body"><i class="icon-comment position-left"></i> Tooltip</button>
							</div>
				    	</div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info text-center">
								...
								<button type="button" class="btn bg-info" data-toggle="modal" data-target="#modal_info"><i class="icon-menu7 position-left"></i> Modal dialog</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info text-center">
								...
								<p class="mb-15 text-muted">Using <code>.bg-info</code> color classes</p>

								<button class="btn bg-info growl-launch">jGrowl notification</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info text-center">
								...
								<button class="btn bg-info pnotify-launch">Pnotify notification</button>
							</div>
				    	</div>
				    </div>
				    <!-- /notifications and dialogs -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-info</code> color classes</p>
								</div>

								<ul class="dropdown-menu border-info border-lg" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info">
								...
								<ul class="dropdown-menu bg-info" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-info">
								...
								<ul class="dropdown-menu bg-info" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> <span class="label bg-info pull-right">Label</span> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> <span class="badge bg-info pull-right">98</span> Another action</a></li>
									<li class="divider"></li>
