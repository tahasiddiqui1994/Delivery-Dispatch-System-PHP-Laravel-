									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="animations_velocity_ui">UI pack effects</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Velocity</span> - UI Effects</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="animations_velocity_ui">Velocity</a></li>
							<li class="active">UI effects</li>
						</ul>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Velocity callouts
						<small class="display-block">Basic animations using <code>velocity</code> UI pack</small>
					</h6>
						...
						<div class="col-md-4">
							<div class="panel panel-white">
								<div class="panel-heading">
									...
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-animation" data-animation="bounce"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									...
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-animation" data-animation="swing"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-white">
								<div class="panel-heading">
									...
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-animation" data-animation="shake"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									...
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-animation" data-animation="tada"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-4">
							<div class="panel panel-white">
								<div class="panel-heading">
									...
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-animation" data-animation="flash"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									...
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-animation" data-animation="pulse"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<h6 class="content-group text-semibold">
						Basic transitions
						<small class="display-block">Basic transitions of <code>velocity</code> UI pack</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									...
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="fadeIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									...
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="fadeOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SwoopIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="swoopIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SwoopOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="swoopOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">WhirlIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="whirlIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">WhirlOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="whirlOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">ShrinkIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="shrinkIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">ShrinkOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="shrinkOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<h6 class="content-group text-semibold">
						Bounce transitions
						<small class="display-block">Set of In and Out <code>bounce</code> transitions</small>
					</h6>
						...
						<div class="col-md-6">
							<div class="panel panel-white">
								<div class="panel-heading">
									...
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="bounceIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-6">
							<div class="panel panel-white">
								<div class="panel-heading">
									...
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="bounceOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">BounceUpIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="bounceUpIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">BounceUpOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="bounceUpOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">BounceDownIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="bounceDownIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">BounceDownOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="bounceDownOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">BounceLeftIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="bounceLeftIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">BounceLeftOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="bounceLeftOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">BounceRightIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="bounceRightIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">BounceRightOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="bounceRightOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<h6 class="content-group text-semibold">
						Slide transitions
						<small class="display-block">Set of In and Out <code>slide</code> transitions</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideUpIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideUpIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideUpOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideUpOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideUpBigIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideUpBigIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideUpBigOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideUpBigOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideDownIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideDownIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideDownOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideDownOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideDownBigIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideDownBigIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideDownBigOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideDownBigOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideLeftIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideLeftIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideLeftOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideLeftOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideLeftBigIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideLeftBigIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideLeftBigOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideLeftBigOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideRightIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideRightIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideRightOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideRightOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideRightBigIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideRightBigIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">SlideRightBigOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="slideRightBigOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<h6 class="content-group text-semibold">
						Perspective transitions
						<small class="display-block">Set of In and Out <code>perspective</code> transitions</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">PerspectiveUpIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="perspectiveUpIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">PerspectiveUpOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="perspectiveUpOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">PerspectiveDownIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="perspectiveDownIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">PerspectiveDownOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="perspectiveDownOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">PerspectiveLeftIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="perspectiveLeftIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">PerspectiveLeftOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="perspectiveLeftOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">PerspectiveRightIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="perspectiveRightIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">PerspectiveRightOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="perspectiveRightOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<h6 class="content-group text-semibold">
						Flip transitions
						<small class="display-block">Set of In and Out <code>flip</code> transitions</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">FlipXIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="flipXIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">FlipXOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="flipXOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">FlipYIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="flipYIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">FlipYOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="flipYOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">FlipBounceXIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="flipBounceXIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">FlipBounceXOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="flipBounceXOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">FlipBounceYIn</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="flipBounceYIn"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
						...
						<div class="col-md-3">
							<div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">FlipBounceYOut</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a href="#" class="velocity-transition" data-transition="flipBounceYOut"><i class="icon-play3"></i></a></li>
					                	</ul>
				                	</div>
								</div>
