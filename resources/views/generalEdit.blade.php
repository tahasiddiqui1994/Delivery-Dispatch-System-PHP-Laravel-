		...
		<div class="page-content">
			...
			<div class="content-wrapper">
                ...
                <section class="content">
                    <div class="row">
                        <!-- Form controls -->
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="Y2N8szvjJA">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="Y2N8szvjJA" data-index="0" style="position: relative; opacity: 1; left: 0px; top: 0px;">
                                <div class="panel-heading ui-sortable-handle">
                                    <div class="btn-group"> 
                                        <a style="background-color:#26a69a; border-color: #26a69a"  class="btn btn-primary" href="/webgeneral/"> <i class="fa fa-plus"></i> View Setting</a>  
                                    </div>
                                ...
                                <div class="panel-body">
                                    {!! Form::open(['action'=> ['webgeneralsController@update', $data->id], 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
									...
									<tbody><tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('companyName', $data->companyName, ['class' => "form-control"]) }}

                                            </div></td>

    
                                          <td><div class="col-sm-10 form-group">
                                                <label>Company Type<font color="red"> </font></label>
                                                
                                                {{ Form::text('companyType', $data->companyType, ['class' => "form-control"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('streetNo', $data->streetNo, ['class' => "form-control"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('aptOrSuiteOrOther', $data->aptOrSuiteOrOther, ['class' => "form-control"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('state', $data->state, ['class' => "form-control"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::number('zipCode', $data->zipCode, ['class' => "form-control"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('phoneNo', $data->phoneNo, ['class' => "form-control"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('timezone', $data->timezone, ['class' => "form-control"]) }}
								...
								<tr>
									 <td colspan="2"><div class="col-sm-11 form-group">
                                                <label>Note</label>
                                                {{ Form::textarea('comments', $data->comments, ['class' => "form-control"]) }}
                                            </div> 
