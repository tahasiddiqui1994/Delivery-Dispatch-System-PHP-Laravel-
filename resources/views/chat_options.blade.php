...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/chat_layouts.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="chat_options">Chat options</a></li>
											</ul>
										</li>
										<li>
											<a href="#">Search</a>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Conversation</span> - Options</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="chat_options">Conversation</a></li>
				...
				<div class="content">
						...
						<ul class="nav nav-tabs nav-lg nav-tabs-highlight">
							...
							<li>
								<a href="#william" data-toggle="tab">
									<img src="assets/images/placeholder.jpg" alt="" class="img-circle tab-img position-left"> William <span class="status-mark position-right border-success"></span>
								</a>
							</li>

							<li>
								<a href="#jared" data-toggle="tab">
									<img src="assets/images/placeholder.jpg" alt="" class="img-circle tab-img position-left"> Jared <span class="status-mark position-right border-warning"></span>
								</a>
							</li>

							<li>
								<a href="#victoria" data-toggle="tab">
									<img src="assets/images/placeholder.jpg" alt="" class="img-circle tab-img position-left"> Victoria <span class="status-mark position-right border-grey-300"></span>
								</a>
							</li>
					...
					<h6 class="content-group text-semibold">
						...
						<small class="display-block">Conversation inside collapsible or accordion</small>
					</h6>
					...
					<div class="panel-group panel-group-control panel-group-control-right" id="chat-accordion">
						<div class="panel panel-white">
							<div class="panel-heading">
								<h6 class="panel-title">
									<a data-toggle="collapse" href="#collapsible-james" data-parent="#chat-accordion">
							...
							<div id="collapsible-james" class="panel-collapse collapse">
						...
						<div class="panel panel-white">
							<div class="panel-heading">
								<h6 class="panel-title">
									<a data-toggle="collapse" href="#collapsible-monica" data-parent="#chat-accordion">
										<img src="assets/images/placeholder.jpg" alt="" class="img-circle position-left">
										Monica Winslow
										<span class="status-mark border-danger position-right"></span>
									</a>
								</h6>
							</div>

							<div id="collapsible-monica" class="panel-collapse collapse in">
								<div class="panel-body">
									<ul class="media-list chat-list content-group">
										<li class="media">
											<div class="media-left">
						...
						<div class="panel panel-white">
							<div class="panel-heading">
								<h6 class="panel-title">
									<a data-toggle="collapse" href="#collapsible-david" data-parent="#chat-accordion">
										<img src="assets/images/placeholder.jpg" alt="" class="img-circle position-left">
										David Spark
										<span class="status-mark border-primary position-right"></span>
									</a>
								</h6>
							</div>

							<div id="collapsible-david" class="panel-collapse collapse">
								<div class="panel-body">
									<ul class="media-list chat-list content-group">
										<li class="media">
											<div class="media-left">
						...
						<div class="panel panel-white">
							<div class="panel-heading">
								<h6 class="panel-title">
									<a data-toggle="collapse" href="#collapsible-mark" data-parent="#chat-accordion">
										<img src="assets/images/placeholder.jpg" alt="" class="img-circle position-left">
										Mark Baker
										<span class="status-mark border-grey-300 position-right"></span>
									</a>
								</h6>
							</div>

							<div id="collapsible-mark" class="panel-collapse collapse">
								<div class="panel-body">
									<ul class="media-list chat-list content-group">
										<li class="media">
											<div class="media-left">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title">Color options</h6>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<ul class="media-list chat-list content-group">
								...
								<li class="media">
									...
									<div class="media-body">
										<div class="media-content bg-slate">Crud reran and while much withdrew ardent much crab hugely met dizzily that more jeez gent equivalent unsafely far one hesitant so therefore.</div>
										<span class="media-annotation display-block mt-10">Tue, 10:28 am <a href="#"><i class="icon-pin-alt position-right text-muted"></i></a></span>
									</div>
								</li>
								...
								<li class="media reversed">
									<div class="media-body">
										<div class="media-content bg-info">Far squid and that hello fidgeted and when. As this oh darn but slapped casually husky sheared that cardinal hugely one and some unnecessary factiously hedgehog a feeling one rudely much</div>
										<span class="media-annotation display-block mt-10">Mon, 10:24 am <a href="#"><i class="icon-pin-alt position-right text-muted"></i></a></span>
									</div>
								...
								<li class="media">
									...
									<div class="media-body">
										<div class="media-content bg-danger-400">Tolerantly some understood this stubbornly after snarlingly frog far added insect into snorted more auspiciously heedless drunkenly jeez foolhardy oh.</div>
										<span class="media-annotation display-block mt-10">Wed, 4:20 pm <a href="#"><i class="icon-pin-alt position-right text-muted"></i></a></span>
									</div>
								</li>
								...
								<li class="media reversed">
									<div class="media-body">
										<div class="media-content bg-teal-400">Satisfactorily strenuously while sleazily dear frustratingly insect menially some shook far sardonic badger telepathic much jeepers immature much hey.</div>
										<span class="media-annotation display-block mt-10">2 hours ago <a href="#"><i class="icon-pin-alt position-right text-muted"></i></a></span>
									</div>
								...
								<li class="media">
									...
									<div class="media-body">
										<div class="media-content bg-success-400">Grunted smirked and grew less but rewound much despite and impressive via alongside out and gosh easy manatee dear ineffective yikes.</div>
										<span class="media-annotation display-block mt-10">13 minutes ago <a href="#"><i class="icon-pin-alt position-right text-muted"></i></a></span>
									</div>
								</li>
								...
								<li class="media reversed">
									<div class="media-body">
										<div class="media-content bg-indigo-400"><i class="icon-menu display-block"></i></div>
									</div>
