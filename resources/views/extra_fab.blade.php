...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/extra_fab.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="extra_fab">Floating action buttons</a></li>
									</ul>
								</li>
								<li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Extras</span> - FAB Menu</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="extra_fab">Extras</a></li>
							<li class="active">FAB menu</li>
						</ul>
				...
				<div class="content">
					...
					<ul class="fab-menu fab-menu-absolute fab-menu-top-left" data-fab-toggle="hover" id="fab-menu-affixed-demo-left">
						<li>
							<a class="fab-menu-btn btn bg-indigo-400 btn-float btn-rounded btn-icon">
					...
					<div class="panel panel-flat content-group-lg">
						<div class="panel-heading">
							<h5 class="panel-title">Floating action button</h5>
							<div class="heading-elements">
								<ul class="icons-list">
	...
	&lt;!-- /clickable menu -->
					...
					<h6 class="content-group text-semibold">
						Basic examples
						<small class="display-block">Default FAB menu usage</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Single floating button</h6>
								<p class="content-group-sm text-muted">Single clickable button without menu</p>

								<ul class="fab-menu">
									<li>
										<a href="#" class="fab-menu-btn btn bg-blue btn-float btn-rounded btn-icon">
											<i class="fab-icon-open icon-plus3"></i>
											<i class="fab-icon-close icon-cross2"></i>
										</a>
									</li>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Open menu on hover</h6>
								<p class="content-group-sm text-muted">Example of hoverable FAB menu</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Open menu on click</h6>
								<p class="content-group-sm text-muted">Example of clickable FAB menu</p>
					...
					<h6 class="content-group text-semibold">
						FAB menu elements
						<small class="display-block">Buttons, dropdowns and images</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Simple buttons</h6>
								<p class="content-group-sm text-muted">Rounded buttons with icons</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Button with dropdowns</h6>
								<p class="content-group-sm text-muted">Buttons with left/right dropdowns</p>
								...
								<ul class="fab-menu fab-menu-top" data-fab-toggle="click">
									<li>
										...
										<ul class="fab-menu-inner">
											<li>
												<div>
													<a href="#" class="btn btn-default btn-rounded btn-icon btn-float dropdown-toggle" data-toggle="dropdown">
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Button with images</h6>
								<p class="content-group-sm text-muted">Display thumbs instead of buttons</p>
					...
					<h6 class="content-group text-semibold">
						Inner button elements
						<small class="display-block">Badges, labels and status marks</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Badges with number</h6>
								<p class="content-group-sm text-muted">Rounded badges on top right corner</p>
										...
										<ul class="fab-menu-inner">
											...
											<li>
												<div>
													...
													<span class="badge bg-success-400">8</span>
												</div>
											</li>
										</ul>
									</li>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Status mark</h6>
								<p class="content-group-sm text-muted">Rounded status mark sign</p>
										...
										<ul class="fab-menu-inner">
											<li>
												<div>
													...
													<span class="status-mark bg-pink-400"></span>
												</div>
											</li>
											<li>
												<div>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Circle status mark</h6>
								<p class="content-group-sm text-muted">Circle mark on top right corner</p>
					...
					<h6 class="content-group text-semibold">
						Inner button labels
						<small class="display-block">Display tooltips on left/right sides</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Label positions</h6>
								<p class="content-group-sm text-muted">Left and right label positions</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Light labels</h6>
								<p class="content-group-sm text-muted">Change label color from dark to light</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Visible labels</h6>
								<p class="content-group-sm text-muted">Always display button labels</p>
								...
								<ul class="fab-menu fab-menu-top" data-fab-toggle="click">
									<li>
										...
										<ul class="fab-menu-inner">
											...
											<li>
												<div class="fab-label-visible" data-fab-label="Conversations">
													<a href="#" class="btn btn-default btn-rounded btn-icon btn-float">
														<i class="icon-bubbles7"></i>
													</a>
												</div>
					...
					<h6 class="content-group text-semibold">
						Default button colors
						<small class="display-block">Pre-defined contextual colors</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Default button color</h6>
								<p class="content-group-sm text-muted">Default color using <code>.btn-default</code> class</p>
							...
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Success button color</h6>
								<p class="content-group-sm text-muted">Success color using <code>.btn-success</code> class</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Primary button color</h6>
								<p class="content-group-sm text-muted">Primary color using <code>.btn-primary</code> class</p>
							...
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Warning button color</h6>
								<p class="content-group-sm text-muted">Warning color using <code>.btn-warning</code> class</p>

								<ul class="fab-menu fab-menu-top" data-fab-toggle="click">
									<li>
										<a class="fab-menu-btn btn btn-warning btn-float btn-rounded btn-icon">
											<i class="fab-icon-open icon-plus3"></i>
											<i class="fab-icon-close icon-cross2"></i>
										</a>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Danger button color</h6>
								<p class="content-group-sm text-muted">Danger color using <code>.btn-danger</code> class</p>

								<ul class="fab-menu fab-menu-top" data-fab-toggle="click" style="z-index: 1002;">
									<li>
										<a class="fab-menu-btn btn btn-danger btn-float btn-rounded btn-icon">
											<i class="fab-icon-open icon-plus3"></i>
											<i class="fab-icon-close icon-cross2"></i>
										</a>
							...
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Info button color</h6>
								<p class="content-group-sm text-muted">Info color using <code>.btn-info</code> class</p>

								<ul class="fab-menu fab-menu-top" data-fab-toggle="click">
									<li>
										<a class="fab-menu-btn btn btn-info btn-float btn-rounded btn-icon">
											<i class="fab-icon-open icon-plus3"></i>
											<i class="fab-icon-close icon-cross2"></i>
										</a>
					...
					<h6 class="content-group text-semibold">
						Custom color options
						<small class="display-block">Use custom color in main and inner buttons</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Custom main button color</h6>
								<p class="content-group-sm text-muted">Use color helper classes for custom colors</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Custom inner button color</h6>
								<p class="content-group-sm text-muted">Use color helper classes for custom colors</p>
								...
								<ul class="fab-menu fab-menu-top" data-fab-toggle="click">
									<li>
										...
										<ul class="fab-menu-inner">
											<li>
												<div>
													<a href="#" class="btn bg-indigo-400 btn-rounded btn-icon btn-float">
														<i class="icon-pencil"></i>
													</a>
												</div>
											</li>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-danger text-center">
								<h6 class="no-margin text-semibold">Mixing button colors</h6>
								<p class="content-group-sm text-muted">Feel free to mix all button colors</p>
								...
								<ul class="fab-menu fab-menu-top" data-fab-toggle="click">
									<li>
										...
										<ul class="fab-menu-inner">
											...
											<li>
												<div>
													<a href="#" class="btn bg-warning-400 btn-rounded btn-icon btn-float">
														<i class="icon-bubbles7"></i>
													</a>
												</div>
											</li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">FAB menu classes</h5>
						...
						<div class="table-responsive">
							<table class="table table-bordered">
								...
								<tbody>
									<tr>
										<th colspan="2" class="active">Basic classes</th>
									</tr>
									<tr>
									...
									<tr class="border-double">
										<th colspan="3" class="active">Positions and directions</th>
									</tr>
									<tr>
									...
									<tr class="border-double">
										<th colspan="3" class="active">Menu positioning</th>
									</tr>
									<tr>
									...
									<tr>
										<td><code>.fab-menu-affixed</code></td>
										<td>Sticky menu. Can be used in main container only, relative to page layout. Supported in top positions only</td>
									</tr>

									<tr class="border-double">
										<th colspan="3" class="active">Menu visibility</th>
									</tr>
									<tr>
									...
									<tr class="border-double">
										<th colspan="3" class="active">Inner button labels</th>
									</tr>
									<tr>
