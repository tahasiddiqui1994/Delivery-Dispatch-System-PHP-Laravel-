...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/area/area_horizontal.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/area/area_horizontal_stacked.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/area/area_horizontal_stacked_normalized.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/area/area_horizontal_grouped.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/area/area_horizontal_stacked_grouped.js')}}"></script>
	<!-- /theme JS files -->
								...
								<li>
									...
									<ul>
										...
										<li>
											...
											<ul>
												<li class="active"><a href="dimple_area_horizontal">Horizontal orientation</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="dimple_area_horizontal">Dimple</a></li>
