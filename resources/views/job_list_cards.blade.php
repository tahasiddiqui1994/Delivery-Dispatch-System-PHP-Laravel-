								...
								<li>
									...
									<ul>
										...
										<li>
											<a href="#">Job search</a>
											<ul>
												<li class="active"><a href="job_list_cards">Cards view</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Job Search</span> - Cards List</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="job_list_cards">Job search</a></li>
