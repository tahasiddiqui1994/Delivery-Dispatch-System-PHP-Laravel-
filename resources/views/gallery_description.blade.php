...
								<!-- /main -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="gallery_description">Media with description</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Gallery</span> - With Description</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="gallery_description">Gallery</a></li>
							<li class="active">With description</li>
						</ul>
				...
				<div class="content">
					...
					<div class="row">
							...
							<div class="thumbnail">
								<div class="thumb">
									...
									<div class="caption-overflow">
										<span>
											<a href="{{url('assets/images/placeholder.jpg" data-popup="lightbox" class="btn border-white text-white btn-flat btn-icon btn-rounded"><i class="icon-plus3"></i></a>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">An so vulgar</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Not rapturous</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">He it otherwise</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
					...
					<div class="row">
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Unfeeling agreeable</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">So come must</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Do on unpleasing</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Yet joy exquisite</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
					...
					<div class="row">
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Behind lovers</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Whole every miles</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Wished he entire</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">He prevent request</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
					...
					<div class="row">
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Picture too and</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Ten difficult resembled</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Same park bore</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Warmth his law</a> <a href="#" class="text-muted"><i class="icon-download pull-right"></i></a></h6>
					...
					<h6 class="content-group text-semibold">
						Video grid
						<small class="display-block">Video grid with 4 - 2 - 1 columns</small>
					</h6>
					...
					<div class="row">
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									...
									Branched is on an ecstatic directly it. Put off continue you denoting returned juvenile ones
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									...
									On projection apartments unsatiable so if he entreaties appearance you wife how we lady half
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									...
									Welcomed stronger if steepest ecstatic an suitable finished of one. Entered excited forming
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Bed was form</a> <a href="#" class="text-muted"><i class="icon-cog5 pull-right"></i></a></h6>
									Chicken unknown besides attacks gay compact out you. Continuing no simplicity no favourable
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Limits expect wonder</a> <a href="#" class="text-muted"><i class="icon-cog5 pull-right"></i></a></h6>
									Nor hence hoped her after other known defer his. For county now sister engage season better
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Now has you views</a> <a href="#" class="text-muted"><i class="icon-cog5 pull-right"></i></a></h6>
									Day either mrs talent pulled men rather regret admire but. Life ye sake it shed. Five lady he
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">To up remark it</a> <a href="#" class="text-muted"><i class="icon-cog5 pull-right"></i></a></h6>
									Ye to misery wisdom plenty polite to as. Prepared interest proposal it he exercise. My wishing
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Engage piqued in</a> <a href="#" class="text-muted"><i class="icon-cog5 pull-right"></i></a></h6>
									At place no walls hopes rooms fully. Roof hope shy tore leaf joy paid boy noisier out brought
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Left till here away</a> <a href="#" class="text-muted"><i class="icon-cog5 pull-right"></i></a></h6>
									New the her nor case that lady paid read. Invitation friendship travelling eat everything the
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Feelings laughing</a> <a href="#" class="text-muted"><i class="icon-cog5 pull-right"></i></a></h6>
									Downs those still witty an balls so chief so. Moment an little remain no up lively way brought
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Are projecting inquietude</a> <a href="#" class="text-muted"><i class="icon-cog5 pull-right"></i></a></h6>
									Over fact all son tell this any his. No insisted confined of weddings to returned tour debating
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								...
								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Marry of am do avoid</a> <a href="#" class="text-muted"><i class="icon-cog5 pull-right"></i></a></h6>
									Table nay him jokes quick. In felicity up to graceful mistaken horrible consider abode never to
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								<div class="video-container">
									<iframe allowfullscreen="" frameborder="0" mozallowfullscreen="" src="https://player.vimeo.com/video/126090217?title=0&amp;byline=0&amp;portrait=0" webkitallowfullscreen=""></iframe>
					            </div>

								<div class="caption">
									<h6 class="no-margin-top text-semibold"><a href="#" class="text-default">Old disposal followed</a> <a href="#" class="text-muted"><i class="icon-cog5 pull-right"></i></a></h6>
