...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/extra_context_menu.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="extra_context_menu">Context menu</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Extras</span> - Context Menu</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="extra_context_menu">Extras</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						...
						<small class="display-block">Context menu initialization options</small>
					</h6>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Using data attributes</h6>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body" data-toggle="context" data-target=".context-data-menu">
									<p class="mb-15">Add <code>data-toggle="context"</code> to any element that needs a custom context menu. And point <code>data-target</code> attribute to your custom context menu.</p>
...
&lt;/div></code></pre>
									<div class="context-data-menu">
										<ul class="dropdown-menu">
											<li><a href="#"><i class="icon-copy4"></i> Copy</a></li>
											<li><a href="#"><i class="icon-paste3"></i> Paste</a></li>
											<li><a href="#"><i class="icon-file-minus"></i> Remove</a></li>
											<li class="divider"></li>
											<li><a href="#"><i class="icon-cog5"></i> Options</a></li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Using Javascript</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body context-js">
									<p class="mb-15">Also content menu can be initialized via JavaScript call. In this case data attributes are not required, target can be set in plugin configuration.</p>
	...
	scopes: 'tbody > tr'
					...
					<h6 class="content-group text-semibold">
						Content attachment
						<small class="display-block">Panel and content elements attachment</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<!-- Panel attachment -->
							<div class="panel panel-flat" data-toggle="context" data-target=".context-panel-menu">
								<div class="panel-heading">
									<h6 class="panel-title">Panel attachment</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Current example demonstrates context menu attached to the whole panel. Add <code>data-toggle="context"</code> to the panel and point <code>data-target</code> attribute to the menu.
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title" data-toggle="context" data-target=".context-element-menu">Element attachment</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Current example demonstrates context menu attached to some element <span class="text-semibold">only</span> instead of full panel. Right click on current <code>panel title</code> to see it in action
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Inline attachment</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Also context menu can be attached to the <a href="#" data-toggle="context" data-target=".context-inline-menu">link</a> or any other <span class="text-semibold" data-toggle="context" data-target=".context-inline-menu">content elements</span> like headings, paragraphs, span's, lists, labels, form components, buttons, button groups etc.
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Exclude elements</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body context-deactivate">
									Current example demonstrates context menu attached to the panel content, excluding <code>&lt;code>...&lt;/code></code> phrase tag. Try to right click on the <code>code block</code>.
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Table attachment</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Row attachment</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Cell attachment</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Table content attachment</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
									...
									<table class="table table-bordered">
										...
										<tbody>
											<tr>
												...
												<td class="text-center">
													<ul class="icons-list">
														<li><a href="#" data-toggle="context" data-target=".context-table-content"><i class="icon-plus22"></i></a></li>
														<li><a href="#" data-toggle="context" data-target=".context-table-content"><i class="icon-three-bars"></i></a></li>
													</ul>
												</td>
											</tr>
											<tr>
					...
					<h6 class="content-group text-semibold">
						...
						<small class="display-block">Dropdown menu options and colors</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Dropdown submenu</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body" data-toggle="context" data-target=".context-sub-menu">
									Context dropdown menu supports multi level menus as it uses default Bootstrap <code>dropdown-menu</code> markup. As well as left sub menu direction using <code>pull-left</code> helper class.
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Dropdown options</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body" data-toggle="context" data-target=".context-options-menu">
									...
									<div class="context-options-menu">
										<ul class="dropdown-menu border-left-danger">
											<li class="dropdown-header">Dropdown heading</li>
											<li><a href="#">Another <span class="text-semibold">semibold action</span></a></li>
											<li><a href="#"><span class="text-light">Something</span> <span class="text-semibold">else</span> <span class="text-italic">here</span></a></li>
											<li class="disabled"><a href="#"><strong>One more</strong> <span class="text-light">disabled line</span></a></li>
											<li class="divider"></li>
											<li><a href="#"><strong>Separated item</strong></a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Dynamic replacement</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body context-dynamic">
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Name on selection</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body context-selection">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">States color</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body" data-toggle="context" data-target=".context-color-menu">
									Context menus support custom colors for active and hover states. Just add one or both <code>.element-hover-*</code> or <code>.element-active-*</code> classes to the context menu.

									<div class="context-color-menu">
										<ul class="dropdown-menu element-hover-sky">
											<li><a href="#"><i class="icon-copy4"></i> Copy</a></li>
											<li><a href="#"><i class="icon-paste3"></i> Paste</a></li>
											<li><a href="#"><i class="icon-file-minus"></i> Remove</a></li>
											<li class="divider"></li>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Solid color</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body" data-toggle="context" data-target=".context-solid-menu">
									...
									<div class="context-solid-menu">
										<ul class="dropdown-menu bg-slate-shade">
											<li><a href="#"><i class="icon-copy4"></i> Copy</a></li>
											<li><a href="#"><i class="icon-paste3"></i> Paste</a></li>
											<li><a href="#"><i class="icon-file-minus"></i> Remove</a></li>
											<li class="divider"></li>
					...
					<h6 class="content-group text-semibold">
						Plugin events
						<small class="display-block">Context dropdown menu events</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">onShow event</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body" data-toggle="context" data-target=".context-show-menu">
									<p class="mb-15">Current example demonstrates context menu with <code>show.bs.context</code>event. This event fires immediately when the context dropdown menu is opened.</p>
	...
	// do something...
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">onShown event</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body" data-toggle="context" data-target=".context-shown-menu">
									<p class="mb-15">Current example demonstrates context menu with <code>shown.bs.context</code>event. This event is fired when the dropdown has been made visible to the user.</p>
	...
	// do something...
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">onHide event</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body" data-toggle="context" data-target=".context-hide-menu">
									<p class="mb-15">Current example demonstrates context menu with <code>hide.bs.context</code>event. This event is fired immediately when the hide instance method has been called.</p>
	...
	// do something...
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">onHidden event</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body" data-toggle="context" data-target=".context-hidden-menu">
									<p class="mb-15">Current example demonstrates context menu with <code>hidden.bs.context</code>event. This event is fired when the dropdown has finished being hidden from the user.</p>
