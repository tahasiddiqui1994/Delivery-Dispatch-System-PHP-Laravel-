...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="navbar_sizes">Sizing options</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Navbars</span> - Sizing</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navbar_sizes">Navbars</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Large navbar size</h5>
						...
						<div class="panel-body">
							<p class="content-group">Increase height of the navbar by adding <code>.navbar-lg</code> class to the main navbar container. Large navbar height is <code>48px</code>, all navbar components will be adjusted to the large navbar height automatically. If navbar type is <code>fixed</code>, add <code>.navbar-top-lg</code> to the <code>&lt;body></code> tag to set top padding and/or <code>.navbar-bottom-lg</code> class if navbar position is bottom to set bottom padding.</p>

							<p class="text-semibold">Navbar preview</p>
							<div class="navbar navbar-inverse bg-info-700 navbar-lg navbar-component" style="position: relative; z-index: 30">
								<div class="navbar-header">
									<a class="navbar-brand" href="index"><img src="assets/images/logo_light.png" alt=""></a>

									<ul class="nav navbar-nav pull-right visible-xs-block">
										<li><a data-toggle="collapse" data-target="#navbar-size-large"><i class="icon-grid3"></i></a></li>
									</ul>
								</div>

								<div class="navbar-collapse collapse" id="navbar-size-large">
									<ul class="nav navbar-nav">
									...
									<ul class="nav navbar-nav navbar-right">
										<li><a href="#"><i class="icon-pin-alt position-left"></i> Link</a></li>
										<li class="dropdown">
											<a href="#" class="dropdown-toggle" data-toggle="dropdown">
												<i class="icon-cog7"></i>
							...
							<p class="text-semibold">Markup example</p>
							<pre class="language-markup" data-line="2"><code>&lt;!-- Large navbar -->
...
&lt;!-- /large navbar -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Default navbar size</h5>
						...
						<div class="panel-body">
							<p class="content-group">Default navbar doesn't require any additional classes in main navbar container. Default navbar height is <code>46px</code>, all navbar components will be adjusted to the default navbar height automatically. If navbar type is <code>fixed</code>, add <code>.navbar-top</code> to the <code>&lt;body></code> tag to set top padding and/or <code>.navbar-bottom</code> class if navbar position is bottom to set bottom padding.</p>

							<p class="text-semibold">Navbar preview</p>
							<div class="navbar navbar-inverse bg-info-700 navbar-component" style="position: relative; z-index: 29">
								<div class="navbar-header">
									<a class="navbar-brand" href="index"><img src="assets/images/logo_light.png" alt=""></a>

									<ul class="nav navbar-nav pull-right visible-xs-block">
										<li><a data-toggle="collapse" data-target="#navbar-size-base"><i class="icon-grid3"></i></a></li>
									</ul>
								</div>

								<div class="navbar-collapse collapse" id="navbar-size-base">
									<ul class="nav navbar-nav">
										<li class="active"><a href="#">Active</a></li>
										<li><a href="#">Link</a></li>
										<li class="dropdown">
							...
							<p class="text-semibold">Markup example</p>
							<pre class="language-markup" data-line="2"><code>&lt;!-- Default navbar -->
&lt;div class="navbar navbar-inverse">
	&lt;div class="navbar-header">...&lt;/div>
	&lt;ul class="nav navbar-nav">...&lt;/ul>
	&lt;ul class="nav navbar-nav navbar-right">...&lt;/ul>
...
&lt;!-- /default navbar -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Small navbar size</h5>
						...
						<div class="panel-body">
							<p class="content-group">Decrease height of the navbar by adding <code>.navbar-sm</code> class to the main navbar container. Small navbar height is <code>44px</code>, all navbar components will be adjusted to the small navbar height automatically. If navbar type is <code>fixed</code>, add <code>.navbar-top-sm</code> to the <code>&lt;body></code> tag to set top padding and/or <code>.navbar-botom-sm</code> classes if navbar position is bottom to set bottom padding.</p>

							<p class="text-semibold">Navbar preview</p>
							<div class="navbar navbar-inverse bg-info-700 navbar-sm navbar-component" style="position: relative; z-index: 28">
								<div class="navbar-header">
									<a class="navbar-brand" href="index"><img src="assets/images/logo_light.png" alt=""></a>

									<ul class="nav navbar-nav pull-right visible-xs-block">
										<li><a data-toggle="collapse" data-target="#navbar-size-small"><i class="icon-grid3"></i></a></li>
									</ul>
								</div>

								<div class="navbar-collapse collapse" id="navbar-size-small">
									<ul class="nav navbar-nav">
										<li class="active"><a href="#">Active</a></li>
										<li><a href="#">Link</a></li>
										<li class="dropdown">
							...
							<p class="text-semibold">Markup example</p>
							<pre class="language-markup" data-line="2"><code>&lt;!-- Small navbar -->
...
&lt;!-- /small navbar -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Mini navbar size</h5>
						...
						<div class="panel-body">
							<p class="content-group">Set the smallest navbar height of <code>42px</code> by adding <code>.navbar-xs</code> class to the main navbar container, all navbar components will be adjusted to the mini navbar height automatically. If navbar type is <code>fixed</code>, add <code>.navbar-top-xs</code> to the <code>&lt;body></code> tag to set top padding and/or <code>.navbar-bottom-xs</code> class if navbar position is bottom to set bottom padding.</p>

							<p class="text-semibold">Navbar preview</p>
							<div class="navbar navbar-inverse bg-info-700 navbar-xs navbar-component" style="position: relative; z-index: 27">
								<div class="navbar-header">
									<a class="navbar-brand" href="index"><img src="assets/images/logo_light.png" alt=""></a>

									<ul class="nav navbar-nav pull-right visible-xs-block">
										<li><a data-toggle="collapse" data-target="#navbar-size-mini"><i class="icon-grid3"></i></a></li>
									</ul>
								</div>

								<div class="navbar-collapse collapse" id="navbar-size-mini">
									<ul class="nav navbar-nav">
										<li class="active"><a href="#">Active</a></li>
										<li><a href="#">Link</a></li>
										<li class="dropdown">
							...
							<p class="text-semibold">Markup example</p>
							<pre class="language-markup"><code>&lt;!-- Mini navbar -->
...
&lt;!-- /mini navbar -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Mixing navbar sizes</h5>
						...
						<div class="panel-body">
							<p class="content-group">Multiple navbars support different heights as well, just add optional height classes to both navbars. If navbar type is <code>fixed</code>, add <code>.navbar-top-*-*</code> to the <code>&lt;body></code> tag to set top padding and/or <code>.navbar-bottom-*-*</code> class if navbar position is bottom to set bottom padding. Example: add <code>.navbar-top-sm-xs</code> class to <code>&lt;body></code> if first navbar is small and second is mini.</p>

							<p class="text-semibold">Navbar preview</p>
							<div class="navbar-component">
								<div class="navbar navbar-inverse navbar-lg" style="position: relative; z-index: 26">
									<div class="navbar-header">
										<a class="navbar-brand" href="index"><img src="assets/images/logo_light.png" alt=""></a>

										<ul class="nav navbar-nav pull-right visible-xs-block">
											<li><a data-toggle="collapse" data-target="#navbar-mix-first"><i class="icon-tree5"></i></a></li>
										</ul>
									</div>

									<div class="navbar-collapse collapse" id="navbar-mix-first">
										<ul class="nav navbar-nav">
								...
								<div class="navbar navbar-default navbar-xs" style="position: relative; z-index: 25; border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
									<ul class="nav navbar-nav no-border visible-xs-block">
										<li><a class="text-center collapsed" data-toggle="collapse" data-target="#navbar-alt"><i class="icon-circle-down2"></i></a></li>
									</ul>
							...
							<p class="text-semibold">Markup example</p>
							<pre class="language-markup"><code>&lt;!-- Large navbar -->
&lt;div class="navbar navbar-inverse navbar-lg">
	&lt;div class="navbar-header">...&lt;/div>
	&lt;ul class="nav navbar-nav">...&lt;/ul>
	&lt;ul class="nav navbar-nav navbar-right">...&lt;/ul>
