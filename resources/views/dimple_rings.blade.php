...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/rings/ring_basic.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/rings/ring_concentric.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/rings/ring_bubble.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/rings/ring_lollipop.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/rings/ring_scatter.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/rings/ring_matrix.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="dimple_rings">Ring charts</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Dimple</span> - Ring Charts</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="dimple_rings">Dimple</a></li>
							<li class="active">Ring charts</li>
						</ul>
				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Basic ring</h6>
									<div class="heading-elements">
										<ul class="icons-list">
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Concentric ring</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Bubbles with rings</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Lollipop with rings</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Scatter with rings</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Ring matrix</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
