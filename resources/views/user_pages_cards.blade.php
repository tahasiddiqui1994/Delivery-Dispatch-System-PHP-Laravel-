...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="user_pages_cards">User cards</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">User Pages</span> - Cards</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="user_pages_cards">User pages</a></li>
				...
				<div class="content">
							...
							<div class="thumbnail no-padding">
								<div class="thumb">
									...
									<div class="caption-overflow">
										<span>
											<a href="{{url('assets/images/placeholder.jpg" class="btn bg-success-400 btn-icon btn-xs" data-popup="lightbox"><i class="icon-plus2"></i></a>
					...
					<h6 class="content-group text-semibold">
						Dropdown menu
						<small class="display-block">Card with dropdown menu</small>
					</h6>
