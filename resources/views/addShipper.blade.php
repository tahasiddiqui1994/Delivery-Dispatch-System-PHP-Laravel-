                                ...
                                <div class="panel-body">
									...
									<tbody><tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('companyName', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Company Name"]) }}

                                            </div></td>
                                          <td><div class="col-sm-10 form-group">
                                                <label>Customer Type<font color="red">*</font></label>

                                                {{ Form::select('customerType', ['Direct Customer'=>'Direct Customer', '3PL'=>'3PL', 'Broker'=>'Broker'], '', ['required'=>"", 'class'=>'form-control', 'placeholder'=>"Enter Guardian Name"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('streetNo', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Street"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('aptOrSuiteOrOther', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Apt/Suite/Other"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('city', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter city"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('state', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter state"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('zipCode', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Zip code"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('phoneNo', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Phone no."]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('email', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Email"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('website', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Website"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('motorCarrierNo', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Motor Carrier No"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('taxID', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Tax ID"]) }}
                                     ...
                                     <tr><td><div class="col-sm-10 form-group">
                                                ...
                                                {{ Form::select('status', ['Active'=>'Active', 'Inactive'=>'Inactive'], '', ['required'=>"", 'class'=>'form-control', 'placeholder'=>"select"]) }}
