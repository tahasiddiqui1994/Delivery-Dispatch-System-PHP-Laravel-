                        ...
                        @if($data)
							@foreach($data as $rrr)
								<tr>
									...
									<td>
										{{$rrr->firstName}}<br>{{$rrr->lastName}}
									</td>
									<td>
										{{$rrr->paymentType}}
									</td>
									<td>
										{{$rrr->streetNo}},<br>{{$rrr->city}}, {{$rrr->state}}
									</td>
									<td>
										{{$rrr->phoneNo}}
									</td>
								...
								@if(Auth::user()->type == "admin")
									<td>
										<div class="row">
	                                       {!! Form::open(['action'=> ['driversController@destroy', $rrr->id], 'method'=>'POST']) !!}
		                                       <button href="/driver/{{$rrr->id}}/destroy" class="btn btn-danger btn-xs pull-right" data-toggle="tooltip" data-placement="right" title="Delete">
											...
											<a href="/driver/{{$rrr->id}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>
