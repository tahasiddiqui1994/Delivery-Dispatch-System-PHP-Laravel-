									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="gallery_library">Media library</a></li>
											</ul>
										</li>
									</ul>
								</li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Gallery</span> - Media Library</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="gallery_library">Gallery</a></li>
