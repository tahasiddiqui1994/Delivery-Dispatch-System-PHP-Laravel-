...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/forms/inputs/alpaca/price_format.min.js')}}"></script>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/alpaca_advanced.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="alpaca_advanced">Advanced inputs</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="alpaca_advanced">Alpaca</a></li>
