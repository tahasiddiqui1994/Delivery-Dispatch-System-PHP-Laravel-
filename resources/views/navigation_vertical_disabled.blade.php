							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="disabled"><a href="layout_navbar_hideable_sidebar">Hideable &amp; fixed sidebar</a></li>
										<li><a href="layout_footer_fixed">Fixed footer</a></li>
										<li class="navigation-divider"></li>
										<li><a href="boxed_default">Boxed with default sidebar</a></li>
										<li class="disabled"><a href="boxed_mini">Boxed with mini sidebar</a></li>
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="disabled"><a href="form_input_groups">Input groups</a></li>
										...
										<li class="disabled"><a href="form_dual_listboxes">Dual Listboxes</a></li>
										<li class="disabled"><a href="form_editable">Editable forms</a></li>
										<li><a href="form_validation">Validation</a></li>
										<li class="disabled"><a href="form_inputs_grid">Inputs grid</a></li>
									</ul>
								</li>
								<li>
								...
								<li>
									...
									<ul>
										<li class="disabled"><a href="editor_summernote">Summernote editor</a></li>
										<li><a href="editor_ckeditor">CKEditor</a></li>
										<li class="disabled"><a href="editor_wysihtml5">WYSIHTML5 editor</a></li>
								...
								<li>
									...
									<ul>
										...
										<li class="disabled"><a href="picker_location">Location pickers</a></li>
									</ul>
								</li>
								<li class="disabled">
								...
								<li>
									...
									<ul>
										...
										<li class="disabled"><a href="components_notifications_pnotify">PNotify notifications</a></li>
										<li class="disabled"><a href="components_notifications_others">Other notifications</a></li>
										...
										<li class="disabled"><a href="components_page_header">Page header</a></li>
										<li><a href="components_breadcrumbs">Breadcrumbs</a></li>
										<li><a href="components_media">Media objects</a></li>
										<li class="disabled"><a href="components_affix">Affix and Scrollspy</a></li>
									</ul>
								</li>
								<li>
									...
									<ul>
										...
										<li class="disabled"><a href="appearance_typography">Typography</a></li>
										<li><a href="appearance_helpers">Helper classes</a></li>
										<li><a href="appearance_syntax_highlighter">Syntax highlighter</a></li>
										<li class="disabled"><a href="appearance_content_grid">Grid system</a></li>
									</ul>
								</li>
								<li>
									...
									<ul>
										...
										<li class="disabled"><a href="extra_session_timeout">Session timeout</a></li>
										<li class="disabled"><a href="extra_idle_timeout">Idle timeout</a></li>
										<li class="disabled"><a href="extra_trees">Dynamic tree views</a></li>
								...
								<li>
									...
									<ul>
										<li class="disabled"><a href="icons_glyphicons">Glyphicons</a></li>
										<li><a href="icons_icomoon">Icomoon</a></li>
										<li class="disabled"><a href="icons_fontawesome">Font awesome</a></li>
									</ul>
								</li>
								<!-- /appearance -->
								...
								<li>
									...
									<ul>
										...
										<li class="disabled"><a href="sidebar_default_hide">Default hideable</a></li>
										<li><a href="sidebar_mini_collapse">Mini collapsible</a></li>
										<li class="disabled"><a href="sidebar_mini_hide">Mini hideable</a></li>
										<li>
										...
										<li class="disabled"><a href="sidebar_hidden">Hidden sidebar</a></li>
								...
								<li>
									...
									<ul>
										<li class="disabled"><a href="navigation_vertical_collapsible">Collapsible menu</a></li>
										<li><a href="navigation_vertical_accordion">Accordion menu</a></li>
										<li><a href="navigation_vertical_sizing">Navigation sizing</a></li>
										<li class="disabled"><a href="navigation_vertical_bordered">Bordered navigation</a></li>
										<li class="disabled"><a href="navigation_vertical_right_icons">Right icons</a></li>
										<li><a href="navigation_vertical_labels_badges">Labels and badges</a></li>
										<li class="active"><a href="navigation_vertical_disabled">Disabled navigation links</a></li>
									</ul>
								</li>
								<li>
								...
								<li>
									...
									<ul>
										...
										<li class="disabled"><a href="navbar_sizes">Sizing options</a></li>
								...
								<li>
									...
									<ul>
										...
										<li class="disabled"><a href="table_borders">Table borders</a></li>
										<li class="disabled"><a href="table_styling">Table styling</a></li>
								...
								<li>
									...
									<ul>
										...
										<li class="disabled"><a href="datatable_sorting">Sorting options</a></li>
								...
								<li>
									...
									<ul>
										...
										<li class="disabled"><a href="datatable_extension_fixed_columns">Fixed columns</a></li>
										<li><a href="datatable_extension_fixed_header">Fixed header</a></li>
										<li><a href="datatable_extension_autofill">Auto fill</a></li>
										<li class="disabled"><a href="datatable_extension_key_table">Key table</a></li>
										...
										<li class="disabled"><a href="datatable_extension_colvis">Columns visibility</a></li>
									</ul>
								</li>
								<li class="disabled">
								...
								<li class="disabled">
									...
									<ul>
										<li><a href="chat_layouts">Conversation layouts</a></li>
										<li><a href="chat_options">Conversation options</a></li>
										<li><a href="support_knowledgebase">Knowledgebase</a></li>
										<li><a href="support_faq">FAQ page</a></li>
									</ul>
								</li>
								<li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Vertical Nav</span> - Disable Items</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navigation_vertical_disabled">Vertical nav</a></li>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Disable navigation items</h6>
						Disable certain navigation links by adding <code>.disabled</code> class to the parent <code>&lt;li></code>. Works in all navigations.
				    </div>
				    <!-- /info alert -->
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<div class="content-group-lg">
								Vertical navigation - type of navigation that is used in sidebars and has vertical direction. By default navigation includes custom icons based on<code>16px</code> grid, aligned to the left (to the right in RTL layout) and have absolute position. In <code>mini</code> sidebar navigation text is hidden and appears as additional labels on parent level item hover. In this type of sidebar icons are centered and have static position. Also optional styling is available: different <code>sizes</code>, <code>bordered</code> nav and layout with <code>right</code> aligned icons. Vertical navigation supports the following options:
							</div>

							<div class="content-group-lg">
								<h6 class="text-semibold">1. Navigation placement</h6>
								<p>Main navigation can be used in any sidebar type - main, secondary or opposite. Please note - collapsed navigation is allowed only in main sidebar, all other sidebars display full sized navigation. Since navigation is a part of sidebar content, it can be mixed with other components and can be placed before or after them depending on the priority.</p>
							</div>

							<div class="content-group-lg">
								<h6 class="text-semibold">2. Navigation types</h6>
								<p>Default navigation type is <strong>collapsible</strong>: when new item is expanded, current level remains opened. This logic works in all navigation levels. Collapsible navigation doesn't require any additional classes. The second navigation type is <strong>accordion</strong>: when new item is expanded, current level is collapsed. This logic works in all navigation levels as well. In mini sidebar parent level of navigation doesn't have click event and shows child levels on hover, but child levels functionality remains according to the type of navigation. Sidebar navigation supports <strong>up to 3 levels</strong> of child menus.</p>
							</div>

							<div class="content-group-lg">
								<h6 class="text-semibold">3. Navigation sizing</h6>
								<p>By default, 1st level navigation items have <code>44px</code> height, other levels have <code>40px</code> height. Besides default size, sidebar navigation supports 3 additional sizes: <code>large</code>, <code>small</code> and <code>mini</code>. Basically, these sizes change item height. To use, just add one of <code>.navigation-lg (sm, xs)</code> classes to the navigation container. This option works in all sidebars.</p>
							</div>

							<div class="content-group">
								<h6 class="text-semibold">4. Additional styling</h6>
								<p>Depending on sidebar background color, navigation menu automatically adjusts active link color for parent level. This color can be changed by adding <code>.element-*</code> class to the navigation container. Besides color options, selected items can be disabled on the fly by adding <code>.disabled</code> class to the parent <code>&lt;li></code> item, it sets reduced opacity and disables click event. Additional options: navigation with <code>right</code> icons - has right positioned icons, <code>bordered</code> navigation - has additional borders between items for better separation.</p>
							</div>
						</div>
					</div>
					<!-- /main navigation overview -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Navigation classes</h5>
						...
						<div class="panel-body">
							This table contains all classes related to the sidebar navigation. Vertical navigation is a custom layout element and adapted for main navigation purposes: depending on the needs, it supports different options such as size, active item background color, type, placement etc. All these options can be set via these classes:
						</div>
						...
						<div class="table-responsive">
							<table class="table table-bordered">
								...
								<tbody>
									...
									<tr>
										<td><code>.navigation-alt</code></td>
										<td>Class for alternative navigation. Defines navigation in other sidebars. This navigation has its own functionality and keeps its functionality without main sidebar size dependency.</td>
									</tr>
									<tr>
										<td><code>.navigation-accordion</code></td>
										<td>Changes navigation type from default collapsible to accordion-like.</td>
									</tr>
									<tr>
										<td><code>.navigation-icons-right</code></td>
										<td>Changes icons position from left to right. Note: arrows that define children group state are hidden in right icons layout.</td>
									</tr>
									<tr>
										<td><code>.element-*</code></td>
										<td>Custom color system class. Changes background color of active item in 1st menu level, text and arrow of the second menu level in collapsed mode.</td>
									</tr>
									<tr>
										<td><code>.navigation-bordered</code></td>
										<td>Adds horizontal borders to menu items in parent level only.</td>
									</tr>
									<tr>
										<td><code>.navigation-lg (sm, xs)</code></td>
										<td>Changes navigation size. Basically, all these classes change vertical spacing of the items.</td>
									</tr>
									<tr>
										<td><code>li.category-title</code></td>
										<td>Divide navigation with titles by adding <code>.category-title</code> to the parent <code>&lt;li></code> item and wrap inner text in <code>&lt;span /></code>.</td>
									</tr>
									<tr>
										<td><code>li.disabled</code></td>
										<td>Disables any navigation item. Sets reduced opacity, changes cursor to <code>not-allowed</code> and disables click events.</td>
									</tr>
									<tr>
										<td><code>li.active</code></td>
										<td>Defines active navigation item. No need to add this class to all parent level <code>&lt;li></code>'s, but only for actual active link, jQuery code will do the rest.</td>
									</tr>
								</tbody>
							</table>
						</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Navigation options</h5>
						...
						<div class="panel-body">
							<h6 class="text-semibold">Collapsible and accordion types</h6>
							<p class="content-group">Flexible template functionality offers 2 different kinds of navigation: collapsible and accordion. Both have custom jQuery code and provide extended control over the child nav items. Default type is <code>collapsible</code> navigation: open as many child levels as you want, they all will be visible all the time. Second type is <code>accordion</code> navigation: allows to display only 1 parent level, collapsing all others. Both navigation types have hidden 2nd level in mini sidebar that opens on hover.</p>

							<div class="row">
								<div class="col-md-6">
									<p class="text-semibold">Collapsible navigation markup</p>
									<pre class="language-markup content-group" data-line="3"><code>&lt;!-- Default navigation markup -->
&lt;div class="category-content no-padding">
...
&lt;!-- /default navigation markup -->										
								...
								<div class="col-md-6">
									<p class="text-semibold">Accordion navigation markup</p>
									<pre class="language-markup content-group" data-line="3"><code>&lt;!-- Accordion navigation markup -->
&lt;div class="category-content no-padding">
	&lt;ul class="navigation navigation-main navigation-accordion">
		&lt;li>
			&lt;a href="index">
...
&lt;!-- /accordion navigation markup -->										
							...
							<h6 class="text-semibold">Icons position</h6>
							<p class="content-group">Sidebar navigation supports icons in all menu levels. Default icons position is left. All icons have absolute position, allowing parent link text wrap and keep permanent left padding. Left position of icons allows to keep a visual hierarchy: icon > text > arrow (label), but right position of icons makes usage of arrows useless as they won't be visible. To change icons position just add <code>.navigation-icons-right</code> to the <code>.navigation</code> container, CSS will do the rest.</p>

							<div class="row">
								<div class="col-md-6">
									<p class="text-semibold">Default left icons position</p>
									<pre class="language-markup content-group" data-line="3"><code>&lt;!-- Left icons position -->
&lt;div class="category-content no-padding">
	&lt;ul class="navigation navigation-main">
		&lt;li>
			&lt;a href="index">
...
&lt;!-- /left icons position -->										
								...
								<div class="col-md-6">
									<p class="text-semibold">Optional right icons position</p>
									<pre class="language-markup content-group" data-line="3"><code>&lt;!-- Right icons position -->
&lt;div class="category-content no-padding">
...
&lt;!-- /right icons position -->										
							...
							<h6 class="text-semibold">Display options</h6>
							<p class="content-group">Default navigation menu doesn't have any borders, parent level items are <code>44px</code> high, child levels items are <code>40px</code> high. It can be extended using 3 optional classes: <code>.navigation-lg</code> - changes parent level item height to <code>46px</code> and child levels to <code>42px</code>, <code>.navigation-sm</code> - changes parent level item height to <code>42px</code> and child levels to <code>38px</code>, <code>.navigation-xs</code> - changes parent level item height to <code>40px</code> and child levels to <code>36px</code>.</p>

							<div class="row">
								<div class="col-md-6">
									<p class="text-semibold">Mini navigation example</p>
									<pre class="language-markup" data-line="3"><code>&lt;!-- Mini navigation -->
&lt;div class="category-content no-padding">
...
&lt;!-- /mini navigation -->										
								...
								<div class="col-md-6">
									<p class="text-semibold">Bordered navigation example</p>
									<pre class="language-markup" data-line="3"><code>&lt;!-- Bordered navigation -->
&lt;div class="category-content no-padding">
