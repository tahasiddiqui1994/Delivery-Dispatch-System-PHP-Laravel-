...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/extension_blockui.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="extension_blockui">Block UI</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Extensions</span> - Block UI</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="extension_blockui">Extensions</a></li>
							<li class="active">Block UI</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat content-group-lg">
						<div class="panel-heading">
							<h5 class="panel-title">BlockUI extension</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<div class="content-group-lg">
								<h6 class="text-semibold">BlockUI overview</h6>
							...
							<h6 class="text-semibold">Sample markup</h6>
							<p class="content-group">Sample examples of blocking user activity with the entire page and with content panel on button click. In both examples <code>auto unblock</code> is enabled for demonstration purposes and unblock specified containers in 2 seconds. In real final working version all containers can be unblocked when ajax activity stops. All styles for overlay and message are custom, default message displays text only.</p>
							<div class="row">
								<div class="col-md-6">
									<p>Block the panel</p>
									<pre class="language-javascript content-group"><code>/* Block the panel on button click */
	...
	$(block).block({ 
	    ...
	    css: {
	        ...
	        backgroundColor: 'transparent'
								...
								<div class="col-md-6">
									<p>Block current page</p>
									<pre class="language-javascript content-group"><code>/* Block current page on button click */
	    ...
	    css: {
	        ...
	        backgroundColor: 'transparent'
					...
					<h6 class="content-group text-semibold">
						Blocking areas
						<small class="display-block">Block layout areas, content components or entire page</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Whole page blocking</h6>
								<p class="content-group-sm text-muted">Block entire page using default options</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Layout area blocking</h6>
								<p class="content-group-sm text-muted">Block layout areas using default options</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Content component blocking</h6>
								<p class="content-group-sm text-muted">Block content components using default options</p>
								<button type="button" class="btn btn-primary" id="block-panel">Block this panel</button>
							</div>
						</div>
					</div>
					<!-- blocking areas -->
					...
					<h6 class="content-group text-semibold">
						Overlay options
						<small class="display-block">Default and custom overlay options</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Basic light overlay</h6>
								<p class="content-group-sm text-muted">Displays basic overlay with opacity</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Custom overlay color</h6>
								<p class="content-group-sm text-muted">Displays custom background color in overlay</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Full overlay cover</h6>
								<p class="content-group-sm text-muted">Displays fully opaque overlay</p>
					...
					<h6 class="content-group text-semibold">
						Display options
						<small class="display-block">Variations of message and overlay appearance</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Block without message</h6>
								<p class="content-group-sm text-muted">Displays overlay only, message is empty</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Block without overlay</h6>
								<p class="content-group-sm text-muted">Displays message only, overlay is hidden</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Basic Growl example</h6>
								<p class="content-group-sm text-muted">Displays message and overlay as a Growl</p>
								<button type="button" class="btn btn-success" id="growl">Growl example</button>

								<div class="blockui-growl">
					...
					<h6 class="content-group text-semibold">
						Message options
						<small class="display-block">Default and custom options for messages</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Block with spinner only</h6>
								<p class="content-group-sm text-muted">Displays animated spinner icon only, no text</p>
								<button type="button" class="btn btn-info" id="spinner-only">With spinner only</button>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Block with DOM element</h6>
								<p class="content-group-sm text-muted">Displays DOM element as a message</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Block with default message</h6>
								<p class="content-group-sm text-muted">Displays default text message, no spinner</p>
								<button type="button" class="btn btn-info" id="default-message">With default message</button>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Multiple messages</h6>
								<p class="content-group-sm text-muted">Multiple messages with different styles</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Block with custom message</h6>
								<p class="content-group-sm text-muted">Custom message with overlay and spinner</p>
								<button type="button" class="btn btn-info" id="custom-message">With custom message</button>
							</div>

							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Message animation</h6>
								<p class="content-group-sm text-muted">Message animation using <code>animate.css</code></p>
					...
					<h6 class="content-group text-semibold">
						Other options
						<small class="display-block">Message position and unblocking options</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Message position</h6>
								<p class="content-group-sm text-muted">Displays custom message position</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Auto unblocking</h6>
								<p class="content-group-sm text-muted">Demonstrates auto unblocking feature</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">Click to unblock</h6>
								<p class="content-group-sm text-muted">Click overlay to unblock the element</p>
					...
					<h6 class="content-group text-semibold">
						Callback methods
						<small class="display-block">On block, on unblock and on overlay click</small>
					</h6>

					<div class="row">
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">onBlock callback</h6>
								<p class="content-group-sm text-muted">Invoked when blocking message is visible</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">onUnblock callback</h6>
								<p class="content-group-sm text-muted">Invoked when unblocking has completed</p>
						...
						<div class="col-md-4">
							<div class="panel panel-body border-top-primary text-center">
								<h6 class="no-margin text-semibold">onOverlayClick callback</h6>
								<p class="content-group-sm text-muted">Invoked when blocking overlay is clicked</p>
