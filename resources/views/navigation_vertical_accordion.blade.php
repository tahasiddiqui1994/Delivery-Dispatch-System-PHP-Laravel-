...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="navigation_vertical_accordion">Accordion menu</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Vertical Nav</span> - Accordion</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navigation_vertical_accordion">Vertical nav</a></li>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Accordion navigation</h6>
						Change collapsible navigation type to accordion by adding <code>.navigation-accordion</code> class to <code>&lt;ul class="navigation" /></code> container.
				    </div>
				    <!-- /info alert -->
