...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/mail_list_read.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="mail_read">Read mail</a></li>
									...
									<div class="navbar navbar-default">
										...
										<div class="navbar-collapse collapse" id="inbox-toolbar-toggle-single">
											<div class="btn-group navbar-btn">
												<a href="mail_write" class="btn btn-default"><i class="icon-reply"></i> <span class="hidden-xs position-right">Reply</span></a>
												<a href="mail_write" class="btn btn-default"><i class="icon-reply-all"></i> <span class="hidden-xs position-right">Reply to all</span></a>
												<a href="mail_write" class="btn btn-default"><i class="icon-forward"></i> <span class="hidden-xs position-right">Forward</span></a>
