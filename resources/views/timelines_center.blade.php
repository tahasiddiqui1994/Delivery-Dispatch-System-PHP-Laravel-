...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/timelines.js')}}"></script>
	<!-- /theme JS files -->
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="timelines_center">Centered timeline</a></li>
											</ul>
										</li>
										<li>
											<a href="#">Gallery</a>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Timelines</span> - Center Position</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="timelines_center">Timelines</a></li>
							<li class="active">Center position</li>
						</ul>
