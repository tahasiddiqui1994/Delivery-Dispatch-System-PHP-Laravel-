...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/forms/inputs/maxlength.min.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/forms/inputs/formatter.min.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/pages/form_floating_labels.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="form_floating_labels">Floating labels</a></li>
										<li>
											<a href="#">Selects</a>
											<ul>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Forms</span> - Floating Labels</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="form_floating_labels">Forms</a></li>
							<li class="active">Floating labels</li>
						</ul>
				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Text inputs</h5>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									...
									<div class="form-group form-group-material">
										<label class="control-label">Input with helper</label>
										<input type="text" class="form-control" placeholder="Input with helper">
										<span class="help-block">Input helper text block</span>
									</div>

									<div class="form-group form-group-material has-success has-feedback">
										<label class="control-label">Contextual input</label>
										<input type="text" class="form-control" placeholder="Success with icon">
										<div class="form-control-feedback">
											<i class="icon-checkmark3"></i>
										</div>
										<span class="help-block">Contextual input helper</span>
									</div>

									<div class="form-group form-group-material">
										<label class="control-label">Disabled input field</label>
										<input type="text" class="form-control" disabled="disabled" placeholder="Disabled input field">
									</div>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Input groups</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="form-group form-group-material">
										<label class="control-label">Left group addon</label>
										<div class="input-group">
											<span class="input-group-addon"><i class="icon-paperplane"></i></span>
											<input type="text" class="form-control" placeholder="Left group addon">
										</div>
									</div>

									<div class="form-group form-group-material">
										<label class="control-label">Right group addon</label>
										<div class="input-group">
									...
									<div class="form-group form-group-material">
										<label class="control-label has-margin">Left group button</label>
										<div class="input-group">
											<div class="input-group-btn">
												<button type="button" class="btn bg-blue dropdown-toggle" data-toggle="dropdown">Action <span class="caret"></span></button>
									...
									<div class="form-group form-group-material">
										<label class="control-label has-margin">Right group button</label>
										<div class="input-group">
									...
									<div class="form-group form-group-material has-warning has-feedback">
										<label class="control-label">Contextual input group</label>
										<div class="input-group">
											<span class="input-group-addon"><i class="icon-blocked"></i></span>
											<input type="text" class="form-control" placeholder="Contextual input group">
										</div>
										<div class="form-control-feedback">
											<i class="icon-spam"></i>
										</div>
										<span class="help-block">Contextual input group helper</span>
									</div>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Selects</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<div class="form-group form-group-material">
										...
										<select class="form-control">
											<option value="" selected="selected">Basic select</option>
									...
									<div class="form-group form-group-material">
										<label class="control-label has-margin">Multiple Select2 select</label>
									...
									<div class="form-group form-group-material">
										<label class="control-label">Bootstrap multiselect</label>
									...
									<div class="form-group form-group-material">
										<label class="control-label">Bootstrap select</label>
										<select class="bootstrap-select" data-width="100%">
											<option value="" selected="selected">Bootstrap select</option>
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
									...
									<div class="form-group form-group-material">
										<label class="control-label">SelectBoxIt select</label>
										<select class="selectbox">
											<option value="" selected="selected">SelectBoxIt select</option>
											<option value="AK">Alaska</option>
											<option value="HI">Hawaii</option>
											<option value="CA">California</option>
											<option value="NV">Nevada</option>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Other inputs</h5>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									...
									<div class="form-group form-group-material">
										<label class="control-label">Input formatter</label>
			                        	<input type="text" class="form-control" name="format-date" placeholder="Input formatter">
			                        	<span class="help-block">99/99/9999</span>
									</div>

									<div class="form-group form-group-material">
										<label class="control-label">Bootstrap Maxlength</label>
			                        	<input type="text" class="form-control maxlength" maxlength="10" placeholder="Bootstrap Maxlength">
									</div>

									<div class="form-group form-group-material">
										<label class="control-label has-margin">Bootstrap Tokenfield</label>
										<input type="text" class="form-control token-field" placeholder="- Bootstrap Tokenfield">
									</div>

									<div class="form-group form-group-material">
										<label class="control-label has-margin">Bootstrap tags input</label>
										<input type="text" class="tags-input" placeholder="- Bootstrap tags input">
									</div>

									<div class="form-group form-group-material">
										<label class="display-block control-label has-margin">Default file input</label>
										<input type="file" class="form-control">
									</div>

									<div class="form-group form-group-material">
										<label class="display-block control-label has-margin">Styled file input</label>
						...
						<div class="col-md-6">
							...
							<h6 class="content-group text-semibold">
								Visible labels
								<small class="display-block">Inputs with predefined values</small>
							</h6>
							<!-- /title -->
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									...
									<div class="form-group form-group-material has-success has-feedback">
										<label class="control-label">Contextual input</label>
										<input type="text" class="form-control" value="Value" placeholder="Success with icon">
										<div class="form-control-feedback">
											<i class="icon-checkmark3"></i>
										</div>
										<span class="help-block">Contextual input helper</span>
									...
									<div class="form-group form-group-material">
										<label class="control-label">Disabled input field</label>
										<input type="text" class="form-control" disabled="disabled" value="Value" placeholder="Disabled input field">
									</div>
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									...
									<div class="form-group form-group-material has-warning has-feedback">
										...
										<div class="input-group">
											<span class="input-group-addon"><i class="icon-blocked"></i></span>
											<input type="text" class="form-control" value="Value" placeholder="Contextual input group">
										</div>
										<div class="form-control-feedback">
											<i class="icon-spam"></i>
										</div>
									...
									<div class="form-group form-group-material">
										<label class="control-label has-margin">Touchspin spinners</label>
										<input type="text" value="10" class="touchspin-basic" placeholder="Touchspin spinners">
									</div>
								</div>
							</div>
							<!-- /input groups -->
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									...
									<div class="form-group form-group-material">
										<label class="control-label">Bootstrap Maxlength</label>
			                        	<input type="text" class="form-control maxlength" maxlength="10" value="Value" placeholder="Bootstrap Maxlength">
									</div>

									<div class="form-group form-group-material">
										<label class="control-label has-margin">Bootstrap Tokenfield</label>
										<input type="text" class="form-control token-field" value="California,Washington" placeholder="- Bootstrap Tokenfield">
									</div>

									<div class="form-group form-group-material">
										<label class="control-label has-margin">Bootstrap tags input</label>
										<input type="text" class="tags-input" value="Miami,Texas" placeholder="- Bootstrap tags input">
									</div>

									<div class="form-group form-group-material">
										<label class="display-block has-margin">Default file input (forced)</label>
										<input type="file" class="form-control" src="/file.txt" value="10" name="uploadform" size="30" id="fileupload2">
									</div>

									<div class="form-group form-group-material">
										<label class="display-block has-margin">Styled file input (forced)</label>
										<input type="file" class="file-styled">
									</div>
								</div>
							</div>
