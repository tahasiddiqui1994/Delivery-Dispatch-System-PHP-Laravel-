...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/visualization/dimple/dimple.min.js')}}"></script>

	<script type="text/javascript" src="{{url('assets/js/core/app.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/bars/bar_horizontal.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/bars/bar_horizontal_stacked.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/bars/bar_horizontal_stacked_normalized.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/bars/bar_horizontal_grouped.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/bars/bar_horizontal_stacked_grouped.js')}}"></script>
	<!-- /theme JS files -->
								...
								<li>
									...
									<ul>
										...
										<li>
											<a href="#">Bar charts</a>
											<ul>
												<li class="active"><a href="dimple_bars_horizontal">Horizontal orientation</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Dimple</span> - Horizontal Bars</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="dimple_bars_horizontal">Dimple</a></li>
							<li class="active">Horizontal bars</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Basic unstacked bar chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Stacked bar chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Stacked normalized bar chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Grouped unstacked bar chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Grouped stacked bar chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
