...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="table_sizing">Table sizing</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Tables</span> - Sizing</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="table_sizing">Tables</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Table sizing
						<small class="display-block">Additional table cell sizing.</small>
					</h6>
					<!-- /cell sizing title -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Extra large table</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							Example of <code>extra large</code> table sizing using <code>.table-xlg</code> class added to the <code>.table</code>. All table rows have <code>60px</code> height.
						</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Large table</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							Example of <code>large</code> table sizing using <code>.table-lg</code> class added to the <code>.table</code>. All table rows have <code>50px</code> height.
						</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Default table</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							Example of <code>default</code> table sizing. This table doesn;t require any additional classes using in the table with <code>.table</code> class. All table rows have <code>44px</code> height.
						</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Small table</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							Example of <code>small</code> table sizing using <code>.table-sm</code> class added to the <code>.table</code>. All table rows have <code>40px</code> height.
						</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Mini (condensed) table</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							Example of <code>mini</code> table sizing using <code>.table-xs</code> class added to the <code>.table</code>. All table rows have <code>36px</code> height. This table size also has an alias - Bootstrap's condensed table available via <code>.table-condensed</code> class.
						</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Extra mini table</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							Example of <code>extra mini</code> table sizing using <code>.table-xxs</code> class added to the <code>.table</code>. All table rows have <code>32px</code> height.
						</div>
					...
					<h6 class="content-group text-semibold">
						Column sizing
						<small class="display-block">Column sizing based on 12 columns grid.</small>
					</h6>
					<!-- /Column sizing title -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Column grid sizing</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							In this table all columns have percentage based widths. These width options are based on 12 columns mobile first responsive grid system, accessible via default Bootstrap column classes - <code>col-*-*</code>, where the first option is screen size (xs, sm, md, lg), second option is column width (1 - 12). To use, just add one of these classes to any <code>&lt;th></code> or <code>&lt;td></code> element.
						</div>
