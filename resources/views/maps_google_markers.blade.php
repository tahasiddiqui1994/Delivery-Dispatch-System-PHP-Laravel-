...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/maps/google/markers/simple.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/google/markers/animation.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/google/markers/symbols_predefined.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/maps/google/markers/symbols_custom.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
									...
									<ul>
										<li>
											...
											<ul>
												...
												<li class="active"><a href="maps_google_markers">Markers</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Google Maps</span> - Markers</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="maps_google_markers">Google maps</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Animated markers</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Predefined symbols</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
