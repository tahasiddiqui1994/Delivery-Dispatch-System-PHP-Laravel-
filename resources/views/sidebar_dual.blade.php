								...
								<li>
									...
									<ul>
										...
										<li>
											...
											<ul>
												<li class="active"><a href="sidebar_dual">Dual sidebar</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Dual Left</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_dual_left">Sidebars</a></li>
							<li class="active">Dual left</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Dual sidebar</h6>
						Dual sidebar layout type includes 2 separate sidebars that come one after another. Main sidebar must have <code>.sidebar-main</code> class and secondary - <code>.sidebar-secondary</code>. Mini sidebar works only with <strong>main</strong> sidebar.
				    </div>
				    <!-- /info alert -->
