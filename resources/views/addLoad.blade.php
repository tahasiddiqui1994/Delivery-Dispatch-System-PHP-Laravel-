                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
										{!! Form::open(['action'=> 'loadController@store', 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
										...
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                ...
                                                {{ Form::text('loadNo', '', ['class' => "form-control", 'placeholder' => "Load No"]) }}
                                          ...
                                          <td><div class="col-sm-8 form-group">
                                               ...
                                               <select name="customerName" id="customerName" class="form-control" placeholder="Select Customer Name">
									...
									<tr>
									  ...
									  <tr>
										<td bgcolor=""><div class="col-sm-8 form-group">
                                               ...
                                               <select name="driverName" id="driverName" class="form-control" placeholder="Select">
