...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/jqueryui_interactions.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="jqueryui_interactions">Interactions</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">jQuery UI</span> - Interactions</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="jqueryui_interactions">jQuery UI</a></li>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Draggable
						<small class="display-block">Allow elements to be moved using the mouse</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<!-- Basic -->
							<div class="panel panel-flat" id="draggable-default-container">
								...
								<div class="panel-body">
									<p class="content-group">Enable draggable functionality on any DOM element. Move the draggable object by clicking on it with the mouse and dragging it anywhere within the viewport. Draggable area is limited to this panel using <code>containment</code> option.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element draggable-element"><span>Drag</span></div>
										<div class="jqueryui-demo-element draggable-element"><span>Drag</span></div>
										<div class="jqueryui-demo-element draggable-element"><span>Drag</span></div>
									</div>
								</div>
						...
						<div class="col-md-6">
							...
							<!-- Cursor style -->
							<div class="panel panel-flat" id="draggable-cursor-container">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Cursor style</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Position the cursor while dragging the object. By default the cursor appears in the center of the dragged object; use the <code>cursorAt</code> option to specify another location (specify a pixel value from the top, right, bottom, and/or left).</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element" id="draggable-cursor-move"><span>Move</span></div>
										<div class="jqueryui-demo-element" id="draggable-cursor-crosshair"><span>Crosshair</span></div>
										<div class="jqueryui-demo-element" id="draggable-cursor-bottom"><span>Bottom</span></div>
									</div>
								</div>
							</div>
							<!-- /cursor style -->
					...
					<div class="row">
						<div class="col-md-6">
							...
							<!-- Constrain movement -->
							<div class="panel panel-flat" id="draggable-containment-container">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Constrain movement</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Constrain the movement of each draggable by defining the boundaries of the draggable area. Set the <code>axis</code> option to limit the draggable's path to the x- or y-axis, or use the <code>containment</code> option to specify another parent.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element" id="draggable-move-both"><span>Both</span></div>
										<div class="jqueryui-demo-element" id="draggable-move-vertical"><span>Vertical</span></div>
										<div class="jqueryui-demo-element" id="draggable-move-horizontal"><span>Horizontal</span></div>
									</div>
								</div>
							</div>
							<!-- /constrain movement -->
						...
						<div class="col-md-6">
							...
							<!-- Handles -->
							<div class="panel panel-flat" id="draggable-handle-container">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Handles</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">You can use the <code>handle</code> option to specify the jQuery selector of an element used to drag the object or prevent dragging. Use the <code>cancel</code> option to specify a jQuery selector over which to "cancel" draggable functionality.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element" id="draggable-handle-text"><span class="cursor-pointer">Text</span></div>
										<div class="jqueryui-demo-element" id="draggable-handle-icon"><span><i class="icon-pointer handle-icon cursor-pointer"></i></span></div>
										<div class="jqueryui-demo-element cursor-pointer" id="draggable-handle-exception"><span class="cursor-default">Exception</span></div>
									</div>
								</div>
							</div>
							<!-- /handles -->
					...
					<div class="row">
						<div class="col-md-6">
							...
							<!-- Revert position -->
							<div class="panel panel-flat" id="draggable-revert-container">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Revert position</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Return the draggable (or it's helper) to its original location when dragging stops with the boolean <code>revert</code> option. If set to true the element will always revert. Also can be a string (<code>valid</code> or <code>invalid</code>) or a function.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element" id="draggable-revert-element"><span>Element</span></div>
										<div class="jqueryui-demo-element" id="draggable-revert-clone"><span>Clone</span></div>
										<div class="jqueryui-demo-element" id="draggable-revert-speed"><span>Speed</span></div>
									</div>
								</div>
							</div>
							<!-- /revert position -->
						...
						<div class="col-md-6">
							...
							<!-- Events -->
							<div class="panel panel-flat" id="draggable-events-container">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Events</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Layer functionality onto the draggable using the <code>start</code>, <code>drag</code>, and <code>stop</code> events. <code>Start</code> is fired at the start of the drag; <code>drag</code> during the drag; and <code>stop</code> when dragging stops. Drag the circles to see events in action.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element" id="draggable-event-start"><span>Start <span class="event-count">0</span>x</span></div>
										<div class="jqueryui-demo-element" id="draggable-event-drag"><span>Drag <span class="event-count">0</span>x</span></div>
										<div class="jqueryui-demo-element" id="draggable-event-stop"><span>Stop <span class="event-count">0</span>x</span></div>
									</div>
								</div>
							</div>
							<!-- /events -->
					...
					<h6 class="content-group text-semibold">
						Droppable
						<small class="display-block">Create targets for draggable elements</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat" id="droppable-basic-container">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Default functionality</h6>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									<p class="content-group">Enable any DOM element to be droppable, a target for draggable elements. This is a very basic example with default options, to see it in action simply drag grey circle and drop to the blue one. Callback is included.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element" id="droppable-basic-element"><span>Drag me</span></div>
										<div class="jqueryui-demo-element droppable-demo-target" id="droppable-basic-target"><span>Drop here</span></div>
									</div>
								</div>
							</div>
							<!-- /default functionality -->
						...
						<div class="col-md-6">
							...
							<!-- Accept drop -->
							<div class="panel panel-flat" id="droppable-accept-container">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Accept drop</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Specify using the <code>accept</code> option which element (or group of elements) is accepted by the target droppable. Can be either a selector indicating which draggable elements are accepted or a function.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element" id="droppable-accept-yes"><span>Accept</span></div>
										<div class="jqueryui-demo-element" id="droppable-accept-no"><span>Not accept</span></div>
										<div class="jqueryui-demo-element droppable-demo-target" id="droppable-accept-target"><span>Drop here</span></div>
									</div>
								</div>
							</div>
							<!-- /accept drop -->
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat" id="droppable-revert-container">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Revert draggable position</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Return the draggable (or it's helper) to its original location when dragging stops with the boolean <code>revert</code> option. If set to <code>true</code> the element will always revert. Also can be a string (<code>valid</code> or <code>invalid</code>) or a function.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element" id="droppable-revert-drop"><span>On drop</span></div>
										<div class="jqueryui-demo-element" id="droppable-revert-except"><span>Except drop</span></div>
										<div class="jqueryui-demo-element droppable-demo-target" id="droppable-revert-target"><span>Drop here</span></div>
									</div>
								</div>
							</div>
							<!-- /revert draggable position -->
						...
						<div class="col-md-6">
							...
							<!-- Visual feedback -->
							<div class="panel panel-flat" id="droppable-visual-container">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Visual feedback</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Change the droppable's appearance on hover, or when the droppable is active (an acceptable draggable is dropped on it). Use the <code>hoverClass</code> or <code>activeClass</code> options to specify respective classes.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element" id="droppable-visual-element"><span>Drag me</span></div>
										<div class="jqueryui-demo-element droppable-demo-target" id="droppable-visual-target-active"><span>When active</span></div>
										<div class="jqueryui-demo-element droppable-demo-target" id="droppable-visual-target-hover"><span>On hover</span></div>
									</div>
								</div>
							</div>
							<!-- /visual feedback -->
					...
					<h6 class="content-group text-semibold">
						Resizable
						<small class="display-block">Change the size of an element using the mouse</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<!-- Default functionality -->
							<div class="panel panel-flat" id="resizable-basic-container">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Default functionality</h6>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									<p class="content-group">Enable any DOM element to be resizable. With the cursor grab the right or bottom border and drag to the desired width or height. To see resizable in action simply drag resizable handle on bottom right corner.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element no-border-radius" id="resizable-basic-element"><span>Resize me</span></div>
									</div>
								</div>
							</div>
							<!-- /default functionality -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Animated resize</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Animate the resize action using the <code>animate</code> option. When this option is set to <code>true</code>, drag the outline to the desired location; the element animates to that size on drag stop. Supports easing and duration options.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element no-border-radius" id="resizable-animate-element"><span>Resize me</span></div>
									</div>
								</div>
							</div>
							<!-- /Animated resize -->
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat" id="resizable-basic-container">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Synchronous resize</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Resize multiple elements simultaneously by clicking and dragging the sides of one. Pass a shared selector into the <code>alsoResize</code> option or get/set the <code>alsoResize</code> option after initialization. Try to resize any block.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element no-border-radius" id="resizable-sync-element1"><span>Resize me</span></div>
										<div class="jqueryui-demo-element no-border-radius" id="resizable-sync-element2"><span>Resize me</span></div>
									</div>
								</div>
							</div>
							<!-- /synchronous resize -->
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Preserve aspect ratio</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Maintain the existing aspect ratio or set a new one to constrain the proportions on resize. Set the <code>aspectRatio</code> option to <code>true</code>, and optionally pass in a new ratio (i.e., 4/3). Here aspect ratio is set to <strong>16/9</strong>.</p>

									<div class="jqueryui-demo-container text-center">
										<div class="jqueryui-demo-element no-border-radius" id="resizable-ratio-element"><span>Resize me</span></div>
									</div>
								</div>
							</div>
							<!-- /preserve aspect ratio -->
					...
					<h6 class="content-group text-semibold">
						Sortable
						<small class="display-block">Reorder elements using the mouse</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Connect list</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Sort items from one list into another by passing a selector into the <code>connectWith</code> option. The simplest way to do this is to group all related lists with a CSS class, and then pass that class into the sortable function.</p>
									...
									<div class="text-center">
										...
										<ul class="selectable-demo-list selectable-demo-connected" id="sortable-list-second">
											<li>List 2 item 1</li>
											<li>List 2 item 2</li>
											<li>List 2 item 3</li>
											<li>List 2 item 4</li>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Include/exclude items</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">Specify which items are eligible to sort using <code>items</code> option. Items excluded from this option are not sortable, nor are they valid targets. To only prevent sorting on certain items, pass a jQuery selector into the <code>cancel</code> option.</p>

									<div class="text-center">
										<ul class="selectable-demo-list selectable-demo-connected" id="sortable-list-specify">
											<li>List 1 item 1</li>
											<li class="ui-handle-excluded ui-state-disabled"><span class="ui-sortable-handle">Not sortable or a drop target</span></li>
											<li class="ui-handle-excluded ui-state-disabled">Not sortable or a drop target</li>
											<li>List 1 item 4</li>
											<li>List 1 item 5</li>
										</ul>

										<ul class="selectable-demo-list selectable-demo-connected" id="sortable-list-cancel">
											<li>List 2 item 1</li>
											<li class="ui-state-disabled">Not sortable</li>
											<li class="ui-state-disabled">Not sortable</li>
											<li>List 2 item 4</li>
											<li>List 2 item 5</li>
										</ul>
					...
					<h6 class="content-group text-semibold">
						Selectable
						<small class="display-block">Use the mouse to select elements</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									<p class="content-group">Enable a DOM element (or group of elements) to be selectable. Draw a box with your cursor to select items. Hold down the <kbd>Ctrl</kbd> key to make multiple non-adjacent selections. Styles are for demo purposes only.</p>
						...
						<div class="col-md-6">
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Serialize</h6>
									<div class="heading-elements">
										<span class="heading-text">Selected: <strong id="select-result">none</strong></span>
								...
								<div class="panel-body">
									<p class="content-group">Write a function that fires on the stop event to collect the index values of selected items. Present values as feedback, or pass as a data string. Select one or more items to see the callback values on top right corner.</p>
