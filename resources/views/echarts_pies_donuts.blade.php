...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/echarts/pies_donuts.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="echarts_pies_donuts">Pies and donuts</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="echarts_pies_donuts">ECharts</a></li>
