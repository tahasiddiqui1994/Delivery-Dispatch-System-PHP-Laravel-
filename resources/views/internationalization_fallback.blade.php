...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/internationalization_fallback.js')}}"></script>
	<!-- /theme JS files -->
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li><a href="internationalization_switch_query" data-i18n="nav.int.qs"></a></li>
										...
										<li class="active"><a href="internationalization_fallback" data-i18n="nav.int.fallback"></a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Translation</span> - Fallback</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="internationalization_fallback">Translation</a></li>
							<li class="active">Fallback</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Language fallback</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<p class="content-group">Example of defined <code>fallback</code> language. If user selects any language that is missed or detected user navigator language doesn't exist in your <code>/locales/</code> folder, defined fallback language will be loaded. In this example Hungarian and Spanish language files don't exist in <code>/locales/</code> folder. When one of these languages is selected, English language specified in <code>fallbackLng</code> option will be loaded.</p>

							<p class="text-semibold">Language fallback:</p>
							...
							<div class="navbar navbar-inverse bg-teal-400 navbar-component" style="position: relative;">
								...
								<div class="navbar-collapse collapse" id="navbar-demo-mobile">
									<ul class="nav navbar-nav">
										<li class="dropdown language-switch">
											...
											<ul class="dropdown-menu">
												...
												<li><a href="?lang=hu" class="hungarian"><img src="assets/images/flags/hu.png" alt=""> Hungarian</a></li>
												<li><a href="?lang=es" class="spanish"><img src="assets/images/flags/es.png" alt=""> Spanish</a></li>
											</ul>
										</li>
									</ul>
									...
									<ul class="nav navbar-nav navbar-right language-switch">
										...
										<li><a href="?lang=hu" class="hungarian"><img src="assets/images/flags/hu.png" class="position-left" alt=""> HU &rarr;</a></li>
										<li><a href="?lang=es" class="spanish"><img src="assets/images/flags/es.png" class="position-left" alt=""> ES &rarr;</a></li>
									</ul>
								</div>
							</div>
...
&lt;ul class="dropdown-menu">
	...
	&lt;/li>
	&lt;li>
		&lt;a href="?lang=hu" class="hungarian">
			&lt;img src="assets/images/flags/hu.png" alt=""> Hungarian
		&lt;/a>
	&lt;/li>
	...
&lt;/ul>
