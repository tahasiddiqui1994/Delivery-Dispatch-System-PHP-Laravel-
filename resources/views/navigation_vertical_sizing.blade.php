...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/navigation_vertical_sizing.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="navigation_vertical_sizing">Navigation sizing</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Vertical Nav</span> - Sizing</h4>
						</div>

						<div class="heading-elements">
							<span class="heading-text">Navigation size:</span>
							<form class="heading-form" action="#">
								<div class="form-group">
									<select data-placeholder="Select size" class="select select-sm">
										<option></option>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navigation_vertical_sizing">Vertical nav</a></li>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Navigation sizing</h6>
						Change navigation items height in all levels with sizing classes: <code>.navigation-lg (*-sm, *-xs)</code>. To use, add one of them to the navigation container.
				    </div>
				    <!-- /info alert -->
