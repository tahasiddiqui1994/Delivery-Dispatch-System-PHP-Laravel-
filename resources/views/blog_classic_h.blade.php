		...
		<div class="page-content">
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="blog_classic_h">Classic horizontal</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Blog</span> - Horizontal Layout</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="blog_classic_h">Blog</a></li>
				...
				<div class="content">
					...
					<div class="row">
							...
							<div class="panel panel-flat blog-horizontal blog-horizontal-1">
								<div class="panel-heading">
									<h5 class="panel-title text-semibold">
										<a href="#">Blog layout #1 with image</a>
									</h5>
								</div>
						...
						<div class="col-lg-6">
							...
							<div class="panel panel-flat blog-horizontal blog-horizontal-1">
								<div class="panel-heading">
									<h5 class="panel-title text-semibold">
										<a href="#">Blog layout #1 with video</a>
									</h5>
								</div>
								...
								<div class="panel-body">
									...
									<div class="blog-preview">
										<h5 class="blog-title text-semibold">
											<a href="#">Blog layout #2 with image</a>
										</h5>
						...
						<div class="col-lg-6">
							...
							<div class="panel panel-flat blog-horizontal blog-horizontal-2">
								<div class="panel-body">
									...
									<div class="blog-preview">
										<h5 class="blog-title text-semibold">
											<a href="#">Blog layout #2 with video</a>
										</h5>
					...
					<h6 class="content-group text-semibold">
						Layout #3
						<small class="display-block">Layout without buttons</small>
					</h6>
								...
								<div class="panel-body">
									...
									<div class="blog-preview">
										<div class="content-group">
											<h5 class="blog-title text-semibold">
												<a href="#">Blog layout #3 with image</a>
											</h5>
							...
							<div class="panel panel-flat blog-horizontal blog-horizontal-3">
								<div class="panel-body">
									...
									<div class="blog-preview">
										<div class="content-group">
											<h5 class="blog-title text-semibold">
												<a href="#">Blog layout #3 with video</a>
											</h5>
					...
					<h6 class="content-group text-semibold">
						Media sizes
						<small class="display-block">4 different media sizes</small>
					</h6>
									...
									<div class="blog-preview">
										<div class="content-group-sm">
											<h6 class="blog-title text-semibold">
												<a href="#">Blog with small media</a>
											</h6>
					...
					<div class="row">
							...
							<div class="panel panel-flat blog-horizontal blog-horizontal-3">
								<div class="panel-body">
									...
									<div class="blog-preview">
										<div class="content-group-sm">
											<h5 class="blog-title text-semibold">
												<a href="#">Blog with default media</a>
											</h5>
						...
						<div class="col-lg-6">
							...
							<!-- Large size -->
							<div class="panel panel-flat blog-horizontal blog-horizontal-3 blog-horizontal-lg">
								<div class="panel-body">
									<div class="thumb">
										<img src="assets/images/placeholder.jpg" alt="" class="img-responsive">
										<div class="caption-overflow">
									...
									<div class="blog-preview">
										<div class="content-group-sm">
											<h5 class="blog-title text-semibold">
												<a href="#">Blog with large media</a>
											</h5>
					...
					<h6 class="content-group text-semibold">
						Basic layouts
						<small class="display-block">Layouts without media</small>
					</h6>
								...
								<div class="panel-footer panel-footer-transparent pb-20">
									<div class="heading-elements">
										<ul class="list-inline list-inline-condensed heading-text">
											<li><a href="#"><span class="label bg-blue-300">Image</span></a></li>
											<li><a href="#"><span class="label bg-blue-300">Blog</span></a></li>
											<li><a href="#"><span class="label bg-blue-300">Post</span></a></li>
										</ul>

										<a href="#" class="btn bg-blue-400 heading-btn pull-right">Read more <i class="icon-arrow-right14 position-right"></i></a>
									</div>
								</div>
							</div>
							<!-- /clean blog layout #2 -->
							...
							<div class="panel panel-flat">
								...
								<div class="panel-footer panel-footer-transparent">
									<div class="heading-elements">
										...
										<span class="heading-text ml-10">Eugene Kopyov</span>
