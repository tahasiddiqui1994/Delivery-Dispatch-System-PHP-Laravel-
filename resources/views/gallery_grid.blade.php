								...
								<li>
									...
									<ul>
										...
										<li>
											<a href="#">Gallery</a>
											<ul>
												<li class="active"><a href="gallery_grid">Media grid</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Gallery</span> - Media Grid</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="gallery_grid">Gallery</a></li>
							<li class="active">Media grid</li>
						</ul>
				...
				<div class="content">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-sm-6">
							<div class="thumbnail">
								<div class="video-container">
									<iframe allowfullscreen="" frameborder="0" mozallowfullscreen="" src="https://player.vimeo.com/video/127053285?title=0&amp;byline=0&amp;portrait=0" webkitallowfullscreen=""></iframe>
					            </div>
							</div>
						</div>
