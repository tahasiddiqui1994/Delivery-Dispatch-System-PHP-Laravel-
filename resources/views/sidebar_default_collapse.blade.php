...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="sidebar_default_collapse">Default collapsible</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_default_collapse">Sidebars</a></li>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Collapsible default sidebar</h6>
						By default main sidebar is expanded. Use the button in top navbar to collapse <code>default</code> sidebar.
				    </div>
				    <!-- /info alert -->
