...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/extensions/mockjax.min.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/plugins/forms/editable/address.js')}}"></script>
	...
	<script type="text/javascript" src="{{url('assets/js/plugins/forms/inputs/autosize.min.js')}}"></script>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/form_editable.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="form_editable">Editable forms</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Forms</span> - Editable</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="form_editable">Forms</a></li>
