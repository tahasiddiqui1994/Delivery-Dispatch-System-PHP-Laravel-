...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/colors_grey.js')}}"></script>
	<!-- /theme JS files -->
		...
		<div class="page-content">
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="colors_grey">Grey palette</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Colors</span> - Grey Palette</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="colors_grey">Colors</a></li>
							<li class="active">Grey palette</li>
						</ul>
				...
				<div class="content">
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#444444</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#grey_800"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#5555555</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#grey_700"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#666666</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#grey_600"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#777777</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#grey_500"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#888888</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#grey_400"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="p-15">
									<div class="media-body">
										...
										<div class="text-muted mt-5">#999999</div>
									</div>

									<div class="media-right">
										<ul class="icons-list">
											<li><a href="#" data-toggle="modal" data-target="#grey_300"><i class="icon-three-bars"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.text-grey</code> classes</p>
								</div>

								<input type="text" class="form-control text-grey text-uppercase text-semibold text-size-small" value="Input field text">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-grey</code> or classes</p>
								</div>

								<input type="text" class="form-control border-grey border-lg" placeholder="Input field border">
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-grey</code> classes</p>
								</div>

								<input type="text" class="form-control bg-grey-600" placeholder="Input field background">
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								...
								<div class="has-feedback">
									<input type="text" class="form-control bg-grey-600" placeholder="Icon feedback, grey input">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								...
								<select class="form-control bg-grey-600">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								...
								<div class="input-group">
									<span class="input-group-addon bg-grey-600"><i class="icon-menu7"></i></span>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								...
								<div class="input-group">
									<span class="input-group-addon bg-grey-700"><i class="icon-lock2"></i></span>
									<input type="text" class="form-control bg-grey-600" placeholder="Solid background color">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
										<button class="btn bg-grey-600" type="button">Button</button>
									</span>									
								</div>
							</div>
				    	</div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<label class="radio-inline">
									<input type="radio" class="styled" name="grey-radio" checked="checked">
									Selected
								</label>

								<label class="radio-inline">
									<input type="radio" class="styled" name="grey-radio">
									Unselected
								</label>
							</div>
				    	</div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								...
								<select class="select bg-grey-600">
									<optgroup label="Mountain Time Zone">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.bg-grey</code> or classes</p>

									<select class="selectbox bg-grey-600">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								<div class="text-center">
									...
									<select class="bootstrap-select" data-style="bg-grey-600">
										<option value="AZ">Arizona</option>
										<option value="CO">Colorado</option>
										<option value="ID">Idaho</option>
										<option value="WY">Wyoming</option>
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										<ul class="nav nav-tabs bg-grey-600">
				    		...
				    		<div class="panel panel-flat">
								...
								<div class="panel-body">
									<div class="tabbable tab-content-bordered">
										...
										<div class="tab-content bg-grey-600">
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<span class="label bg-grey-600">Grey label</span>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<span class="badge bg-grey-600">390</span>
							</div>
				    	</div>
				    </div>
				    <!-- /text options -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-grey-600" style="width: 55%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-grey-600 progress-bar-striped" style="width: 65%">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<div class="progress progress-lg">
									<div class="progress-bar bg-grey-600 progress-bar-striped active" style="width: 75%">
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th>Last Name</th>
												<th class="bg-grey-600">Username</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												...
												<td>Kopyov</td>
												<td class="bg-grey-600">@Kopyov</td>
											</tr>
											<tr>
												<td>2</td>
												<td class="alpha-grey">Victoria</td>
												<td>Baker</td>
												<td class="bg-grey-600">@Vicky</td>
											</tr>
											<tr>
												<td>3</td>
												<td class="alpha-grey">James</td>
												<td>Alexander</td>
												<td class="bg-grey-600">@Alex</td>
											</tr>
										</tbody>
										<tfoot>
											<tr>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<button type="button" class="btn bg-grey-600"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<button type="button" class="btn bg-grey-600 btn-labeled"><b><i class="icon-menu7"></i></b> Labeled button</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<button type="button" class="btn text-grey-800 border-grey btn-flat"><i class="icon-menu7 position-left"></i> Button</button>
							</div>
				    	</div>
				    </div>
				    <!-- /buttons -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel">
								<div class="panel-heading bg-grey-600">
									<h6 class="panel-title">Grey panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Grey panel using <code>.bg-grey</code> class added to the panel heading
								</div>
							</div>
				    	</div>

				    	<div class="col-md-4">
				    		<div class="panel border-grey-600">
								<div class="panel-heading bg-grey-600">
									<h6 class="panel-title">Grey bordered panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Bordered grey panel using <code>.bg-grey</code> and <code>.border-grey</code> classes
								</div>
							</div>
				    	</div>

				    	<div class="col-md-4">
				    		<div class="panel bg-grey-600">
								<div class="panel-heading">
									<h6 class="panel-title">Grey solid panel</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									Solid grey panel using <code>.bg-grey</code> class added to the panel container
								</div>
							</div>
				    	</div>
				    </div>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<button type="button" class="btn bg-grey-600" data-popup="tooltip-custom" title="Grey tooltip" data-placement="bottom" data-container="body"><i class="icon-comment position-left"></i> Tooltip</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<button type="button" class="btn bg-grey-600" data-popup="popover-custom" title="Grey popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<button type="button" class="btn bg-grey-600" data-popup="popover-solid" title="Grey popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom" data-container="body">
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<button type="button" class="btn bg-grey-600" data-toggle="modal" data-target="#modal_grey"><i class="icon-menu7 position-left"></i> Modal dialog</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<p class="mb-15 text-muted">Using <code>.bg-grey</code> color classes</p>

								<button class="btn bg-grey-600 growl-launch">jGrowl notification</button>
							</div>
				    	</div>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey text-center">
								...
								<button class="btn bg-grey-600 pnotify-launch">Pnotify notification</button>
							</div>
				    	</div>
				    </div>
				    <!-- /notifications and dialogs -->
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								<div class="text-center">
									...
									<p class="mb-15 text-muted">Using <code>.border-grey</code> color classes</p>
								</div>

								<ul class="dropdown-menu border-grey-600 border-lg" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								...
								<ul class="dropdown-menu bg-grey-600" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> Another action</a></li>
									<li><a href="#"><i class="icon-mail5"></i> Something else here</a></li>
									<li class="divider"></li>
				    	...
				    	<div class="col-md-4">
				    		<div class="panel panel-body border-top-grey">
								...
								<ul class="dropdown-menu bg-grey-600" style="display: block; position: static; width: 100%; margin-top: 0; float: none;">
									<li><a href="#"><i class="icon-menu7"></i> <span class="label bg-grey pull-right">Label</span> Action</a></li>
									<li><a href="#"><i class="icon-screen-full"></i> <span class="badge bg-grey pull-right">98</span> Another action</a></li>
									<li class="divider"></li>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn bg-grey-600">Save changes</button>
								</div>
							</div>
						</div>
					</div>
