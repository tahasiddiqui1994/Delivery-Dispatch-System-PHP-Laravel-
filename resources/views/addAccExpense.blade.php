...
<br>
		<!-- Main content -->
                <section class="content">
                    <div class="row">
                        <!-- Form controls -->
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="739bvlxQsQ">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="739bvlxQsQ" data-index="0">
                                <div class="panel-heading ui-sortable-handle">
                                    <div class="btn-group"> 
                                       <a class="btn btn-primary" href="\accExpense\"> <i class="fa fa-plus"></i> View Expenses</a>  
                                  </div>
                              ...
                              <div class="panel-body">
                               ...
                               {!! Form::open(['action'=> 'accExpensesController@store', 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
                                    <div class="form-group">
                                        <label>Expenses Category</label>

                                            <select name="expenseCategory" id="expenseCategory" class="form-control" placeholder="Select" required="">
                                                  @foreach($categories as $category)
													<option value="{{$category->expenseCategory}}">
														{{$category->expenseCategory}}
													</option>
                                                  @endforeach
                                            </select>
                                            <label></label>
											<a class="btn btn-primary pull-right" href="\expenseCategory\create"> <i class="fa fa-fw fa-plus-circle"></i> Quick Add</a>
                                    </div>
									
									<div class="form-group">
                                               <label>Expense Date <font color="red">*</font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                     <i class="fa fa-calendar"></i>
                                                    </div>

                                                    {{ Form::date('expenseDate', \Carbon\Carbon::now(), ['required'=>"", 'class' => "form-control pull-right", 'id'=>"expenseDate"])}}
                                                   </div>
                                            </div>
									...
									<div class="form-group">
										...
										{{ Form::text('amount', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter amount"]) }}
									...
									<div class="form-group">
                                        <label>Truck No</label>
											...
											<select name="truckNo" id="truckNo" class="form-control" placeholder="Select" required="">
											...
											<label></label>
											<a class="btn btn-primary pull-right" href="\truck\create"> <i class="fa fa-fw fa-plus-circle"></i> Quick Add</a>

                                    </div>
									
									<div class="form-group">
                                        <label>Load No</label>
											<select name="loadNo" id="loadNo" class="form-control" placeholder="Select" required="">
                                                  @foreach($loads as $load)
													<option value="{{$load->loadNo}}">{{$load->loadNo}}
													</option>
                                                  @endforeach

                                            </select>
                                            <label></label>
											<a class="btn btn-primary pull-right" href="\load\create"> <i class="fa fa-fw fa-plus-circle"></i> Quick Add</a>
                                    </div>
									
									<!--<div class="form-group">
                                        <label>Gallons<font color="red"></font></label>
                                        <input type="text" name="registratin_fee" class="form-control" placeholder="0.00" required="">
                                    </div>-->
									
									<div class="form-group">
                                        <label>Odometer<font color="red"></font></label>
                                        {{ Form::text('odometerReading', '', ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Odometer reading"]) }}
                                    </div>
