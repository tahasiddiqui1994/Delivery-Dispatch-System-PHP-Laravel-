	...
	<div class="navbar navbar-inverse">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav">
				...
				<li>
					<a class="sidebar-control sidebar-opposite-fix hidden-xs" data-popup="tooltip" title="Hide opposite" data-placement="bottom" data-container="body">
						<i class="icon-lan3"></i>
					</a>
				</li>
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="sidebar_double_visible">Opposite sidebar visible</a></li>
											</ul>
										</li>
										<li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Opposite Visible</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_double_visible">Sidebars</a></li>
							<li class="active">Opposite visible</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Visible opposite sidebar</h6>
						Display opposite sidebar on page load by adding <code>.sidebar-opposite-visible</code> class to the <code>&lt;body></code> tag.
				    </div>
				    <!-- /info alert -->
