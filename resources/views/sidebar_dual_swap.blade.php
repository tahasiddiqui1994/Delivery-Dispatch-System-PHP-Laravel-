	...
	<div class="navbar navbar-inverse">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav">
				...
				<li>
					<a class="sidebar-control sidebar-all-hide hidden-xs" data-popup="tooltip" title="Hide all" data-placement="bottom" data-container="body">
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="sidebar_dual_swap">Swap sidebars</a></li>
											</ul>
										</li>
										<li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sidebars</span> - Dual Swap</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="sidebar_dual_swap">Sidebars</a></li>
							<li class="active">Dual swap</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Swap sidebars</h6>
						All sidebars can be swapped and used together to extend the layout: main/secondary, secondary/main, opposite/main, opposite/secondary, main/secondary/another secondary etc.
				    </div>
				    <!-- /info alert -->
