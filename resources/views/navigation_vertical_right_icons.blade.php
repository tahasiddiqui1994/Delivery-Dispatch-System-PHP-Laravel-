				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion navigation-icons-right">
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="navigation_vertical_right_icons">Right icons</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Vertical Nav</span> - Right Icons</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navigation_vertical_right_icons">Vertical nav</a></li>
							<li class="active">Right icons</li>
						</ul>
				...
				<div class="content">
					...
					<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">
						...
						<h6 class="alert-heading text-semibold">Right positioned icons</h6>
						Default position of top level items is left, it can be changed to right by adding <code>.navigation-icons-right</code> class to the navigation container.
				    </div>
				    <!-- /info alert -->
