...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/lines/line_horizontal_single.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/lines/line_horizontal_single_grouped.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/lines/line_horizontal_multiple.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/dimple/lines/line_horizontal_multiple_grouped.js')}}"></script>
	<!-- /theme JS files -->
								...
								<li>
									...
									<ul>
										<li>
											...
											<ul>
												<li class="active"><a href="dimple_lines_horizontal">Horizontal orientation</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Dimple</span> - Horizontal Lines</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="dimple_lines_horizontal">Dimple</a></li>
							<li class="active">Horizontal lines</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Single line chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Single line grouped</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Multiple line chart</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title text-semibold">Multiple line grouped</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
