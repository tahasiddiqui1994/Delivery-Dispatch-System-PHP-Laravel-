                                ...
                                <div class="panel-body">
									...
									<tbody><tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('companyName', $data->companyName, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Company Name"]) }}

                                            </div></td>
                                          <td><div class="col-sm-10 form-group">
                                                <label>Customer Type<font color="red">*</font></label>

                                                {{ Form::select('customerType', ['Direct Customer'=>'Direct Customer', '3PL'=>'3PL', 'Broker'=>'Broker'], $data->customerType, ['required'=>"", 'class'=>'form-control', 'placeholder'=>"Enter Guardian Name"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('streetNo', $data->streetNo, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Street"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('aptOrSuiteOrOther', $data->aptOrSuiteOrOther, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Apt/Suite/Other"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('state', $data->state, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter state"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('zipCode', $data->zipCode, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Zip code"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('phoneNo', $data->phoneNo, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Phone no."]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('email', $data->email, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Email"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('website', $data->website, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Website"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('motorCarrierNo', $data->motorCarrierNo, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Motor Carrier No"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('taxID', $data->taxID, ['required'=>"", 'class' => "form-control", 'placeholder' => "Enter Tax ID"]) }}

                                            
											</div></td> 
                                     </tr>
                                     <tr><td><div class="col-sm-10 form-group">
                                                <label>Status<font color="red">*</font></label>

                                                {{ Form::select('status', ['Active'=>'Active', 'Inactive'=>'Inactive'], $data->status, ['required'=>"", 'class'=>'form-control', 'placeholder'=>"select"]) }}
