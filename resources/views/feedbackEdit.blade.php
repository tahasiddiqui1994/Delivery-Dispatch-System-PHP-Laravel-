                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
										{!! Form::open(['action'=> ['feedbacksController@update', $data->id], 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
									...
									<tr> 
                                        <td>
                                          	<div class="col-sm-8 form-group">
                                               ...
                                               <select name="name" id="name" class="form-control" placeholder="Select Customer Name">
                                                  @foreach($users as $user)
													<option value="{{$user->name}}">{{$user->name}}, {{$user->id}}
													</option>
                                                  @endforeach
                                                </select>
                                                {{ Form::text('id', $user->id, ['class' => "form-control", hidden]) }}
                                                {{ Form::text('status', $user->status, ['class' => "form-control", hidden]) }}
                                                {{ Form::text('email', $user->email, ['class' => "form-control", hidden]) }}
                                            </div>
										</td> 
                                     </tr>
                                     <tr>
										<td bgcolor="">
											<div class="col-sm-10 form-group">
                                               ...
                                               <select name="receiverName" id="receiver" class="form-control" placeholder="Select Receiver">
                                                ...
                                                {{ Form::text('receiverId', $user->id, ['class' => "form-control", hidden]) }}
                                                {{ Form::text('receiverStatus', $user->status, ['class' => "form-control", hidden]) }}
                                                {{ Form::text('receiverEmail', $user->email, ['class' => "form-control", hidden]) }}
									...
									<tr>
										<td bgcolor="">
											<div class="col-sm-10 form-group">
                                                ...
                                                {{ Form::text('title', '', ['class' => "form-control", 'placeholder' => "Title of report/Feedback"]) }}
									...
									<tr>
										<td bgcolor="">
											<div class="col-sm-10 form-group">
                                                ...
                                                {{ Form::textarea('comments', '', ['class' => "form-control", 'placeholder' => "Enter response"]) }}
									...
									<tr>
										<td bgcolor="">
											<div class="col-sm-10 form-group">
                                                ...
                                                {{ Form::select('status', ['solved'=>'solved', 'unsolved'=>'unsolved'], 'unsolved', ['class'=>'form-control', 'placeholder'=>"select"]) }}
