...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/pages/navbar_single.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										<li class="active"><a href="navbar_single">Single navbar</a></li>
										<li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Navbars</span> - Single</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="navbar_single">Navbars</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Single top navbar</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
								...
								<div class="navbar-collapse collapse" id="navbar-demo-mobile">
									<form class="navbar-form navbar-left">
										<label class="checkbox-inline checkbox-switchery switchery-sm switchery-double">
											Static
											<input type="checkbox" class="toggle-type">
											Fixed
										</label>
									</form>
							...
							<p class="text-semibold">Static navbar markup:</p>
							<pre class="language-markup content-group"><code>&lt;!-- Default navbar -->
&lt;div class="navbar navbar-inverse">
...
&lt;!-- /default navbar -->
							...
							<p class="text-semibold">Top fixed navbar markup:</p>
							<pre class="language-markup"><code>&lt;!-- Body with top padding -->
...
&lt;!-- /body with top padding -->
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Single bottom navbar</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							<p class="content-group">Since navbars are available in 4 different sizes, it's required to specify proper class in <code>&lt;body></code> tag to set correct padding. If single navbar is <strong>sticked to the bottom</strong> of the page, correct body classes will be <code>.navbar-bottom</code> for default height and <code>.navbar-bottom-*</code> for given size - large (<code>*-lg</code>), small (<code>*-sm</code>) and mini (<code>*-xs</code>).</p>
							...
							<div class="navbar navbar-inverse bg-info-700 navbar-component" style="position: relative; z-index: 29;">
								<div class="navbar-header">
									...
									<ul class="nav navbar-nav pull-right visible-xs-block">
										<li><a data-toggle="collapse" data-target="#navbar-demo-mobile2"><i class="icon-grid3"></i></a></li>
									</ul>
								</div>

								<div class="navbar-collapse collapse" id="navbar-demo-mobile2">
									<form class="navbar-form navbar-left">
										<label class="checkbox-inline checkbox-switchery switchery-sm switchery-double">
											Top
							...
							<p class="text-semibold">Bottom fixed navbar markup:</p>
							<pre class="language-markup"><code>&lt;!-- Body with bottom padding -->
