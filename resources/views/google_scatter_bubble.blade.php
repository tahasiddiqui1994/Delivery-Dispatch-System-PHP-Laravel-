...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/google/bubbles/bubble.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/bubbles/bubble_gradient.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/scatter/scatter.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/google/scatter/scatter_diff.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="google_scatter_bubble">Bubble &amp; scatter charts</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Google</span> - Scatter &amp; Bubbles</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="google_scatter_bubble">Google</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Bubble charts</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<div class="content-group">
								<h6 class="text-semibold">Simple bubble chart</h6>
								<p class="content-group">Example of a simple <code>bubble</code> chart. A bubble chart is used to visualize a data set with two to four dimensions. The first two dimensions are visualized as coordinates, the third as color and the fourth as size. Bubble charts can be considered a variation of the scatter plot, in which the data points are replaced with bubbles. By default all bubble charts display tips when hovering over bubbles. </p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Scatter charts</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							...
							<div class="content-group">
								<h6 class="text-semibold">Diff scatter chart</h6>
								<p class="content-group">A <code>diff chart</code> is a chart designed to highlight the differences between two charts with comparable data. By making the changes between analogous values prominent, they can reveal variations between datasets. You create a diff chart by calling the computeDiff method with two datasets to generate a third dataset representing the diff, and then drawing that. Supports all scatter chart options, as it jsut combines 2 charts into 1.</p>
