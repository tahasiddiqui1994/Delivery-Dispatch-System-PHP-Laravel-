...
<head>
	...
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_advanced_difference.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_advanced_missing.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_advanced_small_multiples.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_advanced_transitions.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_advanced_zoom.js')}}"></script>
	<script type="text/javascript" src="{{url('assets/js/charts/d3/lines/lines_advanced_spline_transition.js')}}"></script>
	<!-- /theme JS files -->
...
								<!-- /main -->
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="d3_lines_advanced">Advanced lines</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">D3</span> - Advanced Lines</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="d3_lines_advanced">D3</a></li>
							<li class="active">Advanced lines</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Chained transitions</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<p class="content-group">This variation of a line chart demonstrates a sequence of <code>chained transitions</code>. Clicking on the radio buttons changes the displayed metric. First, the line transitions to the new values. Then, the axes rescale to fit the new data. X-axes remain the same. Transitions may have per-element delays and durations, computed using functions of data similar to other operators. This makes it easy to stagger a transition for different elements, either based on data or index.</p>
							<p>
								<label class="radio-inline"><input type="radio" name="city" class="chained" value="New York" checked="checked"> New York</label>
								<label class="radio-inline"><input type="radio" name="city" class="chained" value="San Francisco"> San Francisco</label>
							</p>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Difference area chart</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Pan and zoom</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Small multiples</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Path transitions</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Missing data with tooltips</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
